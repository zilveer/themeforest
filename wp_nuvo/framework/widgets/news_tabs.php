...
class WW_News_Tabs_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'ww_news_tabs', esc_html__('CS News Tab Widget', 'wp_nuvo'), array('description' => esc_html__('Popular post, recent post and comments.', 'wp_nuvo'),)
        );
    }
            ...
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs">
                    <?php if ($show_popular_posts == 'true'): ?>
                        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo esc_html__('Popular', 'wp_nuvo'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_recent_posts == 'true'): ?>
                        <li><a href="#tab2" data-toggle="tab"><?php echo esc_html__('Recent', 'wp_nuvo'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_comments == 'true'): ?>
                        <li><a href="#tab3" data-toggle="tab"><?php echo esc_html__('Comments', 'wp_nuvo'); ?></a></li>
                    <?php endif; ?>
                </ul>
