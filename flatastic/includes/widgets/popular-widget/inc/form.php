<?php extract(wp_parse_args($instance, $this->defaults)); ?>
	...
	<p>
		<label for="<?php $this->field_id('title'); ?>"><?php _e('Title', 'flatastic'); ?>
	...
	<div class="popw-tabs">
		...
		<h4 class="popw-collapse"><?php _e( 'Type:', 'flatastic'); ?><span></span></h4>
		<div style="display: block" class="popw-inner sort-type">
			<p>
				<label for="<?php $this->field_id('type-popular'); ?>">
					...
					<abbr title="Display the most viewed posts"><?php _e('Popular', 'flatastic')?></abbr>
				</label> <br /><small><?php _e( 'Display the most viewed posts', 'flatastic') ?></small><br />
				...
				<label for="<?php $this->field_id( 'type-latest' )?>">
					...
					<abbr title="Display the latest posts"><?php _e( 'Latest', 'flatastic' )?></abbr>
				</label><br /><small><?php _e( 'Display the latest posts', 'flatastic' ) ?></small>
			</p>
		</div>
	...
	<div class="popw-tabs <?php echo ($type == 'latest') ? 'disabled' : '' ?>" data-tab="calculate">
		<h4 class="popw-collapse"><?php _e('Calculate:', 'flatastic')?><span></span></h4>
		<div class="popw-inner">
			<p>
				<label for="<?php $this->field_id('calculate-views'); ?>">
					...
					<abbr title="Every time the user views the page"><?php _e('Views', 'flatastic'); ?></abbr>
				</label><br /><small><?php _e('Every time user views the post.', 'flatastic'); ?></small><br />
				...
				<label for="<?php $this->field_id('calculate-visits'); ?>">
					...
					<abbr title="Every time the user visits the site"><?php _e('Visits', 'flatastic'); ?></abbr>
				</label><br /><small><?php _e('Calculate only once per visit.', 'flatastic'); ?></small>
			</p>
		</div>
	</div>

	<div class="popw-tabs">
		<h4 class="popw-collapse"><?php _e('Display:', 'flatastic'); ?><span></span></h4>
		<div class="popw-inner">
			<p>
				<label for="<?php $this->field_id('counter'); ?>">
					...
					<?php _e('Display count', 'flatastic'); ?>
				</label><br />
				...
				<label for="<?php $this->field_id('thumb'); ?>">
					...
					<?php _e('Display thumbnail', 'flatastic'); ?>
				</label><br />
				...
				<label for="<?php $this->field_id('excerpt'); ?>">
					...
					<?php _e('Display post excerpt', 'flatastic'); ?>
				</label>
			</p>
			<p>
				<label for="<?php $this->field_id('limit'); ?>"><?php _e('Show how many posts?', 'flatastic'); ?>
					<input id="<?php $this->field_id('limit'); ?>" name="<?php $this->field_name('limit'); ?>" size="5" type="text" value="<?php echo esc_attr($limit); ?>" />
				</label>
			</p>
			<p>
				<label for="<?php $this->field_id('excerptlength'); ?>"><?php _e('Excerpt length', 'flatastic'); ?>
					<input id="<?php $this->field_id('excerptlength'); ?>" name="<?php $this->field_name('excerptlength'); ?>" size="5" type="text"
						   value="<?php echo esc_attr($excerptlength); ?>"/> <?php _e('Words', 'flatastic'); ?>
				</label>
			</p>
		</div>
