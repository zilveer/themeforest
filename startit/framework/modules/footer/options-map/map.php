...
if ( ! function_exists('qode_startit_footer_options_map') ) {
	/**
	 * Add footer options
	 */
	function qode_startit_footer_options_map() {
		...
		$footer_panel = qode_startit_add_admin_panel(
			array(
				'title' => 'Footer',
				'name' => 'footer',
				'page' => '_footer_page'
		...
		$show_footer_top_container = qode_startit_add_admin_container(
			array(
		...
		$show_footer_bottom_container = qode_startit_add_admin_container(
			array(
	...
	add_action( 'qode_startit_options_map', 'qode_startit_footer_options_map', 5);
