...
class HeaderStandardExtended extends HeaderType {
	...
	public function __construct() {
		...
		if(!is_admin()) {
            ...
            $logoAreaHeight       = hue_mikado_filter_px(hue_mikado_options()->getOptionValue('logo_area_height_header_standard_extended'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? intval($logoAreaHeight) : 155;

			$menuAreaHeight       = hue_mikado_filter_px(hue_mikado_options()->getOptionValue('menu_area_height_header_standard_extended'));
	...
	public function headerPerPageStyles($style) {
        ...
        $disable_logo_border = hue_mikado_get_meta_field_intersect('logo_area_border_header_standard_extended',$id) == 'no';
        $disable_logo_grid_border = hue_mikado_get_meta_field_intersect('logo_area_in_grid_border_header_standard_extended',$id) == 'no';

        $disable_menu_border = hue_mikado_get_meta_field_intersect('menu_area_border_header_standard_extended',$id) == 'no';
        $disable_menu_grid_border = hue_mikado_get_meta_field_intersect('menu_area_in_grid_border_header_standard_extended',$id) == 'no';
	...
	public function loadTemplate($parameters = array()) {
        ...
        $parameters['logo_area_in_grid'] = hue_mikado_get_meta_field_intersect('logo_area_in_grid_header_standard_extended',$id) == 'yes' ? true : false;
        $parameters['menu_area_in_grid'] = hue_mikado_get_meta_field_intersect('menu_area_in_grid_header_standard_extended',$id) == 'yes' ? true : false;

		$parameters = apply_filters('hue_mikado_header_standard_extended_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
        ...
        } elseif(hue_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') == '') {
            $logoAreaTransparent = hue_mikado_options()->getOptionValue('logo_area_grid_background_color_header_standard_extended') !== '' &&
                hue_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_standard_extended') !== '1';
        } else {
            $logoAreaTransparent = hue_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') !== '' &&
                hue_mikado_options()->getOptionValue('logo_area_background_transparency_header_standard_extended') !== '1';
        }
		...
		} elseif(hue_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') == '') {
			$menuAreaTransparent = hue_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard_extended') !== '' &&
			                       hue_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard_extended') !== '1';
		} else {
			$menuAreaTransparent = hue_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') !== '' &&
			                       hue_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard_extended') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'mkd_logo_area_background_color_header_standard_extended_meta', true) !== '') {
            ...
            $logoAreaTransparent = hue_mikado_options()->getOptionValue('logo_area_grid_background_color_header_standard_extended') !== '' &&
                hue_mikado_options()->getOptionValue('logo_area_grid_background_transparency_header_standard_extended') === '0';
        } else {
            $logoAreaTransparent = hue_mikado_options()->getOptionValue('logo_area_background_color_header_standard_extended') !== '' &&
                hue_mikado_options()->getOptionValue('logo_area_background_transparency_header_standard_extended') === '0';
        }
		...
		if(get_post_meta($id, 'mkd_menu_area_background_color_header_standard_extended_meta', true) !== '') {
			...
			$menuAreaTransparent = hue_mikado_options()->getOptionValue('menu_area_grid_background_color_header_standard_extended') !== '' &&
			                       hue_mikado_options()->getOptionValue('menu_area_grid_background_transparency_header_standard_extended') === '0';
		} else {
			$menuAreaTransparent = hue_mikado_options()->getOptionValue('menu_area_background_color_header_standard_extended') !== '' &&
			                       hue_mikado_options()->getOptionValue('menu_area_background_transparency_header_standard_extended') === '0';
		}
