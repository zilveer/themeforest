				...
				<div class="container box">
					...
					<div class="row">
						...
						<div class="col-sm-12">
							...
							<h1 data-0="opacity:1;margin-top:50px;margin-bottom:50px;" data-290="opacity:0;margin-top:90px;margin-bottom:10px" class="page-title"><?php esc_html_e("Category", "themesdojo"); ?>: <?php printf( __( ' %s', '' ), '' . single_cat_title( '', false ) . '' );	?></h1>
