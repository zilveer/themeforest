...
<div class="row" id="customer_login">
	...
	<div class="col-sm-6">
		...
		<form method="post" class="login login-form">
			...
			<h3><span><?php _e( 'Login', 'woocommerce' ); ?></span></h3>
			...
			<p class="lost-password pull-left"><?php _e('Lost your password?', ETHEME_DOMAIN); ?> <a href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php _e( 'Remind password', ETHEME_DOMAIN ); ?></a></p>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-sm-6">
		...
		<form method="post" class="register">
			...
			<h3><span><?php _e( 'Register', 'woocommerce' ); ?></span></h3>
