...
<div id="reviews">
	<div id="comments">
		...
		<?php else : ?>
			...
			<p class="woocommerce-noreviews"><?php _e( 'There are no reviews yet.', 'wpdance' ); ?></p>
			...
			<div id="review_form">
				<?php
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['comment_field'] = '<p class="comment-form-rating"><label for="rating">' . __( 'Your Rating', 'wpdance' ) .'</label><select name="rating" id="rating">
