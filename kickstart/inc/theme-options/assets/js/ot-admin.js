...
;(function($) {
  OT_UI = {
	...
	font_preview: function() {
		$("#google_menu_font-font-family").change(function() {
		var font_name = $('#google_menu_font-font-family option:selected').text();
		$('<link/>', {
			href: 'http://fonts.googleapis.com/css?family=' + encodeURI(font_name),
			rel: 'stylesheet',
			type: 'text/css'
		}).appendTo('head');
		$(".menu_font_preview").css('font-family', font_name);
		});
		$('#google_menu_font-font-family').change();
		
		$("#google_page_font-font-family").change(function() {
		var font_name = $('#google_page_font-font-family option:selected').text();
		$('<link/>', {
			href: 'http://fonts.googleapis.com/css?family=' + encodeURI(font_name),
			rel: 'stylesheet',
			type: 'text/css'
		}).appendTo('head');
		$(".title_preview").css('font-family', font_name);
		});
		$('#google_page_font-font-family').change();

		$("#google_fonts_headings-font-family").change(function() {
		var font_name = $('#google_fonts_headings-font-family option:selected').text();
		$('<link/>', {
			href: 'http://fonts.googleapis.com/css?family=' + encodeURI(font_name),
			rel: 'stylesheet',
			type: 'text/css'
		}).appendTo('head');
		$(".heading_preview").css('font-family', font_name);
		});
		$('#google_fonts_headings-font-family').change();

		$("#widget_font_family-font-family").change(function() {
		var font_name = $('#widget_font_family-font-family option:selected').text();
		$('<link/>', {
			href: 'http://fonts.googleapis.com/css?family=' + encodeURI(font_name),
			rel: 'stylesheet',
			type: 'text/css'
		}).appendTo('head');
		$(".widget_preview").css('font-family', font_name);
		});
		$('#widget_font_family-font-family').change();

		$("#google_body_font-font-family").change(function() {
		var font_name = $('#google_body_font-font-family option:selected').text();
		$('<link/>', {
			href: 'http://fonts.googleapis.com/css?family=' + encodeURI(font_name),
			rel: 'stylesheet',
			type: 'text/css'
		}).appendTo('head');
		$(".content_preview").css('font-family', font_name);
		});
		$('#google_body_font-font-family').change();

		
		$("#google_custom_font-font-family").change(function() {
		var font_name = $('#google_custom_font-font-family option:selected').text();
		$('<link/>', {
			href: 'http://fonts.googleapis.com/css?family=' + encodeURI(font_name),
			rel: 'stylesheet',
			type: 'text/css'
		}).appendTo('head');
		$(".custom_font_preview").css('font-family', font_name);
		});
		$('#google_custom_font-font-family').change();
    }
  };
