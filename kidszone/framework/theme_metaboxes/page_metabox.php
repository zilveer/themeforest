...
<?php  wp_reset_postdata();
	...
	function page_meta_save($post_id){
		...
		if ( (key_exists('post_type', $_POST)) && ('page' == $_POST['post_type']) ) :
			...
			|| 'tpl-home.php' == $_POST["page_template"] || 'tpl-feature.php' ==  $_POST["page_template"] || 'tpl-contact.php' == $_POST["page_template"] || 'tpl-fullwidth.php' == $_POST["page_template"] || 'tpl-fullwidth-home.php' == $_POST["page_template"]) :
