      ...
      <div id="of-nav">
        <ul>
          <?php echo $pmc_options_machine->Menu ?>
			...
			<li class="update"><a title="Update" href="#update">Update</a></li>			
		...
		<div class="group" id="import"><h2>Import</h2>
				<div class = "pmc-importer-notes">
					...
					<ol>
						...
						<li>You will only need to manually import Revolution Sliders and add it to sidebar widgets. You can find demo sliders in main zip under DEMO_CONTENT folder.</li>	
						<li>Before import install all plugins.</li>
				...
				<h4>Which demo you wish to import?</h4>
				<p><input type="radio" name="import_demo" value="default" checked>Default Theme -> <a target = "_blank" href="http://brixton.premiumcoding.com">Check demo</a></p>
				<p><input type="radio" name="import_demo" value="demo3" >Demo version 3 -> <a target = "_blank" href="http://brixton.premiumcoding.com/demo3">Check demo</a></p>			
				<p><input type="radio" name="import_demo" value="demo4" >Demo version 4 -> <a target = "_blank" href="http://brixton.premiumcoding.com/demo4">Check demo</a></p>
				<p><input type="radio" name="import_demo" value="demo5" >Demo version 5 -> <a target = "_blank" href="http://brixton.premiumcoding.com/demo5">Check demo</a></p>				
				<p><input type="radio" name="import_demo" value="demo6" >Demo version 6 -> <a target = "_blank" href="http://brixton.premiumcoding.com/demo6">Check demo</a></p>
				<p><input type="radio" name="import_demo" value="demo7" >Demo version 7 -> <a target = "_blank" href="http://brixton.premiumcoding.com/demo7">Check demo</a></p>
				<p><input type="radio" name="import_demo" value="demo8" >Demo version 8 -> <a target = "_blank" href="http://brixton.premiumcoding.com/demo8">Check demo</a></p>				
			<a class="import">Import Demo</a>
		</div>
		<div class="group" id="update"><h2>Update</h2>
			<div class = "amory-importer-notes">
				<h4>Auto updates</h4>
			</div>
			<p>
				If you wish to have auto updates download plugins : <a href="http://envato.github.io/wp-envato-market/" target="_blank">http://envato.github.io/wp-envato-market/</a>
			</p>
		</div>		
	</div> 
      <div class="clear"></div>
...
function of_admin_head() { 
	...
	<?php } elseif (isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'finished'){ ?>	
		$('#update').fadeIn();	
		$('#of-nav li.update').addClass('current');	
	<?php } else { ?>	
		$('.group:first').fadeIn();	
	...
	$('#of_save').live('click',function() {
		...
		$('#of_container iframe').each(function(){
			var content = $(this).contents();
			var html = content.find('.mce-content-body').html();
			var id = content.find('.mce-content-body').attr('data-id');
			$('#'+id).html(html);
		});	
	...
	<?php  if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'true'){   ?>
		$('#of_save').click();
		window.location.href = "<?php echo admin_url( 'themes.php?page=optionsframework&pmc_import=finished' ) ?>";
	<?php } ?>
	<?php  if((isset($_GET["pmc_options"]) && $_GET["pmc_options"] == 'save') || (isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'false')){   ?>
		$('#of_save').click();
	<?php } ?>	
...
public static function optionsframework_machine($options) {
  ...
  if(isset($_GET["pmc_import"]) && $_GET["pmc_import"] == 'start'){   
		...
		if($_GET['import_demo'] == 'default') {
			$theme_xml = PMC_PATH . 'import/brixton.xml';
		} else if($_GET['import_demo'] == 'demo3')  {
			$theme_xml = PMC_PATH . 'import/brixton_3.xml';			
		} else if($_GET['import_demo'] == 'demo4')  {
			$theme_xml = PMC_PATH . 'import/brixton_4.xml';	
		} else if($_GET['import_demo'] == 'demo5')  {
			$theme_xml = PMC_PATH . 'import/brixton_5.xml';				
		} else if($_GET['import_demo'] == 'demo6')  {
			$theme_xml = PMC_PATH . 'import/brixton_6.xml';	
		} else if($_GET['import_demo'] == 'demo7')  {
			$theme_xml = PMC_PATH . 'import/brixton_7.xml';	
		} else if($_GET['import_demo'] == 'demo8')  {
			$theme_xml = PMC_PATH . 'import/brixton_8.xml';				
		} else {
			$theme_xml = PMC_PATH . 'import/brixton.xml';
		}				
		...
		if($_GET['import_demo'] == 'default') {
			...
			$file_widget = PMC_PATH . '/import/widget_3.json';
			import(get_template_directory() . '/admin/import/options_3.json');				
		} else if($_GET['import_demo'] == 'demo4')  {
			$file_widget = PMC_PATH . '/import/widget_4.json';
			import(get_template_directory() . '/admin/import/options_4.json');	
		} else if($_GET['import_demo'] == 'demo5')  {
			$file_widget = PMC_PATH . '/import/widget_5.json';
			import(get_template_directory() . '/admin/import/options_5.json');				
		} else if($_GET['import_demo'] == 'demo6')  {
			$file_widget = PMC_PATH . '/import/widget_6.json';
			import(get_template_directory() . '/admin/import/options_6.json');
		} else if($_GET['import_demo'] == 'demo7')  {
			$file_widget = PMC_PATH . '/import/widget_7.json';
			import(get_template_directory() . '/admin/import/options_7.json');	
		} else if($_GET['import_demo'] == 'demo8')  {
			$file_widget = PMC_PATH . '/import/widget_8.json';
			import(get_template_directory() . '/admin/import/options_8.json');				
		} else {
			$file_widget = PMC_PATH . '/import/widget.json';
			import(get_template_directory() . '/admin/import/options.json');
		}
	...
	foreach ($options as $value) {
		...
		case 'textarea':	
				...
				if(isset($value['options'])){
					...
					if (is_admin() && isset($_GET['page'] ) && $_GET['page'] == "optionsframework" ) {
					ob_start();
					$settings = array( 'quicktags' => true, 'textarea_rows' => 30, 'textarea_name' =>  $value['id'],'editor_class' => 'of-input','editor_height' => '300px');
					// Echo the editor to the buffer
					wp_editor($ta_value,$value['id'],$settings);
