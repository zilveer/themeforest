...
?>
<div
  class="posts-wrap <?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base'], $atts ) ?>">
		...
		<div class="teaser_grid_container">
			...
			<ul class="wpb_thumbnails wpb_thumbnails-fluid vc_clearfix"
				...
				<?php foreach ( $posts as $post ): ?>
					...
					?>
					<li
					  class="grid-post post-item isotope-item <?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $li_span_class, 'vc_teaser_grid_li', $atts ) . $post->categories_css ?>"<?php echo $block_style ?>>
                        <div class="inner isotope-inner">
                            <div class="post-content-wrap"><div class="post-content grid">
