...
?>
<div class="form-third cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">

	<?php do_action( 'woocommerce_before_cart_totals' ); ?>

	<div class="tag-title-wrap clearfix">
		<h4 class="tag-title"><?php _e( 'Cart Totals', 'woocommerce' ); ?></h4>
	</div>
