...
<?php } elseif (get_pix_option('pix_body_background')=='pattern') { ?>
    ...
    background-image: url(<?php echo get_template_directory_uri().'/images/'.get_pix_option('pix_body_background_pattern').'.png'; ?>);
...
#wide_flash, object#wide_flash {
    ...
    top: 0;
    width: 100%;
<?php if (strpos($os,'opera')!==false && strpos($os,'mac')!==false && strpos($os,'applewebkit')!==false) { ?>
	z-index: -1;
<?php } else { ?>
	z-index: 0;
<?php } ?>
...
nav > ul#secondary > li > ul li.nav_li_hover > a {
	color: <?php echo get_pix_option('pix_second_level_hover_2nd'); ?>!important;
}
...
nav > ul#secondary > li > ul li li.nav_li_hover > a {
	color: <?php echo get_pix_option('pix_third_level_hover_2nd'); ?>!important;
}
span.submenu {
	color: <?php echo get_pix_option('pix_first_level_color'); ?>;
    .display: inline;
...
#cboxOverlay{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/overlay.png) 0 0 repeat;}
#colorbox{}
    #cboxTopLeft{width:21px; height:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) -100px 0 no-repeat;}
    #cboxTopRight{width:21px; height:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) -129px 0 no-repeat;}
    #cboxBottomLeft{width:21px; height:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) -100px -29px no-repeat;}
    #cboxBottomRight{width:21px; height:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) -129px -29px no-repeat;}
    #cboxMiddleLeft{width:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) left top repeat-y;}
    #cboxMiddleRight{width:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) right top repeat-y;}
    #cboxTopCenter{height:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/border.png) 0 0 repeat-x;}
    #cboxBottomCenter{height:21px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/border.png) 0 -29px repeat-x;}
    #cboxContent{background:#fff;}
        #cboxLoadedContent{margin-bottom:28px;}
        #cboxTitle{position:absolute; bottom:4px; left:0; text-align:center; width:100%; color:#949494;}
        #cboxCurrent{position:absolute; bottom:4px; left:58px; color:#949494;}
        #cboxSlideshow{position:absolute; bottom:4px; right:30px; color:#0092ef;}
        #cboxPrevious{position:absolute; bottom:0; left:0px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) -75px 0px no-repeat; width:25px; height:25px; text-indent:-9999px;}
        #cboxPrevious.hover{background-position:-75px -25px;}
        #cboxNext{position:absolute; bottom:0; left:27px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) -50px 0px no-repeat; width:25px; height:25px; text-indent:-9999px;}
        #cboxNext.hover{background-position:-50px -25px;}
        #cboxLoadingOverlay{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/loading_background.png) center center no-repeat;}
        #cboxLoadingGraphic{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/loading.gif) center center no-repeat;}
        #cboxClose{position:absolute; bottom:0; right:0; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox1/controls.png) -25px 0px no-repeat; width:25px; height:25px; text-indent:-9999px;}
...
#colorbox{}
    #cboxContent{margin-top:20px;}
        ...
        #cboxPrevious{position:absolute; top:50%; left:5px; margin-top:-32px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox3/controls.png) no-repeat top left; width:28px; height:65px; text-indent:-9999px;}
        #cboxPrevious.hover{background-position:bottom left;}
        #cboxNext{position:absolute; top:50%; right:5px; margin-top:-32px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox3/controls.png) no-repeat top right; width:28px; height:65px; text-indent:-9999px;}
        #cboxNext.hover{background-position:bottom right;}
        #cboxLoadingOverlay{background:#000;}
        #cboxLoadingGraphic{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox3/loading.gif) no-repeat center center;}
        #cboxClose{position:absolute; top:5px; right:5px; display:block; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox3/controls.png) no-repeat top center; width:38px; height:19px; text-indent:-9999px;}
...
#colorbox{}
    #cboxTopLeft{width:25px; height:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border1.png) no-repeat 0 0;}
    #cboxTopCenter{height:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border1.png) repeat-x 0 -50px;}
    #cboxTopRight{width:25px; height:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border1.png) no-repeat -25px 0;}
    #cboxBottomLeft{width:25px; height:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border1.png) no-repeat 0 -25px;}
    #cboxBottomCenter{height:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border1.png) repeat-x 0 -75px;}
    #cboxBottomRight{width:25px; height:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border1.png) no-repeat -25px -25px;}
    #cboxMiddleLeft{width:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border2.png) repeat-y 0 0;}
    #cboxMiddleRight{width:25px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/border2.png) repeat-y -25px 0;}
    #cboxContent{background:#fff;}
        #cboxError{padding:50px; border:1px solid #ccc;}
        ...
        #cboxLoadingOverlay{background:#fff url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/loading.gif) no-repeat 5px 5px;}
...
*/
.cboxIE6 #cboxTopLeft{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderTopLeft.png);}
.cboxIE6 #cboxTopCenter{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderTopCenter.png);}
.cboxIE6 #cboxTopRight{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderTopRight.png);}
.cboxIE6 #cboxBottomLeft{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderBottomLeft.png);}
.cboxIE6 #cboxBottomCenter{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderBottomCenter.png);}
.cboxIE6 #cboxBottomRight{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderBottomRight.png);}
.cboxIE6 #cboxMiddleLeft{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderMiddleLeft.png);}
.cboxIE6 #cboxMiddleRight{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox4/ie6/borderMiddleRight.png);}
...
#cboxOverlay{background:#000;}
#colorbox{}
    #cboxTopLeft{width:14px; height:14px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/controls.png) no-repeat 0 0;}
    #cboxTopCenter{height:14px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/border.png) repeat-x top left;}
    #cboxTopRight{width:14px; height:14px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/controls.png) no-repeat -36px 0;}
    #cboxBottomLeft{width:14px; height:43px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/controls.png) no-repeat 0 -32px;}
    #cboxBottomCenter{height:43px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/border.png) repeat-x bottom left;}
    #cboxBottomRight{width:14px; height:43px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/controls.png) no-repeat -36px -32px;}
    #cboxMiddleLeft{width:14px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/controls.png) repeat-y -175px 0;}
    #cboxMiddleRight{width:14px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/controls.png) repeat-y -211px 0;}
    #cboxContent{background:#fff; overflow:visible;}
        #cboxLoadedContent{margin-bottom:5px;}
        #cboxLoadingOverlay{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/loading_background.png) no-repeat center center;}
        #cboxLoadingGraphic{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/loading.gif) no-repeat center center;}
        #cboxTitle{position:absolute; bottom:-25px; left:0; text-align:center; width:100%; font-weight:bold; color:#7C7C7C;}
        #cboxCurrent{position:absolute; bottom:-25px; left:58px; font-weight:bold; color:#7C7C7C;}
        
        #cboxPrevious, #cboxNext, #cboxClose, #cboxSlideshow{position:absolute; bottom:-29px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox5/controls.png) no-repeat 0px 0px; width:23px; height:23px; text-indent:-9999px;}
...
#colorbox{}
    #cboxContent{margin-top:32px; overflow:visible;}
        ...
        #cboxLoadingGraphic{background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox2/loading.gif) no-repeat center center;}
        #cboxLoadingOverlay{background:#000;}
        #cboxTitle{position:absolute; top:-22px; left:0; color:#000;}
        #cboxCurrent{position:absolute; top:-22px; right:205px; text-indent:-9999px;}
        #cboxSlideshow, #cboxPrevious, #cboxNext, #cboxClose{text-indent:-9999px; width:20px; height:20px; position:absolute; top:-20px; background:url(<?php echo get_template_directory_uri(); ?>/images/colorBox2/controls.png) no-repeat 0 0;}
