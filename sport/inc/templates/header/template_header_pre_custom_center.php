<!-- TEMPLATE HEADER: pre_custom_center -->
...
<?php
    ...
    if ($canon_options['dev_mode'] == "checked") {
        if (isset($_GET['pre_custom_center'])) { $canon_options_frame['pre_custom_center'] = wp_filter_nohtml_kses($_GET['pre_custom_center']); }
    ...
    <div class="outter-wrapper pre-header-container pre-center-head <?php if ($canon_options_frame['use_sticky_preheader'] == 'checked') { echo "canon_sticky"; } ?>">
        ...
        <div class="wrapper">
            <header class="clearfix centered">
                ...
                <?php get_template_part('inc/templates/header/template_header_element_' . $canon_options_frame['pre_custom_center']); ?>
