		...
		return
			array(
				  ...
				  array( 
						...
						"default" => apply_filters( 'pe_theme_view_layout_module_CallToAction_content', __('<h5>This is an action block, a kick-ass invitation to do something. <a href="#">Go Now <i class="icon-right-open-mini"></i></a></h5>','Pixelentity Theme/Plugin') )
						)
				  );
