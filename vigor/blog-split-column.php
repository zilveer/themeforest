...
if(isset($edgt_options['blog_split_column_content_position'])){
	$blog_content_position = $edgt_options['blog_split_column_content_position'];
}
...
if(isset($edgt_options['blog_split_column_number_of_chars']) && $edgt_options['blog_split_column_number_of_chars'] != "") {
	edgt_set_blog_word_count(esc_attr($edgt_options['blog_split_column_number_of_chars']));
}
