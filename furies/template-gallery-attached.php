 ...
 *
 * Template Name: Gallery Attached Images
 * @package WordPress
 */
...
<div id="page_content_wrapper">
    ...
    <div class="inner">
    	...
    	<?php
    		foreach($all_photo_arr as $key => $photo_id)
    		{
	    		...
	    		if(!empty($photo_id))
	    		{
	    		    ...
	    		    $small_image_url = wp_get_attachment_image_src($photo_id, 'gallery_a', true);
	    		}
    	...
    	?>
    		...
    		?>	
    				<a class="fancy-gallery" data-fancybox-group="fancybox-thumb" href="<?php echo $image_url[0]; ?>" <?php if(!empty($pp_portfolio_enable_slideshow_title)) { ?>data-title="<?php echo $image_title; ?> - <?php echo $image_desc; ?>"<?php } ?>>
    					<img src="<?php echo $small_image_url[0]; ?>" alt="" style="height:auto"/>
    				</a><br/>
