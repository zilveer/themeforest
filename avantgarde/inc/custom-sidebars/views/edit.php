...
<h2 style="border-bottom:0"><?php echo esc_attr($sb['id'])?></h2>

<form action="themes.php?page=customsidebars" method="post">
	<?php wp_nonce_field('custom-sidebars-update');?>
	<input type="hidden" name="cs_id" value="<?php echo esc_attr($sb['id'])?>" />
	<div id="titlediv">
		<h3><label for="sidebar_name"><?php _e('Name','custom-sidebars'); ?></label></h3>
		<input type="text" name="sidebar_name" value="<?php echo esc_attr($sb['name'])?>" id="title" maxlength="30" />
	</div>
	
	
	<h3><label for="sidebar_description"><?php _e('Description','custom-sidebars'); ?></label></h3>
	<input type="text" name="sidebar_description" value="<?php echo esc_attr($sb['description'])?>" style="width:100%;margin-bottom:20px;" maxlength="200" />
	...
	<div id="col-right">
		...
		<textarea name="cs_after_title" class="large-text code" style="height:100px;margin-bottom:20px;"><?php echo esc_attr($sb['after_title'])?></textarea>
		
		<h3><label for="cs_after_widget"><?php _e('After Widget','custom-sidebars'); ?></label></h3>
		<textarea name="cs_after_widget" class="large-text code" style="height:100px"><?php echo esc_attr($sb['after_widget'])?></textarea>
	...
	<div id="col-left">
		...
		<textarea name="cs_before_title" class="large-text code" style="height:100px;margin-bottom:20px;"><?php echo esc_attr($sb['before_title'])?></textarea>
		
		<h3><label for="cs_before_widget"><?php _e('Before Widget','custom-sidebars'); ?></label></h3>
		<textarea name="cs_before_widget" class="large-text code" style="height:100px" ><?php echo esc_attr($sb['before_widget'])?></textarea>
