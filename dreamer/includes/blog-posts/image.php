...
<div class="blog-format format-posts single-post <?php if (is_sticky()) { echo 'sticky'; } ?> ">
    ...
    <div class="twelve columns news-item mobile-two">
        <?php if (isset($smof_data['news_image_post_icon']) && !empty($smof_data['news_image_post_icon'])): ?>
            <section class="news-cat-image format-cat-image">
                <img src="<?php echo $smof_data['news_image_post_icon']; ?>" alt="Icon">
            </section>
        <?php endif ?>
        <a href="<?php the_permalink(); ?>" class="photo-link format-link-photo"><?php if ( has_post_thumbnail() ) { the_post_thumbnail('format-large'); } ?>
            <section class="news-hover format-hover hide-for-small">
                <div class="open-news-item open-format-item">
                    <span class="news-link"></span>
                </div>
            </section>
        </a>
        <section style="height: auto;" class="format-large">
