 ...
 *
 *
 * @package 	proStore/woocommerce/checkout/review-order.php
 * @sub-package WooCommerce/Templates/checkout/review-order.php
 * @file		1.0
 * @file(Woo)	1.6.4
 */
?>
...
<div id="order_review">
	...
	<div id="payment">
		...
		<div class="payment_methods methods clearfix">
			<?php
				...
				if ($available_gateways) :
					...
					foreach ($available_gateways as $gateway ) :
						/* Add style="background:none !important" if necessary */
						?>
		...
		<div class="form-row place-order">
			...
			<input type="submit" class="button large" name="woocommerce_checkout_place_order" id="place_order" value="<?php echo apply_filters('woocommerce_order_button_text', __('Place order', 'woocommerce')); ?>" />
