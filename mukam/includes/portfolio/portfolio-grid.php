		   ...
		   <div class="row">
			  <div class="col-md-12 portfolio-wrapper">
				 ...
				 <div class="portfolio-style-1-filter">
					<ul>
						<a href="#portfolio-item-2"><li class="slug-portfolio-item-2 active"><?php echo __('All', 'mukam');?></li></a>
						<?php
				 ...
				 <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					<article class="portfolio-item-2 <?php $categories = wp_get_object_terms($post->ID, 'portfolio-category');
