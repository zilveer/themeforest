...
class PexetoCustomPage{
	 ...
	 * @param $preview_image the ID of the field that will be used for preview 
	 * image of the items
	 ...
	 */
	function __construct($post_type, $fields, $page_name, $allow_multiinstance, $parent_slug, $preview_image, $type, $file_name, $minimizable=true, $set_name=''){
