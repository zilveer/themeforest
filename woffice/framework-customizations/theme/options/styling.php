	...
	'styling' => array(
		...
		'options' => array(
			...
			'other-box' => array(
				...
				'options' => array(
					'design_update' => array(
						'label' => __( 'Main style version', 'woffice' ),
						'type'         => 'switch',
						'right-choice' => array(
							'value' => '1.X',
							'label' => __( '1.X', 'woffice' )
						),
						'left-choice'  => array(
							'value' => '2.X',
							'label' => __( '2.X', 'woffice' )
						),
						'value'        => '2.X',
						'help' => __('This option allows you to remove the design changes from 2.0 update.','woffice'),
					),
					'remove_radius' => array(
