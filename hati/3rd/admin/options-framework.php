...
function optionsframework_load_styles() {
	...
	// wp_enqueue_style('codemirror-style', OPTIONS_FRAMEWORK_URL.'codemirror/codemirror.css');
}	
...
function optionsframework_load_scripts() {
	...
	// wp_enqueue_script('codemirror', OPTIONS_FRAMEWORK_URL.'codemirror/codemirror.js');
	// wp_enqueue_script('codemirror-load', OPTIONS_FRAMEWORK_URL.'codemirror/util/loadmode.js', array('codemirror'));
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options', 'translateme' ),
