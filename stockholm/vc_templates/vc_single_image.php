...
//to disable relative links uncomment this..
	...
	$image_string = !empty($link_to) ? '<a' . esc_attr($a_class) . ' href="' . esc_url($link_to) . '"' . ' target="' . esc_attr($img_link_target) . '"' . '><div class="vc_single_image-wrapper ' . $style . ' ' . $border_color . '">' . $img_output . '</div></a>' : '<div class="vc_single_image-wrapper ' . $style . ' ' . $border_color . '">' . $img_output . '</div>';
	...
	$output .= "\n\t" . '<div class="' . esc_attr($css_class) . esc_attr($clsss_css_animation) . '">';
	$output .= "\n\t\t" . '<div' . wp_kses($delay, array('style')) . '>';
	$output .= "\n\t\t" . '<div class="wpb_wrapper">';
	$output .= "\n\t\t\t" . wpb_widget_title(array('title' => $title, 'extraclass' => 'wpb_singleimage_heading'));
	$output .= "\n\t\t\t" . $image_string;
