...
class crazyblog_Author_setting_menu {

	public $title = 'Author Settings';
	...
	public function crazyblog_menu() {
		...
		$return = array(
			array(
				'type' => 'section',
				'title' => esc_html__( 'Author Page Settings', 'crazyblog' ),
				'name' => 'author_page_settings',
				'fields' => array(
					array(
						'type' => 'toggle',
						'name' => 'author_page_title_section',
						'label' => esc_html__( 'Show Title Section', 'crazyblog' ),
						'description' => esc_html__( 'Enable to show Author page title section', 'crazyblog' ),
					),
					array(
						'type' => 'textbox',
						'name' => 'author_page_title',
						'label' => esc_html__( 'Page Title', 'crazyblog' ),
						'description' => esc_html__( 'Enter the title for Author page', 'crazyblog' ),
						'dependency' => array(
							'field' => 'author_page_title_section',
					...
					array(
						...
						'label' => esc_html__( 'Author Page Layout', 'crazyblog' ),
						'description' => esc_html__( 'Choose the layout for author pages', 'crazyblog' ),
						'items' => array(
							array(
								'value' => 'left',
					...
					array(
						...
						'description' => esc_html__( 'Select sidebar to show at author page', 'crazyblog' ),
						'items' => crazyblog_get_sidebars( true ),
						'dependency' => array(
							'field' => 'author_sidebar_layout',
							'function' => 'vp_dep_sidebar_boolean',
						),
					),
					array(
						'type' => 'select',
						'name' => 'author_post_column',
		...
		return apply_filters( 'crazyblog_vp_opt_author_', $return );
	}
