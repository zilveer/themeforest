<?php
/**
 * Swift Page Builder Media tab for adding media content to visual composer
 *
...
class WPBakeryMediaTab extends SwiftPageBuilderAbstract implements SwiftPageBuilderTemplateInterface {
