<?php
$theme_obj = wp_get_theme('artemis_tg');
...
define("THEMEDEMOURL", 'http://themes.themegoods2.com/artemis');
...
$pp_include_from_skin_arr = array(SHORTNAME.'_font_color', SHORTNAME.'_font_color', SHORTNAME.'_frame_color', SHORTNAME.'_content_color', SHORTNAME.'_link_color', SHORTNAME.'_hover_link_color', SHORTNAME.'_h1_font_color', SHORTNAME.'_button_bg_color', SHORTNAME.'_button_font_color', SHORTNAME.'_button_border_color', SHORTNAME.'_menu_font_color', SHORTNAME.'_active_menu_font_color', SHORTNAME.'_content_opacity_color');
...
if ( function_exists( 'add_image_size' ) ) { 
	...
	add_image_size( 'gallery_3', 300, 300, true );
	add_image_size( 'gallery_4', 225, 225, true );
	add_image_size( 'gallery_a', 900, 9999, true );
	add_image_size( 'project_s', 520, 520, true );
	add_image_size( 'blog', 660, 400, true );
}
...
if (isset($_GET['activated']) && $_GET['activated']){
	...
	include_once(get_template_directory() . "/default_skins.php");
