...
if (!class_exists('MAD_PLUGINS_CONFIG')) {
	...
	class MAD_PLUGINS_CONFIG {
		...
		public function woocommerce_brands_add_tab_woocommerce ($tabs) {
			...
			$tabs['flash_sale'] = __('Flash Sale', 'flatastic');
			return $tabs;
		}
		...
		private function woocommerce_brands_plugin_options() {
			$options['general_settings'] = array(
				array(
					'name' => __( 'General Settings', 'flatastic' ),
					'type' => 'title',
					'desc' => '',
					'id' => 'pw_woocommerce_brands_general_settings'
				),
				array(
					'name'      => __( 'Show Count Down Single', 'flatastic' ),
					'desc'      => __( 'Show Count Down Single.', 'flatastic'),
				...
				array(
					'name'      => __( 'Show Count Down Archive', 'flatastic' ),
					'desc'      => __( 'Show Count Down Archive', 'flatastic' ),
									...
									<div class="fl-pcountdown-cnt">
										<ul class="fl-countdown fl-countdown-pub countdown_' . $id . '">
										  <li><span class="days">00</span><p class="days_text">Days</p></li>
											...
											<li><span class="hours">00</span><p class="hours_text">'.__('Hours','flatastic').'</p></li>
											<li class="seperator">:</li>
											<li><span class="minutes">00</span><p class="minutes_text">'.__('Minutes','flatastic').'</p></li>
											<li class="seperator">:</li>
											<li><span class="seconds">00</span><p class="seconds_text">'.__('Seconds','flatastic').'</p></li>
										</ul>
									</div>
