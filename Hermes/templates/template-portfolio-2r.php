...
?>	
						<div class="sidebar_wrapper" style="margin-left:0">
							...
							<div class="sidebar">
								...
								<div class="content">
									...
									<?php  
										...
										{
									?>
										<h2 class="widgettitle">Filter by Set</h2>
										<ul class="portfolio-main filter"> 
											<li class="all-projects"><a href="javascript:;">All</a></li>
											<?php
												foreach($sets_arr as $key => $set_item)
												{
											?>
											<li class="cat-item <?php echo $set_item->slug; ?>" data-type="<?php echo $set_item->slug; ?>">
						...
						?>
								<div class="portfolio-content section content clearfix" style="width:690px;margin-top:10px;">
											<?php
												...
												foreach($page_photo_arr as $key => $portfolio_item)
												{
													...
													$pp_portfolio_image_height = 111;
											?>
															<div data-id="post-<?php echo $key+1; ?>" class="<?php echo $portfolio_item_set; ?> project" data-type="<?php echo $portfolio_item_set; ?>" style="width:225px;float:left;margin-bottom:50px;">
															<?php
															...
															<div class="portfolio3_shadow">
																...
																<span class="overlay_detail">
																	...
																	<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo $image_url[0]?>&amp;h=<?php echo $pp_portfolio_image_height; ?>&amp;w=184&amp;zc=1" alt="" class="img_nofade frame" width="184" height="<?php echo $pp_portfolio_image_height; ?>"/>
																</a>
															</div>
							        	...
							        	<param name="wmode" value="transparent">
			  				    		...
			  				    		<param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=<?php echo $portfolio_video_id; ?>&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=ffffff&amp;fullscreen=1" />
															...
															?>
																...
																<div class="portfolio_desc" style="width:180px;margin-top:15px">
																	<strong class="header"><?php echo $portfolio_item->post_title?></strong>
																	<?php
