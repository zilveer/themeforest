...
if(YSettings::g('berg_blog_list_sidebar_pos', $pageId) == 'right') {
	$sidebar = 'sidebar-right';
	$posts_size_content = 'col-md-8';
} 
if(YSettings::g('berg_blog_list_sidebar_pos', $pageId) == 'left') {
	$sidebar = 'sidebar-left';
	$posts_size_content = 'col-md-8';
} 
if(YSettings::g('berg_blog_list_sidebar_pos', $pageId) == 'none') {
	$sidebar = 'hidden';
	$posts_size_content = 'col-md-10 col-md-offset-1';
} 

$sidebar_name = YSettings::g('berg_blog_list_sidebar_select', $pageId);


?>
<section id="blog-list" class="section-scroll main-section blog-content blog blog-sidebar blog-list">
