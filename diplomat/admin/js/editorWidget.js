...
TMM_EDITOR_WIDGET = {
	...
	showEditor: function(contentId) {
		jQuery('#tmm-editor-widget-backdrop').show();
		jQuery('#tmm-editor-widget-container').show();
	 ...
	 */
	hideEditor: function() {
		jQuery('#tmm-editor-widget-backdrop').hide();
		jQuery('#tmm-editor-widget-container').hide();
	...
	setEditorContent: function(contentId) {
		var editor = tinyMCE.EditorManager.get('tmm_editorwidget');
		var content = jQuery('#'+ contentId).val();

		if (typeof editor == "object" && editor !== null) {
			editor.setContent(content);
		}
		jQuery('#tmm_editorwidget').val(content);
	},
	...
	updateWidgetAndCloseEditor: function() {
		...
		if (typeof editor == "undefined" || editor == null || editor.isHidden()) {
			var content = jQuery('#tmm_editorwidget').val();
		}
		else {
