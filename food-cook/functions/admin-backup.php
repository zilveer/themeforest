...
class WooThemes_Backup {
	...
	public function register_admin_screen () {
		...
		$this->admin_page = remove_submenu_page('woothemes', __( 'WooThemes Settings Backup', 'woothemes' ), __( 'Backup Settings', 'woothemes' ), 'manage_options', $this->token, array( &$this, 'admin_screen' ) );
