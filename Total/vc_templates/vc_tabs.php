...
if ( ! empty( $atts['style'] ) ) {
	$css_class .= ' tab-style-'. $atts['style'];
}

if ( 'vc_tour' === $this->shortcode ) {
	$next_prev_nav = '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', 'total' ) . '">' . __( 'Previous tab', 'total' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', 'total' ) . '">' . __( 'Next tab', 'total' ) . '</a></span></div>';
} else {
	$next_prev_nav = '';
}
