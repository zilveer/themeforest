/*-----------------------------------------------------------------------------------*/
/* DesThemes Media Library-driven AJAX File Uploader Module - JavaScript Functions */
/* 2010-11-05. */
/*
/* The code below is designed to work as a part of the DesThemes Media Library-driven
...
/*-----------------------------------------------------------------------------------*/
	...
	$( 'input.upload_button' ).removeAttr( 'style' );
      ...
      $( 'input.upload_button').live( "click", function () {
       ...
       if ( $(this).parents( '.section').find( '.heading') ) { des_title = $(this).parents( '.section').find( '.heading').text(); } // End IF Statement
        
        // tb_show( des_title, 'media-upload.php?post_id='+formID+'&type=image&amp;is_desthemes=yes&amp;des_title=' + des_title + '&amp;TB_iframe=1&amp;width=630&amp;height=500' );
        
        // tb_show( des_title, 'media-upload.php?post_id='+formID+'&type=image&amp;is_desthemes=yes&amp;TB_iframe=1&amp;width=630&amp;height=500' );
        
        tb_show( des_title, 'media-upload.php?post_id='+formID+'&amp;title=' + des_title + '&amp;is_desthemes=yes&amp;TB_iframe=1' );
        return false;
      });
  ...
  }; // End desthemesMLU Object // Don't remove this, or the sky will fall on your head.

/*-----------------------------------------------------------------------------------*/
/* Execute the above methods in the desthemesMLU object.
/*-----------------------------------------------------------------------------------*/
  
	$(document).ready(function () {

		desthemesMLU.removeFile();
		desthemesMLU.recreateFileField();
		desthemesMLU.mediaUpload();
