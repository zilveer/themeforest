...
if(!function_exists('qode_startit_accordions_map')) {
   ...
   function qode_startit_accordions_map() {
       ...
       qode_startit_add_admin_field(array(
		...
		$accordions_color_group = qode_startit_add_admin_group(array(
           'name' => 'accordions_color_group',
           'title' => 'Accordion Color Styles',
			'description' => 'Set color styles for accordion title',
           'parent' => $panel
       ));
		$accordions_color_row = qode_startit_add_admin_row(array(
		...
		$active_accordions_color_group = qode_startit_add_admin_group(array(
		...
		$active_accordions_color_row = qode_startit_add_admin_row(array(
		...
		$boxed_accordions_color_group = qode_startit_add_admin_group(array(
           'name' => 'boxed_accordions_color_group',
           'title' => 'Boxed Accordion Title Color Styles',
			'description' => 'Set color styles for boxed accordion title',
           'parent' => $panel
       ));
		$boxed_accordions_color_row = qode_startit_add_admin_row(array(
      ...
      $active_boxed_accordions_color_group = qode_startit_add_admin_group(array(
           'name' => 'active_boxed_accordions_color_group',
           'title' => 'Active and Hover Title Color Styles',
			'description' => 'Set color styles for active and hover accordions',
           'parent' => $panel
       ));
		$active_boxed_accordions_color_row = qode_startit_add_admin_row(array(
