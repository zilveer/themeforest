 ...
 *
 *
 * @package 	proStore/woocommerce/single-product/add-to-cart/variable.php
 * @sub-package WooCommerce/Templates/single-product/add-to-cart/variable.php
 * @file		1.0
 * @file(Woo)	1.6.4
 */
?>
...
<div class="variation_placeholder" style="display:none"></div>
