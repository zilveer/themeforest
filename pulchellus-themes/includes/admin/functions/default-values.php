<?php
	...
	if ( is_admin() && isset($_GET['activated'] ) && $pagenow == 'themes.php' ) {
		$theme_logo = THEME_IMAGE_URL."PulchellusWinter.png";
		$theme_logo_f = THEME_IMAGE_URL."PulchellusWinter-footer.png";
		...
		update_option(THEME_NAME.'_contact_subjects', "Support,Sales,Report a bug");
		...
		update_option(THEME_NAME.'_slider_enable', "off");
		update_option(THEME_NAME.'_layout', "boxed");
		update_option(THEME_NAME.'_color_skin', "winter");
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_template_directory(). '/includes/lib/plugins/layersliderwp-5.3.2.installable.zip', // The plugin source
