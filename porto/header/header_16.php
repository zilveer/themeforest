...
?>
<header id="header" class="header-corporate header-16 <?php echo $search_size ?><?php echo ($porto_settings['logo-overlay'] && $porto_settings['logo-overlay']['url']) ? ' logo-overlay-header' : '' ?>">
