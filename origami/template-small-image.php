 ...
 */
/**
Template Name: Small Image Listing
*/
get_header(); ?>
          ...
          <div class="clearfix">
            ...
            <div class="grid_8">
             ...
             <div class="post">
                ...
                <div class="imgframe"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_post_thumbnail('thumb220'); ?><span class="frame"><span><span><span><span><span class="empty"><em> </em></span></span></span></span></span></span></a></div>
                <?php endif ?>
                <div class="prefix_3">
