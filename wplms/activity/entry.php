		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<div class="activity-meta">
				...
				<?php if ( bp_activity_can_comment() ) : ?>
					...
					<a href="<?php bp_activity_comment_link(); ?>" class="acomment-reply bp-primary-action" id="acomment-comment-<?php bp_activity_id(); ?>"><?php printf( __( 'Comment <span>%s</span>', 'vibe' ), bp_activity_get_comment_count() ); ?></a>
