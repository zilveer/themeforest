<?php
/*
Template Name: Portfolio - Full - 2 columns portrait
*/
get_header(); ?>
...
<?php foreach ( $portfolios as $portfolio) :?>
    ...
    <section id="content" class="clearfix">
    	<div class="content-header-sep"></div>
        	<div class="page page-full portfolio-columns  portfolio-columns portfolio-portrait-columns">
								...
								<?php if( $dt_projectImagebehaviour == 'readmore' ): ?>
                                    <div class="project-image">
                                        <a class="post-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
                                            ...
                                            <img src="<?php resizeimage($thumbnail_src,435,570,$dt_ProjectImageCrop); ?>" alt="<?php the_title(); ?>" />
                                        </a>                     
                                    </div>       
                                <?php endif; ?>
