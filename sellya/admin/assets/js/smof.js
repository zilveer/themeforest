...
/*$(".htabs a:first-child").addClass("selected"); 
 
$(".htabs_container div.htabs_group").css("display","none");
$(".htabs_container div.htabs_group:first-child").css("display","block");
 
 
//Current Menu Class
$(".htabs  a").click(function(evt){
// event.preventDefault();
	...
	$(".htabs_container .htabs_group").hide();
	...
	/*if ($.cookie("of_current_opt") !== null) {
		...
		var cookieval = $.cookie("of_current_opt");
		
		var cookieElem = $(cookieval);
		
		cookieElem.show();
			
		$('#of-nav ul.of_nav_parent > li').each(function(){
		
			$(this).find('a').each(function(){
			
				if($(this).attr('href') == cookieval){
				
					if($(this).parents('ul.sub_nav').length > 0){
						
						$(this).addClass('sub-current').parents('ul.sub_nav').slideDown(400);
						
					}
					
					else{
						
						if($(this).parent().find('ul.sub_nav').length < 1){
	...
	$('#of-nav ul.of_nav_parent > li:first-child > ul.sub_nav').show();
	
	$('#of-nav ul.of_nav_parent > li:first-child > ul.sub_nav > li:first-child > a').addClass('sub-current');
	
	$('#of-nav ul.of_nav_parent > li:first-child > a > span').html('-')
	
	$('.option_group:first-child').show();
	...
	$('#of-nav li a').click(function(){
		...
		if($(this).parents('ul.sub_nav').length < 1){
			$('#of-nav ul.sub_nav').slideUp(400);
			
			$('#of-nav li a span').html('+');
			
		}
		if($(this).parent().find('ul.sub_nav').length>0){
		
			var submenu = $(this).parent().find('ul.sub_nav');
		
			if(submenu.css('display') == 'none' ){
		
				$(this).find('span').html('-');
			
				$(this).parent().find('ul.sub_nav').slideDown(400);
				...
				$(this).parent().find('ul.sub_nav').slideUp(400);	
			}
	...
	$('#of-nav li a').click(function(){
		...
		//$.cookie("of_current_opt", $(this).attr('href'), { expires: 7, path: '/' })
		
		$('#of-nav li a').removeClass('sub-current');
		
		if($(this).parent().find('ul.sub_nav').length>0){
		
			var child = $(this).parent().find('ul.sub_nav > li:first-child > a');
			
			var elemid = child.attr('href');
			
			$('ul.sub_nav li a').removeClass('sub-current');
			
			child.addClass('sub-current');
	...
	$('.of-radio-tile-img').click(function(){
		...
		$(this).parents(".controls").find('.of-radio-tile-img').removeClass('of-radio-tile-selected');
