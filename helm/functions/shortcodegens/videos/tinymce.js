function insertTypeShortcode() {
	...
	switch (videotype) {
		case 'youtube':
			shortcodeText = '<br />[youtube_video ' + vID + vheight + vwidth + ']<br />';
			break;			
		case 'vimeo':
			shortcodeText = '<br />[vimeo_video ' + vID + vheight + vwidth + ']<br />';	
			break;
		case 'dailymotion':
			shortcodeText = '<br />[dailymotion_video ' + vID + vheight + vwidth + ']<br />';	
			break;
		case 'flash':
			shortcodeText = '<br />[flash_video ' + flashsrc + vheight + vwidth + ']<br />';	
			break;
	}
