...
<?php } else { // Display single post ?>
	...
	<div class="blog_row">
		<?php
			$audio_oembed_url = get_post_meta( get_the_ID(), '_sama_oembed', true );
			if( ! empty( $audio_oembed_url ) ) {
		?>
				<div class="video-wrap soundcloud">
					<iframe src="https://w.soundcloud.com/player/?url=<?php echo urlencode( esc_url( $audio_oembed_url) ); ?>&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true" class="soundcloud"></iframe>
				</div>
