...
jQuery(document).ready(function($){
	...
	$('.file_delete_button').live('click', function(){
	// event.preventDefault();
	...
	//Add new file
	$(".file_add_button").live('click', function(){
		var slidesContainer = $(this).prev();
		var sliderId = slidesContainer.attr('id');
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>File ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Title</label><input class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><label>File URL</label><input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button" id="' + sliderId + '_' + newNum + '">Upload</span><span class="button remove-image hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
	...
	//Add new audio
	$(".audio_add_button").live('click', function(){		
		var slidesContainer = $(this).prev();
		var sliderId = slidesContainer.attr('id');
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>Audio ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none; "><label>Title</label><input class="slide of-input of-slider-title" name="' + sliderId + '[' + newNum + '][title]" id="' + sliderId + '_' + newNum + '_slide_title" value=""><label>Artist</label><input class="of-input of-slider-artist" name="' + sliderId + '[' + newNum + '][artist]" id="' + sliderId + '_' + newNum + '_slide_artist" value=""><div class="section-media"><label>Audio URL</label><input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][url]" id="' + sliderId + '_' + newNum + '_slide_url" value=""><div class="upload_button_div"><span class="button media_upload_button_2" id="' + sliderId + '_' + newNum + '">Upload</span><span class="button remove-image-2 hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div></div><div class="section-media"><label>Poster Image URL</label><input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][poster_url]" id="' + sliderId + '_' + newNum + '_poster_url" value=""><div class="upload_button_div"><span class="button media_upload_button_2" id="' + sliderId + '_' + newNum + '">Upload</span><span class="button remove-image-2 hide" id="reset_' + sliderId + '_' + newNum + '" title="' + sliderId + '_' + newNum + '">Remove</span></div><div class="screenshot"></div></div><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
	...
	/**
	  ...
	  * Date 			 : 05.28.2013
	  */
	function optionsframework_add_file_2(event, selector) {
		var upload = $(".uploaded-file"), frame;
		var $el = $(this);
		...
		frame.on( 'select', function() {
			...
			selector.find('.media_upload_button').unbind();
			selector.find('.remove-image-2').css('display','inline-block').removeClass('hide');//show "Remove" button
			selector.find('.of-background-properties').slideDown();
			optionsframework_file_bindings();
		});
	...
	function optionsframework_remove_file_2(selector) {
		selector.find('.remove-image').hide().addClass('hide');//hide "Remove" button
		selector.find('.upload').val('');
		selector.find('.of-background-properties').hide();
		selector.find('.screenshot').slideUp();
	...
	function optionsframework_file_bindings() {
        ...
        $('.remove-image-2').on('click', function() {
			optionsframework_remove_file_2( $(this).parents('.section-upload, .section-media') );
        });
        ...
        $('.media_upload_button').unbind('click').click( function( event ) {
         ...
         $('.media_upload_button_2').unbind('click').click( function( event ) {
        	optionsframework_add_file_2(event, $(this).parents('.section-media'));
        });
    }
