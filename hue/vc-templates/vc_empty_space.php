...
foreach($sizes as $size) {
	if(!empty($$size)) {
		$data_attr['data-'.$size] = hue_mikado_filter_px($$size);
	}
}

$data_attr['data-original-height'] = hue_mikado_filter_px($height);

?>
<div <?php echo hue_mikado_get_inline_attrs($data_attr); ?> class="<?php echo esc_attr(trim($css_class)); ?>" <?php print $inline_css; ?> >
