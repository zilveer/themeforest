...
class BFISidebarModel {
    ...
    public static function registerDynamicSidebar($sidebarName, $sidebarID) {
        register_sidebar(array(
            ...
            'after_widget' => '<div class="clearfix"></div></div></div></article>',
            'before_title' => '<div class="amplus_panel title"><div><h4 class="title">',
            'after_title' => '</h4></div></div><div class="amplus_panel"><div>',
        ));
    }
}
