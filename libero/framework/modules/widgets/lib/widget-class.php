 ...
 * Class LiberoWidget
 */
abstract class LiberoWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'libero'); ?></p>
        <?php }
    }
...
$libero_mikado_Framework = LiberoFramework::get_instance();
$mkdSkinManager = new LiberoSkinManager();
$libero_mikado_Framework->setSkin($mkdSkinManager->getSkin());
