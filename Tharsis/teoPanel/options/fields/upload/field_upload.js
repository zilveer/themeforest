...
jQuery(document).ready(function(){
            ...
            jQuery(".nhp-opts-upload").click( function( event ) {
                ...
                custom_file_frame.on( "select", function() {
                    ...
                    jQuery('.nhp-opts-screenshot',activeFileUploadContext).attr('src', attachment.attributes.url);
                    jQuery('#' + relid ).val(attachment.attributes.url);

                    jQuery('.nhp-opts-upload',activeFileUploadContext).hide();
                    jQuery('.nhp-opts-screenshot',activeFileUploadContext).show();
                    jQuery('.nhp-opts-upload-remove',activeFileUploadContext).show();
            });

            custom_file_frame.open();
        });

    jQuery(".nhp-opts-upload-remove").click( function( event ) {
        var activeFileUploadContext = jQuery(this).parent();
        var relid = jQuery(this).attr('rel-id');
        ...
        jQuery('.nhp-opts-screenshot',activeFileUploadContext).fadeOut('slow');
