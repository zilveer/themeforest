...
class td_smart_list_2 extends td_smart_list {
    ...
    function render_list_item($item_array, $current_item_id, $current_item_number, $total_items_number) {
        ...
        $buffy .= '<div class="td-item">';
            $buffy .= '<span class="td-number-and-title"><h2><span class="td-sml2-current-item-nr">' . $current_item_number. '</span><span class="td-sml2-current-item-title">' . $smart_list_2_title . '</span></h2></span>';
                ...
                if (!empty($first_img_info[0])) {
                    ...
                    $buffy .= '
                            <figure class="td-slide-smart-list-figure td-slide-smart-list-2' . $smart_list_lightbox . '">
                                <a class="td-sml2-link-to-image" href="' . $first_img_all_info['src'] . '" data-caption="' . esc_attr($first_img_caption, ENT_QUOTES) . '">
