...
class recent_posts extends WP_Widget {
	function recent_posts() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'recent_posts', 'description' => 'Displays the post image and title.'.'buler' );



		/* Create the widget. */
		parent::__construct( 'recent_posts-widget', __('Buler - Premium Recent Posts', 'buler'), $widget_ops, '' );
	}
