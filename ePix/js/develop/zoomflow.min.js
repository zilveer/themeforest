    ...
    return this.each(function() {
        ...
        function setupStructure(){
            ...
            for(i=0; i<_items.children().length; i++){
                ...
                //console.log(_c);
                var the_type = 'image',
					  classes = _c.attr('class').replace( 'item-tobe','' );
                ...
                if(the_type=='image'){
					...
					{
                    	_theItems.children().eq(i).append('<canvas class="da-shadow"></canvas><div class="the-bg '+ classes +'" style="background-image: url('+_c.attr('data-source')+')"></div>');
					}
					else
					{
						_theItems.children().eq(i).append('<div class="the-bg '+ classes +'" style="background-image: url('+_c.attr('data-source')+')"></div>');
					}
                }
