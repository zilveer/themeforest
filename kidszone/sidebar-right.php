...
elseif( is_post_type_archive('dt_galleries') ):
	...
	$disable = dt_theme_option('specialty',"disable-everywhere-right-sidebar-for-archives");
	if( is_null($disable) ):
...
elseif( class_exists('woocommerce') && is_product_category() ):
	...
	if(function_exists('dynamic_sidebar') && dynamic_sidebar('product-category-sidebar-right') ): endif;
...
elseif( class_exists('woocommerce') && is_product_tag() ):
	...
	if(function_exists('dynamic_sidebar') && dynamic_sidebar('product-tag-sidebar-right') ): endif;
...
elseif( is_404() ):
	...
	$disable = dt_theme_option('specialty',"disable-everywhere-right-sidebar-for-404");
	if( is_null($disable) ):
		if(function_exists('dynamic_sidebar') && dynamic_sidebar(('display-everywhere-sidebar-right')) ): endif;
	endif;
