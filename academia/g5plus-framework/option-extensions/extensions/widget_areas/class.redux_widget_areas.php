        ...
        */
        public function __construct( $parent ) {
            ...
            if ( empty( $this->extension_dir ) ) {
                $this->extension_dir = trailingslashit( str_replace( '\\', '/', G5PLUS_THEME_DIR . 'g5plus-framework/option-extensions/extensions/widget_areas/' ) );
            ...
            ?>
              <script type="text/html" id="redux-add-widget-template">
				<div id="redux-add-widget" class="widgets-holder-wrap">
				 <div class="">
				  <input type="hidden" name="redux-nonce" value="<?php echo esc_attr($nonce) ?>" />
				  <div class="sidebar-name">
				   <h3><?php echo esc_html__('Create Widget Area', 'g5plus-academia'); ?> <span class="spinner"></span></h3>
				  </div>
				  <div class="sidebar-description">
					<form id="addWidgetAreaForm" action="" method="post">
				      <div class="widget-content">
				        <input id="redux-add-widget-input" name="redux-add-widget-input" type="text" class="regular-text" title="<?php echo esc_html__('Name', 'g5plus-academia'); ?>" placeholder="<?php echo esc_html__('Name', 'g5plus-academia'); ?>" />
				      </div>
				      <div class="widget-control-actions">
				        <div class="aligncenter">
				          <input class="addWidgetArea-button button-primary" type="submit" value="<?php echo esc_html__('Create Widget Area', 'g5plus-academia'); ?>" />
				        </div>
				        <br class="clear">
				      </div>
				    </form>
