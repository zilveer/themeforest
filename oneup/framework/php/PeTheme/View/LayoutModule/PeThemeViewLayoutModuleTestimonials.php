...
class PeThemeViewLayoutModuleTestimonials extends PeThemeViewLayoutModuleServices {
		...
		return
			array(
				  ...
				  array(
						...
						"type"=>"Links",
						"description" => __("Add one or more testimonial. If none selected, all available testimonials will be shown.",'Pixelentity Theme/Plugin'),
	...
	public function tooltip() {
		return __("Use this block to add a testimonial module to your layout, testimonial items are created separately.",'Pixelentity Theme/Plugin');
	}
