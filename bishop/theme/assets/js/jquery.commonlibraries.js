...
var YIT_Browser = {
    ...
    isResponsiveOn: function() {
        return jQuery( document.body).hasClass('responsive');
    },

    isTablet: function () {
        return this.isResponsiveOn() && ( this.isViewportBetween( 1024, 768 ) || jQuery( document.body ).is( '.isIpad, .isBlakberrytablet, .isAndroid-tablet, .isPalm') );
    },

    isPhone: function () {
        return this.isResponsiveOn() && ( this.isViewportBetween( 767 ) || jQuery( document.body ).is('.isIphone, .isWindows-phone, .isAndroid, .isBlackberry') );
    },
    ...
    isIE: function () {
        return jQuery( document.body ).is( 'ie' );
    },
...
//center
;(function(a,b){a.fn.center=function(){c=this;d=a(b).height();e=a(b).width();c.css({position:'fixed',top:Math.max(0,((d-c.outerHeight())/2))+"px",left:Math.max(0,((e-c.outerWidth())/2))+"px"});return c;}})(jQuery,window)

//sticky footer
;(function(a){var d;a.fn.extend({stickyFooter:function(e){function c(){var b = a(document.body).height() - a("#sticky-footer-push").height();b < a(window).height() && (b = a(window).height() - b, 0 < !a("#sticky-footer-push").length && a(d).before('<div id="sticky-footer-push"></div>'), 0 < a("#wpadminbar").length && (b -= 28), a("#sticky-footer-push").height(b))}d = this;c();a(window).on("sticky", c).scroll(c).resize(c)}})})(jQuery);
 ...
 * version 1.0
 * copyright (c) 2012 https://github.com/simov/simplr-smoothscroll licensed under MIT
 */
/**
 * jquery.simplr.smoothscroll
 * version 1.0
...
;(function(e){"use strict";e.srSmoothscroll=function(t){var n=e.extend({step:85,speed:600,ease:"linear"},t||{});var r=e(window),i=e(document),s=r.scrollTop(),o=n.step,u=n.speed,a=r.height(),f=navigator.userAgent.indexOf("AppleWebKit")!==-1?e("body"):e("html"),l=false;e("body").mousewheel(function(e,t){l=true;if(t<0)s=s+a>=i.height()?s:s+=o;else s=s<=0?0:s-=o;f.stop().animate({scrollTop:s},u,n.ease,function(){l=false});return false});r.on("resize",function(e){a=r.height()}).on("scroll",function(e){if(!l)s=r.scrollTop()})}})(jQuery);
...
(function ($, window, document) {
    ...
    $.yit_faq.prototype = {
        ...
        _open : function( selector ) {
            this._closeAll();
            selector.toggleClass('active').find(':first-child').toggleClass('fa-plus').toggleClass('plus').toggleClass('fa-minus').toggleClass('minus');
