...
class RecentPostsPlus extends WP_Widget {
    ...
    private $default_config = array(
        ...
        'truncate_elipsis'           => '...',
        'post_thumbnail_width'       => '95',
        'post_thumbnail_height'      => '71',
        'post_date_format'           => 'd M Y',
        'wp_query_options'           => '',
        'widget_output_template'     => '
        <div class="news-item">
        <a href="{PERMALINK}" class="img-polaroid-a no_thickbox">{THUMBNAIL}</a>
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => __('The most recent posts on your site. Includes advanced options.', 'ch')
        );
        parent::__construct('recent-posts-plus', __('Believe - Recent Posts Plus', 'ch'), $widget_ops);
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Number of posts to show:', 'ch'); ?></label>
        ...
        <p>
            <?php if( current_theme_supports('post-thumbnails') ): ?>
                ...
                <label for="<?php echo $this->get_field_id('include_post_thumbnail'); ?>"><?php _e('Include post thumbnail', 'ch'); ?></label><br>
            <?php endif; ?>
            ...
            <label for="<?php echo $this->get_field_id('include_post_excerpt'); ?>"><?php _e('Include post excerpt', 'ch'); ?></label><br>
            ...
            <label for="<?php echo $this->get_field_id('show_expert_options'); ?>"><?php _e('Show expert options', 'ch'); ?></label>
        </p>

        <div class="rpp_expert-panel" style="display:none; margin-top: 10px">

            <p>
                <label for="<?php echo $this->get_field_id('truncate_post_title'); ?>"><?php _e('Limit post title:', 'ch'); ?></label>
                ...
                <label for="<?php echo $this->get_field_id('truncate_post_excerpt'); ?>"><?php _e('Limit post excerpt:', 'ch'); ?></label>
                ...
                <label for="<?php echo $this->get_field_id('truncate_elipsis'); ?>"><?php _e('Limit ellipsis:', 'ch'); ?></label>
                ...
                <label for="<?php echo $this->get_field_id('post_date_format'); ?>"><?php _e('Post date format:', 'ch'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a>
            ...
            <?php if( current_theme_supports('post-thumbnails') ): ?>
                <p>
                    <label for="<?php echo $this->get_field_id('post_thumbnail_width'); ?>"><?php _e('Thumbnail size (WxH):', 'ch'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('wp_query_options'); ?>"><?php _e('WP_Query Options', 'ch'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a><br />
            ...
            <p>
                <label for="<?php echo $this->get_field_id('widget_output_template'); ?>"><?php _e('Widget Output Template', 'ch'); ?></label> <a title="View Documentation" target="_blank" href="http://www.pjgalbraith.com/2011/08/recent-posts-plus/">(?)</a><br />
