...
<?php if ( get_option( 'woocommerce_ship_to_billing_address_only' ) === 'no' && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) echo '<div class="columns addresses">'; ?>

<?php foreach ( $get_addresses as $name => $title ) : ?>

	<div class="col col2 address">
		<h3><?php echo $title; ?></h3>
		<p><a href="<?php echo wc_get_endpoint_url( 'edit-address', $name ); ?>" class="edit"><?php _e( 'Edit', 'woocommerce' ); ?></a></p>
		<address>
			<?php
