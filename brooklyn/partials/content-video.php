...
<?php /* start output for classic blog , search , category tag or archive page */ ?>   
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> >
    	...
    	<div class="entry-meta">
            ...
            <?php endif; ?>
            <span class="permalink"><i class="fa fa-link"></i><a title="<?php printf(esc_html__('Permanent Link to %s', 'unitedthemes'), get_the_title()); ?>" href="<?php the_permalink(); ?>"><?php _e('Permalink', 'unitedthemes') ?></a></span>
