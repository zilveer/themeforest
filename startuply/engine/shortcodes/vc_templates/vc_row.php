<?php
$output = $vsc_id = $full_width = $vsc_parallax = $vsc_bg_image = $vsc_bg_position = $vsc_bg_repeat = $vsc_bg_size = $vsc_bg_color = $video_url = $vsc_text_scheme = $vsc_class = $vsc_youtube_url = $video_raster = $css = $bg_image = $bg_color = $vsc_bg_gradient = $vsc_custom_style = '';
