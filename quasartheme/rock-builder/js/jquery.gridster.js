...
;(function($, window, document, undefined) {
    ...
    */
    fn.add_widget = function(html, size_x, size_y, col, row, max_size) {
        ...
        //this.register_widget($w);//XanderRock moved below set_dom_grid_height() function

        this.add_faux_rows(pos.size_y);
        //this.add_faux_cols(pos.size_x);
		
		this.register_widget($w);//XanderRock
    ...
    */
    fn.register_widget = function($el) {
		...
		//console.dir(wgd);//XanderRock
		//console.dir($el);//XanderRock
    ...
    */
    fn.update_widget_position = function(grid_data, value) {
        this.for_each_cell_occupied(grid_data, function(col, row) {
			//console.log("COL "+col+ " ROW "+row);//XanderRock
            if (!this.gridmap[col]) { return this; }
			//console.log("	AFTER COL "+col+ " ROW "+row+" VAL "+value);//XanderRock
    ...
    */
    fn.add_to_gridmap = function(grid_data, value) {
        ...
        if (grid_data.el) {
			//console.log("EL DEFINED");//XanderRock
    ...
    */
    fn.can_move_to = function(widget_grid_data, col, row, max_row) {
		...
		//Prevent widgets to go out of max_size_x
		if(right_col > this.options.max_size_x){
			//return false;	
		}
    ...
    */
    fn.add_faux_cell = function(row, col) {
        ...
        this.gridmap[col][row] = false;// XanderRock : continue from here
    ...
    */
    fn.add_faux_rows = function(rows) {
		...
		//console.log("ACTUAL ROWS "+actual_rows+" MAX ROWS "+max_rows);
