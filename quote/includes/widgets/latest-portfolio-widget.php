<?php
class DistinctiveThemes_Recent_Portfolio_Widget extends WP_Widget {
    function DistinctiveThemes_Recent_Portfolio_Widget() { 
        parent::WP_Widget(false, $name = 'DistinctiveThemes Recent Portfolio Widget'); 
    }
...
function form($instance) {  
    ...
    <p><label for="<?php echo $this->get_field_id('dis_posts'); ?>"><?php _e('Number of Portfolio Items Displayed (Required):', 'quote' ); ?> <input class="widefat" id="<?php echo $this->get_field_id('dis_posts'); ?>" name="<?php echo $this->get_field_name('dis_posts'); ?>" type="text" value="<?php echo $dis_posts; ?>" /></label></p>
...
function widget($args, $instance) { 
    ...
    <div class="dt-recent-posts">
        <?php global $post;
        $args = array( 'numberposts' => $dis_posts, 'post_type' => 'dt_portfolio_cpt');
...
<?php add_action('widgets_init', create_function('', 'return register_widget("DistinctiveThemes_Recent_Portfolio_Widget");')); ?>