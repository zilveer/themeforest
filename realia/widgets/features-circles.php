...
class Aviators_Widget_Features_Circles extends WP_Widget {
    function __construct( $id_base = null, $name = null, $widget_options = array(), $control_options = array() )  {
        if( !$id_base ) {
            $id_base = 'aviators_features_circles';
        }

        if ( ! $name ) {
            $name = __( 'Features Circles', 'aviators' );
        }
        ...
        <div class="<?php echo esc_attr( $instance['class'] ); ?>">
            <div class="row">
                <?php for( $i = 1; $i <= 3; $i++) : ?>
                    ...
                    <?php $icon_id = 'icon_' . $i; ?>
                    <?php $button_link_id = 'button_link_' . $i; ?>
                    <?php $button_text_id = 'button_text_' . $i; ?>

                    <div class="feature-wrapper col-sm-4">
                        <div class="feature-box">
                            ...
                            <div class="feature-content">
                                ...
                                <?php if ( ! empty( $instance[ $button_link_id ] ) && ! empty( $instance[ $button_text_id ] ) ) : ?>
                                    <a class="btn btn-primary" href="<?php echo esc_attr( $instance[ $button_link_id ] ); ?>"><?php echo esc_attr( $instance[ $button_text_id ] ); ?></a>
                                <?php endif; ?>
                            </div><!-- /.feature-content -->
                        </div><!-- /.feature-box -->
                    </div><!-- /.feature-wrapper -->
    ...
    function form( $instance ) {
        ...
        <?php for ( $i = 1; $i <= 3; $i++ ) : ?>
            ...
            <?php $button_link = ! empty( $instance[ $button_link_id ] ) ? $instance[ $button_link_id ] : ''; ?>
            <?php $button_text = ! empty( $instance[ $button_text_id ] ) ? $instance[ $button_text_id ] : ''; ?>
                ...
                <div class="widget">
                    ...
                    <div class="widget-inside">
                        ...
                        <p>
                            ...
                            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( $button_text_id ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( $button_text_id ) ); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>"/>
                        </p>
