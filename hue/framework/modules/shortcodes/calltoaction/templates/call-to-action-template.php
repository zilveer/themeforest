...
<?php } ?>
	...
	<div class="mkd-call-to-action <?php echo esc_attr($type) ?>" <?php hue_mikado_inline_style($call_to_action_styles); ?>>
		...
		<?php } ?>
				...
				<?php } ?>
					...
					<div class="mkd-call-to-action-text" <?php echo hue_mikado_get_inline_style($content_styles) ?>>
						<?php
						echo hue_mikado_remove_auto_ptag($content, true);
						?>
					</div>
				...
				<?php if ($show_button == 'yes') { ?>
					...
					<div class="mkd-button-wrapper mkd-call-to-action-column2 mkd-call-to-action-cell" style ="text-align: <?php echo esc_attr($button_position) ?> ;">
						...
						<?php echo hue_mikado_get_button_html($button_parameters); ?>
