...
$options = array(
    ...
    array('name' => __('Gallery images','tfuse'),
        'desc' => __('Upload the images for your gallery.The resolution for full page is 960x460 and with sidebar is 630x286','tfuse'),
        'id' => TF_THEME_PREFIX . '_post_gallery',
        'value' => '',
        'type' => 'multi_upload',
    ),
    // Single Image
