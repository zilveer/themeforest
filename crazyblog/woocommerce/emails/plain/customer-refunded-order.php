...
echo sprintf( esc_html__( "Hi there. Your order on %s has been refunded. Your order details are shown below for your reference:", 'crazyblog' ), get_option( 'blogname' ) ) . "\n\n";
