...
//                 var yit_this_object = null;
//                 
//                 $('.upload-image').click(function(){
//                     yit_this_object = $(this).prev();
//                     alert(yit_this_object + ' + ' + $(this).prev());
//                 });
//                     
//                 window.send_to_editor = function(html) {
//                  imgurl = $('img', html).attr('src');
//                  yit_this_object.val(imgurl);
//                  yit_this_object = null;
//                  
//                  tb_remove();
//              }          
            });  
    ...
    function update( $new_instance, $old_instance ) {
        ...
        yit_wpml_register_string( 'Widgets', 'widget_text_image' . sanitize_title( $instance['text'] ), $instance['text'] );
