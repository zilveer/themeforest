            ...
            foreach ( $data as $block ) {
                ...
                if ( $block->name === 'title' ) {
                    ...
                    if ( $block->mode === 'custom' ) {
                        ...
                        $settings[] = $block->mode;
                        $post->excerpt = wp_trim_words( $this->getPostExcerpt(), 25 );
                    } else {
                        $settings[] = $block->mode;
        ...
        <div class="teaser_grid_container">
            ...
            <ul class="wpb_thumbnails wpb_thumbnails-fluid vc_clearfix" data-layout-mode="<?php echo $grid_layout_mode ?>">
                ...
                <?php foreach ( $posts as $post ): ?>
                    ...
                    ?>
                <li class="isotope-item <?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $li_span_class, 'vc_teaser_grid_li', $atts ) . $post->categories_css ?>"<?php echo $block_style ?>>
