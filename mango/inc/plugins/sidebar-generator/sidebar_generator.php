...
class sidebar_generator {
        ...
        if(is_array($sidebars)){
            foreach($sidebars as $sidebar){
				...
				//if(!empty($sidebar)){
					$arg = array(
						'name'=>  $sidebar ,
						'id' =>  str_replace(" ","-", $sidebar),
						'before_widget' => '<div id="%1$s" class="page-sidebar widget '.$sidebar_class.' %2$s">',
						'after_widget' => '</div>',
    ...
    public static function admin_page(){
        ...
        <div class="wrap">
            <h2 class="h2">Sidebar Generator</h2>
            <p>
    ...
    */
    ...
    <div id='sbg-sortables' class='meta-box-sortables'>
        <div id="sbg_box" class="postbox " >
            <div class="handlediv" title="Click to toggle"><br /></div><h3 class='h3 hndle'><span>Sidebars</span></h3>
            <div class="inside">
