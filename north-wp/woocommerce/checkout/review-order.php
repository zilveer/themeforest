...
<?php endif; ?>
		<table class="shop_table woocommerce-checkout-review-order-table order_table">
			<thead>
				<tr>
					<th class="product-name" colspan="3"><?php _e( 'Product', 'north' ); ?></th>
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								<td class="product-name" colspan="3">
									<h6><?php echo apply_filters( 'woocommerce_cart_item_name', $_product->get_title(), $cart_item, $cart_item_key ); ?>
			...
			<tfoot>
				...
				<tr class="cart-subtotal">
					<th colspan="3"><?php _e( 'Subtotal', 'north' ); ?></th>
