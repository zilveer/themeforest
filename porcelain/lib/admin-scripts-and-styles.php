...
if ( !function_exists( 'pexeto_register_admin_scripts_and_styles' ) ) {
	function pexeto_register_admin_scripts_and_styles() {
		...
		wp_register_script( 'pexeto-jquery-form', PEXETO_SCRIPT_URL.'jquery-form.js', array( 'jquery' ) , $ver);
		...
		wp_register_script( 'pexeto-update', PEXETO_SCRIPT_URL.'update-notifier.js' , array(), $ver);
