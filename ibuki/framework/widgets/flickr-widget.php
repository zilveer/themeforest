...
class Quick_Flickr_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct( 
			'quick-flickr-widget', 
			__('Quick Flickr Widget', AZ_THEME_NAME), array(
			'description' => __('Display up to 20 of your latest Flickr submissions in your sidebar.', AZ_THEME_NAME)
		) );
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php _e( 'Username or RSS:', AZ_THEME_NAME ); ?></label> 
			<input class="widefat" id="<?php echo $this->get_field_id( 'username' ); ?>" name="<?php echo $this->get_field_name( 'username' ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" />
		</p>
		<p>
			<label for="<?php echo $this->get_field_id( 'tags' ); ?>"><?php _e( 'Tags:', AZ_THEME_NAME ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Count:', AZ_THEME_NAME ); ?></label><br />
