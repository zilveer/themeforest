 ...
 * Dual-licensed under the BSD or MIT licenses: http://socialitejs.com/license.txt
 */
(function(e,t,n,r){n.network("pinterest",{script:{src:"//assets.pinterest.com/js/pinit.js"}});n.widget("pinterest","pinit",{process:function(e){if(e.el.nodeName.toLowerCase()!=="a"){return true}var t="socialite-instance-"+e.uid,n=e.el.getAttribute("href");e.el.id=t;e.el.href="#"+t;e.el.setAttribute("data-default-href",n);e.el.setAttribute("onclick",'(function(){window.open("'+n+'")})();')},init:function(e){n.processInstance(e);var r=t.createElement("a");r.className="pin-it-button";n.copyDataAttributes(e.el,r);r.setAttribute("href",e.el.getAttribute("data-default-href"));r.setAttribute("count-layout",e.el.getAttribute("data-count-layout")||"horizontal");e.el.appendChild(r);if(n.networkReady("pinterest")){n.reloadNetwork("pinterest")}}})})(window,window.document,window.Socialite)

jQuery(document).ready(function($) {
	var	articles = $('.social-buttons, .social-buttons-small'), socialised = { }, win = $(window), updateArticles, onUpdate, updateTimeout;
