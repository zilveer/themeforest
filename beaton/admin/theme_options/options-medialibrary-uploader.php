...
if ( ! function_exists( 'optionsframework_mlu_css' ) ) {
        ...
        function optionsframework_mlu_css () {
                ...
                $_html = '';
                $_html .= '<link rel="stylesheet" href="' . esc_url(get_option('siteurl')) . '/' . WPINC . '/js/thickbox/thickbox.css" type="text/css" media="screen" />' . "\n";
...
if ( ! function_exists( 'optionsframework_mlu_js' ) ) {
        ...
        function optionsframework_mlu_js () {
                ...
                // Registers custom scripts for the Media Library AJAX uploader.
                                wp_register_script('of-medialibrary-uploader', get_template_directory_uri().'/includes/admin/js/of-medialibrary-uploader.js', array( 'jquery', 'thickbox' ) );
...
if ( ! function_exists( 'optionsframework_medialibrary_uploader' ) ) {
        ...
        function optionsframework_medialibrary_uploader( $_id, $_value, $_mode = 'full', $_desc = '', $_postid = 0, $_name = '') {
                ...
                $output .= '<input id="' . esc_attr($id) . '" class="upload' . $class . '" type="text" name="' . esc_attr($name) . '" value="' . esc_attr($value) . '" />' . "\n";
                $output .= '<input id="upload_' . esc_attr($id) . '" class="upload_button button" type="button" value="' . esc_attr( 'Upload', 'wizedesign') . '" rel="' . $int . '" />' . "\n";
