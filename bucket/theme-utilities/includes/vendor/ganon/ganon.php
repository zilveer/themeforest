 ...
 */
function wpgrade_str_get_dom($str, $return_root = true) {
 ...
 * @return HTML_Parser_HTML5|HTML_Node
 */
function wpgrade_file_get_dom($file, $return_root = true, $use_include_path = false, $context = null) {
 ...
 * @return bool
 */
function wpgrade_dom_format(&$root, $options = array()) {
