<p>
    <label for="<?php echo $widget->get_field_id('title'); ?>"><?php _e('Title', 'flatastic') ?>:</label>
    <input class="widefat" type="text" id="<?php echo $widget->get_field_id('title'); ?>" name="<?php echo $widget->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>" />
</p>

<p>
	<label for="<?php echo $widget->get_field_id('facebook_links'); ?>"><?php _e('Facebook Link', 'flatastic') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('twitter_links'); ?>"><?php _e('Twitter Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('gplus_links'); ?>"><?php _e('Google Plus Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('pinterest_links'); ?>"><?php _e('Pinterest Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('instagram_links'); ?>"><?php _e('Instagram Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('linkedin_links'); ?>"><?php _e('Linkedin Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('vimeo_links'); ?>"><?php _e('Vimeo Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('youtube_links'); ?>"><?php _e('Youtube Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('flickr_links'); ?>"><?php _e('Flickr Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('vk_links'); ?>"><?php _e('Vkontakte Link', 'flatastic') ?>:</label>
...
<p>
	<label for="<?php echo $widget->get_field_id('contact_us'); ?>"><?php _e('Contact us', 'flatastic') ?>:</label>
