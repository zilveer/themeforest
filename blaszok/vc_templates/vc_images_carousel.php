...
$i = - 1;
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_images_carousel wpb_content_element' . $el_class . ' vc_clearfix' . ( $brands ? ' mpcth-brands ' : '' ), $this->settings['base'], $atts );
...
?>
<div class="<?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base'], $atts ); echo $simple_arrows ? ' mpcth-simple-arrows' : ''; ?>">
