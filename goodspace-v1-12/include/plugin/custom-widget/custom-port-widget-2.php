...
class Recent_Port2 extends WP_Widget {
	...
	function Recent_Port2() {
		...
		/* Create the widget. */
		parent::__construct('recentport-widget2', __('Recent Port 2nd Style (Goodlayers)', 'gdl_back_office'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		if( !empty($port_cat) ){
			$category_term = get_term_by( 'name', $port_cat , 'portfolio-category');
			$port_cat = $category_term->slug;
		}		
