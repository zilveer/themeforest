 ...
 */
if(!class_exists('HueMikadoTopNavigationWalker')) {
	class HueMikadoTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
			...
			if($item->hide == '') {
				...
				if(!empty($icon) && hue_mikado_get_meta_field_intersect('header_type', hue_mikado_get_page_id()) !== 'header-vertical') {
				...
				if(!empty($item->description) && hue_mikado_get_meta_field_intersect('header_type', hue_mikado_get_page_id()) !== 'header-vertical') {
