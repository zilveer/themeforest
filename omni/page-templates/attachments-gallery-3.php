...
<?php get_header(); ?>
	...
	<section class="blog-section">
		<div class="container">
			...
			<div class="row">
				...
				<div class="sorting-container full-page wow fadeInUp <?php echo esc_attr( $gallery_style_class ); ?>" data-wow-delay="0.3s">
	...
	<div class="gallery-popup">
				...
				<div class="swiper-wrapper">
					...
					if ( $attachments_query->have_posts() ) :
						...
						while ( $attachments_query->have_posts() ) : $attachments_query->the_post();
							...
							if ( ! is_wp_error( $attachment ) && isset( $attachment->post_excerpt ) ) {
								$attachment_text = $attachment->post_excerpt;
							} else {
								$attachment_text = $attachment->post_content;
							}

							$slide_parsed = parse_url( wp_get_attachment_url( get_the_ID() ) );
							$slide_url    = dirname( $slide_parsed ['path'] ) . '/' . rawurlencode( basename( $slide_parsed['path'] ) );

							echo '<div class="swiper-slide">';
							echo '<div class="image-container">';
							echo '<img src="' . esc_url( $slide_url ) . '" alt="" />';
							echo '<div class="description">';
							echo '<div class="title">' . get_the_title( get_the_ID() ) . '</div>';
							echo '<div class="description">' . $attachment_text . '</div>';
		...
		<div class="swiper-arrow-gallery left default-arrow">
			<span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span></div>
		<div class="swiper-arrow-gallery right default-arrow">
