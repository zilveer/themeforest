<?php
// Template Name: Menu Page - Dessert
/**
 *
 * @package progression
...
<?php if ( is_active_sidebar( 'dessert-widgets-col-2' ) ) : ?><div class="grid2column"><?php endif; ?>

<?php if ( ! dynamic_sidebar( 'Dessert Widgets Column 1' ) ) : ?>
<?php endif; // end sidebar widget area ?>
<?php if ( is_active_sidebar( 'dessert-widgets-col-2' ) ) : ?></div><?php endif; ?>

<?php if ( is_active_sidebar( 'dessert-widgets-col-2' ) ) : ?>
<div class="grid2column lastcolumn">
<?php if ( ! dynamic_sidebar( 'Dessert Widgets Column 2' ) ) : ?>
<?php endif; // end sidebar widget area ?>
</div>
<?php endif; ?>
