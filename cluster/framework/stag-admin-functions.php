...
function stag_create_field( $item ) {
    ...
    if( $item['type'] == 'editor' || $item['type'] == 'wysiwyg' ) {
    	...
    	$default_editor_settings = array(
    		...
    		'editor_height' => 150,
    		'tinymce' => array(
    			'theme_advanced_buttons1' => 'bold,italic,link,unlink,strikethrough,blockquote',
    			'theme_advanced_buttons2' => '',
    			'toolbar1'                => 'bold,italic,link,unlink,strikethrough,blockquote',
    			'toolbar2'                => '',
    			'toolbar3'                => '',
    			'toolbar4'                => '',
			),
			'quicktags' => array(
    			'buttons' => 'strong,em,link,block,del'
			),
    	);
