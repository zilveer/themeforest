...
if( !function_exists( 'mars_home_v1_2cols_right_sidebar' ) ){
	function mars_home_v1_2cols_right_sidebar($data) {
		...
		[vc_row][vc_column width="1/1"][vc_row_inner][vc_column_inner width="8/12" css=".vc_custom_1405954490755{padding-left: 0px !important;}"][videotube type="main" show="18" id="video-widget-3911" rows="1" columns="2" navigation="on" title="Recent Videos" orderby="ID" order="DESC"][/vc_column_inner][vc_column_inner width="4/12" el_class="sidebar"][mars_vc_socialsbox title="Socials Box"][videotube type="widget" show="3" id="video-widget-3338" rows="1" columns="1" title="Latest Videos" orderby="ID" order="DESC"][vc_wp_text title="ABOUT VIDEOTUBE"]Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean which is great.
