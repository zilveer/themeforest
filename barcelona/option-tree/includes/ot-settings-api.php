  ...
  class OT_Settings {
    ...
    public function add_page() {
      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          $theme_check_bs2  = "add_{$type_2}_{$pg_1}";
          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                if ( isset( $page['sections'] ) && count( $page['sections'] ) > 0 ) {
                  ...
                  foreach( (array) $page['sections'] as $section ) {
                    echo '<li id="tab_' . esc_attr( $section['id'] ) . '"><a href="#section_' . esc_attr( $section['id'] ) . '">' . $section['title'] . '</a></li>';
                  }
              ...
              if ( $show_buttons ) {
                ...
                echo '<form method="post" action="' . esc_url( str_replace( '&settings-updated=true', '', $_SERVER["REQUEST_URI"] ) ) . '">';
    ...
    public function do_settings_sections( $page ) {
      ...
      foreach ( (array) $wp_settings_sections[$page] as $section ) {
        ...
        echo '<div id="section_' . esc_attr( $section['id'] ) . '" class="postbox ui-tabs-panel">';
    ...
    public function do_settings_fields( $page, $section ) {
      ...
      foreach ( (array) $wp_settings_fields[$page][$section] as $field ) {
        ...
        if ( isset( $field['args']['condition'] ) && ! empty( $field['args']['condition'] ) ) {
          ...
          $conditions.= isset( $field['args']['operator'] ) && in_array( $field['args']['operator'], array( 'and', 'AND', 'or', 'OR' ) ) ? ' data-operator="' . esc_attr( $field['args']['operator'] ) . '"' : '';
        ...
        echo '<div id="setting_' . esc_attr( $field['id'] ) . '" class="' . esc_attr( $class ) . '"' . $conditions . '>';
