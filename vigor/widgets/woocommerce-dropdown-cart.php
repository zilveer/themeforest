...
class Woocommerce_Dropdown_Cart extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => __( 'Woocommerce Dropdown Cart', 'edgt' ), ) // Args
		);
	}
										...
										<li>
											...
											<div class="item_info_holder">
												<div class="item_left">
													...
													<span class="quantity"><?php _e('Quantity: ','edgt'); echo esc_html($cart_item['quantity']); ?>
												</div>
												<div class="item_right">
													<?php echo apply_filters( 'woocommerce_cart_item_price_html', wc_price( $product_price ), $cart_item, $cart_item_key ); ?>
													<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove remove_item_from_dropdown_cart" title="%s">&times;</a>', esc_url( $woocommerce->cart->get_remove_url( $cart_item_key ) ), __('Remove this item', 'edgt') ), $cart_item_key ); ?>
...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	<?php
	$fragments['div.shopping_cart_header_holder'] = ob_get_clean();
	return $fragments;
}
?>