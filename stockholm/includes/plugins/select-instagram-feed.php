 ...
 */
add_action( 'tgmpa_register', 'my_theme_register_select_instagram_feed' );
/**
 ...
 */
function my_theme_register_select_instagram_feed() {
    /**
    ...
    $plugins = array(
        ...
        array(
            'name'			=> esc_html__('Select Instagram Feed', 'qode'), // The plugin name
            'slug'			=> 'select-instagram-feed', // The plugin slug (typically the folder name)
            'source'			=> get_template_directory() . '/plugins/select-instagram-feed.zip', // The plugin source
