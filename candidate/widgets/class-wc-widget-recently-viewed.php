...
class Candidat_WC_Widget_Recently_Viewed extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a list of recently viewed products.', 'candidate' );
		$this->widget_id          = 'woocommerce_recently_viewed_products';
		$this->widget_name        = __( 'WooCommerce Recently Viewed', 'candidate' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Recently Viewed Products', 'candidate' ),
