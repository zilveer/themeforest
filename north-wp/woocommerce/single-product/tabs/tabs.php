...
<div class="woocommerce-tabs wc-tabs-wrapper">
	<?php if (ot_get_option('shop_product_style', 'style1') == 'style1') { ?>
		<ul class="accordion">
			<?php foreach ( $tabs as $key => $tab ) : ?>
	
				<li class="<?php echo esc_attr( $key ); ?>_tab">
					<div class="title"><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', esc_html( $tab['title'] ), $key ); ?></div>
					<div class="content post-content text-left"><?php call_user_func( $tab['callback'], $key, $tab ) ?></div>
				</li>
