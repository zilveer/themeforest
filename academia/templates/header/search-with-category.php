...
?>
<div class="search-with-category header-customize-item" data-hint-message="<?php esc_html_e('Type at least 3 characters to search','g5plus-academia') ?>">
	<div class="search-with-category-inner search-box">
		<div class="form-search-left">
			<span data-id="-1"><?php esc_html_e('Categories','g5plus-academia') ?></span>
