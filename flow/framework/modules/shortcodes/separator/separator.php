...
class Separator implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html = flow_elated_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(flow_elated_string_ends_with($params['width'], '%') || flow_elated_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(flow_elated_string_ends_with($params['top_margin'], '%') || flow_elated_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(flow_elated_string_ends_with($params['bottom_margin'], '%') || flow_elated_string_ends_with($params['bottom_margin'], 'px')) {
