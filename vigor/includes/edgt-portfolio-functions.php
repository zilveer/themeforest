...
if(!function_exists('edgt_get_portfolio_image_meta')) {
	function edgt_get_portfolio_image_meta($image_src) {
		global $wpdb;
...
if (!function_exists('edgtComparePortfolioImages')) {
	/**
	 ...
	 */
	function edgtComparePortfolioImages($a, $b){
...
if (!function_exists('edgtComparePortfolioOptions')){
	/**
	 ...
	 * @return int result of comparison
	 */
	function edgtComparePortfolioOptions($a, $b){
