...
onmessage = function (e) {
    ...
    var r = function () {
        ...
        function dt(e, t) {
            var n;
            for (n in t)
                ut(t, n) && !ut(r.blacklist, n) && (e[n] = t[n])
        }
        function vt() {
        ...
        function Ct() {
            ...
            e:for (; ; ) {
                ...
                if (v.id === ":") {
                    ...
                    if (g.indexOf(p.value) > -1 && (t === "/*jshint" || t === "/*jslint"))
                        a = +v.value, (typeof a != "number" || !isFinite(a) || a <= 0 || Math.floor(a) !== a) && Et("Expected a small integer and instead saw '{a}'.", v, v.value), p.value === "indent" && (l.white = !0), l[p.value] = a;
                    else if (p.value === "validthis")
                        h["(global)"] ? Et("Option 'validthis' can't be used in a global scope.") : v.value === "true" || v.value === "false" ? l[p.value] = v.value === "true" : Et("Bad option value.", v);
                    else if (p.value === "quotmark" && t === "/*jshint")
                        switch (v.value) {
                            case"true":
                                l.quotmark = !0;
                                break;
                        ...
                        v.value === "true" || v.value === "false" ? (t === "/*jslint" ? (d = o[p.value] || p.value, l[d] = v.value === "true", s[d] !== undefined && (l[d] = !l[d])) : l[p.value] = v.value === "true", p.value === "newcap" && (l["(explicitNewcap)"] = !0)) : Et("Bad option value.", v);
                    p = Tt.token()
                } else
                    (t === "/*jshint" || t === "/*jslint") && Et("Missing option value.", p), l[p.value] = !1, t === "/*global" && m === !0 && (r.blacklist[p.value] = p.value, vt()), p = v
            }
        ...
        function Lt(t, n) {
            ...
            for (; ; ) {
                C = S.shift() || Tt.token();
                if (C.id === "(end)" || C.id === "(error)")
                    return;
                if (C.type === "special")
                    Ct();
                else if (C.id !== "(endline)")
                    break
            }
        }
        function At(t, n) {
            ...
            if (n === !0 && z.fud)
                ...
                if (z.nud)
                    ...
                    if (C.type === "(number)" && z.id === ".")
                        return bt("A leading decimal point can be confused with a dot: '.{a}'.", z, C.value), Lt(), z;
                    Et("Expected an identifier and instead saw '{a}'.", z, z.id)
                }
                while (t < C.lbp)
                    i = z.value === "Array", s = z.value === "Object", r && (r.value || r.first && r.first.value) && (r.value !== "new" || r.first && r.first.value && r.first.value === ".") && (i = !1, r.value !== z.value && (s = !1)), Lt(), i && z.id === "(" && C.id === ")" && bt("Use the array literal notation [].", z), s && z.id === "(" && C.id === ")" && bt("Use the object literal notation {}.", z), z.led ? r = z.led(r) : Et("Expected an operator and instead saw '{a}'.", z, z.id)
            }
            return r
        }
        function Ot(e, t) {
        ...
        function zt(e, t) {
            ...
            return Ut(n), n.nud = typeof t == "function" ? t : function () {
                ...
                if (this.id === "++" || this.id === "--")
                    A.plusplus ? bt("Unexpected use of '{a}'.", this, this.id) : (!this.right.identifier || this.right.reserved) && this.right.id !== "." && this.right.id !== "[" && bt("Bad operand.", this);
                return this
            }, n
        }
        function Wt(e, t) {
        ...
        function Qt(e) {
            return Ft(e, 20).exps = !0, $t(e, function (e, t) {
                ...
                if (e) {
                    ...
                    if (e.id === "." || e.id === "[")
                        return(!e.left || e.left.value === "arguments") && bt("Bad assignment.", t), t.right = At(19), t;
                    if (e.identifier && !e.reserved)
                        return h[e.value] === "exception" && bt("Do not assign to the exception parameter.", e), t.right = At(19), t;
        ...
        function Yt(e) {
            return Ft(e, 20).exps = !0, $t(e, function (e, t) {
                ...
                if (e)
                    return e.id === "." || e.id === "[" || e.identifier && !e.reserved ? (At(19), t) : (e === R["function"] && bt("Expected an identifier in an assignment, and instead saw a function invocation.", z), t);
                Et("Bad assignment.", t)
            }, 20)
        }
        function Zt(e) {
        ...
        function en(e) {
            if (C.identifier)
                return Lt(), z.reserved && !A.es5 && (!e || z.value !== "undefined") && bt("Expected an identifier and instead saw '{a}' (a reserved word).", z, z.id), z.value
        }
        function tn(e) {
            var t = en(e);
            if (t)
        ...
        function sn(e) {
            var t = [], n;
            while (!C.reach && C.id !== "(end)")
                C.id === ";" ? (n = kt(), (!n || n.id !== "(") && bt("Unnecessary semicolon."), Lt(";")) : t.push(rn(e === C.line));
            return t
        }
        function on() {
            var e, t, n;
            for (; ; ) {
                if (C.id === "(string)") {
                    ...
                    if (t.id === "(endline)") {
                        ...
                        while (n.id === "(endline)");
                        if (n.id !== ";") {
                            if (n.id !== "(string)" && n.id !== "(number)" && n.id !== "(regexp)" && n.identifier !== !0 && n.id !== "}")
                                break;
                            bt("Missing semicolon.", C)
                        } else
                            t = n
                    } else if (t.id === "}")
                        bt("Missing semicolon.", t);
                    else if (t.id !== ";")
                        break;
        ...
        function un(e, t, n) {
            ...
            if (C.id === "{") {
                ...
                e ? ((!t || A.curly) && bt("Expected '{a}' and instead saw '{b}'.", C, "{", C.value), L = !0, y += A.indent, r = [rn(C.line === z.line)], y -= A.indent, L = !1) : Et("Expected '{a}' and instead saw '{b}'.", C, "{", C.value);
            h["(verb)"] = null;
            if (!e || !A.funcscope)
                B = u;
        ...
        function mn() {
            function e() {
                ...
                if (C.id !== "}")
                    for (; ; ) {
                        if (C.id === "(end)")
                            Et("Missing '}' to match '{' from line {a}.", C, t.line);
                        else {
                            if (C.id === "}") {
            ...
            function t() {
                ...
                if (C.id !== "]")
                    for (; ; ) {
                        if (C.id === "(end)")
                            Et("Missing ']' to match '[' from line {a}.", C, e.line);
                        else {
                            if (C.id === "]") {
                                bt("Unexpected comma.", z);
                                break
        ...
        var Tt = function () {
            ...
            function o(e, i) {
                function u(e) {
                    ...
                    var t = /^(_+.*|.*_+)$/.test(e);
                    if (A.nomen && t && e !== "_") {
                        if (A.node && z.id !== "." && /^(__dirname|__filename)$/.test(e))
                            return;
            ...
            return{init: function (e) {
                    ...
                    function E(e) {
                        var r = e.exec(i), s;
                        if (r)
                            return p = r[0].length, s = r[1], u = s.charAt(0), i = i.substr(p), n = t + p - s.length, t += p, s
                    }
                    function S(e) {
                        function c(e) {
                        ...
                        e:for (; ; ) {
                            ...
                            u = i.charAt(a);
                            if (u === e)
                                return t += 1, i = i.substr(a + 1), o("(string)", f, e);
                            if (u < " ") {
                                if (u === "\n" || u === "\r")
                                    break;
                    ...
                    for (; ; ) {
                        ...
                        if (!m) {
                            ...
                            if (lt(u) || u === "_" || u === "$")
                                return o("(identifier)", m);
                            if (ct(u))
                                return isFinite(Number(m)) || wt("Bad number '{a}'.", r, t, m), lt(i.substr(0, 1)) && wt("Missing space after '{a}'.", r, t, m), u === "0" && (f = m.substr(1, 1), ct(f) ? z.id !== "." && wt("Don't use extra leading zeros '{a}'.", r, t, m) : b && (f === "x" || f === "X") && wt("Avoid 0x-. '{a}'.", r, t, m)), m.substr(m.length - 1) === "." && wt("A trailing decimal point can be confused with a dot '{a}'.", r, t, m), o("(number)", m);
                            switch (m) {
                                case'"':
                                case"'":
                                    return S(m);
        ...
        Wt("(number)", function () {
            ...
            return this
                ...
                if (h === n)
                    ...
                    A.undef && typeof O[t] != "boolean" && (e !== "typeof" && e !== "delete" || C && (C.value === "." || C.value === "[")) && yt(h, "'{a}' is not defined.", z, t), fn(z);
                else
                    switch (h[t]) {
                        case"closure":
                        case"function":
                        ...
                        default:
                            if (n === !0)
                                ...
                                bt("'{a}' is not allowed.", z, t), fn(z);
                            else if (typeof n != "object")
                                A.undef && (e !== "typeof" && e !== "delete" || C && (C.value === "." || C.value === "[")) && yt(h, "'{a}' is not defined.", z, t), h[t] = !0, fn(z);
                            else
                                switch (n[t]) {
                                    case"function":
                                    case"unction":
            ...
            if (e && e.id !== "function")
                if (e.identifier) {
                    ...
                    e.id !== "." && e.id !== "[" && e.id !== "(" && bt("Bad constructor.", z);
            else
                A.supernew || bt("Weird construction. Delete 'new'.", this);
            ...
            e.nud = function () {
                ...
                for (; ; ) {
                    if (C.id === "}")
                        break;
                    e && Ht();
                    if (C.value === "get" && kt().id !== ":")
                        Lt("get"), A.es5 || Et("get/set are ES5 features."), n = ln(), n || Et("Missing property name."), a(n), i = C, Ot(z, C), t = hn(), r = t["(params)"], r && bt("Unexpected parameter '{a}' in get {b} function.", i, r[0], n), Ot(z, C);
                    else if (C.value === "set" && kt().id !== ":")
                        Lt("set"), A.es5 || Et("get/set are ES5 features."), n = ln(), n || Et("Missing property name."), u(n, C), i = C, Ot(z, C), t = hn(), r = t["(params)"], (!r || r.length !== 1) && bt("Expected a single parameter in set {a} function.", i, n);
                    else {
                        n = ln(), o(n, C);
                        if (typeof n != "string")
                            break;
                ...
                if (A.es5)
                    for (var f in s)
                        ut(s, f) && s[f].setter && !s[f].getter && bt("Setter is defined without getter.", s[f].setterToken);
                return this
            }, e.fud = function () {
                ...
                switch (C.id) {
                    ...
                    case"}":
                        ...
                        if (this.cases.length === 1 || this.condition.id === "true" || this.condition.id === "false")
                            A.onecase || bt("This 'switch' should be an 'if'.", this);
        ...
        var gn = function (e, t, n) {
            ...
            if (t) {
                ...
                for (u = 0; u < a.length; u++)
                    l[a[u]] = t[a[u]], a[u] === "newcap" && t[a[u]] === !1 && (l["(explicitNewcap)"] = !0), a[u] === "indent" && (l.white = !0)
            }
            A = l, A.indent = A.indent || 4, A.maxerr = A.maxerr || 50, U = "";
            for (s = 0; s < A.indent; s += 1)
                U += " ";
            ...
            if (!ft(e) && !Array.isArray(e))
                return St("Input is neither a string nor an array of strings.", 0), !1;
            if (ft(e) && /^\s*$/g.test(e))
                return St("Input is an empty string.", 0), !1;
            if (e.length === 0)
                return St("Input is an empty array.", 0), !1;
            ...
            try {
                ...
                var p = function (e, t) {
                    ...
                    if (!m[e])
                        return;
                    var n = [];
                    for (var r = 0; r < m[e].length; r += 1)
                        m[e][r] !== t && n.push(m[e][r]);
                ...
                for (s = 0; s < r.undefs.length; s += 1)
                    o = r.undefs[s].slice(0), p(o[2].value, o[0]) ? w(o[2].value, o[2].line) : bt.apply(bt, o.slice(1));
                d.forEach(function (e) {
                    ...
                    while (r) {
                        ...
                        if (r === "undefined")
                            return;
                        if (i !== "unused" && i !== "unction")
                            return;
                        N(r, e["(tokens)"][r]), r = n.pop()
                    }
                });
                for (var L in f)
                    ut(f, L) && !ut(v, L) && N(L, f[L])
            } catch (D) {
                if (D) {
                    var H = C || {};
            ...
            if (r.scope === "(main)") {
                t = t || {};
                for (s = 0; s < r.internals.length; s += 1)
                    o = r.internals[s], t.scope = o.elem, gn(o.value, t, n)
            }
