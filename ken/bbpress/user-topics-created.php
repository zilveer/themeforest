...
?>
	...
	<div id="bbp-author-topics-started" class="bbp-author-topics-started">
		<h2 class="entry-title"><?php _e( 'Forum Topics Created', 'mk_framework' ); ?></h2>
		<div class="bbp-user-section">
			...
			<?php else : ?>
				...
				<p><?php bbp_is_user_home() ? _e( 'You have not created any topics.', 'mk_framework' ) : _e( 'This user has not created any topics.', 'mk_framework' ); ?></p>
