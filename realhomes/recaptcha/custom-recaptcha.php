...
if(!empty($reCAPTCHA_public_key) && !empty($reCAPTCHA_private_key) && $show_reCAPTCHA == 'true' ){
    ...
    <script type="text/javascript" src="//www.google.com/recaptcha/api/challenge?k=<?php echo $reCAPTCHA_public_key; ?>"></script>
    <noscript>
        <iframe src="//www.google.com/recaptcha/api/noscript?k=<?php echo $reCAPTCHA_public_key; ?>" height="300" width="220" frameborder="0"></iframe><br>
