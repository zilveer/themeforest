...
$slides_wrap_start = '';
$slides_wrap_end = '';
$fancybox_rel = $onclick === 'link_image' ? ' data-fancybox-type="image"' : '';
...
$fancybox_gallery = ' data-fancybox-group="media-gallery-'. rand() .'"';
?>
<div class="<?php echo esc_attr( $css_class ); ?>">
	<div class="wpb_wrapper">
		<?php echo wpb_widget_title( array( 'title' => esc_html( $title ), 'extraclass' => 'wpb_gallery_heading' ) ) ?>
							...
							<div class="vc_item">
								<div class="vc_inner">
									<?php if ( 'link_image' === $onclick ): ?>
										...
										<a class="fancybox"
										   href="<?php echo esc_url( $p_img_large[0] ) ?>" <?php echo $fancybox_rel . $fancybox_gallery; ?>>
											<?php echo $thumbnail ?>
										</a>
