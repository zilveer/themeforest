...
if ( !function_exists( 'theme_post_gallery' ) )
{
	...
	function theme_post_gallery($type) 
	{
		...
		switch($type)
		{
			case 'portfolio': $size = 'portfolio'; break;
			case 'product': $size = 'product'; break;
			case 'gallery': $size = 'gallery'; break;
		}

		if ($attachments) 
		{
			echo '<div class="flex-container flex-container-gallery post-entry-gallery">'."\n";
			echo '<div class="flexslider flexslider-'.$type.'">'."\n";
