            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
					...
					<div class="column one-column">
                    	<h6><?php esc_html_e('Mailchimp API Key', 'veda'); ?></h6>
						<div class="column one-half">
                        	<input name="dttheme[layout][mailchimp-key]" type="text" value="<?php echo veda_option('layout', 'mailchimp-key');?>">
                        </div>
                        <div class="column four-fifth last">    
	                        <p class="note"><?php esc_html_e('Enter mailchimp api key.', 'veda');?></p>
                        </div>    
                    </div>                    
