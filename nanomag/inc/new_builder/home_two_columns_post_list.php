...
class home_post_two_columns_list extends AQ_Block {
	...
	function __construct() {
		$block_options = array(
      'name' => esc_attr__('Post two columns list', 'nanomag'),
			'size' => 'span12',
		);
	...
	function form($instance) {
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('title1')); ?>"><?php esc_attr_e('Title for right column:','nanomag'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('cats'); ?>"><?php esc_attr_e('Choose your category:', 'nanomag'); ?> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('cats1')); ?>"><?php esc_attr_e('Choose your category:', 'nanomag'); ?> 
