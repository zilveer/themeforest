...
$margin_horizontal_elements[]   = '.portfolio-container-and-title.full-width-portfolio.portfolio-loop-layout-type-1';
...
if ( count( $full_margin_elements )  ) {
	...
	generate_custom_style( '.main-footer.fixed-footer', "left: {$border_width}px; right: {$border_width}px;", 'screen and (min-width: 992px)' );
}
