...
"use strict";   
	...
	tinymce.PluginManager.add( 'themeva_shortcodes', function( editor, url ) {
		...
		editor.addButton( 'themeva_shortcodes', { 
			...
			onclick : function(e) {},
			menu: [
				{text: 'Button', icon: 'themeva_button', onclick: function() {editor.insertContent('[button title="my button" type="linkbutton" color="grey-lite, green, green-lite, blue, blue-lite" align="aligncenter, alignleft or alignright" url="#" target="_self" el_class="medium-text, big-text or leave blank"]');}},
				...
				{text: 'Image Effect', icon: 'themeva_image_effect', onclick: function() {editor.insertContent('[imageeffect url="e.g. /wp-content/uploads/your-image.png" type="frame, blackwhite" width="300" height="300" align="alignleft, alignright or aligncenter" target="_self or _blank" lightbox="yes" overlay_state="hover" zoomhover="zoomhover" alt="this is an image" videourl="#" ]');}},
				...
				{text: 'List', icon: 'themeva_list', onclick: function() {editor.insertContent('[list style="custom,arrow,bullet,check,cross" color="blue-lite" unicode="F0F4"]\
								<ul>\
								<li>List Item</li>\
								<li>List Item</li>\
								<li>List Item</li>\
