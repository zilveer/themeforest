...
function update_notifier_menu() {  
	...
	$theme_data = wp_get_theme('circolare'); // Get theme data from style.css (current version is what we want)
...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://unifato.net/circolare/updates.xml';
