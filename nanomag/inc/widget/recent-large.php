...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_attr__('Display post list on menu or widget.', 'nanomag')
        );
        parent::__construct('recent-post-large-style', esc_attr__('jellywp: Recent post large', 'nanomag'), $widget_ops);
    }
