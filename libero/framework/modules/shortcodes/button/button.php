...
class Button implements ShortcodeInterface {
        ...
        vc_map(array(
            ...
            'params'                    => array_merge(
                ...
                array(
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Between Border Color',
                        'param_name'  => 'icon_border_color',
                        'admin_label' => true,
                        'group'       => 'Design Options',
                        'dependency'  => array('element' => 'icon_pack', 'not_empty' => true),
                        'description' => 'Choose color for border between text and icon'
                    ),
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Between Hover Border Color',
                        'param_name'  => 'icon_hover_border_color',
                        'admin_label' => true,
                        'group'       => 'Design Options',
                        'dependency'  => array('element' => 'icon_pack', 'not_empty' => true),
                        'description' => 'Choose hover color for border between text and icon'
                    ),
                    array(
                        'type'        => 'textfield',
                    ...
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => __('Insert margin in format: 0px 0px 1px 0px', 'libero'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    ),
                    array(
    ...
    public function render($atts, $content = null) {
        ...
        return libero_mikado_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
