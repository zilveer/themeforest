...
*/
    ...
    $post_content = get_the_content('<span class="btn big filled pull-right read-more">'.__('Read More', ET_DOMAIN).'</span>');
...
<article <?php post_class($postClass); ?> id="post-<?php the_ID(); ?>" >
	<div>
		<?php if($post_format == 'quote' || $post_format == 'video'): ?>
	            ...
	            <?php the_content('<span class="btn big filled pull-right read-more">'.__('Read More', ET_DOMAIN).'</span>'); ?>
