...
?>
					...
					<nav id="nav-single">
						...
						<span class="nav-previous"><?php previous_image_link( false, __( 'Older <i class="icon-chevron-right"></i>' , 'mega' ) ); ?></span>
						<span class="nav-next"><?php next_image_link( false, __( '<i class="icon-chevron-left"></i> Newer' , 'mega' ) ); ?></span>
					</nav><!-- #nav-single -->
