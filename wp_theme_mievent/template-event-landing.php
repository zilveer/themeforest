...
<?php }elseif($logo_position=='header' || $logo_position=='both'){ ?>
	...
	<div class="header header-hide">
		<div class="container">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">				
					<a class="navbar-brand" href="<?php echo SITE_URL; ?>"><img src="<?php echo MthemeCore::getOption("site_logo",CHILD_URI."site/img/logo.png"); ?>" alt="<?php echo MthemeCore::getOption('logo_text','logo');?>"/></a>				
			   </div>
			</nav>
		</div>
	</div>
