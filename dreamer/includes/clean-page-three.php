...
<div class="page-container pattern-1" id="about-us">
    <div class="row" id="clean-page-three">
    ...
    $dreamer_content_page_three = $smof_data['third_content_page'];
    $dreamer_page_id = smof_get_ID_by_page_name($dreamer_content_page_three); ?>
