...
if( $atts['onclick'] == 'modal') {
	$data_modal =  ' data-modal-link="vivaco-'.$modal_box_id.'"';
	$data_modal_w_modal = '<a href=""' . $data_modal . '>' . $html . '</a>';
} else {
	$data_modal_w_modal = $html;
}
$html = '<div class="vc_single_image-wrapper ' . $style . ' ' . $border_color . '">'.$data_modal_w_modal.'</div>';
