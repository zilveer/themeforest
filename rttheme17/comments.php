...
$comments_args = array( 	
	'comment_field'        => '<div class="text-boxes"><ul><li><p class="comment-form-comment"><textarea tabindex="4" class="comment_textarea showtextback" rows="10" id="comment" name="comment">'. __('Comment','rt_theme') .' *</textarea></p></li></ul></div><div class="clear space"></div>',
	'id_form'              => 'commentform', 
