...
function my_theme_register_required_plugins() {
    ...
    array(
			...
			'source'   				=> get_stylesheet_directory() . '/recommended-plugins/revslider.zip', // The plugin source
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/recommended-plugins/LayerSlider.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
	...
	$theme_text_domain = 'smooththemes';
	...
	$config = array(
		...
		'menu'         		=> 'smooththemes-required-plugins', 	// Menu slug
