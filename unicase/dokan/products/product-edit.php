...
if ( $post->post_author != $seller_id ) {
    wp_die( __( 'Access Denied', 'unicase' ) );
}
        ...
        <div class="dokan-product-edit-area">
            ...
            <header class="dokan-pro-edit-breadcrumb">
                <h1 class="dokan-header-crumb">
                    <span class="dokan-breadcrumb"><a href="<?php echo dokan_get_navigation_url( 'products' ) ?>"><?php _e( 'Products', 'unicase' ); ?></a> &rarr; </span>
                    <?php echo $post->post_title; ?>

                    <?php if ( $_visibility == 'hidden' ) { ?>
                        <span class="dokan-label dokan-label-default"><?php _e( 'Hidden', 'unicase' ); ?></span>
                    <?php } ?>
                        ...
                        <div class="dokan-product-edit-left">
                            ...
                            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                                <div class="dokan-message">
                                    ...
                                    <strong><?php _e( 'Success!', 'unicase' ); ?></strong> <?php _e( 'The product has been updated successfully.', 'unicase' ); ?>
                            ...
                            <div id="tab-container" class='tab-container'> <!-- Only required for left/right tabs -->
                                ...
                                <ul class="dokan_tabs">
                                    ...
                                    $dokan_product_data_tabs = apply_filters( 'dokan_product_data_tabs', array(
                                        ...
                                        'edit' => array(
                                            'label'  => __( 'Edit', 'unicase' ),
                                            'target' => 'edit-product',
                                            'class'  => array( 'active' ),
                                        ),
                                        'options' => array(
                                            'label'  => __( 'Options', 'unicase' ),
                                            'target' => 'product-options',
                                            'class'  => array(),
                                        ),
                                        'inventory' => array(
                                            'label'  => __( 'Inventory', 'unicase' ),
                                            'target' => 'product-inventory',
                                            'class'  => array(),
                                        ),
                                        'shipping' => array(
                                            'label'  => __( 'Shipping', 'unicase' ),
                                            'target' => 'product-shipping',
                                            'class'  => array(),
                                        ),
                                        'attributes' => array(
                                            'label'  => __( 'Attributes', 'unicase' ),
                                            'target' => 'product-attributes',
                                            'class'  => array(),
                                        ),
                                        'variations' => array(
                                            'label'  => __( 'Variations', 'unicase' ),
                                            ...
                                            <div class="content-half-part">
                                                ...
                                                <div class="show_if_simple dokan-clearfix">
                                                    ...
                                                    <div class="discount-price">
                                                        <label>
                                                            <input type="checkbox" <?php checked( $is_discount, true ); ?> class="_discounted_price" name="_discounted_price"> <?php _e( 'Enable Discounted Price', 'unicase' ); ?>
                                                        </label>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="special-price-container<?php echo $is_discount ? '' : ' dokan-hide'; ?>">
                                                        <div class="dokan-form-group dokan-clearfix">
                                                            <div class="dokan-input-group dokan-left" style="width:55%">
                                                                <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                                <?php dokan_post_input_box( $post_id, '_sale_price', array( 'placeholder' => __( 'Special Price', 'unicase' ) ) ); ?>
                                                            </div>

                                                            <div class="dokan-right">
                                                                <a href="#" class="sale-schedule dokan-right"><?php _e( 'Schedule', 'unicase' ); ?></a>
                                                            </div>
                                                        </div>
