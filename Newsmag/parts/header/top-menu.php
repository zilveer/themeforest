<div class="td-header-sp-top-menu">
    ...
    if (td_util::get_option('tds_login_sign_in_widget') == 'show') {
        ...
        if ( is_user_logged_in() ) {
            ...
            echo '<ul class="top-header-menu td_ul_login"><li class="menu-item"><a class="td-login-modal-js menu-item" href="#login-form" data-effect="mpf-td-login-effect">' . __td('Sign in / Join', TD_THEME_NAME) . '</a></li></ul>';
        }
    }//end login window
