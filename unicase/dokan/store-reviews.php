    ...
    <div id="dokan-content" class="store-review-wrap woocommerce" role="main">
        ...
        <div id="reviews">
            <div id="comments">
                ...
                <h2 class="headline"><?php _e( 'Seller Review', 'unicase' ); ?></h2>

                <ol class="commentlist">
                    <?php
                    if ( count( $comments ) == 0 ) {
                        echo '<span colspan="5">' . __( 'No Results Found', 'unicase' ) . '</span>';
                    } else {
                                            ...
                                            <a href="<?php echo $permalink; ?>">
                                                ...
                                                if ( get_option('woocommerce_enable_review_rating') == 'yes' ) :
                                                    ...
                                                    <div class="dokan-rating">
                                                        <div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf(__( 'Rated %d out of 5', 'unicase' ), $rating) ?>">
                                                            <span style="width:<?php echo ( intval( get_comment_meta( $single_comment->comment_ID, 'rating', true ) ) / 5 ) * 100; ?>%"><strong itemprop="ratingValue"><?php echo $rating; ?></strong> <?php _e( 'out of 5', 'unicase' ); ?></span>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </a>
