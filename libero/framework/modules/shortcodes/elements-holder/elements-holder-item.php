<?php
namespace Libero\Modules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => 'Elements Holder Item', 'libero',
					'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = libero_mikado_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
