<?php
$blog_archive_pages_classes = hashmag_mikado_blog_archive_pages_classes(hashmag_mikado_get_category_blog_list());
?>
<?php get_header(); ?>
...
<?php do_action('hashmag_mikado_after_container_open'); ?>
	<div class="<?php echo esc_attr($blog_archive_pages_classes['inner']); ?>">
		<?php hashmag_mikado_get_blog(hashmag_mikado_get_category_blog_list()); ?>
	</div>
