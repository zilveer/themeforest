<?php
namespace Libero\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
		...
		vc_map( array(
				...
				'params' => array(
					...
					array(
						...
						"value" => libero_mikado_get_font_style_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						...
						"value" => libero_mikado_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => libero_mikado_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
	...
	public function render($atts, $content = null) {
		...
		$html = libero_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
