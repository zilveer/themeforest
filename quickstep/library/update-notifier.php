...
define( 'NOTIFIER_THEME_NAME', 'QuickStep' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'quickstep' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.themeluxe.com/themes/quickstep/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
