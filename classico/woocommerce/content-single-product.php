                            ...
                            <div class="fixed-content">
                                <?php
                                    if(etheme_get_option('product_name_signle')) {
                                        ...
                                        echo '<h4 class="title">' . __('Product Information', ET_DOMAIN) . '</h4>';
                                    }
                                    ...
                                    if (etheme_get_option('product_name_signle') || $rating_count > 0) {
                                        echo '<hr class="divider short">';
                                    }

                                    woocommerce_template_single_excerpt();
                                    if(etheme_get_option('share_icons')) echo do_shortcode('[share title="'.__('Share Social', ET_DOMAIN).'" text="'.get_the_title().'"]');
                                 ?>
                             </div>
                         </div>
                    </div>
