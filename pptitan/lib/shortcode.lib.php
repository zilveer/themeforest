...

		{
...

			{
				...
				default:
					...
					$return_html.= '<a href="'.$permalink_url.'"><img src="'.$image_url[0].'" alt="" class="portfolio_img"/><div class="portfolio200_overlay"><img src="'.get_template_directory_uri().'/images/icon_link.png" alt="" class=""/></div></a>';
				...
				default:
					...
					$return_html.= '<a href="'.get_permalink($recent_portfolio->ID).'"><img src="'.$image_url[0].'" alt="" class="portfolio_img"/><div class="portfolio200_overlay"><img src="'.get_template_directory_uri().'/images/icon_link.png" alt="" class=""/></div></a>';
				...
				case 'Image':
					...
					$return_html.= '<a href="'.$large_image_url[0].'" class="img_frame"><img src="'.$image_url[0].'" alt="" class="portfolio_img"/><div class="portfolio200_overlay"><img src="'.get_template_directory_uri().'/images/icon_image.png" alt="" class=""/></div></a>';
				...
				case 'Youtube Video':
					...
					$return_html.= '<a href="#video_'.$portfolio_video_id.'" class="lightbox_youtube"><img src="'.$image_url[0].'" alt="" class="portfolio_img"/><div class="portfolio200_overlay"><img src="'.get_template_directory_uri().'/images/icon_video.png" alt="" class=""/></div></a>';
				...
				case 'Vimeo Video':
					...
					$return_html.= '<a href="#video_'.$portfolio_video_id.'" class="lightbox_vimeo"><img src="'.$image_url[0].'" alt="" class="portfolio_img"/><div class="portfolio200_overlay"><img src="'.get_template_directory_uri().'/images/icon_video.png" alt="" class=""/></div></a>';
				...
				case 'Self-Hosted Video':
					...
					$return_html.= '<a href="#video_self_'.$key.'" class="lightbox_vimeo"><img src="'.$image_url[0].'" alt="" class="portfolio_img"/><div class="portfolio200_overlay"><img src="'.get_template_directory_uri().'/images/icon_video.png" alt="" class=""/></div></a>';
...

		{
...

			{
				...
				case 'Image':
					...
					$return_html.= '<a href="'.$full_image_url[0].'" class="img_frame"><img src="'.$image_url[0].'" alt="" class="portfolio_img"/><div class="portfolio200_overlay"><img src="'.get_template_directory_uri().'/images/icon_image.png" alt="" class=""/></div></a>';
...
function pp_gallery_func($atts, $content) {
...

	{
...

		{
			...
			$small_image_url = wp_get_attachment_image_src($image->ID, 'thumbnail', true);
			
			$return_html.= '<div style="float:left;margin-right:10px;margin-bottom:10px">';

			$return_html.= '<a rel="gallery" class="fancy-gallery" href="'.$image_url.'">';
