...
jQuery(document).ready(function($) {
    ...
    jQuery(".add-new-strip").click(function(){
        ...
        jQuery.post(ajaxurl, data, function (response) {
            ...
            striproottag.parents(".gt3settings_box_content").find(".append_items").append('<li class="strip_block"><div class="sort_drug strip_head">Strip item</div><div class="strip_block_container"><input type="text" placeholder="Title" name="pagebuilder[strips][' + response + '][striptitle1]" value="" class="strip_input"><input type="text" placeholder="Link" name="pagebuilder[strips][' + response + '][link]" value="" class="strip_input"><input type="text" placeholder="Image" name="pagebuilder[strips][' + response + '][image]" value="" class="gt3UploadImg strip_input"><input type="text" placeholder="Background Image" name="pagebuilder[strips][' + response + '][bgimage]" value="" class="gt3UploadImg strip_input"><div class="strip_color_box"><span>Text Color:</span><input class="cpicker" type="text" name="pagebuilder[strips][' + response + '][tcolor]" value="ffffff" placeholder="Text Color"><input type="text" value="" class="cpicker_preview" disabled="disabled" style="background-color:#ffffff"><span>Overlay settings:</span><input class="cpicker" type="text" name="pagebuilder[strips][' + response + '][fcolor]" value="1d1e1f" placeholder="Overlay Color"><input type="text" value="" class="cpicker_preview" disabled="disabled" style="background-color:#1d1e1f"><input type="text" placeholder="Overlay Opacity (0-1)" name="pagebuilder[strips][' + response + '][opacity]" value="" class="strip_input_opacity"><div class="clear"></div></div><span class="remove_strip">[x]</span></div></li>');			
