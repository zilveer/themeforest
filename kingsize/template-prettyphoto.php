								...
								if ($attachments) { 
									foreach ($attachments as $attachment) { 
										...
										if($no_of_page_columns=="2columns"){
											...
											$relative_gal = 'rel="prettyPhoto[gallery2col]"';
										...
										elseif($no_of_page_columns=="3columns"){
											...
											$relative_gal = 'rel="prettyPhoto[gallery3col]"';
										...
										elseif($no_of_page_columns=="4columns"){
											...
											$relative_gal = 'rel="prettyPhoto[gallery4col]"';
										...
										elseif($no_of_page_columns=="grid"){
											...
											$relative_gal = 'rel="prettyPhoto[galleryGrid]"';
									...
									<div class="<?php echo $div_layout;?> space-bottom mobile-fullwidth">
										<div class="row">
											<div class="twelve columns pV0H5">
												<a class="<?php echo $class_gal;?> image" href="<?php echo wp_get_attachment_url($attachment->ID);?>" <?php echo $relative_gal;?>   href="<?php echo wp_get_attachment_url($attachment->ID);?>" title="<?php  echo $post_title; ?>">
												<?php //lazy loader
												if($data["wm_lazyloader_option"] == "Enable Lazyloader") : ?>
												<img  class="lazy" data-original="<?php echo $url_post_img?>" src="<?php echo get_template_directory_uri().'/images/loading.gif';?>" alt="<?php  echo $post_alt;?>" title="<?php  echo $attachment->post_title;  ?>">
												<?php else : ?>
												<img  src="<?php echo $url_post_img;?>" alt="<?php  echo $post_alt;  ?>" title="<?php  echo $attachment->post_title;  ?>">
												<?php endif;?>
												</a>
											</div>
										</div>
