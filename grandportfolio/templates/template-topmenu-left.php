    ...
    <div class="standard_wrapper">
        ...
        <div id="menu_wrapper">
        	...
        	<?php
				...
				if($tg_menu_layout == 'leftalign' OR $tg_menu_layout == 'leftalign_center')
				{
			?>
		    	...
		    	<div id="logo_right_button">
			    	<div class="logo_right_button">
						...
						<div class="post_share_wrapper">
							<a id="page_share" class="tooltip" href="javascript:;" title="<?php esc_html_e('Share', 'grandportfolio-translation' ); ?>"><i class="fa fa-share-alt"></i></a>
						</div>
						<?php
							$post_type = get_post_type();
						...
						<div class="view_fullscreen_wrapper">
							<a class="tooltip" id="page_maximize" href="javascript:;" title="<?php esc_html_e('View Fullscreen', 'grandportfolio-translation' ); ?>"><i class="fa fa-expand"></i></a>
							<a class="tooltip" id="page_minimize" href="javascript:;" title="<?php esc_html_e('Exit Fullscreen', 'grandportfolio-translation' ); ?>"><i class="fa fa-compress"></i></a>
						</div>
						<?php
							}
						?>
						...
						<div class="header_cart_wrapper">
						    ...
						    <a class="tooltip" href="<?php echo esc_url($cart_url); ?>" title="<?php esc_html_e('View Cart', 'grandportfolio-translation' ); ?>"><i class="fa fa-shopping-cart"></i></a>
						</div>
						<?php
						}
						?>
