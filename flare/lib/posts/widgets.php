 ...
 * Table of contents: 
 *
 * 1. class BTP_Custom_Posts_Widget
 * 2. class BTP_Popular_Posts_Widget
 * 3. class BTP_Recent_Posts_Widget
 * 4. class BTP_Related_Posts_Widget
 */
...
function btp_post_init_custom_posts_widget() {
	register_widget( 'BTP_Custom_Posts_Widget' );
}
add_action( 'widgets_init', 'btp_post_init_custom_posts_widget' );
...
class BTP_Custom_Posts_Widget extends WP_Widget {
	...
	function BTP_Custom_Posts_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 'btp_custom_posts_widget', __('BTP Custom Posts', 'btp_theme'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$templates = btp_post_get_collection_templates();
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'hide_author' ); ?>"><?php echo 'author'; ?></label>
			<br />
...
/* Function called by action/hook 'widgets_init' */
function btp_post_init_popular_posts_widget() {
	register_widget( 'BTP_Popular_Posts_Widget' );
}
add_action( 'widgets_init', 'btp_post_init_popular_posts_widget' );
...
class BTP_Popular_Posts_Widget extends WP_Widget {
	...
	function BTP_Popular_Posts_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 'btp_popular_posts_widget', __('BTP Popular Posts', 'btp_theme'), $widget_ops, $control_ops );
	}
...
/* Function called by action/hook 'widgets_init' */
function btp_post_init_recent_posts_widget() {
	register_widget( 'BTP_Recent_Posts_Widget' );
}
add_action( 'widgets_init', 'btp_post_init_recent_posts_widget' );
...
class BTP_Recent_Posts_Widget extends WP_Widget {
	...
	function BTP_Recent_Posts_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 'btp_recent_posts_widget', __('BTP Recent Posts', 'btp_theme'), $widget_ops, $control_ops );
	}
...
/* Function called by action/hook 'widgets_init' */
function btp_post_init_related_posts_widget() {
	register_widget( 'BTP_Related_Posts_Widget' );
}
add_action( 'widgets_init', 'btp_post_init_related_posts_widget' );
...
class BTP_Related_Posts_Widget extends WP_Widget {
	...
	function BTP_Related_Posts_Widget() {
		...
		/* Create the widget. */
		parent::__construct( 'btp_related_posts_widget', __('BTP Related Posts', 'btp_theme'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'entry_id' ); ?>"><?php _e('Related entry ID', 'btp_theme'); ?>:</label>
