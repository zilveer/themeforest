...
class PeThemeViewGallerySlider extends PeThemeViewGallery {


	public function name() {
		return __("Gallery - Thumbnails + Slider",'Pixelentity Theme/Plugin');
	...
	public function template() {
		peTheme()->get_template_part("view","gallery-slider");
	}
