...
function enable_featured_sort() {
    add_submenu_page('edit.php?post_type=mtheme_featured', 'Sort Featured', 'Sort Featured Slides', 'edit_posts', basename(__FILE__), 'sort_featured');
}
...
?>
	<div class="wrap">
	<h2>Sort Featured Slides<img src="<?php bloginfo('url'); ?>/wp-admin/images/loading.gif" id="loading-animation" /></h2>
...
?>
	<div class="wrap">
	<h2>Sort portfolio Slides<img src="<?php bloginfo('url'); ?>/wp-admin/images/loading.gif" id="loading-animation" /></h2>
	<div class="description">
	Drag and Drop the slides to order them
	</div>
