...
$avia_elements[] =	array(	
					"slug"	=> "contact",
					"name" 	=> "Contact form Quicklink",
					"desc" 	=> "This will display a link at the left side of the page that leads to the contact form. Type the label of the button here. If left empty it will not display",
					"id" 	=> "feedback_button",
					"std" 	=> "Feedback",
					"type" 	=> "text"
					);
