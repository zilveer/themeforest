...
PEXETO.tinymce.buttons=[
		...
		},
		{
			...
			title:'YouTube Video',
			allowSelection:false,
			fields:[{id:'src', name:'Video URL'}, {id:'width', name:'Display width', desc: '(pixels)'}],
		...
		{
			id:'pexetocontentslider',
			image:'testimonials.png',
			title:'Content Slider',
			allowSelection:false,
			fields:[{id:'sliderid', name:'Name of slider', values:PEXETO.contentSliders, desc:'You can create a Content slider in '+PEXETO.themeName+' &raquo; Content Slider section.'}],
			visual:{'shortcode':'pexcontentslider', img:PEXETO.tinymce.btnImageUri+'bg.png'},
			generateHtml:function(obj){
				return PEXETO.tinymce.buildShortcode(obj, this.fields, this.visual.shortcode);
			}
		},
...
PEXETO.tinymce.excludeDialogButtons = /(wp_more|fullscreen|undo|redo|wp_help|pexetobgsection|pexetonivoslider|pexetocontentslider|charmap|pastetext|pasteword),?/g;
