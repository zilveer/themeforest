...
if ( ! function_exists( 'woothemes_add_admin' ) ) {
	function woothemes_add_admin() {
   	...
   	------------------------------------------------------------*/
		...
		add_menu_page( 'Page Title', $themename, 'manage_options', 'woothemes', 'woothemes_options_page', $icon, 25 );
		...
		if( $super_user == $current_user_id || empty( $super_user ) ) {
			$wooframeworksettings = remove_submenu_page( 'woothemes', __( 'Framework Settings', 'woothemes' ), __( 'Framework Settings', 'woothemes' ), 'manage_options', 'woothemes_framework_settings', 'woothemes_framework_settings_page' );
		}
		...
		if( $super_user == $current_user_id || empty( $super_user ) ) {
			$woothemepage = remove_submenu_page( 'woothemes', 'WooFramework Update', 'Update Framework', 'manage_options', 'woothemes_framework_update', 'woothemes_framework_update_page' );
		}
...
if ( ! function_exists( 'woothemes_options_page' ) ) {
	function woothemes_options_page() {
		...
		$documentation = get_option( 'woo_doc' );
		$support = get_option( 'woo_support' );
...
?>
		<div id="support-links">
			<ul>
				<li class="changelog"><a title="Theme Changelog" href="<?php echo esc_url( $manualurl ); ?>" target="_blank"><?php _e( 'View Changelog', 'woothemes' ); ?></a></li>
				<li class="docs"><a title="Theme Documentation" href="<?php echo esc_url( $documentation ); ?>" target="_blank"><?php _e( 'View Theme Documentation', 'woothemes' ); ?></a></li>
				<li class="forum"><a title="Theme Support" href="<?php echo esc_url( $support ); ?>" target="_blank"><?php _e( 'Get Support', 'woothemes' ); ?></a></li>
