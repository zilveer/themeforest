	...
	function print_meta_header($args){
		...
		?>	
			...
			<div id="meta-header" class="<?php echo $meta_id; ?>">
				<h2><?php printf(__('%s','crunchpress'),$title ); ?></h2>
			</div>
					...
					<?php foreach( $options as $option ){ ?>
						<div class='radio-image-wrapper'>
							<label for="<?php echo $option['value']; ?>">
								<img src=<?php echo CP_THEME_PATH_URL.$option['image']?> alt=<?php echo $name;?>>
...
<?php }
  ...
  $labels = array(
    'name' => _x( 'Author', 'taxonomy general name','crunchpress' ),
    'singular_name' => _x( 'Author', 'taxonomy singular name' ,'crunchpress'),
    'search_items' =>  __( 'Search authors','crunchpress' ),
    'popular_items' => __( 'Popular authors','crunchpress' ),
    'all_items' => __( 'All authors','crunchpress' ),
    'parent_item' => null,
    'parent_item_colon' => null,
    'edit_item' => __( 'Edit Author','crunchpress' ), 
    'update_item' => __( 'Update Author','crunchpress' ),
    'add_new_item' => __( 'Add New Author','crunchpress' ),
    'new_item_name' => __( 'New Author Name','crunchpress' ),
    'separate_items_with_commas' => __( 'Separate authors with commas','crunchpress' ),
    'add_or_remove_items' => __( 'Add or remove authors','crunchpress' ),
    'choose_from_most_used' => __( 'Choose from the most used authors','crunchpress' ),
    'menu_name' => __( 'Author','crunchpress' ),
  ); 
  register_taxonomy('author','product',array(
    'hierarchical' => false,
    'labels' => $labels,
    'show_ui' => true,
