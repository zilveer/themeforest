...
<?php			    endif; ?>
			...
			<script type="text/javascript">
			    // <![CDATA[
			    var so = new SWFObject("<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/piecemaker/<?php echo $piecemaker_swf; ?>?random_number=<?php echo rand(1, 10000);?>", "piecemaker-slider", "1100", "455", "10");
			    so.addParam("menu", "false");
			    so.addParam("wmode", "transparent");
			    so.addParam("bgcolor", "#F4F4F4");
			    so.addVariable("xmlSource", "<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/piecemaker/piecemakerXML.xml");
			    so.addVariable("cssSource", "<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/piecemaker/piecemakerCSS.css");
