...
class SocialChef_Theme_Utils {
	...
	public static function display_pager($max_num_pages) {
		...
		if ($count_links > 0) {
			echo '<span><a href="' . esc_url( get_pagenum_link( 1 ) ) . '">' . __('&laquo;', 'socialchef') . '</a></span>';
			...
			echo '<span><a href="' . esc_url( get_pagenum_link( $max_num_pages ) ) . '">' . __('&raquo;', 'socialchef') . '</a></span>';
		}
	}
