...
<?php 
   ...
   $page_layout = isset($page_layout) && $page_layout != '' ? $page_layout = $page_layout : $page_layout = 'wide';
?>
<?php 
// Include page header
...
<section id="main-content" class="container clearfix">
   ...
   <section <?php if ($page_layout != 'wide') echo 'id="main"'; ?> class="clearfix">
      ...
      <article id="post-<?php the_ID(); ?>" <?php if ('open' == $post->comment_status && isset($r_option['display_comments']) && $r_option['display_comments'] == 'on') echo 'class="entry"'; ?>>
         <?php the_content();?>
         <div id="page-link"><?php wp_link_pages('page-link=%'); ?></div> 
      </article>
      <?php endwhile; ?>
      <?php if ('open' == $post->comment_status && isset($r_option['display_comments']) && $r_option['display_comments'] == 'on') comments_template(); ?>
      <?php endif; ?>
   </section>
   <!-- /main -->
