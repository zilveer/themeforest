...
if($background_color != "") {
    if($background_transparency !="") {
        $bg_color = edgt_hex2rgb($background_color);
...
$html .= '<li class="edgt_circle_outer '.$circle_wrapper_classes.'">';
...
$html .= '<span class="edgt_circle_inner'. $border_class.' " style="'.$circle_wrapper_style.'"><span class="edgt_circle_inner2 '.$image_with_text_class.'" style="'.$circle_style.' '.$image_with_text_style.'">';
...
if($type == "image_type"){
    ...
    if($image_src != ""){
        $html .= '<img class="edgt_image_in_circle" src="'.$image_src.'" alt="'.$image_alt.'" />';
    }
...
//		$html .= '<span class="process_icon edgt_font_elegant_icon '.$fe_icon.'" style="'.$icon_style.'" ></span>';
//	}
} else if ($type == "text_type"){
    $html .= '<'.$text_in_circle_tag.' class="edgt_text_in_circle" style="'.$text_in_circle_style.'">'.$text_in_circle.'</'.$text_in_circle_tag.'>';
}
...
if($title != "" || $text != ""){
    $html .= '<div class="edgt_circle_text_holder  '.$title_alignment.' '.$text_alignment.' " '.$circle_text_holder_style.'>';

    if($title != ""){
        $html .= '<'.$title_tag.' class="edgt_circle_title" style="'.$title_style.'">'.$title.'</'.$title_tag.'>';
    }

    if($text != ""){
        $html .= '<p class="edgt_circle_text" style="'.$text_style.'">'.$text.'</p>';
    }
