...
<head>
	...
	function insertShortcode() {
		...
		var galleria_images = document.getElementById('galleria_images').value;
		if ( galleria_images != '' ) shortcode_params = shortcode_params + 'urls="'+galleria_images+'"';
		var shortcode_content = '[dt-galleria'+shortcode_params+']';
		if(window.tinyMCE) {
...
<body>
	<form action="#">
        <h3 class="page-title">Insert a Galleria slideshow</h3>
		<div id="shorcode-manager">
         	<div class="table-row table-row-beforelast"> 
                <label style="width:100px;">Images:</strong></label>
                <textarea id="galleria_images" style="width:450px; height:120px;clear:both;"></textarea>
