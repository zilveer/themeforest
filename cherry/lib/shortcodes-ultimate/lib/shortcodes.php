<?php
	...
	function su_button_shortcode( $atts, $content = null ) {
		...
		$link_style = $span_style = $img_style = '';
	...
	function su_nivo_slider_shortcode( $atts, $content = null ) {
		...
		if ( count( $slides ) > 1 ) {
			...
			$return .= '<div id="nivo-wrap" style="width:' . $width . 'px;height:' . $height . 'px"><div id="' . $slider_id . '" class="su-nivo-slider nivoSlider" style="width:' . $width . 'px;height:' . $height . 'px">';
			foreach ( $slides as $slide ) {
				$return .= '<a href="' . $slide['link'] . '" title="' . $slide['name'] . '"><img src="' . $slide['thumbnail'] . '" data-thumb="' . $slide['thumbnail'] . '" alt="' . $slide['name'] . '" width="' . $width . '" height="' . $height . '" /></a>';
			}
			$return .= '</div></div><div class="clearfix"></div>';
		}
	...
	function su_jcarousel_shortcode( $atts, $content = null ) {
		...
		if ( count( $slides ) > 1 ) {
			...
			foreach ( $slides as $slide ) {
				$return .= '<li style="width:' . $widthli . 'px;height:' . $heightli . 'px;margin-right:' . $margin . 'px"><a href="' . $slide['link'] . '" title="' . $slide['name'] . '"><img src="' . $slide['thumbnail'] . '" alt="' . $slide['name'] . '" width="' . $width . '" height="' . $height . '" /></a></li>';
			}
			$return .= '</ul></div>';
		}
