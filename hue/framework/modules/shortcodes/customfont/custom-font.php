<?php
namespace Hue\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Custom Font', 'hue'),
            'base'                      => $this->getBase(),
            'category'                  => 'by MIKADO',
            ...
            'params'                    => array(
                array(
                    "type"       => "dropdown",
                    "heading"    => esc_html__("Custom Font Tag", 'hue'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Font family", 'hue'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Line height (px)", 'hue'),
                    "param_name" => "line_height",
                    "value"      => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Font Style", 'hue'),
                    "param_name"  => "font_style",
                    "value"       => hue_mikado_get_font_style_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                    ...
                    "value"       => array_flip(hue_mikado_get_font_weight_array()),
                    "save_always" => true
                ),
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Letter Spacing (px)", 'hue'),
                ...
                array(
                    ...
                    "value"       => hue_mikado_get_text_transform_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Text decoration", 'hue'),
                    "param_name"  => "text_decoration",
                    "value"       => array(
                        esc_html__('None', 'hue')         => '',
                        esc_html__('Underline', 'hue')    => 'underline',
                        esc_html__('Overline', 'hue')     => 'overline',
                        esc_html__('Line Through', 'hue') => 'line-through'
                    ),
                    "description" => ""
                ),
                array(
                ...
                array(
                    ...
                    "value"       => array(
                        ...
                        esc_html__('Justify', 'hue') => 'justify'
                    ),
                    "description" => ""
                ),
                array(
                    ...
                    "value"       => esc_html__('Custom Font Content', 'hue'),
                    "description" => "",
                    "save_always" => true
                )
            )
    ...
    public function render($atts, $content = null) {
        ...
        $html = hue_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
