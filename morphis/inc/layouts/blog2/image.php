		...
		<div class="post clearfix layout2">					
			<div class="four columns alpha">
				<div class="half-bottom">					
					...
					<?php if ( $image_pf != '' ) { ?>
					<?php printf( '<div class="overlay squared add-bottom"><figure><div class="overlay-mask"><a class="icon-view" href="%1$s" rel="prettyPhoto" title=""></a><a class="icon-link" href="'. get_permalink() .'"></a></div><img src="%1$s" alt="' . get_the_title() . '" title="' . get_the_title() . '" /></figure></div>', $image_pf ); ?>					
					<?php } ?>			
				</div>
			</div>
			<?php 
