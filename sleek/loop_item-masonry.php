<?php
	...
	$loop_masonry_size = get_post_meta( get_the_ID(), 'loop_masonry_size', true ) != '' ? get_post_meta( get_the_ID(), 'loop_masonry_size', true ) : 'small';
	$post_classes .= ' post--size-' . $loop_masonry_size;
