...
<?php if( !yit_get_option('shop-checkout-multistep') ): ?>
    ...
    <?php endif; ?>
<?php else: ?>
    <?php if ( ( WC()->cart->needs_shipping() || get_option('woocommerce_calc_shipping') == 'yes' ) && ! WC()->cart->ship_to_billing_address_only() ) : ?>
        ...
        <p class="form-row" id="shiptobilling_bill">
            <input id="shiptobilling_bill-checkbox" class="input-checkbox" <?php checked($shiptobilling, 0); ?> type="checkbox" name="ship_to_billing" value="0" />
