...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		...
		<p><?php _e("\"yymmdd\" is the most versatile save format. Read more about",'acf'); ?></p>
	</td>
	<td>
		<?php 
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		...
		<p><?php _e("\"dd/mm/yy\" or \"mm/dd/yy\" are the most used display formats. Read more about",'acf'); ?></p>
	</td>
	<td>
		<?php 
		do_action('acf/create_field', array(
