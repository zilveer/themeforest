...
class Royal_Recent_Category_Post_Widget extends WP_Widget {
    ...
    function Royal_Recent_Category_Post_Widget() {
		global $themename;
		$widget_ops = array('classname' => 'custom-recent-category-widget', 'description' => __( "Recent category post widget with post thumbnails", 'my-text-domain') );
		$control_ops = array('width' => 250, 'height' => 200);
		$this->WP_Widget('recentcategoryposts', __('1) Royal Recent Category Post', 'my-text-domain'), $widget_ops, $control_ops);
    }
