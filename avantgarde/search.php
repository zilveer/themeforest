...
<?php $default_sidebar = $theme_prefix['blog_sidebar']; ?>
	<div class="title pos-center margint60 cat-title"><h6><?php printf( __( 'SEARCH RESULT : %s', '2035themes-fm' ), get_search_query()); ?></h6></div>
	<div class="row clearfix"><!-- Row Start -->
	    ...
	    <div class="col-lg-12 col-sm-12" ><?php } else { ?> <div class="col-lg-9 col-sm-8" > <?php } ?> <!-- If Sidebar is not defined, then Post will be Full Screen -->
	    	...
	    	<?php endwhile; else : ?>
	    	<div class="margint30"><h4><?php echo __('Your search returned no results. Please try a different keyword!','2035Themes-fm') ?></h4></div>
	    	<?php endif; ?>
