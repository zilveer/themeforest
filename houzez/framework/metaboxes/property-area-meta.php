...
if ( !function_exists( 'houzez_save_property_area_meta_fields' ) ) :
    function houzez_save_property_area_meta_fields( $term_id ) {
...
add_action( 'edited_property_area', 'houzez_save_property_area_meta_fields', 10, 2 );
add_action( 'create_property_area', 'houzez_save_property_area_meta_fields', 10, 2 );
