...
function vntd_services_register() {
    $args = array(
        'label' => __('Services', 'veented_backend'),
        'public' => true,
        'show_ui' => true,
...
?>
	<div class="metabox-options form-table fullwidth-metabox image-upload-dep">
		...
		<div class="metabox-option">
			<h6><?php _e('Title', 'veented_backend') ?>:</h6>
			<input type="text" name="title" value="<?php echo $title; ?>">
		</div>
		
		<div class="metabox-option">
			<h6><?php _e('Description', 'veented_backend') ?>:</h6>
			<textarea name="desc"><?php echo $desc; ?></textarea>
		</div>		
		
		<div class="metabox-option">
			<h6><?php _e('Font-Awesome Icon', 'veented_backend') ?>:</h6>
			<?php
