<?php
/**
 * The template for displaying content using "left thumbnail and excerpt" style. 
  ...
  <article id="post-<?php the_ID(); ?>" <?php post_class('post-blog'); ?> >
	<div class="entry">
	  ...
	  <div class="post-content group">
	    <?php prima_image( array ( 'width' => 150, 'height' => 150, 'image_class' => 'alignleft', 'link_to_post' => true ) ); ?>
		<?php the_excerpt(); ?>
	  </div>
