<?php
class rt_generate_woo_products_extended_class extends RTThemePageLayoutOptions{
	#
	#	Product Box
	#
	function rt_generate_woo_products_extended($theGroupID,$theTemplateID,$options,$randomClass){
			...
			$options = array (
						...
						array(
								...
								"id" => $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][heading]", 
								"value"=> $heading,
								"type" => "text"
						), 
						...
						array(
								...
								"id" 	=> $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][categories][]",
						...
						array(
								...
								"id" => $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][list_orderby]", 
						...
						array(
								...
								"id" => $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][list_order]", 
						...
						array(
								...
								"id" 	=> $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][item_per_page]",
								"min"	=> "1",
								"max"	=> "200",
								"class"	=> $randomClass,
								"value"	=> $item_per_page,
						...
						array(
								...
								"id" 	=> $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][pagination]",
								"type" 	=> "checkbox2",
								"class"	=> $randomClass,
								"value"	=> $pagination, 	 
								"default"	=> "off",
						...
						array(
								...
								"id" => $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][item_width]",
								"options" =>	array(
											5 => "1/5", 
											4 => "1/4",
											3 => "1/3",
						...
						array(
								...
								"id" 	=> $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][with_borders]",
								"type" 	=> "checkbox2",
								"class"	=> $randomClass,
								"value"	=> $with_borders, 	  
								"std" 	=> "false"),	
						...
						array(
								...
								"id" 	=> $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][with_effect]",
								"type" 	=> "checkbox2",
								"class"	=> $randomClass,
								"value"	=> $with_effect, 	 
								"default"	=> "off",
						...
						array(
								...
								"id" 	=> $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][no_top_border]",
								"type" 	=> "checkbox2",
								"class"	=> $randomClass,
								"value"	=> $no_top_border, 	  
								"std" 	=> "false"),	
						...
						array(
								...
								"id" 	=> $theTemplateID.'_'.$theGroupID."_woo_products_extended[values][no_bottom_border]",
								"type" 	=> "checkbox2",
								"class"	=> $randomClass,
