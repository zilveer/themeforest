...
$edit_allowed = (woffice_edit_allowed('post') == true) ? true : false;
$delete_allowed = (woffice_edit_allowed('post', 'delete') == true) ? true : false;
if ($edit_allowed) {
							...
							<div class="box">
								<div class="intern-padding">
									...
									<div class="center" id="blog-bottom">
										...
										<?php
                                        if($edit_allowed)
                                            echo'<a href="javascript:void(0)" class="btn btn-default" id="show-blog-edit"><i class="fa fa-pencil-square-o"></i> '. __("Edit Post", "woffice") .'</a>'; ?>
