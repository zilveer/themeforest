<?php
/**
 * Template Name: Portfolio Masonry Fullwidth
...
{
?>
    <ul class="portfolio_filters portfolio-main filter full"> 
    	<li class="all-projects active">
    		<a class="active" href="javascript:;" data-filter="*" data-target="photo_wall_wrapper"><?php echo _e( 'All', THEMEDOMAIN ); ?></a>
    	...
    	<li class="cat-item <?php echo $set_item->slug; ?>" data-type="<?php echo $set_item->slug; ?>" style="clear:none">
    		<a data-filter=".<?php echo $set_item->slug; ?>" data-target="photo_wall_wrapper" href="javascript:;" title="<?php echo $set_item->name; ?>"><?php echo $set_item->name; ?></a>
    		<span class="separator">/</span>
    	</li> 
    	<?php
    		}
...
<div class="inner">
	...
	<div id="page_main_content" class="sidebar_content full_width">
		...
		?>
		<div class="wall_entry <?php echo $portfolio_item_set; ?>">
