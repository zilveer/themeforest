<?php
/**
 * The Template with the sidebar on the left side for displaying single post.
 *
...
<?php get_header(); ?>
	...
	<div id="content" class="<?php echo btp_content_get_class(); ?>">
		<div id="content-inner">
			...
			<div class="grid">
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'c-two-third push-one-third' ); ?>>					
					...
					<?php if ( $elems[ 'related_posts' ] ) { get_template_part( '/lib/posts/templates/related' ); } ?>
