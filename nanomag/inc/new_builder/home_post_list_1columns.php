<?php
class home_post_list_1columns extends AQ_Block {
	
	//set and create block
	function __construct() {
		$block_options = array(
	    'name' => esc_attr__('Post small list 1 columns', 'nanomag'),
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('home_post_list_1columns', $block_options);
	}
	
	
	//create form
	function form($instance) {
        $titles = isset($instance['titles']) ? esc_attr($instance['titles']) : 'Home small post list';
...
<?php echo jelly_post_meta(get_the_ID()); ?>
   ...
   <div class="clearfix"></div>
				 ...
				 <?php if($i==2 || $i==4 || $i==6 || $i==8 || $i==10 || $i==12){echo '<div class="clearfix"></div>';}?>
				<?php }?>
