...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<div class="col-2">
		...
		<p class="form-row-wide form-row-first">
			<label for="username"><?php _e( 'Username or email', 'flatastic' ); ?> <span class="required">*</span></label>
		...
		<p class="form-row">
			...
			<label for="rememberme" class="inline"><?php _e( 'Remember me', 'flatastic' ); ?></label>
		</p>

		<p class="form-row">
			<?php wp_nonce_field( 'woocommerce-login' ); ?>
			<input type="submit" class="button" name="login" value="<?php _e( 'Login', 'flatastic' ); ?>" />
