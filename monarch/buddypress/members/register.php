...
/*
Template Name: Monarch BuddyPress Registration Page
*/
    ...
    <?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
      ...
      <div class="register-section" id="basic-details-section">
        ...
        <div class="signup_username">
          ...
          <input type="text" placeholder="<?php _e( 'Username', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?>" name="signup_username" id="signup_username" value="<?php bp_signup_username_value(); ?>" <?php bp_form_field_attributes( 'username' ); ?>/>
        </div>

        <div class="signup_email">
          <label for="signup_email"><?php _e( 'Email Address', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?></label>
          <?php do_action( 'bp_signup_email_errors' ); ?>
          <input type="email" placeholder="<?php _e( 'Email Address', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?>" name="signup_email" id="signup_email" value="<?php bp_signup_email_value(); ?>" <?php bp_form_field_attributes( 'email' ); ?>/>
        </div>

        <div class="signup_password">
          <label for="signup_password"><?php _e( 'Choose a Password', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?></label>
          <?php do_action( 'bp_signup_password_errors' ); ?>
          <input type="password" placeholder="<?php _e( 'Choose a Password', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?>" name="signup_password" id="signup_password" value="" class="password-entry" <?php bp_form_field_attributes( 'password' ); ?>/>
        </div>
        ...
        <div class="signup_password_confirm">
          ...
          <input type="password" placeholder="<?php _e( 'Confirm Password', 'buddypress' ); ?> <?php _e( '(required)', 'buddypress' ); ?>" name="signup_password_confirm" id="signup_password_confirm" value="" class="password-entry-confirm" <?php bp_form_field_attributes( 'password' ); ?>/>
        </div>
      ...
      <div class="submit">
        <input type="submit" class="btn btn-primary" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
      </div>
