...
/*-----------------------------------------------------------------------------------*/
		...
		<h3 id="comments"><?php comments_number(__('0 Comments', 'framework'), __('One Comment', 'framework'), __('% Comments', 'framework')); ?></h3>
		
		<ol class="commentlist">
        <?php wp_list_comments('type=comment&avatar_size=35&callback=tz_comment'); ?>
        </ol>
...
/*-----------------------------------------------------------------------------------*/
		...
		if ('closed' == $post->comment_status && !is_page()) : // if the post has comments but comments are now closed ?>
...
/*-----------------------------------------------------------------------------------*/
	...
	<div id="respond">
		...
		<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
			...
			<label for="author"><small><?php _e('Name', 'framework') ?> <?php if ($req) echo "<span>*</span>"; ?></small></label></p>
		
			<p><input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" />
			<label for="email"><small><?php _e('Email <span>*</span> (never published)', 'framework') ?></small></label></p>
			...
			<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Submit', 'framework') ?>" />
