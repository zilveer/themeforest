    ...
    <script type="text/javascript" src="<?php bloginfo('template_url');?>/js/slider_v1.js"></script>
		...
		<div id="full-width-slider">
					...
					<?php if($featureditem != '487'){?>
                        ...
                        <div style="width:100%;height:400px;background-image:url('<?php echo $themeteam_image_upload; ?>');">
		            		<div class="container_12">
		                        <div class="slider-texts">
                                   <h2><?php if ( $themeteam_custom_link ) {?>
