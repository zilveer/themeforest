function desServiceMaker(h, i, f) {
    ...
    this.buildTextInputControl = function ( id ) {
    	...
    	var inputElement2 = '<select id="des_service_icon_' + id.toString() + '" class="select input-select" name="des_service_icon" onchange="document.getElementById(\'des_service_iconh_' + id.toString() + '\').value = this.value; document.getElementById(\'img_preview_' + id.toString() + '\').src = \''+icon_url+'\' + this.value + \'.png\'" style="opacity:1">';
    	for (var i=0; i < 36; i++){
    		inputElement2 += '<option value="icon' + (i+1) + '">Icon ' + (i+1) + '</option>';
    	}
    	inputElement2 += '</select><img id="img_preview_'+id.toString()+'" src="'+icon_url+'icon1.png" width="22px" height="22px">';
        ...
        this.textInputControl = jQuery( '<tr class="remover"><th>' + labelElement + '</th><td class="td-first">' + inputElement + '</td></tr><tr class="remover"><th>' + labelElement2 + '</th><td>' + inputElement2 + inputElementh + '</td></tr><tr class="remover"><th>' + labelElement3 + '</th><td>' + inputElement3 + '</td></tr><tr class="remover"><td class="td-divider" colspan=2></tr>' );
