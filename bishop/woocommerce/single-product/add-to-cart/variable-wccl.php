        ...
        <table class="variations" cellspacing="0">
            ...
            <?php foreach ( $attributes as $name => $options ) : ?>
                ...
                <tr>
                    ...
                    <td class="value">
                        <select id="<?php echo esc_attr( sanitize_title($name) ); ?>" name="attribute_<?php echo esc_attr( sanitize_title( $name ) ) ?>" data-attribute_name="attribute_<?php echo esc_attr( sanitize_title( $name ) ) ?>" data-type="<?php echo $attributes_types[$name] ?>">
