...
if($options_data['select_bloglayout'] == 'Blog Medium') { 
	...
	$video_height = '340';
	$video_width = '470';
} elseif($options_data['select_blogsidebar'] != 'none' && $options_data['select_blogsidebar'] != '') {
	$video_height = '410';
	$video_width = '875';
} else {
	$video_height = '410';
									...
									<div class="post-content-container">
										...
										<div class="wrapper">
											<?php if($options_data['check_readmore'] != "0") { ?>
												<div class="post-more"><a href="<?php the_permalink(); ?>" class="button medium default" title="<?php printf( esc_attr__('Permalink to %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php _e('Read more', 'richer'); ?></a></div>
											<?php }?>
