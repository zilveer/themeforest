...
$border_color = ( $border_color !== '' ) ? ' vc_box_border_'. esc_attr( $border_color ) : '';
...
switch ( $onclick ) {
	...
	case 'link_image':
		...
		$a_attrs['data'] = 'data-fancybox-type="image"';
...
$html = '<div class="vc_single_image-wrapper '. esc_attr( $style .' '. $border_color ) .'">'. $html .'</div>';
...
$class_to_filter = 'wpb_single_image wpb_content_element vc_align_'. esc_attr( $alignment ) .' '. $this->getCSSAnimation( $css_animation );
