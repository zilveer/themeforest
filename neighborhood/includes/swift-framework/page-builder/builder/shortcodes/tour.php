<?php
	...
	*/
	...
	SPBMap::map( 'spb_tour', array(
	    "name"		=> __("Tour Section", "swiftframework"),
	    "base"		=> "spb_tour",
	    "controls"	=> "full",
	    "class"		=> "spb_tour",
		"icon"		=> "spb-icon-tour",
	    ...
	    "params"	=> array(
	        ...
	        array(
	            "type" => "dropdown",
	            "heading" => __("Auto rotate slides", "swiftframework"),
	            "param_name" => "interval",
	            "value" => array(0, 3, 5, 10, 15),
	            "description" => __("Auto rotate slides each X seconds. Select 0 to disable.", "swiftframework")
	        ),
	        array(
	            "type" => "textfield",
		...
		<div class="tab_controls">
			<button class="add_tab">'.__("Add slide", "swiftframework").'</button>
		</div>
	    ...
	    'default_content' => '
		<ul>
			<li><a href="#tab-1"><span>'.__('Slide 1', "swiftframework").'</span></a><a class="delete_tab"></a><a class="edit_tab"></a></li>
			<li><a href="#tab-2"><span>'.__('Slide 2', "swiftframework").'</span></a><a class="delete_tab"></a><a class="edit_tab"></a></li>
		</ul>
