<?php
namespace QodeStartit\Modules\Shortcodes\Button;
 ...
 * @package QodeStartit\Modules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            ...
            'params'                    => array_merge(
                ...
                qode_startit_icon_collections()->getVCParamsArray(array(), '', true),
                array(
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Color',
                    ...
                    array(
                        ...
                        'heading'     => 'Margin',
                        'param_name'  => 'margin',
                        'description' => esc_html__('Insert margin in format: 0px 0px 1px 0px', 'startit'),
                        'admin_label' => true,
                        'group'       => 'Design Options'
                    )
                )
    ...
    public function render($atts, $content = null) {
        ...
        return qode_startit_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.qode_startit_filter_px($params['font_size']).'px';
        }
