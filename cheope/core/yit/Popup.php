...
class YIT_Popup {
	...
	public function add_popup_css_js() {
		...
		wp_enqueue_script( 'jquery-cookie', YIT_CORE_ASSETS_URL . '/js/jq-cookies.js', array('jquery') );
		...
		<div id="popupWrap" class="popupWrap span6">
				<div class="popup">
					...
					<?php if( ($this->image) || ($this->message) || $this->newsletter) : ?>
						<div class="row">
							<?php if($this->image) : ?>
							<div class="popup_img span2"><img alt="popup-image" src="<?php echo $this->image ?>" /></div>
							<?php endif ?>
