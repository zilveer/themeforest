<?php
namespace QodeStartit\Modules\PricingTable;
...
class PricingTable implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= qode_startit_get_shortcode_module_template_part('templates/pricing-table-template','pricing-table', '', $params);
		return $html;
