...
<?php 
					...
					<div class="fw-portPreview">
                        <div class="img_block wrapped_img fs_port_item">
                            <a class="featured_ico_link" href="<?php echo $linkToTheWork; ?>" <?php echo $target; ?>>
                            	<img alt="<?php echo $featured_alt; ?>" width="540" height="" src="<?php echo aq_resize($featured_image[0], "540", "440", true, true, true); ?>" />
							</a>
	...
	<?php if (isset($gt3_theme_pagebuilder['portfolio']['port_type']) && $gt3_theme_pagebuilder['portfolio']['port_type'] == 'port_isotope') {?>
        function get_works() {
            gt3_get_isotope_posts("port", <?php gt3_the_theme_option('fw_port_per_page'); ?>, posts_already_showed, "port_grid_isotope", ".fs_blog_module", categories, '<?php echo $setPad; ?>', '<?php echo $post_type_field; ?>');
	...
	<?php } else { ?>
        function get_works() {
            ...
            gt3_get_portfolio("port", <?php gt3_the_theme_option('fw_port_per_page'); ?>, posts_already_showed, "port_grid_template", ".fs_blog_module", categories, '<?php echo $setPad; ?>', '<?php echo $post_type_field; ?>');
            posts_already_showed = posts_already_showed + <?php gt3_the_theme_option('fw_port_per_page'); ?>;
        }	
