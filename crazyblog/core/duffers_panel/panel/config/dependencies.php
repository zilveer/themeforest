...
return array(
	...
	'scripts' => array(
		...
		'paths' => array(
			...
			'jquery-ui-timepicker' => array(
				'path' => VP_PUBLIC_URL . '/js/vendor/jquery-ui-timepicker-addon.js',
				'deps' => array( 'jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-datepicker', 'jquery-ui-slider' ),
				'ver' => '1.4.4',
			),
			'jquery-typing' => array(
			...
			'vp-timepicker' => array(
				'path' => VP_PUBLIC_URL . '/js/jquery-ui-timepicker.js',
				'deps' => array( 'jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-datepicker', 'jquery-ui-slider' ),
				'ver' => '3.3.2',
				'override' => true,
				'localize' => array(
			...
			'vp-gallery' => array(
				'path' => VP_PUBLIC_URL . '/js/gallery.js',
				'deps' => array( 'jquery' ),
				'ver' => '3.3.2',
				'override' => true,
				'localize' => array(
	...
	'styles' => array(
		...
		'paths' => array(
			...
			'vp-timepicker' => array(
				'path' => VP_PUBLIC_URL . '/css/vendor/jquery-ui-timepicker-addon.css',
				'deps' => array(),
			),
			'vp_flateicon' => array(
				'path' => VP_PUBLIC_URL . '/css/flaticon.css',
				'deps' => array(),
			),
			'vp_gallery' => array(
				'path' => VP_PUBLIC_URL . '/css/gallery.css',
				'deps' => array(),
			),
		),
	),
	...
	'rules' => array(
		...
		'time' => array( 'js' => array( 'jquery-ui-timepicker' ), 'css' => array( 'jqui' ) ),
		...
		'flateicon' => array( 'js' => array( 'select2' ), 'css' => array( 'select2' ) ),
		'timepicker' => array( 'js' => array( 'jquery-ui-timepicker' ), 'css' => array( 'jqui' ) ),
		'gallery' => array( 'js' => array( 'vp-gallery' ), 'css' => array( 'vp_gallery' ) ),
