		...
		<?php while ( bbp_forums() ) : bbp_the_forum(); ?>
			...
			<div class="section-head gallery-title forum-cat">
				...
				<ul class="forum-titles">
					...
					<li class="normal bbp-forum-topic-count"><?php _e( 'Topics', 'nanomag' ); ?> / <?php bbp_show_lead_topic() ? _e( 'Replies', 'nanomag' ) : _e( 'Posts', 'nanomag' ); ?></li>
					<li class="normal bbp-forum-freshness"><?php _e( 'Freshness', 'nanomag' ); ?></li>
				</ul>
