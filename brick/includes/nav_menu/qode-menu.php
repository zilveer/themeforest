...
function qode_edit_walker($walker,$menu_id) {
	...
	return 'Qode_Walker_Nav_Menu_Edit_Custom';
...
if (!class_exists('qode_type1_walker_nav_menu')) {
	...
	// add classes to ul sub-menus
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			$wide_background = '';
			if(isset($qode_options['enable_wide_manu_background']) && $qode_options['enable_wide_manu_background'] == "yes" ){
			...
			if($item->hide == ""){
                ...
                if($depth == 0 && isset($qode_options['enable_dropdown_menu_item_icon']) && $qode_options['enable_dropdown_menu_item_icon'] == "yes" ){
