...
/* Deprecated Filters in 2.0 */
add_filter( 'get_data_portfolio_type_1_columns_count', 'kalium_portfolio_columns_translate_to_number' );
add_filter( 'get_data_portfolio_type_2_columns_count', 'kalium_portfolio_columns_translate_to_number' );

// Animated Eye is also deprecated, moved to select list
if ( ! get_data( 'portfolio_type_1_hover_layer_type' ) ) {
	add_filter( 'get_data_portfolio_type_1_hover_layer_type', laborator_immediate_return_fn( get_data( 'portfolio_type_1_hover_animatd_eye' ) ? true : false ) );
}

if ( ! get_data( 'blog_post_hover_layer_icon' ) ) {
	add_filter( 'get_data_blog_post_hover_layer_icon', laborator_immediate_return_fn( get_data( 'blog_post_hover_animatd_eye' ) ? true : false ) );
}