    ...
    if ( ! class_exists( 'ReduxDebugObject' ) ) {
        ...
        class ReduxDebugObject {
            ...
            public function render() {
                ...
                echo '<h3>' . esc_html__( 'Options Object', 'redux-framework' ) . '</h3>';
                ...
                echo '<a href="#" id="consolePrintObject" class="button">' . esc_html__( 'Show Object in Javascript Console Object', 'redux-framework' ) . '</a>';
            ...
            public function render_tab() {
                ...
                echo '<a href="javascript:void(0);" id="dev_mode_default_section_group_li_a" class="redux-group-tab-link-a custom-tab" data-rel="dev_mode_default">' . $icon . ' <span class="group_title">' . esc_html__( 'Options Object', 'redux-framework' ) . '</span></a>';
                echo '</li>';
            }
            ...
            public function add_submenu() {
	            add_theme_page(
                    ...
                    esc_html__( 'Options Object', 'redux-framework' ),
                    esc_html__( 'Options Object', 'redux-framework' ),
