(function( $ ) {
    ...
    $.fn.lionbars_reload = function() {
        $(this).find('.lb-v-scrollbar').remove();
        height=$(this).height();
        width=$(this).width();
        $(this).removeAttr('style').removeAttr('vratio').removeAttr('hratio');
        $(this).height(height).width(width);
        $(this).find('.lb-content').children().eq(0).unwrap();
        $(this).find('.lb-wrap').children().eq(0).unwrap();
        $(this).lionbars();
    };
