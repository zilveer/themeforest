...
if ( $layout == 'cs' ) {
	...
	$blog_posts_class = 'sponsors-listing-style-2';
	$has_sidebar = true;
...
?>
	...
	<div class="container clearfix">
		...
		<div id="content" class="<?php echo $content_class; ?>">
			...
			<div class="sponsors sponsors-listing <?php echo $blog_posts_class; ?> clearfix">
				...
				<?php
					...
					endwhile; else:
						...
						?><div class="align-center">There are no sponsors yet. Go to WP admin &rarr; Sponsors &rarr; Add New.</div><?php
		...
		<?php if ( $has_sidebar ) { get_sidebar( 'sponsors' ); } ?>
