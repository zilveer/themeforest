<?php
	...
	*/
	...
	if(function_exists('add_theme_support')){
		...
		register_nav_menus(array('main_menu' =>'Main Navigation Menu', 'main_menu_2' => 'Main Navigation Menu 2'));
	}	
	...
	if (function_exists('register_sidebar')){	
		...
		$sidebar_attr['before_title'] = '<div class="sidebar-title-wrapper"><h3 class="custom-sidebar-title">';
		$sidebar_attr['after_title'] = '</h3><div class="sidebar-title-gimmick"></div><div class="clear"></div></div>';
