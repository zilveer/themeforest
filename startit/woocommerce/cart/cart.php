...
<table class="shop_table shop_table_responsive cart" cellspacing="0">
	<thead>
		<tr>
			...
			<th class="product-name"><?php esc_html_e( 'Product', 'startit' ); ?></th>
			<th class="product-price"><?php esc_html_e( 'Price', 'startit' ); ?></th>
			<th class="product-quantity"><?php esc_html_e( 'Quantity', 'startit' ); ?></th>
			...
			<td colspan="6" class="actions">
				...
				<?php if ( wc_coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'startit' ); ?>" />
