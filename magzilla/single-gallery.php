...
if( get_post_meta( get_the_ID(), '_favethemes_gallery_posttype_meta', true ) ):

	$fave_meta = get_post_meta( get_the_ID(), '_favethemes_gallery_posttype_meta', true );
	
	if( $ft_option['single_gallery_default_settings'] != 1 ) {
		...
		$single_sidebar_pos = $ft_option['single_gallery_default_sidebar_position'];
		$post_layout = $ft_option['single_gallery_default_template'];
		$fave_sidebar = $ft_option['single_gallery_custom_sidebar'];
...
<div class="container">
	...
	if ( have_posts() ) : while ( have_posts() ) : the_post();
        ...
        get_template_part( 'single-gallery/single-template', $post_layout );
