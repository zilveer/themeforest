        ...
        <div class="row">
            <div class="breadcrumb-container clearfix">
                ...
                <?php if(count($category) == 1): ?>
                    ...
                    <?php
                    global $clx_data;
                    echo '<nav class="categories-portfolio"><ul data-option-key="filter" class="option-set"><li><a class="selected" href="'.get_permalink($clx_data['events-page-default']).'">'.__('All', LANGUAGE_ZONE).'</a></li></ul></nav>';
                    ?>

                <?php else: ?>

                    <?= clx_breadcrumbs_filter(EventPostType::get_instance()->postTypeTax, $category); ?>
                            ...
                            <div class="filter-container events-container">
                                ...
                                <?php if ( $query->have_posts() ) : ?>
                                    ...
                                    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                                        ...
                                        $terms = wp_get_post_terms( get_the_ID(), EventPostType::get_instance()->postTypeTax );
                                        ?>

                                        <article class="<?= 'col-sm-4 col-xs-6'; ?> <?php foreach($terms as $term) { echo $term->slug . ' '; } ?>">
                                            <figure>
