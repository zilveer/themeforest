...
?>
	...
	<div class="module-8 <?php echo $text_align; ?> gallery" <?php echo $style; ?>>
		
		<?php if ( $hide_title != 'hide_title' ) { ?>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="module-top clearfix"> <?php echo fave_get_gallery_block_title( $atts ); ?> </div><!-- .module-top -->
				...
				<div class="slide">
					<div class="slide-image-wrap slider-with-animation">
						...
						<a href="<?php echo esc_url( get_permalink() ); ?>">
							<img class="featured-image lazyOwl" data-src="<?php echo fave_featured_image( get_the_ID(), $img_width, $img_height, true, true, true ); ?>" alt="<?php the_title(); ?>" src="<?php echo fave_featured_image( get_the_ID(), $img_width, $img_height, true, true, true ); ?>">
						</a>
...
add_shortcode('fav-gallery-module-2', 'fav_gallery_module_2');
?>