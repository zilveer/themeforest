<div class="wrap" id="of_container">
	...
	<div id="of-popup-install-data" class="of-save-popup">
		<div class="of-save-save">Installer Success</div>
	</div>

	<div id="of-popup-generate_less" class="of-save-popup">
		<div class="of-save-save">Generated</div>
	</div>
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="info_bar">
			...
			<button id="of_generate_less" type="button" class="button-primary"><?php esc_html_e('Generate Less to CSS', 'zorka' ); ?></button>


			<button id="of_save" type="button" class="button-primary"><?php esc_html_e('Save All Changes','zorka');?></button>
		...
		<div class="save_bar"> 
			...
			<img style="display:none" src="<?php echo ADMIN_DIR; ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
			<button id="of_generate_less" type="button" class="button-primary"><?php esc_html_e('Generate Less to CSS', 'g5plus' ); ?></button>
			<button id ="of_save" type="button" class="button-primary"><?php  esc_html_e('Save All Changes','zorka');?></button>
			<button id ="of_reset" type="button" class="button submit-button reset-button" ><?php esc_html_e('Options Reset','zorka');?></button>
