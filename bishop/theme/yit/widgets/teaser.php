    ...
    class teaser extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            if( function_exists( 'icl_translate' ) )  {
                $instance['slogan'] = icl_translate( 'Widgets', 'widget_teaser_slogan_' . $instance['slogan'], $instance['slogan'] );
                $instance['subslogan'] = icl_translate( 'Widgets', 'widget_teaser_subslogan_' . $instance['subslogan'], $instance['subslogan'] );
            }
