...
<div class="inner">
	...
	<div class="element <?php echo $portfolio_item_set; ?>" style="overflow:hidden;margin-bottom:20px">
		...
		<div class="one_fourth gallery4 filterable portfolio_type" data-id="post-<?php echo $key+1; ?>" data-type="<?php echo $portfolio_item_set; ?>">
		<?php 
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_item->ID; ?>" class="portfolio_desc portfolio4 filterable <?php echo $last_class; ?>">
