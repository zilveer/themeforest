...
<div class="inner">
	...
	<div class="element classic2_cols">
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_ID; ?>" class="portfolio_desc portfolio2 filterable">
            <h5><?php echo get_the_title(); ?></h5>
            <p><?php echo pp_substr(strip_tags(pp_strip_shortcodes(get_the_content())), 130); ?></p>
        </div>
	</div>
	<?php
		endwhile; endif;
