...
if (!function_exists('create_post_type')) {
	function create_post_type() {
		global $qode_options;
		$slug = 'portfolio_page';
		if(isset($qode_options['portfolio_single_slug'])) {
			if($qode_options['portfolio_single_slug'] != ""){
				$slug = $qode_options['portfolio_single_slug'];
			}
		}
		...
		register_post_type('slides',
			array(
				'labels' 		=> array(
				'name' 				=> __('Select Slider','qode' ),
				'menu_name'	=> __('Select Slider','qode' ),
	  ...
	  register_post_type('carousels',
			array(
				'labels'    => array(
				'name'        => __('Select Carousel','qode' ),
				'menu_name' => __('Select Carousel','qode' ),
