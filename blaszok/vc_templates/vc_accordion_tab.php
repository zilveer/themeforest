...
$output .= "\n\t\t\t" . '<div class="'.$css_class.'">';
    $output .= "\n\t\t\t\t" . '<h3 class="wpb_accordion_header ui-accordion-header"><a href="#'.sanitize_title($title).'">'.$title.'</a><i class="fa fa-fw fa-angle-down"></i><i class="fa fa-fw fa-angle-up"></i></h3>';
