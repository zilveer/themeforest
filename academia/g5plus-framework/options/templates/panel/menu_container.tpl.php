        ...
        <?php if ( $this->parent->args[ 'system_info' ] === true ) : ?>
            <li id="system_info_default_section_group_li" class="redux-group-tab-link-li">
                ...
                <a href="javascript:void(0);" id="system_info_default_section_group_li_a"
                   class="redux-group-tab-link-a custom-tab" data-rel="system_info_default"><?php echo sprintf('%s', $icon); ?><span
                        class="group_title"><?php esc_html_e( 'System Info', 'redux-framework' ); ?></span></a>
            </li>
        <?php endif; ?>
    </ul>
</div>