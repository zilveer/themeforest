	...
	public static function optionsframework_machine($options) {
		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case 'favethemes_typo':


					$fave_type = $smof_data[$value['id']];

					if(isset($fave_type['font_size'])) {
						$output .= '<div class="select_wrapper typography-size fave_typo" original-title="Font Size">';
						$output .= '<select class="of-typo of-typo-font-size select" name="' . $value['id'] . '[font_size]" id="' . $value['id'] . '_font_size">';
						for ( $i = 0; $i < 76; $i ++ ) {
							$output .= '<option value="' . $i . '" ' . selected( $fave_type['font_size'], $i, false ) . '>' . $i . 'px</option>';
						}
						$output .= '</select></div>';
					}

					/* Font Weight */
					if(isset($fave_type['font_weight'])) {
						$output .= '<div class="select_wrapper typography-size fave_typo" original-title="Font Weight">';
						$output .= '<select class="of-typo of-typo-font_weight select" name="' . $value['id'] . '[font_weight]" id="' . $value['id'] . '_font_weight">';
						...
						foreach ( $font_weight as $i => $w ) {
							$output .= '<option value="' . $i . '" ' . selected( $fave_type['font_weight'], $i, false ) . '>' . $w . '</option>';
						}
					...
					/* Line Height */
					if(isset($fave_type['line_height'])) {
						$output .= '<div class="select_wrapper typography-size fave_typo" original-title="Line Height">';
						$output .= '<select class="of-typo of-typo-line_height select" name="' . $value['id'] . '[line_height]" id="' . $value['id'] . '_line_height">';
						for ( $i = 0; $i < 76; $i ++ ) {
							$output .= '<option value="' . $i . '" ' . selected( $fave_type['line_height'], $i, false ) . '>' . $i . 'px</option>';
						}
						$output .= '</select></div>';
					}

					/* Font Weight */
					if(isset($fave_type['font_style'])) {
						$output .= '<div class="select_wrapper typography-size fave_typo" original-title="Font Style">';
						$output .= '<select class="of-typo of-typo-font_weight select" name="' . $value['id'] . '[font_style]" id="' . $value['id'] . '_font_style">';
						...
						foreach ( $font_style as $i => $style ) {
							$output .= '<option value="' . $i . '" ' . selected( $fave_type['font_style'], $i, false ) . '>' . $style . '</option>';
						}
					...
					/* Letter */
					if(isset($fave_type['letter_spacing'])) {
						$output .= '<div class="select_wrapper typography-size fave_typo" original-title="Letter Spacing">';
						$output .= '<select class="of-typo of-typo-letter_spacing select" name="' . $value['id'] . '[letter_spacing]" id="' . $value['id'] . '_letter_spacing">';
						for ( $i = 0; $i < 25; $i ++ ) {
							$output .= '<option value="' . $i . '" ' . selected( $fave_type['letter_spacing'], $i, false ) . '>' . $i . 'px</option>';
						}
						$output .= '</select></div>';
					}

					/* Text Transform */
					if(isset($fave_type['text_transform'])) {
						$output .= '<div class="select_wrapper typography-size fave_typo" original-title="Text Transform">';
						$output .= '<select class="of-typo of-typo-text_transform select" name="' . $value['id'] . '[text_transform]" id="' . $value['id'] . '_text_transform">';
						...
						foreach ( $text_transform as $i => $tt ) {
							$output .= '<option value="' . $i . '" ' . selected( $fave_type['text_transform'], $i, false ) . '>' . $tt . '</option>';
						}
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ','realto').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
				...
				case 'myswitch':
					...
					$output .= '<p class="switch-options">';
						$output .= '<label class="'.$fold.'cb-enable myon'. $cb_enabled .'" data-id="'.$value['id'].'"><span>'. $on .'</span></label>';
						$output .= '<label class="'.$fold.'cb-disable myoff'. $cb_disabled .'" data-id="'.$value['id'].'"><span>'. $off .'</span></label>';
