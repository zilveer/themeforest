...
<div id="pagebuilder" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel"> 
            <li><a href="#my-pagebuilder"><?php esc_html_e("Page Builder",'iamd_text_domain');?></a></li>
        </ul>
        ...
        <div id="my-pagebuilder" class="tab-content">
            ...
            <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php esc_html_e('Page Builder','iamd_text_domain');?></h3>
                </div>
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
						 ...
						 ?>
                         <h6><?php esc_html_e('Keep page builder active in above selected post types','iamd_text_domain'); ?></h6>
                ...
                <?php } else { ?>
                	...
                	<div class="bpanel-box">
                    	 <div class="bpanel-option-set">
                            <p class="note"><?php esc_html_e('Please activate "DesignThemes Core Features Plugin" to get the Page Builder options.','iamd_text_domain');?></p>
                        </div>
                    </div>
