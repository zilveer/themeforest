...
;(function ($, window) {
    ...
    var defaults = {
        ...
        videoId: '0_jNjpVxUt0', // toy robot in space is a good default, no?
        mute: true,
        repeat: true,
        width: $(window).width(),
        wrapperZIndex: 0,
    ...
    var tubular = function(node, options) { // should be called on the wrapper div
        var options = $.extend({}, defaults, options),
            $body = $('.videoBackground') // cache body node
        ...
        $('.videoBackground').on('click','.' + options.playButtonClass, function(e) { // play button
            e.preventDefault();
            player.playVideo();
