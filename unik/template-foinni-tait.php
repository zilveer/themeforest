...
<?php 
	...
	wp_enqueue_style('foinni-tait-style',get_template_directory_uri().'/foinni.css');
	wp_enqueue_script('foinni-tait-script',get_template_directory_uri().'/foinni.js');
?>
