...
class EdgeIconsIonIcons implements iIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = EDGE_ROOT . "/css/ion-icons/css/ionicons.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="edgt_icon_ion_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
