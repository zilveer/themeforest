...
if ( !function_exists( 'morning_records_template_single_standard_theme_setup' ) ) {
	add_action( 'morning_records_action_before_init_theme', 'morning_records_template_single_standard_theme_setup', 1 );
	function morning_records_template_single_standard_theme_setup() {
		morning_records_add_template(array(
			'layout' => 'single-standard',
			'mode'   => 'single',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single standard', 'morning-records'),
...
// Template output
if ( !function_exists( 'morning_records_template_single_standard_output' ) ) {
	function morning_records_template_single_standard_output($post_options, $post_data) {
		...
		if (!$post_data['post_protected'] && morning_records_get_custom_option('show_post_info')=='yes') {
			$post_options['info_parts'] = array('snippets'=>false, 'terms' => false, 'different_comments'=>true);
