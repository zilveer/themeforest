...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
		['1/4','element1-4',1/4,['Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog','Stunning-Text','Title','Feature-Service-1','Feature-Service-2']],
		['1/3','element1-3',1/3,['Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog','Stunning-Text','Title','Feature-Service-1','Feature-Service-2']],
		['1/2','element1-2',1/2,['Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog','Stunning-Text','Title','Feature-Service-1','Feature-Service-2']],
		['2/3','element2-3',2/3,['Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog','Stunning-Text','Title','Feature-Service-1','Feature-Service-2']],
		['3/4','element3-4',3/4,['Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog','Stunning-Text','Title','Feature-Service-1','Feature-Service-2']],
		['1/1','element1-1',1  ,['Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item','Blog','Stunning-Text','Title','Feature-Service-1','Feature-Service-2','Contact-Form']]
	];
