...
defined( 'VP_DIR' ) or define( 'VP_DIR', untrailingslashit( crazyblog_ROOT . 'core/duffers_panel/panel' ) );
...
$dirname = str_replace( '\\', '/', crazyblog_ROOT . 'core/duffers_panel/panel' );
$dirname = preg_replace( '|/+|', '/', $dirname );
$vp_url = trailingslashit( crazyblog_URI ) . 'core/duffers_panel/' . VP_DIR_NAME;
