...
<div class="meta-option">
	...
	<div class="meta-description">
		<h4 class="heading"><?php _e('Show Row Top widgets ?', 'flatastic'); ?></h4>
		<span><?php _e('Select yes if you want to show the top row of widgets', 'flatastic'); ?></span>
	...
	<div class="meta-controls">
		...
		<div class="meta-button-set">
			...
			<div class="meta-radio-button">
				...
				<label for="footer_row_top_show_yes"><?php _e('Show', 'flatastic') ?></label>
			</div>
			...
			<div class="meta-radio-button">
				...
				<label for="footer_row_top_show_no"><?php _e('Hide', 'flatastic') ?></label>
			</div>
...
<div class="meta-option footer_row_top_show" <?php if ($footer_row_top_show == 'no'): ?>style="display: none;"<?php endif; ?>>
	...
	<div class="meta-description">
		<h4 class="heading"><?php _e('Footer Row Top Widget', 'flatastic'); ?></h4>
		<span><?php _e('Here you can select how your footer row top widgets will be displayed.', 'flatastic'); ?></span>
	</div><!--/ .meta-description-->
		...
		<div class="meta-set">
			...
			<?php if (is_array($footer_row_top_widgets_array)): ?>
				...
				<div class="meta-list-set">
					...
					<span><?php _e('Columns', 'flatastic') ?>:</span>
...
<div class="meta-option">
	...
	<div class="meta-description">
		<h4 class="heading"><?php _e('Show Row Bottom widgets ?', 'flatastic'); ?></h4>
		<span><?php _e('Select yes if you want to show the bottom row of widgets', 'flatastic'); ?></span>
	</div><!--/ .meta-description-->
	...
	<div class="meta-controls">
		...
		<div class="meta-button-set">
			...
			<div class="meta-radio-button">
				...
				<label for="footer_row_bottom_show_yes"><?php _e('Show', 'flatastic') ?></label>
			</div>
			...
			<div class="meta-radio-button">
				...
				<label for="footer_row_bottom_show_no"><?php _e('Hide', 'flatastic') ?></label>
			</div>
...
<div class="meta-option footer_row_bottom_show" <?php if ($footer_row_bottom_show == 'no'): ?>style="display: none;"<?php endif; ?>>
	...
	<div class="meta-description">
		<h4 class="heading"><?php _e('Footer Row Bottom Widget', 'flatastic'); ?></h4>
		<span><?php _e('Here you can select how your footer row bottom widgets will be displayed.', 'flatastic'); ?></span>
	</div><!--/ .meta-description-->
