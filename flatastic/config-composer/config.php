...
//			'vc_media_grid', 'vc_masonry_media_grid', 'vc_masonry_grid', 'vc_basic_grid',
		...
		public function add_shortcode_params() {
			...
			WpbakeryShortcodeParams::addField('get_terms', array(&$this, 'param_woocommerce_term_categories'), $this->assetUrl('js/js_shortcode_products_cat.js'));
		}
