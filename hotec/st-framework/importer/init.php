...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_option_name       = ''; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		...
		public function set_demo_menus(){
            ...
            $main_menu   = get_term_by('name', 'Nav', 'nav_menu');
...
add_action('radium_import_end','st_import_set_home_page');