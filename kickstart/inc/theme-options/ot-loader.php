    ...
    private function constants() {
      ...
      if ( false == OT_THEME_MODE && false == OT_CHILD_THEME_MODE ) {
        ...
        if ( true == OT_CHILD_THEME_MODE ) {
			define( 'OT_DIR', get_stylesheet_directory() . '/inc/theme-options/');
			define( 'OT_URL', get_stylesheet_directory_uri() . '/inc/theme-options/');
		} else {
			define( 'OT_DIR', get_template_directory() . '/inc/theme-options/');
			define( 'OT_URL', get_template_directory_uri() . '/inc/theme-options/');
        }
      }
