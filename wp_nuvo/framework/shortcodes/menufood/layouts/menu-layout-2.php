...
<article id="post-<?php the_ID(); ?>" class="<?php echo $col; ?> cs-menuFood cs-menuFood-images layout1 post">
    <div class="cs-menuFood-main" style="height: <?php echo $height_image; ?>px">
        <div class="cs-menuFood-body">
            ...
            <?php endif; ?>
            <div class="menu-content" style="padding-left: <?php echo $width_image; ?>px">
                <div class="padding">
