<?php
namespace QodeStartit\Modules\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . qode_startit_get_class_attribute($elements_holder_class) . ' ' . qode_startit_get_inline_attr($elements_holder_style, 'style'). '>';
