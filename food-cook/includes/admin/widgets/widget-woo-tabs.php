...
class Woo_Widget_WooTabs extends WP_Widget {
    ...
    function Woo_Widget_WooTabs() {
        ...
        /* Create the widget. */
         WP_Widget::__construct('woo_tabs', __('Dahz - Tabs', 'woothemes'), $widget_ops, $control_ops);
    }
...
// End Constructor
    ...
    function widget($args, $instance) {
        ...
        if ($thumb_size == '' AND $thumb_size != 0)
            $thumb_size = 45;
        ...
        if ($days == '')
            $days = '';
        $pop = '';
        if (array_key_exists('pop', $instance))
            $pop = $instance['pop'];
        $latest = '';
        if (array_key_exists('latest', $instance))
            $latest = $instance['latest'];
        $comments = '';
        if (array_key_exists('comments', $instance))
...
if (!function_exists('woo_widget_tabs_popular')) {
    ...
    function woo_widget_tabs_popular($posts = 5, $days = null) {
        global $post;
...
if (!function_exists('woo_widget_tabs_latest')) {
    ...
    function woo_widget_tabs_latest($posts = 5) {
        global $post;
