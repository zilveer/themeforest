...
if( ! class_exists('QodeStartitSidebar') ){
	
	class QodeStartitSidebar{
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','startit');
		...
		function register_custom_sidebars(){
			...
			$args = apply_filters('qode_startit_custom_widget_args', $args);
