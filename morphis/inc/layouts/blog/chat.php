		...
		<div class="three columns alpha clearfix">
			<ul class="entry-meta meta1 clearfix">
				...
				<li><img src="<?php echo get_template_directory_uri() . '/images/icons/glyphish/09-chat-2.png'; ?>" class="post-format-icon" title="<?php _e( 'Chat Post Format', 'morphis' ); ?>"/></li>
				<?php endif; ?>
