...
(function( window, $, undefined ) {
    ...
    $('.faq-filters .minus').on('click', function() {
        var faq_filters_parent = $(this).parent(),
            faq_filters_list = faq_filters_parent.find('ul');

        if( ! faq_filters_list.is(':visible') )
        {
            faq_filters_list.slideDown();
            $(this).addClass('minus').removeClass('plus');
        }
        else
        {
            faq_filters_list.slideUp();
