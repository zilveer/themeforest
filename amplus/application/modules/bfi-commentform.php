...
function bfi_comment_form( $args = array(), $post_id = null ) {
    ...
    $fields =  array(
        'author' => '<p>' . '<label for="author">' . __( 'Name', BFI_I18NDOMAIN) . '</label> ' . ( $req ? '<span class="required">*</span>' : '' ) .
        ...
        <?php if ( comments_open() ) : ?>
            ...
            <div id="respond">
                <?php if ( get_option( 'comment_registration' ) && !is_user_logged_in() ) : ?>
                    <h4 class='reply-title'><?php comment_form_title( $args['title_reply'], $args['title_reply_to'] ); ?></h4>
                ...
                <?php else : ?>
                    <form action="<?php echo site_url( '/wp-comments-post.php' ); ?>" method="post" id="<?php echo esc_attr( $args['id_form'] ); ?>">
                        ...
                        <?php if ( !is_user_logged_in() ) { ?>
                            ...
                            <?php echo do_shortcode("[infobox type='error' style='display: none' id='errorclone'][/infobox]"); ?>
                            <?php
                        ...
                        <p class="form-submit">
                            <a href='#' class='button' onclick='jQuery("form#<?php echo esc_attr( $args['id_form'] ); ?>").submit(); return false;'><?php echo esc_attr( $args['label_submit'] ); ?></a>
