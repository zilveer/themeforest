...
<table class="checkout_cart">
   ...
   <?php while (wpsc_have_cart_items()) : wpsc_the_cart_item(); ?>
      ...
      <tr class="product_row product_row_<?php echo wpsc_the_cart_item_key(); ?> <?php echo $alt_class;?>">
         ...
         <td class="firstcol col1 wpsc_product_image wpsc_product_image_<?php echo wpsc_the_cart_item_key(); ?>">
         ...
         <td class="col2 wpsc_product_name wpsc_product_name_<?php echo wpsc_the_cart_item_key(); ?>">
            <a href="<?php echo wpsc_cart_item_url();?>"><?php echo wpsc_cart_item_name(); ?></a>
         </td>

         <td class="col3 wpsc_product_quantity wpsc_product_quantity_<?php echo wpsc_the_cart_item_key(); ?>"><form action="<?php echo get_option('shopping_cart_url'); ?>" method="post" class="adjustform qty"><input type="text" class="text" name="quantity" size="2" value="<?php echo wpsc_cart_item_quantity(); ?>" /><input type="hidden" name="key" value="<?php echo wpsc_the_cart_item_key(); ?>" /><input type="hidden" name="wpsc_update_quantity" value="true" /><input type="submit" value="<?php _e('Update', 'wpsc'); ?>" name="submit" /><div class="clear"></div></form></td>
         
            <td><?php echo wpsc_cart_single_item_price(); ?></td>
         <td class="col4 wpsc_product_price wpsc_product_price_<?php echo wpsc_the_cart_item_key(); ?>"><span class="pricedisplay"><?php echo wpsc_cart_item_price(); ?></span></td>

         <td class="col5 wpsc_product_remove wpsc_product_remove_<?php echo wpsc_the_cart_item_key(); ?>">
   ...
   <table  class='wpsc_checkout_table table-4 table-4-first'>

   <tr class='total_price'>

      <td class='wpsc_totals' width="750px" style="text-align: right">
      <?php _e('Total Price', 'wpsc'); ?>:
      </td>
      <td class='wpsc_totals' width="118px" style="text-align: right">
        ...
        <?php if(wpsc_checkout_form_is_header() == true){
            ...
            ?>
               <tr class='wpsc_hidden'>
                  <td width="130px" class='<?php echo wpsc_checkout_form_element_id(); ?>'><label for='<?php echo wpsc_checkout_form_element_id(); ?>'><?php echo wpsc_checkout_form_name();?></label></td>
                  <td>
            ...
            <?php
               ...
               "<div class='wpsc_email_address'>
                  <p class='" . wpsc_checkout_form_element_id() . "'><label class='wpsc_email_address' for='" . wpsc_checkout_form_element_id() . "'>" . __('Enter your email address', 'wpsc') . "</label>
			...
			<tr>
               <td width="130px" class='<?php echo wpsc_checkout_form_element_id(); ?>'><label for='<?php echo wpsc_checkout_form_element_id(); ?>'><?php echo wpsc_checkout_form_name();?></label>
               </td>
               <td>
                  <?php echo wpsc_checkout_form_field();?>
                   <?php if(wpsc_the_checkout_item_error() != ''): ?>
