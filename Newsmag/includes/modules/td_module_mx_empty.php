...
class td_module_mx_empty extends td_module {
    ...
    function render($order_no, $post_number) {
        ob_start();
        ?>

        <div class="<?php echo $this->get_module_classes(array("td-big-grid-post-$order_no", "td-post-number-$post_number", "td-big-grid-post", "td-module-empty")); ?>"></div>
