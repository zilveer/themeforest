...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Theme Options', 'ss_framework'), __('Theme Options', 'ss_framework'), 'edit_theme_options', 'ss-theme-options','optionsframework_page');
...
function optionsframework_load_scripts($hook) {
	...
	if ( 'appearance_page_ss-theme-options' != $hook )
        return;
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Clear', 'ss_framework' ),
			'defaultString' => __( 'Default', 'ss_framework' ),
			'pick' => __( 'Select Color', 'ss_framework' )
		);
...
function optionsframework_page() {
    ...
    <div id="optionsframework" class="postbox">
			...
			<?php optionsframework_fields(); /* Settings */ ?>
				...
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'ss_framework' ); ?>" />
	            		<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'ss_framework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'ss_framework' ) ); ?>' );" />
	            		<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'ss_framework' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options', 'ss_framework' ),
			'href' => admin_url( 'themes.php?page=ss-theme-options' )
		));
}
