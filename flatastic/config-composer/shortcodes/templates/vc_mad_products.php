...
class WPBakeryShortCode_VC_mad_products extends WPBakeryShortCode {
	...
	protected function sort_links($products, $params) {
		...
		<ul class="product-filter">
			...
			<li class="active animate-left-to-right"><button data-filter="*" value="All"><?php echo _e('All', 'flatastic') ?></button></li>
			...
			<?php if ($params['random'] == "yes"): ?>
				<li class="animate-left-to-right"><button data-filter="random"><?php echo _e('Random', 'flatastic'); ?></button></li>
			<?php endif; ?>

			<?php if ($params['sale'] == "yes"): ?>
				<li class="animate-left-to-right"><button data-filter="sale"><?php echo _e('Sale', 'flatastic'); ?></button></li>
			<?php endif; ?>
	...
	protected function html() {
		...
		$type = $tag_title = $layout = $columns = $shop_columns = $attr = $css_animation = '';
			...
			<?php if (!woocommerce_product_subcategories(array('before' => '<ul class="products">', 'after' => '</ul>' ))) : ?>
				<div class="woocommerce-error">
					<div class="messagebox_text">
						<p><?php _e( 'No products found which match your selection.', 'flatastic' ) ?></p>
					</div><!--/ .messagebox_text-->
