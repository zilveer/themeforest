...
?>
	...
	<section class="columns portfolio masonry m4">

		<?php
			$ppp = get_theme_mod('projects_per_page_masonry') ? get_theme_mod('projects_per_page_masonry') : 10;
			...
			if($projects_query->have_posts()) while($projects_query->have_posts()) {
				...
				?><article class="brick <?php echo $category_classes; ?>">
					<?php 
					...
					<?php endif; ?>
					<div class="img"><?php the_post_thumbnail('thumbnail-masonry'); ?>
						<div>
							<ul>
								<?php 
					...
					<p class="descr"><?php echo multipurpose_custom_excerpt(20, $post); ?></p>
				</article><?php
			}
		?>
	</section>
<?php  wp_reset_query(); ?>
	<div class='wp-pagenavi'>
		...
		echo paginate_links(array(
			...
			'prev_text' => __('Previous page', 'multipurpose'),
			'next_text' => __('Next page', 'multipurpose'),
		));
		?> 
	</div>
<?php get_footer(); ?>