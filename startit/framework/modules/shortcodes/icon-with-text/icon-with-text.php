<?php
namespace QodeStartit\Modules\Shortcodes\IconWithText;

use QodeStartit\Modules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package QodeStartit\Modules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
    ...
    public function render($atts, $content = null) {
        ...
        return qode_startit_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', $params['icon_position'], $params);
    }
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.qode_startit_filter_px($params['text_left_padding']).'px';
        }

        if($params['icon_position'] == 'right' && !empty($params['text_right_padding'])) {
            $styles[] = 'padding-right: '.qode_startit_filter_px($params['text_right_padding']).'px';
        }
