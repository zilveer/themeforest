<?php
add_action( 'tgmpa_register', 'qode_register_required_plugins' );
/**
...
function qode_register_required_plugins() {
...
add_action('layerslider_ready', 'qode_layerslider_overrides');
function qode_layerslider_overrides() {
