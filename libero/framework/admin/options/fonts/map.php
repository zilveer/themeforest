...
if ( ! function_exists('libero_mikado_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function libero_mikado_fonts_options_map() {
		 ...
		 * Headings
		 */
		$panel_headings = libero_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => 'Headings'
		...
		//H1
		$group_heading_h1 = libero_mikado_add_admin_group(array(
		...
		$row_heading_h1_1 = libero_mikado_add_admin_row(array(
		...
		$row_heading_h1_2 = libero_mikado_add_admin_row(array(
		...
		//H2
		$group_heading_h2 = libero_mikado_add_admin_group(array(
		...
		$row_heading_h2_1 = libero_mikado_add_admin_row(array(
		...
		$row_heading_h2_2 = libero_mikado_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = libero_mikado_add_admin_group(array(
		...
		$row_heading_h3_1 = libero_mikado_add_admin_row(array(
		...
		$row_heading_h3_2 = libero_mikado_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = libero_mikado_add_admin_group(array(
		...
		$row_heading_h4_1 = libero_mikado_add_admin_row(array(
		...
		$row_heading_h4_2 = libero_mikado_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = libero_mikado_add_admin_group(array(
		...
		$row_heading_h5_1 = libero_mikado_add_admin_row(array(
		...
		$row_heading_h5_2 = libero_mikado_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = libero_mikado_add_admin_group(array(
		...
		$row_heading_h6_1 = libero_mikado_add_admin_row(array(
		...
		$row_heading_h6_2 = libero_mikado_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = libero_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
				'title' => 'Text'
		...
		$group_text = libero_mikado_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> 'Paragraph',
		...
		$row_text_1 = libero_mikado_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$row_text_2 = libero_mikado_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_link = libero_mikado_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> 'Links',
		...
		$row_link_1 = libero_mikado_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		$row_link_2 = libero_mikado_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		libero_mikado_add_admin_field(array(
			...
			'options'		=> libero_mikado_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	...
	add_action( 'libero_mikado_options_map', 'libero_mikado_fonts_options_map', 2);
