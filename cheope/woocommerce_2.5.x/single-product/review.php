		...
		<div class="comment-text">
			...
			<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) : ?>
                ...
                <div itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf(__( 'Rated %d out of 5', 'yit' ), $rating) ?>">
                    <span style="width:<?php echo ( $rating / 5 ) * 100; ?>%"><strong itemprop="ratingValue"><?php echo $rating; ?></strong> <?php _e( 'out of 5', 'yit' ); ?></span>
                </div>
			...
			<?php else : ?>
				...
				<p class="meta">
                    ...
                    ?>&ndash;
                    <time itemprop="datePublished" time datetime="<?php echo get_comment_date('c'); ?>" content="<?php echo get_comment_date('Y-m-d'); ?>">
