<?php class WebnusAdvertisementWidget extends WP_Widget{
	...
	public function form($instance){
		...
		<p><label for="<?php echo $this->get_field_id('link') ?>">Ad link URL:</label><input type="text" class="widefat" id="<?php echo $this->get_field_id('link') ?>" name="<?php echo $this->get_field_name('link') ?>" value="<?php if( isset($link) )  echo esc_attr($link); ?>" /></p>
		...
		<p><label for="<?php echo $this->get_field_id('html_content') ?>"><small>Leave blank image url if you want to use html content.</small><br />Html content:</label><textarea class="widefat" id="<?php echo $this->get_field_id('html_content') ?>" name="<?php echo $this->get_field_name('html_content') ?>"><?php if( isset($html_content) )  echo esc_attr($html_content); ?></textarea></p>
		<?php 
	}
