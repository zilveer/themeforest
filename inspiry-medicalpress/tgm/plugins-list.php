...
if ( ! function_exists ( 'medical_theme_register_required_plugins' ) ) {
    function medical_theme_register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                'name' => __( 'Redux Framework', 'framework' ),
                'slug' => 'redux-framework',
                'required' => true,
            ),
            /* Meta box plugin is required for meta boxes */
            array(
                'name' => __( 'Meta Box', 'framework' ),
                'slug' => 'meta-box',
                'required' => true,
            ),
            /* Display Tweets plugin is recommended for twitter tweets */
            /*array(
                'name' => 'Display Tweets',
                'slug' => 'display-tweets-php',
                'required' => false,
            ),*/
            /* WP Email Capture plugin is recommended for email subscriptions */
            /*array(
                'name' => 'WP Email Capture',
                'slug' => 'wp-email-capture',
                'required' => false,
            )*/
        );
