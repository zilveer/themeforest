<?php
/*
Template Name: Blog - Type 3
*/
	get_header();
?>
	<?php $blogs = blog_require();?>
    <?php $pagination = get_option('dt_BlogPaginationType3'); ?>    
	...
	<?php foreach ( $blogs as $blog) :?> 
		<?php if ( is_page($blog->PAGE)): ?>
        	<?php $blog_ids = $blog->CATEGORIES; ?> 
                ...
                ?>
                	<article id="post-<?php the_ID(); ?>" <?php post_class('post post-type-3 clearfix'); ?>>
						<?php if ( has_post_thumbnail() ): ?>
                            ...
                            <a class="post-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
                            	<span></span>
                                <img src="<?php resizeimage($thumbnail_src,180,180,$dt_PostImageCrop); ?>" alt="<?php the_title(); ?>" />
                            </a>
                        <?php endif; ?>                      
                    	<div class="post-content clearfix">
                            ...
                            <h3><a href="<?php the_permalink(); ?>" title="<?php dt_Permalink.the_title_attribute( 'echo=0' ); ?>" rel="bookmark"><?php the_title(); ?></a></h3>                        
                            <?php the_content(''); ?>
