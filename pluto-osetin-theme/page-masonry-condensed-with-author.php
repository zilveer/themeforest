<?php
/*
* Template Name: Masonry Condensed with Avatar
*/
get_header(); ?>
<div class="main-content-w">
  ...
  <div class="main-content-i">
    ...
    <div class="content side-padded-content">
      ...
      <div id="primary-content" class="index-isotope v3 isotope-with-author" data-layout-mode="<?php echo (os_get_use_fixed_height_index_posts() == true) ? 'fitRows' : 'masonry'; ?>">
        <?php
      ...
      <?php if(os_get_next_posts_link($osetin_query)): ?>
        <div class="isotope-next-params" data-params="<?php echo os_get_next_posts_link($osetin_query); ?>" data-layout-type="v3" data-template-type="page-masonry-condensed-with-author"></div>
