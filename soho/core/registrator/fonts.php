...
#get new font list https://www.googleapis.com/webfonts/v1/webfonts?key=* #api key
        ...
        array (
            ...
            365 =>
                array (
                    ...
                    'files' =>
                        array (
                            700 => 'http://themes.googleusercontent.com/static/fonts/fit/v3/WrHDBL1RupWGo2UcdgxB3Q.ttf',
                            'regular' => 'http://themes.googleusercontent.com/static/fonts/fit/v3/Fg1dO8tWVb-MlyqhsbXEkg.ttf',
                            'italic' => 'http://themes.googleusercontent.com/static/fonts/fit/v3/HzyjFB-oR5usrc7Lxz9g8w.ttf',
                            '700italic' => 'http://themes.googleusercontent.com/static/fonts/fit/v3/Gzf5NT09Y6xskdQRj2kz1qCWcynf_cDxXwCLxiixG1c.ttf',
                        ),
                ),
            366 =>
                array (
...
function get_fonts_array()
{
    ...
    return $gt3_fonts['items'];

}


function get_fonts_array_only_key_name()
{

    global $gt3_fonts;

    if (is_array($gt3_fonts['items'])) {
        foreach ($gt3_fonts['items'] as $key => $font) {
...
function get_theme_fonts()
{
    ...
    $list_of_fonts = get_fonts_array_only_key_name();
    $allFonts = array();

    if (in_array(gt3_get_theme_option("main_font"), $list_of_fonts)) {
        $allFonts[] = gt3_get_theme_option("main_font") . gt3_get_theme_option("google_font_parameters_main_font");
    }

    if (in_array(gt3_get_theme_option("text_headers_font"), $list_of_fonts)) {
        $allFonts[] = gt3_get_theme_option("text_headers_font") . gt3_get_theme_option("google_font_parameters_headers_font");
    }

    if (in_array(gt3_get_theme_option("main_menu_font"), $list_of_fonts)) {
        $allFonts[] = gt3_get_theme_option("main_menu_font") . gt3_get_theme_option("google_font_parameters_menu_font");
    }

    $allFontsInline = implode("|", $allFonts);
    wp_enqueue_style("AllFonts", "$protocol://fonts.googleapis.com/css?family=" . $allFontsInline);
