...
?>
<div id="cs_carousel_post<?php echo esc_attr($date); ?>" class="cs-carousel-post cs-carousel-style-1 <?php echo esc_attr($cl_show).' '.esc_attr($el_class); ?> <?php echo $same_height?'sameheight':'';?>">
    <div class="cs-header">
                        ...
                        <article id="post-<?php echo the_ID() ?>" <?php  post_class(); ?>>
                            <div class="cs-carousel-container">
                                <div class="cs-carousel-header">
                                    <div class="cs-carousel-post-date">
                                        <span class="cs-day"><?php echo the_time('d'); ?></span>
                                        <span class="cs-month"><?php echo the_time('M'); ?></span>
                                    </div>
                                    <?php
