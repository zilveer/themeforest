...
(function() {
    ...
    function button_form()
    {
        ...
        form.find('#button-form-submit').click(function() {
            ...
            var shortcode = '[button url="' + button_form_url + '" target="' + button_form_target + '" color="' + button_form_color + '" size="' + button_form_size + '" border="' + button_form_border + '" icon="' + button_form_icon + '" btn_content="' + button_form_text + '"]';
            // inserts the shortcode into the active editor

            if (tinyMCE.activeEditor.selection.getContent() != '') {
                tinyMCE.activeEditor.selection.setContent('[button url="' + button_form_url + '" target="' + button_form_target + '" color="' + button_form_color + '" size="' + button_form_size + '" border="' + button_form_border + '" icon="' + button_form_icon +  '" btn_content="' + button_form_text + '"]');
            } else
                tinyMCE.activeEditor.execCommand('mceInsertContent', 0, shortcode);
