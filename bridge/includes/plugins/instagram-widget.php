...
add_action( 'tgmpa_register', 'my_theme_register_instagram_widget' );
/**
 ...
 */
if (!function_exists('my_theme_register_instagram_widget')) {
	function my_theme_register_instagram_widget() {
		...
		$plugins = array(
			...
			array(
				'name'     				=> 'Qode Instagram Widget', // The plugin name
				'slug'     				=> 'qode-instagram-widget', // The plugin slug (typically the folder name)
				'source'   				=> get_template_directory() . '/plugins/qode-instagram-widget.zip', // The plugin source
