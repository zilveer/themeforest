...
* @return null
*/
if ( bp_is_active( 'xprofile' ) && !function_exists('woffice_social_fields') ){
...
function woffice_member_social_extend(){
	...
	if ( bp_is_active( 'xprofile' ) ){
		...
		if (!empty($woffice_facebook)||!empty($woffice_twitter)||!empty($woffice_linkedin)||!empty($woffice_slack)||!empty($woffice_google)||!empty($woffice_github)||!empty($woffice_instagram)){
			...
			do_action('woffice_before_member_icons');
			...
			do_action('woffice_after_member_icons');
			echo '</div>';
		}
	}
                            ...
                            if (!empty($field_value)) {
	                            ...
	                            elseif ( $containe_url ) {
                                    if(strpos($field_value, 'href') !== false) {
                                        ...
                                        $link_value = (string)$link_content['href'];
                                    }
                                    if(!empty($link_value)){
