	  ...
	  for (var i in icons) {
		  $list.append('<li data-icon="'+icons[i]+'"><a href="#" title="'+icons[i]+'"><span class="'+options[0]+' '+options[1]+'-'+icons[i]+'"></span></a></li>');
				...
				$('a', $list).click(function(e) {
					...
					$('.mtheme-save-button').removeClass('disabled');
		...
		function createPopup($button) {
			...
			$control.html('<p>Select Font: <select><option value="fa">Font Awesome</option><option value="dashicons">Dashicons</option><option value="genericon">Genericons</option></select></p>'+
