		...
		<div class="container">
			<div class="row">
                <div id="bannertext" class="centered fade-down section-heading">
                    ...
                    <a class="btn btn-primary btn-outlined pull-left" id="prevslide" href="#"><i class="fa fa-angle-left"></i></a>
                    <a class="btn btn-primary btn-outlined pull-right" id="nextslide" href="#"><i class="fa fa-angle-right"></i></a>
                </div>
			</div><!-- row -->
		</div><!-- /container -->
	</div><!-- /headerwrap -->
