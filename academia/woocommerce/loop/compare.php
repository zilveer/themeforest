...
<?php if (in_array('yith-woocommerce-compare/init.php', apply_filters('active_plugins', get_option('active_plugins')))): ?>
	<a data-toggle="tooltip" data-placement="top" title="<?php esc_html_e('Compare', 'g5plus-academia'); ?>" href="<?php the_permalink(); ?>?action=yith-woocompare-add-product&amp;id=<?php the_ID(); ?>"
