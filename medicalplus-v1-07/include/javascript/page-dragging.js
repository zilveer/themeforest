...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
		['1/4','element1-4',1/4,['Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Title','Column-Service','Price-Item']],
		['1/3','element1-3',1/3,['Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Title','Column-Service','Price-Item']],
		['1/2','element1-2',1/2,['Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Title','Column-Service','Price-Item']],
		['2/3','element2-3',2/3,['Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Title','Column-Service','Price-Item']],
		['3/4','element3-4',3/4,['Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Title','Column-Service','Price-Item']],
		['1/1','element1-1',1  ,['Media','Column','Gallery','Content','Personnal','Page','Portfolio','Testimonial','Post-Slider','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Title','Column-Service','Price-Item','Blog','Stunning-Text','Contact-Form']]
	];
	...
	// Personnel item type
	jQuery('select#page-option-item-personnal-item-type').change(function(){
		if(jQuery(this).val()=='Carousel Personnel'){
			jQuery(this).parents('.meta-body').siblings('.page-option-item-personnal-item-size-wrapper').slideUp();
		}else{
			jQuery(this).parents('.meta-body').siblings('.page-option-item-personnal-item-size-wrapper').slideDown();
		}	
	});	
	jQuery('select#page-option-item-personnal-item-type').each(function(){
		if(jQuery(this).val()=='Carousel Personnel'){
			jQuery(this).parents('.meta-body').siblings('.page-option-item-personnal-item-size-wrapper').css('display','none');
		}else{
			jQuery(this).parents('.meta-body').siblings('.page-option-item-personnal-item-size-wrapper').css('display','block');
		}	
	});	
	
	// Media item type
	jQuery('select#page-option-item-media-type').change(function(){
		if(jQuery(this).val()=='Video'){
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-image-wrapper').slideUp();
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-video-wrapper').slideDown();
		}else{
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-image-wrapper').slideDown();
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-video-wrapper').slideUp();
		}	
	});	
	jQuery('select#page-option-item-media-type').each(function(){
		if(jQuery(this).val()=='Video'){
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-image-wrapper').css('display','none');
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-video-wrapper').css('display','block');
		}else{
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-image-wrapper').css('display','block');
			jQuery(this).parents('.meta-body').siblings('.page-option-item-media-video-wrapper').css('display','none');
		}	
	});	
