...
/**
 * The ToolbarKallyas class hosts the buttons for styling a text selection.
 *
 * @uses WidgetDropdown
 ...
 * @uses WidgetArrowBox
 *
 * @class ToolbarKallyas
 */
var ToolbarKallyas = React.createClass({
	...
	render: function() {
		...
		if (currentSelection) {
			...
			var cssClasses = 'ae-toolbar-ktoolbar ' + arrowBoxClasses;
...
AlloyEditor.Toolbars[ToolbarKallyas.key] = AlloyEditor.ToolbarKallyas = ToolbarKallyas;
