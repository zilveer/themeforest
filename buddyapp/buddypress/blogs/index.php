...
<div id="buddypress">
	...
	<form action="" method="post" id="blogs-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" role="navigation">
			<ul>
				<li class="selected" id="blogs-all"><a href="<?php bp_root_domain(); ?>/<?php bp_blogs_root_slug(); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'All Sites %s', 'buddypress' ), bp_get_total_blog_count() )); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_total_blog_count_for_user( bp_loggedin_user_id() ) ) : ?>

					<li id="blogs-personal"><a href="<?php echo bp_loggedin_user_domain() . bp_get_blogs_slug(); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'My Sites %s', 'buddypress' ), bp_get_total_blog_count_for_user( bp_loggedin_user_id() ) )); ?></a></li>
