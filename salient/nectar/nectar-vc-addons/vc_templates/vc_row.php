   ...
   extract(shortcode_atts(array(
	...
	if ( 'yes' === $disable_element ) {
		...
		if ( vc_is_page_editable() ) {
			$disable_class = 'vc_hidden-lg vc_hidden-xs vc_hidden-sm vc_hidden-md ';
		} 
	}
	...
	//row bg 
	echo '<div class="row-bg-wrap"> <div class="row-bg '.$using_image_class . ' ' . $using_bg_color_class . ' '. $disable_ken_burns_class . ' '. $etxra_class.'" '.$parallax_speed.' style="'.$bg_props.'" data-color_overlay="'.$color_overlay.'" data-color_overlay_2="'.$color_overlay_2.'" data-gradient_direction="'.$gradient_direction.'" data-overlay_strength="'.$overlay_strength.'" data-enable_gradient="'.$enable_gradient.'"></div> </div>';
