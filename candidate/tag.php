...
<section id="content">	
			...
			<section class="section page-heading ">
				<h1 class="entry-title" ><?php single_tag_title("Tags: &quot;"); echo '&quot;  '; ?></h1>
						...
						<div class="post-content">
							...
							<div class="post-side-meta">
								...
								<div class="post-comments">
									<a href="<?php echo esc_url(get_permalink()).'#comments';?>"><i class="icons icon-chat-empty"></i> <?php echo $num_comments; ?></a>
								</div>
