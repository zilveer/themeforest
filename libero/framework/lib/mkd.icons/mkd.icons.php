...
/*
  Class: LiberoIconCollections
  A class that initializes Mkd Icon Collections
 */
...
class LiberoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new LiberoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new LiberoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new LiberoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new LiberoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new LiberoSimpleLineIcons('Simple Line Icons', 'simple_line_icons'));
        $this->addIconCollection('dripicons', new LiberoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iLiberoIconCollection $collection) {
...
$libero_mikado_IconCollections = LiberoIconCollections::get_instance();