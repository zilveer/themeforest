...
<a class="nav-tab <?php echo esc_attr($tabconfig); ?>" href="themes.php?page=customsidebars"><?php _e('Custom Sidebars','custom-sidebars'); ?></a>
<a class="nav-tab <?php echo esc_attr($tabdefaults); ?>" href="themes.php?page=customsidebars&p=defaults"><?php _e('Default Sidebars','custom-sidebars'); ?></a>
