...
jQuery(window).resize(function(){
    jQuery(".es-carousel").width(jQuery(window).width());
});



	jQuery(".es-carousel-container").each(function(){
		var max_height = 0;
		jQuery(this).find('.es-carousel-container').each(function(){
			if( max_width < jQuery(this).width()){
				max_width = jQuery(this).width();
			}
		});
		jQuery(this).find('.es-carousel-container').height(max_height);
