...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
    	...
    	<?php if ( $redux_demo['archive_post_style'] == 'masonry' ){
    		...
    		include( get_template_directory() . '/archive-masonry.php');
						...
						<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
								...
								<?php if (has_post_thumbnail()): ?>
									<div class="nicdark_featured_image nicdark_relative">
										<a style="left:0;" href="<?php esc_url(the_permalink()); ?>" class="nicdark_btn nicdark_bg_<?php echo esc_attr($redux_demo['metabox_posts_color']); ?> white medium nicdark_absolute_left"><?php the_time('j') ?><br><small><?php the_time('M') ?></small></a>
