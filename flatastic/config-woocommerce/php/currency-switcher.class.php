	...
	class MAD_WC_CURRENCY_SWITCHER extends MAD_WOOCOMMERCE_CONFIG {
		...
		function __construct() {
			...
			$this->settings = array(
				...
				array( 'name' => __( 'Open Exchange Rate API', 'flatastic' ), 'type' => 'title', 'desc' => '', 'id' => 'product_enquiry' ),
				array(
					'name' => __('App Key', 'flatastic'),
					'desc' 		=> sprintf( __('(optional) If you have an <a href="%s">Open Exchange Rate API app ID</a>, enter it here.', 'flatastic'), 'https://openexchangerates.org/signup' ),
		...
		public function enqueue_currency_js() {
			...
			wp_localize_script( MAD_PREFIX . 'woocommerce-mod', 'wc_currency_converter_params', array(
				...
				'i18n_oprice'      => __( 'Original price:', 'flatastic'),
