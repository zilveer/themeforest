...
<?php endif; ?>
       ...
       <?php if( isset($woo_options['woo_facebook_button']) && $woo_options['woo_facebook_button'] == 'true' ) : ?>
		<h2 class="login-facebook"><span><?php _e('or', 'woocommerce');?></span></h2>

		<?php echo do_shortcode( '[facebook_login_button]' ); ?>
