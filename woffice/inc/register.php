...
function registerRedirect(){
    ...
    if (isset($_POST['user_id']) && $_POST['user_id'] > 0) {
        ...
        if( $user ) {
            ...
            // Ajax content :
            echo '<div class="woffice-ajax-main"><i class="fa fa-check-circle-o"></i> Redirecting...</div>';
        }
    }
    wp_die();
}
add_action('wp_ajax_nopriv_WofficeRegisterRedirect', 'registerRedirect');
add_action('wp_ajax_WofficeRegisterRedirect', 'registerRedirect');
