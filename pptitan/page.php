...
$page_body_class = get_body_class();
$is_woocommerce_page = in_array('woocommerce-page', $page_body_class);
...
if(is_bool($bg_style) || empty($bg_style) || $bg_style == 'Static Image')
{
