...
class WPBakeryShortCode_VC_Tab extends WPBakeryShortCode {
    public function content( $atts, $content = null ) {
        ...
        $output .= "\n\t\t\t" . '<div id="tab-'.sanitize_title($title).'" class="wpb_tab">';
    ...
    public function contentAdmin($atts, $content) {
        ...
        return '<div id="tab-'. sanitize_title( $title ) .'" class="row-fluid wpb_column_container wpb_sortable_container not-column-inherit">'. do_shortcode($content) . SwiftPageBuilder::getInstance()->getLayout()->getContainerHelper() . '</div>';
    }
}
...
class WPBakeryShortCode_VC_Tabs extends WPBakeryShortCode {
    ...
    public function __construct($settings) {
        ...
        SwiftPageBuilder::getInstance()->addShortCode( array( 'base' => 'vc_tab' ) );
    }
    ...
    public function content($atts, $content =null)
    {
        ...
        $output .= "\n\t".'<div class="'.$element.' '. $type .' wpb_content_element '.$width.$el_class.'" data-interval="'.$interval.'">';
