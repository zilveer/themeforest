...
<?php 
	...
	$cmb_tagline = get_post_meta($post->ID, 'cmb_tagline', true);
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class("clearfix"); ?>>
                            ...
                            <aside class="left-aside left fifth">
                                <ul class="meta">
                               		...
                               		<?php printf('<li><strong>%s</strong></li>', esc_attr(get_the_title())); ?>
                            ...
                            <div class="four-fifths right last">
                                ...
                                <?php 
									...
									if ( has_post_thumbnail(get_the_ID()) && get_post(get_post_thumbnail_id(get_the_ID())) ) { 
		                                ...
		                                printf("<a title='%s' href='%s'><img src='%s' alt='profileimage'></a>", esc_attr($img_post->post_title), esc_url($post_thumbnail_src[0]), esc_url($post_thumbnail_src[0]));
		                            }
