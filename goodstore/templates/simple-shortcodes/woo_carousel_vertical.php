...
$box_style = jaw_template_get_var('box_style', '0');
...
<div id="jaw-carousel-<?php echo $random; ?>" class="carousel vertical slide woocommerce navigation-<?php echo jaw_template_get_var('carousel_style', 'bar'); ?>">
    <!-- Wrapper for slides -->
