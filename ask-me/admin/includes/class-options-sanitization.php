...
add_filter( 'of_sanitize_sliderui', 'of_sanitize_enum', 10, 2);

/* Sections */

add_filter( 'of_sanitize_sections', 'of_sanitize_enum', 10, 2);
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'vbegy' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'vbegy' ),
		'repeat-y'  => __( 'Repeat Vertically', 'vbegy' ),
		'repeat'    => __( 'Repeat All', 'vbegy' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'vbegy' ),
		'top center'    => __( 'Top Center', 'vbegy' ),
		'top right'     => __( 'Top Right', 'vbegy' ),
		'center left'   => __( 'Middle Left', 'vbegy' ),
		'center center' => __( 'Middle Center', 'vbegy' ),
		'center right'  => __( 'Middle Right', 'vbegy' ),
		'bottom left'   => __( 'Bottom Left', 'vbegy' ),
		'bottom center' => __( 'Bottom Center', 'vbegy' ),
		'bottom right'  => __( 'Bottom Right', 'vbegy')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'vbegy' ),
		'fixed'  => __( 'Fixed in Place', 'vbegy')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'vbegy' ),
		'italic'      => __( 'Italic', 'vbegy' ),
		'bold'        => __( 'Bold', 'vbegy' ),
		'bold italic' => __( 'Bold Italic', 'vbegy' )
		);
