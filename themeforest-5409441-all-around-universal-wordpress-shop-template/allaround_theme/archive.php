	...
	<div class="content_wrapper">
		<div class="content<?php echo $class; ?>">
			<?php 
				...
				if ( is_category() ) :
					$header = '<span>' . single_cat_title( '', false ) . '</span>' . ' / ' . $number_of_posts . __( ' posts found', 'allaround' );
				elseif ( is_tag() ) :
					$header = '<span>' . single_tag_title( '', false ) . '</span>' . ' / ' . $number_of_posts . __( ' posts found', 'allaround' );
				elseif ( is_day() ) :
					$header = '<span>' . get_the_date() . '</span>' . ' / ' . $number_of_posts . __( ' posts found', 'allaround' );
				elseif ( is_month() ) :
					$header = '<span>' . get_the_date( 'F Y' ) . '</span>' . ' / ' . $number_of_posts . __( ' posts found', 'allaround' );
				elseif ( is_year() ) :
					$header = '<span>' . get_the_date( 'Y' ) . '</span>' . ' / ' . $number_of_posts . __( ' posts found', 'allaround' );
				else :
					$header = __( 'Archives', 'allaround' ) . ' / ' . $number_of_posts . __( ' post/s found', 'allaround' );
				endif;
			...
			?>
			<?php // if ( $modular_postmeta['share'] ) echo socialShares(); ?>
			<div class="clear"></div>
		</div><!-- content -->
