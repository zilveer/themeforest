<?php
/*
Template Name: Artist Style 2 (3 COLUMNS)
*/
?>
...
while ($wp_query->have_posts()):
    ...
    $cover          = wp_get_attachment_image_src($image_id, 'artist-style2');
    $cover_large    = wp_get_attachment_image_src($image_id, 'photo-large');
    $no_cover       = get_template_directory_uri();
    echo '                                       
         <div class="atpage2-col wz-last">
            <div class="atpage2-cover">
    ...
    echo '
                  <div class="he-view">
                     <div class="bg a0" data-animate="fadeIn">
                        <a href="' . get_permalink() . '" class="atpage2-link a2" data-animate="zoomIn"></a>
                        <a href="' . $cover_large[0] . '" class="atpage2-zoom a2" data-animate="zoomIn" data-rel="prettyPhoto-cover"></a>
					 </div>
				  </div>			
               </div>
            </div><!-- end .atpage2-cover -->
