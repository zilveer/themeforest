...
class Redux_Options_radio_img_bg extends Redux_Options {	
	...
	*/
	function render(){
		...
		echo '<fieldset class="bg-image-tiles">';
			...
			foreach($this->field['options'] as $k => $v){
				...
				echo '<img src="'.$v.'" alt="'.$v.'" onclick="jQuery:redux_radio_img_select(\''.$this->field['id'].'_'.array_search($k,array_keys($this->field['options'])).'\', \''.$this->field['id'].'\');" />';
				echo '</label>';
