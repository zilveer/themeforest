			...
			<?php  if( class_exists('woocommerce') ) : ?>
                ...
                <div class="box-content">
                    ...
                    <div class="column two-third last">
                        ...
                        <p class="note"><?php _e('Number of products to show in catalog / shop page','iamd_text_domain');?></p>
                    </div>
                    ...
                    <div class="bpanel-option-set">
                        ...
                        <?php $posts_layout = array('one-half-column'=>__("Two products per row.",'iamd_text_domain'),'one-third-column' => __("Three products per row.",'iamd_text_domain'),
													'one-fourth-column' => __("Four products per row","iamd_text_domain"));
