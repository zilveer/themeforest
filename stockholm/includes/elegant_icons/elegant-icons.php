...
if (!function_exists('qode_font_elegant_icon_array')){
	/**
	 * Defines array of icons from Font Elegant
	 * @return array array of icons from Font Elegant
	 */
	function qode_font_elegant_icon_array(){
...
if(!function_exists('qode_font_elegant_social_vc')) {
	/**
	 * Returns flipped array of social icons that is used for Visual Composer
	 * @return array flipped array of social icons
	 */
	function qode_font_elegant_social_vc() {
		return array_flip(qode_font_elegant_social());
	}
