...
if($row_type == 'row') {
	...
	if($row_type == "row" && $css_animation != ""){
		$output .= '<div class="'. $clsss_css_animation .'"><div '. qode_get_inline_style($animation_style).' >';
	}
	...
	if($logo_in_content_menu == 'logo_in_content_menu'){
		...
		if(isset($qode_options['content_menu_logo_image']) && $qode_options['content_menu_logo_image'] != ""){
			$logo_image = $qode_options['content_menu_logo_image'];
		}else if(isset($qode_options['logo_image']) && $qode_options['logo_image'] != ""){
			$logo_image = $qode_options['logo_image'];
		}
	...
	if($custom_widget_area !== ''){
		...
		$output .= qode_get_dynamic_sidebar($custom_widget_area);
		$output .= '</div></div></div>';
	}
