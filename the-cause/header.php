...
<div id="contentHolder" class="width100">
    ...
    <div id="main" class="width100">
        ...
        <!-- Content -->
        <div id="content" class="<?php tb_write_bckg('buttons'); ?> <?php tb_write_bckg('buttonsExtra'); ?>  <?php tb_write_bckg('sidebar'); ?> width1000" <?php if (!$mainImageArray['mainImage']) echo ' style="margin-top: 0 !important;"'; ?>>
		<div class="fullWidth">
