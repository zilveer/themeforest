<?php $large_image_url = wp_get_attachment_image_src( get_post_thumbnail_id(), 'wall-portfolio-squrex2'); 
global $oi_options;
?>
<div class="row">
<div class="col-md-6 oi_chess_img_holder <?php if( $wp_query->current_post%2 == 1 ) {echo ' col-md-push-6';} else {echo 'oi_left_side_post';};?>">
...
<?php }else{ ?>
<img class="img-responsive" src="<?php echo get_template_directory_uri().'/framework/images/noimage-s.jpg'?>">
<?php };?>
</div>
<div class="col-md-6 <?php if( $wp_query->current_post%2 == 1 ) echo ' col-md-pull-6';?>">
