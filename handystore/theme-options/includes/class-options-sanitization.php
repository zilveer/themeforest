...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'plumtree' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'plumtree' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'plumtree' ),
		'repeat'    => esc_html__( 'Repeat All', 'plumtree' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'plumtree' ),
		'top center'    => esc_html__( 'Top Center', 'plumtree' ),
		'top right'     => esc_html__( 'Top Right', 'plumtree' ),
		'center left'   => esc_html__( 'Middle Left', 'plumtree' ),
		'center center' => esc_html__( 'Middle Center', 'plumtree' ),
		'center right'  => esc_html__( 'Middle Right', 'plumtree' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'plumtree' ),
		'bottom center' => esc_html__( 'Bottom Center', 'plumtree' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'plumtree')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'plumtree' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'plumtree')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'plumtree' ),
		'italic'      => esc_html__( 'Italic', 'plumtree' ),
		'bold'        => esc_html__( 'Bold', 'plumtree' ),
		'lighter'     => esc_html__( 'Light', 'plumtree' ),
		'bold italic' => esc_html__( 'Bold Italic', 'plumtree' )
		);
