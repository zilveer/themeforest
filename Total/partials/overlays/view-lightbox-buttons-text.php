...
$output = '<div class="overlay-view-lightbox-text overlay-hide theme-overlay textcenter">';
	$output .= '<div class="overlay-table clr">';
		$output .= '<div class="overlay-table-cell clr">';
			$output .= '<a href="'. $lightbox_link .'" class="wpex-lightbox" title="'. $title .'"'. $lightbox_data .'>'.  esc_html__( 'Zoom', 'total' ) .'<span class="fa fa-search" aria-hidden="true"></span></a>';
			$output .= '<a href="'. $link .'" class="view-post" title="'. $title .'"'. $target .'>'. esc_html__( 'View', 'total' ) .'<span class="fa fa-arrow-right" aria-hidden="true"></span></a>';
		$output .= '</div>';
	$output .= '</div>';
$output .= '</div>';
