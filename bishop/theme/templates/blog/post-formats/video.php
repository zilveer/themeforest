...
$image_size['height'] = ( $blog_type == 'big' && is_singular( 'post' ) || ( isset($doing_ajax) && $doing_ajax ) ) ? ( (int) $image_size['height'] * 1.5 )  : $image_size['height'];

$postformat_class = ( $blog_type == 'big' && is_singular( 'post' ) || ( isset($doing_ajax) && $doing_ajax ) ) ? ( $post_format . ' ' . 'container' ) : $post_format;
...
switch ( $video['host'] ) {
    ...
    case 'youtube':
        ?>
        <div class="post-format <?php echo $postformat_class ?>">
