...
<span class="street-address"><?php echo tribe_get_address( $venue_id ); ?><span class="seperator">,</span></span>
...
if ( tribe_get_region( $venue_id ) ) : ?>
	<abbr class="region tribe-events-abbr" title="<?php esc_attr_e( $full_region ); ?>"><?php echo tribe_get_region( $venue_id ); ?><span class="seperator">,</span></abbr>
<?php endif; ?>

<?php
// This location's postal code.
if ( tribe_get_zip( $venue_id ) ) : ?>
	<span class="postal-code"><?php echo tribe_get_zip( $venue_id ); ?><span class="seperator">,</span></span>
<?php endif; ?>

<?php
// This location's country.
if ( tribe_get_country( $venue_id ) ) : ?>
	<span class="country-name"><?php echo tribe_get_country( $venue_id ); ?><span class="seperator">.</span></span>
<?php endif; ?>
