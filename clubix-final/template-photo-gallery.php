<?php
/* Template Name: Photos Galleries*/
...
$order = rwmb_meta( "{$prefix}pgallery_order", $args = array(), get_the_ID() );
$orderby = rwmb_meta( "{$prefix}pgallery_order_by", $args = array(), get_the_ID() );
$posts_per_page = rwmb_meta( "{$prefix}pgallery_posts_per_page", $args = array(), get_the_ID() );
$category = rwmb_meta( "{$prefix}pgallery_category", array('type'=>'checkbox_list'), get_the_ID() );
    ...
    <div class="container">
        <div class="row">
            <div class="breadcrumb-container clearfix">
                ...
                <!-- BREADCRUMB -->
                <?php
                echo clx_breadcrumbs_filter(PhotoPostType::get_instance()->postTypeTax, $category);
                ?>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="filter-container photos-container">
                               <?php
                                ...
                                $args = array(
                                'post_type'         => PhotoPostType::get_instance()->postType,
                                'post_status'       => 'publish',
                                'paged'             => $paged,
                                ...
                                'tax_query'         => ( !empty($category) ? array(
                                       array(
                                            'taxonomy' => PhotoPostType::get_instance()->postTypeTax,
                                            'field' => 'id',
                                            'terms' => $category
                                          ),
                                       ) : false ),
                               ...
                               ?>
                                ...
                                <?php if ( $query->have_posts() ) : ?>
                                    ...
                                    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                                        <?php $terms = wp_get_post_terms( get_the_ID(), PhotoPostType::get_instance()->postTypeTax ); ?>
