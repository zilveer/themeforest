...
get_header(); ?>
	...
	<?php
		$tag_heading_navigation = ot_get_option( 'tag_heading_navigation' );
		if( $tag_heading_navigation == "on" or !$tag_heading_navigation == "off" ) {
								...
								<article id="post-<?php the_ID(); ?>" <?php post_class( 'animate anim-fadeIn' ); ?>>
									<div class="post-wrapper">
										<div class="post-header">
											<?php
												$tag_post_information = ot_get_option( 'tag_post_information' );
												if( $tag_post_information == "on" or !$tag_post_information == "off" ) {
											?>
											...
											<?php
												$tag_post_title_excerpt = ot_get_option( 'tag_post_title_excerpt' );
												if( $tag_post_title_excerpt == "on" or !$tag_post_title_excerpt == "off" ) {
										...
										<?php
											$tag_post_image = ot_get_option( 'tag_post_image' );
											if( $tag_post_image == "on" or !$tag_post_image == "off" ) {
										?>
											<?php if ( has_post_thumbnail() ) : ?>
												<div class="post-image">
													...
													<?php 
														$tag_post_category_name = ot_get_option( 'tag_post_category_name' );
														if( $tag_post_category_name == "on" or !$tag_post_category_name == "off" ) {
													?>
										...
										<?php } ?>
										<?php
											$tag_post_excerpt = ot_get_option( 'tag_post_excerpt' );
											if( $tag_post_excerpt == "on" or !$tag_post_excerpt == "off" ) { ?>
										...
										<div class="post-bottom">
											<?php
												$tag_post_read_more = ot_get_option( 'tag_post_read_more' );
												if( $tag_post_read_more == "on" or !$tag_post_read_more == "off" ) {
											?>
											...
											<?php } ?>
											<?php
												$tag_post_share_buttons = ot_get_option( 'tag_post_share_buttons' );
												if( $tag_post_share_buttons == "on" or !$tag_post_share_buttons == "off" ) {
											?>
