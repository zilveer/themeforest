...
$page_postmetas = 
	array (
		...
		*/
		array("section" => "Page Style", "id" => "page_style", "type" => "select", "title" => "Select Page style (Right Sidebar style will include wiget on the right side)", "items" => 
		...
		array("section" => "Attach Gallery", "id" => "page_gallery_id", "type" => "select", "title" => "If you select \"Gallery\" page template. Select a gallery here:", "items" => $galleries_select),
