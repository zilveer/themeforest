...
(function($) {
	...
	$.superscrollorama = function(options) {
		...
		function checkScrollAnim() {
			...
			//console.log(_last_offset,$window.scrollTop());
			
			_last_offset = $window.scrollTop();
			...
			var offsetAdjust = superscrollorama.settings.triggerAtCenter ? (superscrollorama.settings.isVertical ? -$window.height()/1.3 : -$window.width()/2) : 0;
			var i, startPoint, endPoint;

			//console.log(currScrollPoint,offsetAdjust);
