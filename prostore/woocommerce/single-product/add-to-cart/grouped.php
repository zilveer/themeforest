 ...
 *
 *
 * @package 	proStore/woocommerce/single-product/add-to-cart/grouped.php
 * @sub-package WooCommerce/Templates/single-product/add-to-cart/grouped.php
 * @file		1.0
 * @file(Woo)	1.6.4
 */
?>
		...
		<tbody>
			<?php foreach ( $grouped_products as $child_product ) : ?>
				<tr>
					...
					<?php echo apply_filters( 'woocommerce_stock_html', '<small class="label stock '.$child_product['availability']['class'].'">'.$child_product['availability']['availability'].'</small>', $child_product['availability']['availability'] ); ?>
					</th>
				</tr>
			<?php endforeach; ?>
		</tbody>
