...
$title_meta_box = suprema_qodef_add_meta_box(
    array(
    ...
    $show_title_area_meta_container = suprema_qodef_add_admin_container(
        array(
            'parent' => $title_meta_box,
        ...
        $title_area_type_meta_container = suprema_qodef_add_admin_container(
            array(
                'parent' => $show_title_area_meta_container,
        ...
        $hide_background_image_meta_container = suprema_qodef_add_admin_container(
            array(
                'parent' => $show_title_area_meta_container,
        ...
        $title_area_background_image_responsive_meta_container = suprema_qodef_add_admin_container(
            array(
                'parent' => $hide_background_image_meta_container,
