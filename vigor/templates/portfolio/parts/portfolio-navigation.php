...
if (isset($edgt_options['portfolio_single_navigation_arrows_type']) && $edgt_options['portfolio_single_navigation_arrows_type'] != '') {
    $icon_navigation_class = $edgt_options['portfolio_single_navigation_arrows_type'];
}
...
if ($edgt_options['portfolio_back_to_button_choice'] == 'icon'){
    if (isset($edgt_options['portfolio_back_to_button_icon']) && $edgt_options['portfolio_back_to_button_icon'] != '') {
        $back_to_button = $edgt_options['portfolio_back_to_button_icon'];
        $back_to_button_code = '<span class="' . $back_to_button . '"></span>';
    }
}
elseif ($edgt_options['portfolio_back_to_button_choice'] == 'custom_icon') {
    if (isset($edgt_options['portfolio_back_to_button_custom_icon']) && $edgt_options['portfolio_back_to_button_custom_icon'] != '') {
