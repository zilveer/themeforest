			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 col-lg-offset-3">
						<div class="info">
							<h1 class="animated" data-animation="flipInX" data-animation-delay="100">Search</h1>
							<div class="description animated" data-animation="fadeInUp" data-animation-delay="300"><?php printf( esc_html__( 'Search Results for: %s', 'wish' ), '<span>' . get_search_query() . '</span>' ); ?></div>
						</div>
					</div>
				</div>
			</div>
