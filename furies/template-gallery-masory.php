    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
	    	...
	    	<?php
	    	    ...
	    	    {
	    	?>
	    	    <?php echo pp_apply_content($post->post_content); ?><br/><br class="clear"/>
	    	<?php
	    	    }
	    	?>
    	...
    	<?php
    		...
    		foreach($all_photo_arr as $key => $photo_id)
    		{
    			...
    			if(!empty($photo_id))
    			{
    			    ...
    			    $small_image_url = wp_get_attachment_image_src($photo_id, 'gallery_m', true);
    			    $medium_image_url = wp_get_attachment_image_src($photo_id, 'gallery_m2', true);
    			}
    			...
    			if($key == 0)
    			{
    				$thumb_image_url = $medium_image_url[0];
    				$thumb_width = $medium_image_url[1];
    				$thumb_height = $medium_image_url[2];
    	...
    	<div class="mansory_thumbnail <?php echo $masory_class; ?>" style="width:<?php echo $thumb_width; ?>px;height:<?php echo $thumb_height; ?>px">
    		<?php 
