        ...
        function _options_page_html() {
            ...
            foreach($this->sections as $k => $section) {
				if($this->args['icon_type'] == 'image' || (isset($section['icon_type']) && $section['icon_type'] == 'image')) {
					...
					$icon = (!isset($section['icon'])) ? '<i class="fa fa-cog' . $icon_class . '"></i> ' : '<i class="fa fa-' . $section['icon'] . $icon_class . '"></i> ';
				} else {
					$icon_class = (!isset($section['icon_class'])) ? '' : ' ' . $section['icon_class'];
					$icon = (!isset($section['icon'])) ? '<i class="fa fa-cog' . $icon_class . '"></i> ' : '<i class="fa fa-' . $section['icon'] . $icon_class . '"></i> ';
				}
            ...
            if(is_array($this->extra_tabs)) {
				foreach($this->extra_tabs as $k => $tab) {
					if($this->args['icon_type'] == 'image' || (isset($tab['icon_type']) && $tab['icon_type'] == 'image')) {
    	                ...
    	                $icon = (!isset($tab['icon'])) ? '<i class="fa fa-cog' . $icon_class . '"></i> ' : '<i class="fa fa-' . $tab['icon'] . $icon_class . '"></i> ';
					} else {
						$icon_class = (!isset($tab['icon_class'])) ? '' : ' ' . $tab['icon_class'];
    	                $icon = (!isset($tab['icon'])) ? '<i class="fa fa-cog' . $icon_class . '"></i> ' : '<i class="fa fa-' . $tab['icon'] . $icon_class . '"></i> ';
					}
            ...
            if(true === $this->args['dev_mode']) {
				...
				if( isset($this->args['dev_mode_icon_type']) && $this->args['dev_mode_icon_type'] == 'image') {
					...
					$icon = (!isset($this->args['dev_mode_icon'])) ? '<i class="fa fa-info' . $icon_class . '"></i>' : '<i class="fa fa-' . $this->args['dev_mode_icon'] . $icon_class . '"></i> ';
				}
            ...
            if(true === $this->args['show_import_export']) {
                ...
                echo '</textarea>';
                echo '<input type="text" class="large-text" id="redux-opts-export-link-value" value="' . esc_url(add_query_arg(array('feed' => 'reduxopts-' . $this->args['opt_name'], 'secret' => md5(AUTH_KEY.SECURE_AUTH_KEY)), home_url())) . '" />';
