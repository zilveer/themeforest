...
$common_meta_box = array(
	...
	'fields' => array(
		...
		array(
			...
			'id' => MTHEME . '_blogpost_style',
			'type' => 'select',
			'options' => array('With Sidebar', 'Fullwidth without sidebar')
		)
	)
);
...
$video_meta_box = array(
	...
	'fields' => array(
		...
		array(
			'name' => 'Normal Video height (in pixels) - postpage with sidebar',
			'id' => MTHEME . '_video_height',
			'type' => 'text',
			'desc' => 'Please provide height in pixels for the video'
		),
		array(
			'name' => 'Fullwidth Video height (in pixels) - postpage without sidebar',
			'id' => MTHEME . '_fullpagevideo_height',
			'type' => 'text',
			'desc' => 'Please provide height in pixels for the video in fullwidth page - postpage without sidebar'
		),
		array(
			'name' => 'M4V File URL',
