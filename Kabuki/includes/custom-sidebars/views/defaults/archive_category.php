...
<h3 class="csh3title" title="<?php _e('Click to toggle', 'custom-sidebars'); ?>"><?php _e('Category archives','custom-sidebars'); ?></h3>
<div class="defaultsContainer"><?php if(!empty($categories)): foreach($categories as $c):?>
        <div id="category-page-<?php echo $c->cat_ID; ?>" class="postbox closed" >
