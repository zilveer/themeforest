<?php
/**
 * The main template file for display gallery page with comment support.
 *
 * Template Name: Gallery Images With Comments
 * @package WordPress
 */
    	...
    	<?php
    		foreach($all_photo_arr as $key => $photo)
    		{
    			...
    			if(!empty($photo->guid))
    			{
    			    ...
    			    $small_image_url = wp_get_attachment_image_src($photo->ID, 'gallery_a', true);
    			}
    		...
    		?>	
    				...
    				<?php if(!empty($pp_portfolio_enable_slideshow_title)) { ?>
	    				<div class="gallery_a_title">
			                <h5><?php echo $photo->post_title; ?></h5>
