			...
			menu: [
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[mkd_blockquote text="' + e.data.text + '" title_tag="' + e.data.title_tag + '" width="' + e.data.width + '" border_color="' + e.data.border_color + '"]');
							}
						});
					}
				},
						...
						ed.windowManager.open( {
							...
							body: [
								...
								},
								{
									type: 'textbox',
									name: 'padding',
									label: 'Padding (in format: 0px 0px 1px 0px)',
								},
								{
									type: 'textbox',
									name: 'line_height',
							...
							onsubmit: function( e ) {
								ed.insertContent( '[mkd_highlight background_color="' + e.data.background_color + '" color="' + e.data.color + '" padding="' + e.data.padding + '" line_height="' + e.data.line_height + '" font_size="' + e.data.font_size + '"]'+ e.data.text +'[/mkd_highlight]');
							}
						});
					}
				},
				...
				},
				{
					text: 'Ordered List',
					onclick: function() {
						ed.insertContent('[mkd_list_ordered]<ol><li>Lorem Ipsum</li><li>Lorem Ipsum</li><li>Lorem Ipsum</li></ol>[/mkd_list_ordered');
					}
				},
				{
					text: 'Unordered List',
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent('[mkd_unordered_list style="' + e.data.style + '" animate="' + e.data.animate + '" font_weight="' + e.data.font_weight + '"]<ul><li>Lorem ipsum</li><li>Lorem ipsum</li><li>Lorem ipsum</li></ul>[/mkd_unordered_list]');
							}
						});
					}
				},
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								...
								ed.insertContent('[mkd_icon_list_item icon_pack="' + e.data.icon_pack + '" ' + icon_pack_prefix + '="' + e.data.icon + '" icon_size="' + e.data.icon_size + '" icon_color="' + e.data.icon_color + '" title="' + e.data.title + '" title_color="' + e.data.title_color + '" title_size="' + e.data.title_size + '"]');
							}
						});
					}
				},
