		...
		array (
			...
			'post' => array(
				...
				*/
				...
				array("section" => "SEO Option", "id" => "post_seo_title", "title" => "Post Title:"),
				array("section" => "SEO Option", "id" => "post_seo_keyword", "type" => "textarea", "title" => "Meta Keyword:"),
				array("section" => "SEO Option", "id" => "post_seo_desc", "type" => "textarea", "title" => "Meta Description:"),
