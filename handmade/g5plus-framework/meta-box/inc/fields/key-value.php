...
if ( ! class_exists( 'RWMB_Key_Value_Field' ) )
{
	class RWMB_Key_Value_Field extends RWMB_Field
	{
		...
		{
			$tpl = '<input type="text" class="rwmb-key-val" name="%s[]" value="%s" placeholder="' . esc_attresc_html__( 'Key', 'meta-box' ) . '">';
			$tpl .= '<input type="text" class="rwmb-key-val" name="%s[]" value="%s" placeholder="' . esc_attresc_html__( 'Value', 'meta-box' ) . '">';
