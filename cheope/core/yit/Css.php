...
class YIT_Css {
	...
	public function enqueue_custom() {
		if( $this->custom_file_exists() ) {
			wp_enqueue_style( 'cache-custom', yit_get_model('cache')->locate_url( $this->_getCustomFilename() ), array(), $this->_config['theme']['version'], 'all' );
		}
	}
	...
	public function enqueue() {
        ...
        wp_enqueue_style( "styles-minified", yit_get_model( 'cache' )->locate_url( $this->_styleFilename ) , array() , $this->_config['theme']['version'] );
