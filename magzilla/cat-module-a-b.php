...
if( $fave_cat_sidebar_position == "none" ) {
	...
	$img_1_width = '1170'; $img_1_height = '550'; $img_2_width = '570'; $img_2_height = '427';
		...
		<main class="site-main" role="main">
			<div class="archive archive-1 post-archive main-box-for-load-more ">
				...
				<div class="row">
					...
					<div id="ID-<?php the_ID(); ?>" <?php post_class('fave-post col-lg-6 col-md-6 col-sm-6 col-xs-6'); ?> <?php echo fave_get_item_scope(); ?>>
