...
function slide_type() {
    ...
    $labels    = array(
        'name' => __('Slider', 'clubber'),
        'singular_name' => __('Slider', 'clubber'),
        'add_new' => __('Add New', 'clubber'),
        'add_new_item' => __('Add New Slider', 'clubber'),
        'edit' => __('Edit', 'clubber'),
        'edit_item' => __('Edit Slider', 'clubber'),
        'new_item' => __('New Slider', 'clubber'),
        'view' => __('View Slide', 'clubber'),
        'view_item' => __('View Slider', 'clubber'),
        'search_items' => __('Search Slider', 'clubber'),
        'not_found' => __('No slider found', 'clubber'),
        'not_found_in_trash' => __('No slider found in Trash', 'clubber'),
        'parent_item_colon' => ''
    );
    $args      = array(
        'labels' => $labels,
        ...
        'rewrite' => true,
        'hierarchical' => false,
        'menu_icon' => $imagepath . '/slider.png',
        'supports' => array(
            'title',
            'thumbnail'
        )
