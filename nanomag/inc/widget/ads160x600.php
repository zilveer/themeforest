...
/*-----------------------------------------------------------------------------------*/
	...
	function jellywp_ads160x600_widget(){
		$widget_ops = array( 'classname' => 'jellywp_ads160x600_widget', 'description' => esc_attr__( 'Ads 160x600' , 'nanomag') );
		parent::__construct('jellywp_ads160x600_widget', esc_attr__('jellywp: Ads 160x600', 'nanomag'), $widget_ops);
	}
