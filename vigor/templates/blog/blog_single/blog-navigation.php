...
if (isset($edgt_options['blog_single_navigation']) && $edgt_options['blog_single_navigation'] == "yes"){
    $enable_blog_navigation = true;
}

$navigation_blog_through_category = false;
if (isset($edgt_options['blog_navigation_through_same_category']) && $edgt_options['blog_navigation_through_same_category'] == "yes")
