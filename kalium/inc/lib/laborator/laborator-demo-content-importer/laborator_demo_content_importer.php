...
function lab_1cl_demo_installer_get_packs() {
	return array(
		...
		array(
			...
			'layerslider'    => '',
			'revslider'      => array( 
									'demo-content/landing/revolutionslider-1.zip', 
									'demo-content/landing/revolutionslider-2.zip' 
								),
		...
		array(
			...
			'layerslider'    => '',
			'revslider'      => array( 
									'demo-content/education/revslider-homepage.zip', 
			...
			'url'			 => 'http://demo.kaliumtheme.com/education',
			'new'			 => true
		),
		...
		array(
			...
			'url'			 => 'http://demo.kaliumtheme.com/fitness',
			'new'			 => true
		),
