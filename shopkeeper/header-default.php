...
<header id="masthead" class="site-header" role="banner">
    ...
    <?php endif; ?>    
            ...
            <div class="site-header-wrapper" style="max-width:<?php echo esc_html($header_max_width_style); ?>">
                ...
                <div class="site-tools <?php echo esc_html($site_tools_padding_class); ?> <?php if ( (isset($shopkeeper_theme_options['main_header_navigation_position_header_1'])) ) echo esc_html($shopkeeper_theme_options['main_header_navigation_position_header_1']); ?>">
                    <ul>
