  ...
  function display_element( $element, &$children_elements, $max_depth, $depth=0, $args, &$output )
	...
	// add main/sub classes to li's and links
	 function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if($qode_options_magnet['separation_number'] != ""):
			$separation_number = $qode_options_magnet['separation_number'];
		else:
			$separation_number = 6;
		endif;
		...
		if ((($item->current && $depth == 0) ||  ($item->current_item_ancestor && $depth == 0)) && (($qode_options_magnet['page_transitions'] == "0") || ($qode_animation == "no"))):
