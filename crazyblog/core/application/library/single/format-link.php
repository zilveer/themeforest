...
$postLink = crazyblog_set( crazyblog_set( crazyblog_set( $post_meta, 'crazyblog_post_format_options' ), '0' ), 'crazyblog_link_post' );
    ...
    <div <?php post_class( 'default-template ' . $no_image ); ?> itemscope itemtype="http://schema.org/Article">
		<?php if ( !empty( $postLink ) ): ?>
			<div class="single-link">
				<a title="" href="<?php echo esc_url( $postLink ); ?>">
					<i class="fa fa-link"></i>
					<span><?php echo esc_html( $postLink ); ?></span>
				</a>
				<ul class="short-info">
        ...
        <div class="post-name">
            ...
            <h1><?php the_title(); ?></h1>
			<?php if ( crazyblog_set( $single_setting, 'single_post_date' ) || crazyblog_set( $single_setting, 'single_post_author' ) == 'show' || crazyblog_set( $single_setting, 'single_post_comment_counter' ) == 'show' || crazyblog_set( $single_setting, 'single_post_category' ) == 'show' ) : ?>
				<ul class="meta">
					<?php if ( crazyblog_set( $single_setting, 'single_post_date' ) ) : ?>
