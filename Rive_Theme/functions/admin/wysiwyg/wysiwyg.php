<?php
    class add_ch_button {
        var $pluginname      = 'ch_shortcodes';
        var $path            = '';
        var $internalVersion = 100;

        function add_ch_button() {
            $this->path = get_template_directory_uri() . '/functions/admin/wysiwyg/';
        ...
        function add_tinymce_langs_path($plugin_array) {
            ...
            $plugin_array[$this->pluginname] = CH_ADMIN . '/wysiwyg/languages.php';
            return $plugin_array;
        }
    ...
    if (is_admin()) {
        $tinymce_button = new add_ch_button();
    }