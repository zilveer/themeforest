...
class mvp_tags_widget extends WP_Widget {
	...
	function mvp_tags_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mvp_tags_widget', 'description' => __('A custom Tag Cloud widget.', 'mvp-text') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'mvp_tags_widget' );

		/* Create the widget. */
		$this->__construct( 'mvp_tags_widget', __('Flex Mag: Tag Cloud Widget', 'mvp-text'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<div class="tag-cloud left relative">
				<?php wp_tag_cloud(array('smallest' => 10, 'largest' => 10, 'unit' => 'px', 'number' => esc_html($number), 'orderby' => 'count', 'order' => 'DESC' )); ?>
			</div>
