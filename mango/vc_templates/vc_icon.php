...
?><div
	class="vc_icon_element icon-show-container vc_icon_element-outer<?php echo esc_attr( $css_class ); ?>  vc_icon_element-align-<?php echo esc_attr( $align ); ?> <?php if( $has_style ): echo 'vc_icon_element-have-style'; endif; ?>" style="padding-top: 0px;padding-bottom: 0px;"><div
