<?php
	...
	*/
	...
	$price_table_meta_boxes = array(
		"Price Color" => array(
			'title'=>__('PRICE COLOR CHANGED','gdl_back_office'),
			'name'=>'price-table-price-color',
			'type'=>'inputtext',
			'description'=>'Insert the (PRICE TITLE/BUTTON BACKGROUND) color you want to be different from the default price item.'),	
		"Price Tag" => array(
