<?php
namespace QodeStartit\Modules\Accordion;
...
class Accordion implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' =>  esc_html__( 'Select Accordion', 'startit' ),
			'base' => $this->base,
			...
			'params' => array(
				array(
					'type' => 'textfield',
					'heading' => esc_html__( 'Extra class name', 'startit' ),
					'param_name' => 'el_class',
					'description' => esc_html__( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'startit' )
				),
				array(
					'type' => 'dropdown',
					'class' => '',
	...
	public function render($atts, $content = null) {
		...
		$output .= qode_startit_get_shortcode_module_template_part('templates/accordion-holder-template','accordions', '', $params);
