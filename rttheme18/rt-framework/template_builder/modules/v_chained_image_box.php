<?php
class rt_generate_v_chained_image_box_class extends RTThemePageLayoutOptions{
	#
	#	Vertical Chained Image Boxes 
	#
	function rt_generate_v_chained_image_box($theGroupID,$theTemplateID,$options,$randomClass){


			$boxName       = __("Vertical Chained Image Boxes", "rt_theme_admin"); 
			$contet_type   = "v_chained_image_box";
			...
			echo '<li class="ui-state-default '.$layout.' '.$randomClass.' v_chained_image_box" style="opacity:'.$opacity.';">';
			...
			$form_options = array (
				...
				array(
						"desc" 		=> __("This module creates a chained content boxes with images.",'rt_theme_admin'),	 
						"hr" 		=> "true",
						"type" 		=> "info"), 	 

				array(
						"name"		=> __("Select Image Alignment",'rt_theme_admin'), 
						"id" 		=> $theTemplateID.'_'.$theGroupID."_v_chained_image_box[media_alignment]", 
						"options" 	=>	array( 
				...
				array(
						...
						"id" 		=> $theTemplateID.'_'.$theGroupID."_v_chained_image_box[media_style]", 
						"options" 	=>	array( 
				...
				array(
						...
						"id" 		=> $theTemplateID.'_'.$theGroupID."_v_chained_image_box[bw_filter]", 
						"options" 	=>	array( 
					...
					echo '<li class="slide_options"><div class="title">'.stripslashes($caption).'<span class="s_edit"></span><span class="s_delete"></span></div><div class="options">';
						...
						$form_options = array (
							...
							array(
								...
								"id"        => $theTemplateID.'_'.$theGroupID."_v_chained_image_box[box_contents][caption][]", 
								"value"     => $caption, 
								"type"      => "text"),  
							...
							array(
									...
									"id" 		=> $theTemplateID.'_'.$theGroupID."_v_chained_image_box[box_contents][link][]", 
									"value"		=> $link, 
									"type"		=> "text"), 					
							...
							array(
								...
								"id"        => $theTemplateID.'_'.$theGroupID."_v_chained_image_box[box_contents][image][]", 
								"value"     => $image,
								"class"     => 'upload', 
								"type"      => "upload"), 
							...
							array(
									...
									"id"        => $theTemplateID.'_'.$theGroupID."_v_chained_image_box[box_contents][link_target][]", 
									"options"   => array(
							...
							array(
								...
								"id"        => $theTemplateID.'_'.$theGroupID."_v_chained_image_box[box_contents][text][]",								
								"css_id"    => $theTemplateID.'_'.$theGroupID."_v_chained_image_box".$key,
								"value"     => $text, 
