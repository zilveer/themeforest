function desColumnMaker(h, i, f) {
    ...
    this.buildTextControl = function () {
        ...
        this.textControl = jQuery( "<div>&nbsp;</div>").attr( "id", "des-column-text").attr( "style", "width: " + (this.width - 50) + "px" );
    ...
    this.buildColumnButtons = function (a) {
        if (this.buttonsControl) {
            ...
            this.buttonsControl = jQuery( "<div></div>").attr( "id", "des-column-buttons" );
