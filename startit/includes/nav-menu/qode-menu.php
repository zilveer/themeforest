...
add_filter( 'wp_setup_nav_menu_item', 'qode_startit_add_custom_nav_fields');

// save menu custom fields
add_action( 'wp_update_nav_menu_item', 'qode_startit_update_custom_nav_fields', 10, 3 );

// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'qode_startit_edit_walker', 10, 2 );


function qode_startit_add_custom_nav_fields( $menu_item ) {
 ...
 * @return      void
*/
function qode_startit_update_custom_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 * @return      void
*/
function qode_startit_edit_walker($walker,$menu_id) {

	return 'QodeStartit_Walker_Nav_Menu_Edit_Custom';
