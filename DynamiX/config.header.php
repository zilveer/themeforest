...
------------------------------------*/ 
	...
	if( of_get_option('enable_droppanel' ) == 'enable' || !empty ( $NV_infobar ) || of_get_option('header_customfield') !='' || of_get_option('enable_search') =='enable' || class_exists('Woocommerce') )
	{ 
		...
		if( of_get_option('enable_droppanel' ) == 'enable' || of_get_option('header_customfield') != '' || of_get_option('enable_search') == 'enable' || class_exists('Woocommerce') ) 
		{ 
            ...
            <div class="tab-wrap">
				<ul class="icon-dock clearfix">
                            <?php
                            if( of_get_option('enable_search') == 'enable' )
                            { ?>                       
                                <li class="searchform">
	...
	echo '<div class="header-wrap '. $page_type . ( of_get_option('sticky_menu') != 'disable' ? ' sticky-header' : '' ) . ( of_get_option('sticky_menu') == 'enabledesktop' ? ' sticky-desktop-only' : '' ) .' '. $NV_header_float .'">';
	...
	?>
		<div class="header-skin-wrap">
			...
			<?php
			// Shadow
			if( $NV_header_shadow != 'disable' )
			{
				echo '<div class="shadow top custom-layer"></div>';
			} ?>
        </div>     
        <div class="wrapper">
           ...
           <?php 
                ...
                <div id="header-logo" class="<?php echo $NV_branding_alignment; ?>">
                    ...
                    if( of_get_option('branding_url') ) : // Is Branding Image Set 
						...
						<a href="<?php echo home_url(); ?>/">
							...
							<?php
							// Transparent Logo
							if( $NV_transparent_branding_ver != '' && $NV_transparent_branding_ver != $NV_branding_ver && $NV_header_float == 'header_float header_transparent' && of_get_option('sticky_menu') != 'disable' )
							{ 
				...
				{
					$header_widget_topmargin = ( of_get_option( 'header_widget_topmargin' ) != '' ? 'margin-top:'. of_get_option( 'header_widget_topmargin' ) .'px;' : '' );
					$header_widget_bottommargin = ( of_get_option( 'header_widget_bottommargin' ) != '' ? 'margin-bottom:'. of_get_option( 'header_widget_bottommargin' ) .'px;' : '' );
					$style = ( !empty( $header_widget_topmargin ) || !empty( $header_widget_bottommargin ) ? 'style="'. $header_widget_topmargin . $header_widget_bottommargin .'"' : '' );
					
					echo "\n". '<ul class="headerpanel-widgets'. ( of_get_option( 'header_widget_align' ) != '' ?  ' '. of_get_option( 'header_widget_align' ) : '' ) . ( of_get_option( 'header_widget_width' ) != '' ?  ' '. of_get_option( 'header_widget_width' ) : '' ) .'" '. $style  .'>';
