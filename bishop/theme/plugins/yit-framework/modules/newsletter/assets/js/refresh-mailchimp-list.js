    ...
    $('.mailchimp-list-refresh').click(function(event){
        ...
        $.ajax({
            beforeSend: function(){
                ...
                div_container.find('.select_wrapper span').html(localization.refresh_label);
            },
            cache: false,
            ...
            data: {
                action: 'refresh_mailchimp_list',
                yit_mailchimp_refresh_list_nonce: localization.nonce_field,
                post_id: $('#post_ID').val()
            },
