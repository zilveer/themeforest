    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        FP.reBuild = function(resizing){
            ...
            var $headerHeight = ($('#header-outer.transparent').length == 0 || ($(window).width() < 1000 && $('#header-outer[data-permanent-transparent="true"]').length == 0) ) ? $('#header-outer').outerHeight(true) : 0 ;
            ...
            var $borderHeight = ($('.body-border-right').length > 0 && $(window).width()>690) ? $('.body-border-right').width()*$borderMultiplier : 0;
            var windowsWidth = $window.outerWidth();
            windowsHeight = $window.height() - $adminBar - $headerHeight - $borderHeight;  //updating global var
        ...
        */
        ...
        var $borderHeight = ($('.body-border-right').length > 0 && $(window).width()>690) ? $('.body-border-right').width()*$borderMultiplier : 0;
        var $headerHeight = ($('#header-outer.transparent').length == 0 || ($(window).width() < 1000 && $('#header-outer[data-permanent-transparent="true"]').length == 0) ) ? $('#header-outer').outerHeight(true) : 0 ;
        var windowsHeight = $window.height() - $adminBar - $headerHeight - $borderHeight;
        ...
        */
        function prepareDom(){
            ...
            var $borderHeight = ($('.body-border-right').length > 0 && $(window).width()>690) ? $('.body-border-right').width()*$borderMultiplier : 0;
            var $headerHeight = ($('#header-outer.transparent').length == 0 || ($(window).width() < 1000 && $('#header-outer[data-permanent-transparent="true"]').length == 0) ) ? $('#header-outer').outerHeight(true) : 0 ;
            windowsHeight = $window.height() - $adminBar - $headerHeight - $borderHeight;
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            if(typeof element === 'undefined' || canScroll == false){ return; } //there's no element to scroll, leaving the function
