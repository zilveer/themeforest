...
**
----------------------------------------------------------*/
if(!function_exists('woffice_redirect_user')) {
...
if(!function_exists('woffice_redirect_login_page')) {
	// REDIRECT LOGIN PAGE
...
if(!function_exists('woffice_login_failed')) {
	// CHECK DATA
...
if(!function_exists('woffice_verify_username_password')) {
...
if(!function_exists('woffice_check_pending')) {
...
if(!function_exists('woffice_lost_password_redirect')) {
...
if(!function_exists('woffice_logout_page')) {
	// LOG OUT
...
if(!function_exists('woffice_redirect_to_custom_lostpassword')) {
	// LOST PASSWORD
...
if(!function_exists('woffice_password_lost')) {
...
if(!function_exists('woffice_auth_css')) {
...
**
----------------------------------------------------------*/
if(!function_exists('woffice_creates_json_manifest')) {
...
**
----------------------------------------------------------*/
if(!function_exists('woffice_search_form')) {
...
**
----------------------------------------------------------*/
if(!function_exists('woffice_action_theme_widgets_init')) {
...
if(!function_exists('woffice_replace_reply_link_class')) {
...
if(!function_exists('woffice_comment_button')) {
...
**
----------------------------------------------------------*/
if(!function_exists('woffice_filter_theme_post_classes')) {
...
**
----------------------------------------------------------*/
if(!function_exists('woffice_backend_style_fixes')) {
	function woffice_backend_style_fixes() {
		...
		echo '<style>';
		//Fix birthday fields style
		echo '  .bp-profile-field .datebox > label:first-child {width: 200px;}
      .bp-profile-field .datebox > label{width: auto;}
      .bp-profile-field select{margin-right:20px}';

		//Image size in the imagepicker
		echo '  .fw-option-type-image-picker ul.thumbnails.image_picker_selector li .thumbnail img {width: 250px; height: auto}';
		echo '</style>';

	}
}
add_action('admin_print_scripts', 'woffice_backend_style_fixes');
...
function woffice_filter_theme_fw_ext_backups_demos($demos) {
    $demos_array = array(
		'allinone-demo' => array(
			...
			'preview_link' => 'http://alka-web.com/woffice-allinone/',
		),
        'business-demo' => array(
...
/*---------------------------------------------------------
**
** Theme settings changes and other WP backend CSS changes
 * @since 2.0.0
**
----------------------------------------------------------*/
function woffice_settings_wp_admin_style() {
...
add_action( 'admin_enqueue_scripts', 'woffice_settings_wp_admin_style', 99 );
/*---------------------------------------------------------
** 
** Add more buttons to the html editor
**
...
if(!function_exists('woffice_remove_admin_bar')) {
...
if(!function_exists('woffice_display_feeds_error')) {
	function woffice_display_feeds_error() {
		$feeds_private = ( function_exists( 'fw_get_db_settings_option' ) ) ? fw_get_db_settings_option('feeds_private') : '';
		if($feeds_private) {
...
**
----------------------------------------------------------*/
if(!function_exists('woffice_filter_search_results')) {
	function woffice_filter_search_results($query) {

		if (is_page_template('page-templates/directory.php')) {
...
add_filter('pre_get_posts','woffice_filter_search_results');
