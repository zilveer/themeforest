...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		...
		/*@todo: for xml and widget file path change*/
		public $mango_demo_content_path = '';
		...
		public function initSettings() {
			...
			if ( isset( $this->active_import_id ) && !empty( $this->active_import_id ) ) {
				...
				if($this->active_import_id=='wbc-import-14'){
						$this->mango_demo_content_path = get_template_directory().'/demo-data/vendor/';
				}else{
				$this->mango_demo_content_path = get_template_directory().'/demo-data/';
				}
