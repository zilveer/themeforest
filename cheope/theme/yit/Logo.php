...
class YIT_Logo {     
   ...
   public function change_icon_menu() {
        ...
        <style type="text/css">
            ...
            /* 3.8 */
            #menu-posts-logos .wp-menu-image:before { content: "" !important; background:transparent url('<?php echo YIT_THEME_ASSETS_URL . '/' . $this->_iconMenu ?>') 0 -32px !important; height: 16px; width: 32px; }
            ...
            <?php else : ?>
            /* 3.7 */
            #menu-posts-logos .wp-menu-image { background:transparent url('<?php echo YIT_THEME_ASSETS_URL . '/' . $this->_iconMenu ?>') 0 -32px !important; }
