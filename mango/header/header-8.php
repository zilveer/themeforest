    ...
    <div id="header-top" class="custom clearfix">
        <div class="container">
            ...
            <div class="nav-right">
				...
				<div class="dropdown language-dropdown btt-dropdown">					<a class="dropdown-toggle header-link" href="#"  id="logout-dropdown" data-toggle="dropdown" aria-expanded="true">			
				<i class="fa fa-user"></i><span class="header-text"><?php _e("My Account",'mango')?></span><i class="fa fa-caret-down"></i> 					</a> 					
				<ul class="dropdown-menu" role="menu">									<li  role="presentation" tabindex="-1" href="<?php 	echo wp_logout_url( home_url() ); ?>">						
