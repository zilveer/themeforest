...
class TH_StaticContentDefault extends ZnElements
{
	...
	function element()
	{
		...
		?>
		<div class="kl-slideshow static-content__slideshow <?php echo implode(' ', $classes); ?> ">
					...
					<div class="kl-slideshow-safepadding sc__container <?php echo $obj_parallax_class; ?>" <?php echo $capt_obj_parallax_attribs; ?>>
						...
						<div class="static-content default-style">
							...
							if ( isset ( $options['ww_slide_title'] ) && ! empty ( $options['ww_slide_title'] ) ) {
								echo '<h2 class="static-content__title text-'.$alignment.'" '.WpkPageHelper::zn_schema_markup('title').'>' . do_shortcode( $options['ww_slide_title'] ) . '</h2>';
							}

							// SUBTITLE
							if ( isset ( $options['ww_slide_subtitle'] ) && ! empty ( $options['ww_slide_subtitle'] ) ) {
								echo '<h3 class="static-content__subtitle text-'.$alignment.'" '.WpkPageHelper::zn_schema_markup('subtitle').'>' . do_shortcode( $options['ww_slide_subtitle'] ) . '</h3>';
							}
	...
	function options()
	{
		...
		$options = array(
			...
			'help' => znpb_get_helptab( array(
				'video'   => 'http://support.hogash.com/kallyas-videos/#W-9NdljkYtw',
				'docs'    => 'http://support.hogash.com/documentation/static-content-default/',
				'copy'    => $uid,
				'general' => true,
			)),
