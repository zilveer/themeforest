...
define( 'GRUNION_PLUGIN_DIR', TEMPLATEPATH . '/framework/grunion-contact-form/');
define( 'GRUNION_PLUGIN_URL', get_template_directory_uri() . '/framework/grunion-contact-form/');
