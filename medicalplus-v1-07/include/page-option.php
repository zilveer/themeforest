	...
	*/
	...
	$page_meta_boxes = array(
			...
			'name'=>array(
				...
				'Accordion' =>array(
					...
					'tab-item'=>array(
						...
						'active'=>''),
					'qatext'=> array(
						'title'=> __('UNDER ACCORDION TEXT', 'gdl_back_office'),
						'name'=> 'page-option-item-accordion-qatext',
						'type'=> 'inputtext',
						'default'=> 'Ask Your Question?',
						'description'=> 'This is a text under the accordion content. ( As you can see at the QA section of the demo site. )'),
					'qalink'=> array(
						'title'=> __('UNDER ACCORDION LINK', 'gdl_back_office'),
						'name'=> 'page-option-item-accordion-qalink',
						'type'=> 'inputtext',
						'hr'=> 'none'),
				),
				...
				'Media'=>array(
					'header'=>array(
						'title'=> 'HEADER TITLE',
						'name'=> 'page-option-item-media-header-title',
						'type'=> 'inputtext'),					
					'type'=>array(
						'title'=>'MEDIA TYPE',
						'name'=>'page-option-item-media-type',
						'options'=>array('Video','Image'),
						'type'=>'combobox'),
					'video'=>array(
						'title'=> 'VIDEO URL',
						'name'=> 'page-option-item-media-video',
						'meta_body'=> 'page-option-item-media-video-wrapper',
						'type'=> 'inputtext',
						'hr'=> 'none'),								
					'image'=>array(
						'title'=> 'IMAGE FILE',
						'name'=> 'page-option-item-media-upload',
						'meta_body'=> 'page-option-item-media-image-wrapper',
						'type'=> 'upload'),		
					'width'=>array(
						'title'=> 'VIDEO WIDTH',
						'name'=> 'page-option-item-media-width',
						'type'=> 'inputtext',
						'default'=> '460'),		
					'height'=>array(
						'title'=> 'VIDEO HEIGHT',
						'name'=> 'page-option-item-media-height',
						'type'=> 'inputtext',
						'default'=> '260',
						'hr'=> 'none'),								
				...
				'Personnal'=>array(
					...
					'item-type'=>array(
						'title'=> 'ITEM TYPE',
						'name'=> 'page-option-item-personnal-item-type',
						'type'=> 'combobox',
						'hr'=>'none',
						'options'=> array('Static Personnel', 'Carousel Personnel')),						
					'item-size'=>array(
						'title'=> 'ITEM SIZE',
						'name'=> 'page-option-item-personnal-item-size',
						'type'=> 'combobox',
						'options'=> array('1/4','1/3','1/2'),
						'meta_body'=> 'page-option-item-personnal-item-size-wrapper'),		
					'num-fetch'=>array(
						'title'=> 'NUM FETCH',
				...
				'Portfolio'=>array(
					...
					'excerpt-num'=>array(					
						...
						'name'=> 'page-option-item-portfolio-excerpt-num',
						'type'=> 'inputtext',
						'default'=> 185),	
					'pagination'=>array(
						'title'=>'ENABLE PAGINATION',
				...
				'Title' =>array(
					'header'=>array(
						'title'=> __('HEADER TITLE', 'gdl_back_office'),
						'name'=> 'page-option-item-title-header-title',
						'type'=> 'inputtext',
						'hr'=> 'none')
				),
		...
		"Page Title" => array(
			...
			'options'=> array('Yes', 'No'),
			'title'=> __('SHOW PAGE TITLE / CAPTION', 'gdl_back_office'),
