...
(function($) {
	...
	$.eAccordion = function(el, options) {
		...
		base.gotoPage = function(page, animate) {
			...
			$page.children('h3').stop(true, true).animate({opacity: 0}, duration);
			...
			$siblings.children('h3').stop(true, true).animate({opacity: .9}, duration);
			$siblings.children('a').hide();
		...
		base.gotoNeutral = function(animate){
			...
			base.$items.children('h3').stop(true, true).animate({opacity: .9}, duration);
			base.$items.children('a').hide();
