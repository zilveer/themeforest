		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case 'backup':
					...
					$output .= '<p><strong>'. esc_html__('Last Backup : ','wp_nuvo').'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
				...
				case 'select_google_font':
					...
					$output .= '<select class="select of-input google_font_select" name="'.$value['id'].'" id="'. $value['id'] .'" data-value="'.$smof_data[$value['id']].'">';
