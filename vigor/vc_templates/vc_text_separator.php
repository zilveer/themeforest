...
$output .= '<div class="'.$css_class.' '.$text_position.'">';
    ...
    if ($text_position == 'center' || $text_position == 'right') {
        $output .= '<div class="edgt_line_before '.$separator_line_classes.'"  style="'.implode(';', $separator_lines_styles).';'.$line_right_margin.'">';
    }
    if($line_dots == "yes") {
        $output .= '<span class="edgt_separator_line_inner" style="' . implode(';', $separator_line_dots_style) . ';' . $separator_line_left_dot_position . '"></span>';
    }
    if ($text_position == 'center' || $text_position == 'right') {
        $output .= '</div>'; // end edgt_line_before
    }
    ...
    if ($text_position == 'center' || $text_position == 'left') {
        $output .= '<div class="edgt_line_after '.$separator_line_classes.'"  style="'.implode(';', $separator_lines_styles).';'.$line_left_margin.'">';
    }
    if($line_dots == "yes") {
        $output .= '<span class="edgt_separator_line_inner" style="' . implode(';', $separator_line_dots_style) . ';' . $separator_line_right_dot_position . '"></span>';
    }
    if ($text_position == 'center' || $text_position == 'left') {
        $output .= '</div>'; // end edgt_line_after
    }
