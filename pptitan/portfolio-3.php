...
<div class="inner">
	...
	?>
	<div class="one_third <?php echo $last_class; ?> portfolio3_wrapper">
	<div class="one_third gallery3 portfolio_type <?php echo $last_class; ?>">
		<?php 
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_item->ID; ?>" class="portfolio_desc portfolio3 <?php echo $last_class; ?>">
