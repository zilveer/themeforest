	...
	<div class="social_icons_holder">
		...
		<ul class="social_icons clearfix">
			...
			<?php if ($instance['facebook_links'] != '') : ?>
				<li class="facebook">
					<span class="tool-tip"><?php esc_html_e('Facebook', 'flatastic') ?></span>
			...
			<?php if ($instance['twitter_links'] != '') : ?>
				<li class="twitter">
					<span class="tool-tip"><?php esc_html_e('Twitter', 'flatastic') ?></span>
			...
			<?php if ($instance['gplus_links'] != '') : ?>
				<li class="google_plus">
					<span class="tool-tip"><?php esc_html_e('Google Plus', 'flatastic') ?></span>
			...
			<?php if ($instance['rss_links'] == 'true') : ?>
				<li class="rss">
					<span class="tool-tip"><?php esc_html_e('Rss', 'flatastic') ?></span>
			...
			<?php if (@$instance['pinterest_links'] != '') : ?>
				<li class="pinterest">
					<span class="tool-tip"><?php esc_html_e('Pinterest', 'flatastic') ?></span>
			...
			<?php if (@$instance['linkedin_links'] != '') : ?>
				<li class="linkedin">
					<span class="tool-tip"><?php esc_html_e('LinkedIn', 'flatastic') ?></span>
			...
			<?php if ($instance['vimeo_links'] != '') : ?>
				<li class="vimeo">
					<span class="tool-tip"><?php esc_html_e('Vimeo', 'flatastic') ?></span>
			...
			<?php if ($instance['youtube_links'] != '') : ?>
				<li class="youtube">
					<span class="tool-tip"><?php esc_html_e('Youtube', 'flatastic') ?></span>
			...
			<?php if ($instance['flickr_links'] != '') : ?>
				<li class="flickr">
					<span class="tool-tip"><?php esc_html_e('Flickr', 'flatastic') ?></span>
			...
			<?php if (@$instance['vk_links'] != '') : ?>
				<li class="vk">
					<span class="tool-tip"><?php esc_html_e('Vkontakte', 'flatastic') ?></span>
			...
			<?php if ($instance['contact_us'] != '') : ?>
				<li class="envelope">
					<span class="tool-tip"><?php _e('Contact Us', 'flatastic') ?></span>
