				...
				<?php if(get_option('show_images_only') != 1): ?>
					<div class="grid_product_info">
						...
						<?php endif; ?>
							...
							<?php if(wpsc_product_on_special()) : ?>
										<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><?php _e('Old Price', ETHEME_DOMAIN); ?>:<span class="oldprice"><?php echo wpsc_product_normal_price(); ?></span></p>
									<?php endif; ?>
									<p class="pricedisplay <?php echo wpsc_the_product_id(); ?>"><?php _e('Price', ETHEME_DOMAIN); ?>:<span id='product_price_<?php echo wpsc_the_product_id(); ?>' class="currentprice pricedisplay"><?php echo wpsc_the_product_price(); ?></span></p>
					...
					<div class="grid_more_info">
						<form class="product_form"  enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="product_<?php echo wpsc_the_product_id(); ?>" id="product_<?php echo wpsc_the_product_id(); ?>" >
                         ...
                         <fieldset><legend><?php _e('Product Options', ETHEME_DOMAIN); ?></legend>       
						<div class="wpsc_variation_forms">
							...
							<?php if((get_option('display_addtocart') == 1) && (get_option('addtocart_or_buynow') !='1')) :?> 	   
								...
								<?php else : ?>
									<p class="soldout"><?php _e('Sorry, sold out!', ETHEME_DOMAIN); ?></p>
								<?php endif ; ?>
							<?php endif; ?>
