...
<div class="inner">
	...
	<div class="element <?php echo $portfolio_item_set; ?> portfolio3filter_wrapper">
	
		<div class="one_third gallery3 filterable portfolio_type" data-id="post-<?php echo $key+1; ?>" data-type="<?php echo $portfolio_item_set; ?>">
		<?php 
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_item->ID; ?>" class="portfolio_desc portfolio3 filterable <?php echo $last_class; ?>">
