 ...
 */
class HashmagMikadoSocialIconWidget extends HashmagMikadoWidget {
    /**
     * Set basic widget options and call parent class construct
     */
    public function __construct() {
        parent::__construct(
            'mkdf_social_icon_widget', // Base ID
    ...
    protected function setParams() {
        $this->params = array_merge(
            hashmag_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => 'Link',
    ...
    public function widget($args, $instance) {
        ...
        <a class="mkdf-social-icon-widget-holder" <?php echo hashmag_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php hashmag_mikado_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
