<?php
/**
 * Template Name: Portfolio Masonry 4 Columns Right Sidebar
...
get_header();
?>
<input type="hidden" id="pp_wall_columns" name="pp_wall_columns" value="4"/>
<br class="clear"/>
...
?>
<div class="wall_entry four_cols <?php echo $portfolio_item_set; ?>">
    <?php 
	...
	?>		
	    ...
	    <?php
	    	...
	    	?>
	    	<a title="<?php echo get_the_title(); ?>" href="#video_self_<?php echo $key; ?>" class="lightbox_vimeo" class="video-container">
	    		<img src="<?php echo $small_image_url[0]; ?>" alt="" />
