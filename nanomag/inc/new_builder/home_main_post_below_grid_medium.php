<?php
class home_post_below_grid_medium extends AQ_Block {
	
	//set and create block
	function __construct() {
		$block_options = array(
			'name' => esc_attr__('Post with medium grid', 'nanomag'),
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('home_post_below_grid_medium', $block_options);
	}
	...
	extract($instance);
        ...
        ?>
        <div class="widget home_grid_medium_post grid_below_list <?php echo esc_attr($instance['css_class_builder']);?>">
...
<?php echo jelly_post_meta(get_the_ID()); ?>
				...
				<div class="grid_2 grid <?php echo 'margin'.$i;?> <?php if(!of_get_option('disable_css_animation')==1){echo esc_attr("appear_animation");}?>">
