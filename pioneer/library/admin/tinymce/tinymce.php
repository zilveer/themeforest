<?php
class add_epic_shortcodes {
	
	var $pluginname = 'epic_shortcodes';
	var $path = '';
	var $internalVersion = 100;
	
	function add_epic_shortcodes()  {
		
		// Set path to editor_plugin.js
		$this->path = get_template_directory_uri() . '/library/admin/tinymce/';	
	...
	function add_tinymce_langs_path($plugin_array) {
		...
		$plugin_array[$this->pluginname] = EPIC_ADMIN . '/tinymce/langs.php';
		return $plugin_array;
	}
...
$tinymce_button = new add_epic_shortcodes ();
