<?php if ('open' == $post->comment_status) : ?>
	...
	<?php else : ?>
			...
			<?php else : ?>
						<br/>
						<p>  
							<input class="round m input" name="author" type="text" id="author" value="" tabindex="1" style="width:97%" title="<?php _e( 'Name', THEMEDOMAIN ); ?>*" /> 
						</p> 
						<br/>
						<p> 
							<input class="round m input" name="email" type="text" id="email" value="" tabindex="2" style="width:97%" title="<?php _e( 'Email', THEMEDOMAIN ); ?>*" /> 
						</p> 
						<br/>
						<p> 
							<input class="round m input" name="url" type="text" id="url" value="" tabindex="3" style="width:97%" title="<?php _e( 'Website', THEMEDOMAIN ); ?>" /> 
						</p> 
						<br/>
			...
			<?php endif; ?>
						...
						<p> 
							<textarea name="comment" cols="40" rows="3" id="comment" tabindex="4" style="width:97%" title="<?php _e( 'Message', THEMEDOMAIN ); ?>*"></textarea> 
						</p> 
						<br /> 
						<p> 
