    ...
    return {
      ...
      link: function ($scope, elem, attrs, ngModel) {
        ...
        var mousemove = function (event) {
          ...
          //ADDED by JAWTEMPLATES  -- pro Pagebuilder je colorpicker fixed, proto se musí souřadnice vypočítávát bez offsetu
          var jaw_offset = 0;
          if(jQuery('body').hasClass('post-php') || jQuery('body').hasClass('post-new-php')){
              jaw_offset = jQuery('#editor_container .content').offset().top-(jQuery('#editor_container').offset().top-jQuery(window).scrollTop())-5;
          }
          //JAW zmena konec**************************************************************************************************
          ...
          var top = Math.max(
            ...
            Math.min(
              slider.maxTop,
              slider.top + ((event.pageY || pointer.top) - jaw_offset - pointer.top) //jaw_offset
            )
          );
        ...
        var getColorpickerTemplatePosition = function() {
          var
            positionValue,
            positionOffset = 0;//helper.getOffset(elem[0]);
        ...
        elem.bind('click', function () {
          ...
          //ADDED by JAWTEMPLATES  
          elem.parent().prepend(colorpickerTemplate);
