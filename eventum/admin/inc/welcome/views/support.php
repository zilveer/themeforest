<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
    ...
    <div id="support_div" class="support">
        ...
        <form id="supportform">
            ...
            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title"><?php esc_html_e( 'Submit a Support Request', 'redux-framework' ); ?></h2>

                <h3 class="fs-title"
                    style="margin-top:0;"><?php esc_html_e( 'To get started, we will need to generate a support hash.', 'redux-framework' ); ?></h3>
            ...
            <fieldset>
                <h2 class="fs-title"><?php esc_html_e( 'Select Your Support Type', 'redux-framework' ); ?></h2>
                ...
                <table id="user_type">
                    <tr>
                        <td id="is_user"><i class="el el-user"></i><br/><?php esc_html_e( 'User', 'redux-framework' ); ?><br/>
                            <small><?php esc_html_e( 'I am a user, using a pre-built product.', 'redux-framework' ); ?></small>
                        </td>
                        <td id="is_developer"><i
                                class="el el-github"></i><br/><?php esc_html_e( 'Developer', 'redux-framework' ); ?><br/>
                            <small><?php esc_html_e( 'I am a developer, building a product using Redux.', 'redux-framework' ); ?></small>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset id="final_support">
                <h2 class="fs-title"><?php esc_html_e( 'How to Get Support', 'redux-framework' ); ?></h2>

                <div class="is_developer">
                    <p><?php esc_html_e( 'Please proceed to the Redux Framework issue tracker and supply us with your support URL below. Please also provide any information that will help us to reproduce your issue.', 'redux-framework' ); ?></p>
                ...
                <div class="is_user">
                    ...
                    <p>
                        <strong><?php esc_html_e( 'Please be sure to include for your developer - via cut and paste - the Support URL in the box below.', 'redux-framework' ); ?></strong>
                    </p>
                    <?php
                    ...
                    <!--                    for="p-->
                    <?php //echo $dirname; ?><!--"><strong>--><?php //esc_html_e( 'Plugin', 'redux-framework' );?>
                    ...
                    <!--            for="-->
                    <?php //echo sanitize_html_class( $active_theme->Name ); ?><!--"><strong>--><?php //esc_html_e( 'Theme', 'redux-framework' ); ?>
