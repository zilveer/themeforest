	...
	<div class="sidebar-position-<?php esc_attr_e( $l['sidebar'] ); ?>">
		<div class="row">
			...
			<div class="content main-products-loop <?php esc_attr_e( $l['content-class'] ); ?>">
				<?php if (et_is_product_brand()): ?>
					<?php et_product_brand_description(); ?>
				<?php endif ?>
				<?php if ( have_posts() ) : ?>
				
                    <div class="<?php echo ($full_width) ? 'container' : ''; ?>">
						<?php et_category_header();?>
                    ...
                    <div class="<?php echo ($full_width) ? 'container after-shop-loop' : 'after-shop-loop'; ?>">
						<?php
							/**
