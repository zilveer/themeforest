...
(function($){
	$.fn.slider=function(options){
		var defaults={
			...
			imgPerScroll:6,  //the number of small thumbnail images per scroll (page)
		...
		var api, timer=-1, images=[], current, root, thumbContainer, containerNum=0, inAnimation=false, descBox, descBottom=2,windowFocus=true;
