...
<div class="inner">
	...
	?>
	<div class="one_half <?php echo $last_class; ?> portfolio2_wrapper">
	<div class="one_half <?php echo $last_class; ?> gallery2">
		<?php 
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_item->ID; ?>" class="portfolio_desc portfolio2 <?php echo $last_class; ?>">
