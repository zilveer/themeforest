...
if( !class_exists( 'YITH_WCWL_Shortcode' ) ) {
    ...
    class YITH_WCWL_Shortcode {
        ...
        public static function add_to_wishlist( $atts, $content = null ) {
            ...
            $linl_wishlist = get_option('sense_link_wishlist');
            ...
            $html = YITH_WCWL_UI::add_to_wishlist_button( $linl_wishlist, $product->product_type, $yith_wcwl->is_product_in_wishlist( $product->id ) ); 
