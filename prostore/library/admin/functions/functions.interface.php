 ...
 *
 *
 * @package 	proStore/library/admin/functions/functions.interface.php
 * @file	 	1.0
 */
?>
<?php 
...
function optionsframework_add_admin() {
	...
	$icon_path = get_template_directory_uri(). '/library/admin/assets/images/icon.png';
    //$of_page = add_theme_page( THEMENAME, 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
	$of_page = add_menu_page('prostore', 'proStore', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page',$icon_path,'3');
...
function of_load_only() 
{
	...
	//wp_enqueue_script('addons-scripts', ADMIN_DIR .'assets/js/jquery.tools.min.js', array( 'jquery' ));
