// JavaScript Document
jQuery.fn.preloader=function(options){var defaults={delay:200,preload_parent:"a",check_timer:300,ondone:function(){},oneachload:function(image){},fadein:500};var options=jQuery.extend(defaults,options),root=jQuery(this),images=root.find("img").css({"visibility":"hidden",opacity:0}),timer,counter=0,i=0,checkFlag=[],delaySum=options.delay,init=function(){timer=setInterval(function(){if(counter>=checkFlag.length)
...
jQuery(this).parent().addClass("preloader");checkFlag[i++]=false;});images=jQuery.makeArray(images);var icon=jQuery("<img />",{id:'loadingicon',src:'/wp-content/themes/origami/images/ajax-loader-1.gif'}).hide().appendTo("body");timer=setInterval(function(){if(icon[0].complete==true)
