								...
								<article id="post-<?php the_ID(); ?>" <?php post_class( 'animate anim-fadeIn' ); ?>>
									<div class="post-wrapper">
										<div class="post-header">
											<?php
												$author_post_information = ot_get_option( 'author_post_information' );
												if( $author_post_information == "on" or !$author_post_information == "off" ) {
											?>
											...
											<?php
												$author_post_title_excerpt = ot_get_option( 'author_post_title_excerpt' );
												if( $author_post_title_excerpt == "on" or !$author_post_title_excerpt == "off" ) {
										...
										<?php
											$author_post_image = ot_get_option( 'author_post_image' );
											if( $author_post_image == "on" or !$author_post_image == "off" ) {
										?>
											<?php if ( has_post_thumbnail() ) : ?>
												<div class="post-image">
													...
													<?php 
														$author_post_category_name = ot_get_option( 'author_post_category_name' );
														if( $author_post_category_name == "on" or !$author_post_category_name == "off" ) {
													?>
										...
										<?php } ?>
										<?php
											$author_post_excerpt = ot_get_option( 'author_post_excerpt' );
											if( $author_post_excerpt == "on" or !$author_post_excerpt == "off" ) { ?>
										...
										<div class="post-bottom">
											<?php
												$author_post_read_more = ot_get_option( 'author_post_read_more' );
												if( $author_post_read_more == "on" or !$author_post_read_more == "off" ) {
											?>
											...
											<?php } ?>
											<?php
												$author_post_share_buttons = ot_get_option( 'author_post_share_buttons' );
												if( $author_post_share_buttons == "on" or !$author_post_share_buttons == "off" ) {
											?>
