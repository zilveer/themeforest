    ...
    <div class="dokan-dashboard-content dokan-product-edit">
        ...
        <header class="dokan-dashboard-header dokan-clearfix">
            <h1 class="entry-title">
                <?php if ( !$post_id ): ?>
                    <?php _e( 'Add New Product', 'unicase' ); ?>
                <?php else: ?>
                    <?php _e( 'Edit Product', 'unicase' ); ?>
                    ...
                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right">
                            <a class="view-product dokan-btn dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'View Product', 'unicase' ); ?></a>
                        </span>
                    <?php } ?>

                    <?php if ( $_visibility == 'hidden' ) { ?>
                        <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="fa fa-eye-slash"></i> <?php _e( 'Hidden', 'unicase' ); ?></span>
                    <?php } ?>
        ...
        <div class="product-edit-new-container">
            <?php if ( Dokan_Template_Products::$errors ) { ?>
                <div class="dokan-alert dokan-alert-danger">
                    ...
                    <?php foreach ( Dokan_Template_Products::$errors as $error) { ?>
                        ...
                        <strong><?php _e( 'Error!', 'unicase' ); ?></strong> <?php echo $error ?>.<br>
            ...
            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                <div class="dokan-message">
                    ...
                    <strong><?php _e( 'Success!', 'unicase' ); ?></strong> <?php _e( 'The product has been saved successfully.', 'unicase' ); ?>

                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <a href="<?php echo get_permalink( $post_id ); ?>" target="_blank"><?php _e( 'View Product &rarr;', 'unicase' ); ?></a>
                    <?php } ?>
                </div>
            <?php } ?>
                ...
                if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                    ...
                    <form class="dokan-product-edit-form" role="form" method="post">
                        ...
                        <div class="dokan-form-top-area">
                            ...
                            <div class="content-half-part">
                                ...
                                <div class="dokan-form-group">
                                    ...
                                    <label for="post_title" class="form-label"><?php _e( 'Title', 'unicase' ); ?></label>
                                    <div class="dokan-product-title-alert hidden dokan-alert dokan-alert-danger">
                                            <?php _e('Please choose a Name !!!', 'unicase'); ?>
                                    </div>
                                    <?php dokan_post_input_box( $post_id, 'post_title', array( 'placeholder' => __( 'Product name..', 'unicase' ), 'value' => $post_title ) ); ?>
                                </div>
                                ...
                                <div class="hide_if_variation dokan-clearfix">
                                    ...
                                    <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                        ...
                                        <div class="content-half-part regular-price">
                                            <label for="_regular_price" class="form-label"><?php _e( 'Price', 'unicase' ); ?></label>

                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                <?php dokan_post_input_box( $post_id, '_regular_price', array( 'placeholder' => __( '0.00', 'unicase' ) ), 'number' ); ?>
                                            </div>
                                        </div>

                                        <div class="content-half-part sale-price">
                                            <label for="_sale_price" class="form-label"><?php _e( 'Discounted Price', 'unicase' ); ?></label>

                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php echo get_woocommerce_currency_symbol(); ?></span>
                                                <?php dokan_post_input_box( $post_id, '_sale_price', array( 'placeholder' => __( '0.00', 'unicase' ) ), 'number' ); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="discount-price dokan-form-group">
                                        <label>
                                            <input type="checkbox" <?php checked( $is_discount, true ); ?> class="sale-schedule"> <?php _e( 'Schedule Discounted Price', 'unicase' ); ?>
                                        </label>
                                    </div>
                                    ...
                                    <div class="sale-schedule-container dokan-clearfix dokan-form-group">
                                        <div class="content-half-part from">
                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php _e( 'From', 'unicase' ); ?></span>
                                        ...
                                        <div class="content-half-part to">
                                            <div class="dokan-input-group">
                                                <span class="dokan-input-group-addon"><?php _e( 'To', 'unicase' ); ?></span>
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group">
                                        ...
                                        <label for="product_cat" class="form-label"><?php _e( 'Category', 'unicase' ); ?></label>
                                        <div class="dokan-product-cat-alert hidden dokan-alert dokan-alert-danger">
                                            <?php _e('Please choose a category !!!', 'unicase'); ?>
                                        </div>
                                        <?php
                                        $product_cat = -1;
                                        $term = array();
                                        ...
                                        $category_args =  array(
                                            'show_option_none' => __( '- Select a category -', 'unicase' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'product_cat',
                                            'id'               => 'product_cat',
                                ...
                                <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                    <div class="dokan-form-group dokan-list-category-box">
                                        <h5><?php _e( 'Choose a category', 'unicase' );  ?></h5>
                                ...
                                <div class="dokan-form-group">
                                    <label for="product_tag" class="form-label"><?php _e( 'Tags', 'unicase' ); ?></label>
                                    <?php
                                    ...
                                    echo str_replace( '<select', '<select data-placeholder="'.__( 'Select product tags','unicase' ).'" multiple="multiple" ', $drop_down_tags );
                            ...
                            <div class="content-half-part featured-image">
                                ...
                                <div class="dokan-feat-image-upload">
                                    ...
                                    <div class="instruction-inside<?php echo $instruction_class; ?>">
                                        ...
                                        <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php _e( 'Upload a product cover image', 'unicase' ); ?></a>
                                    </div>
                                ...
                                <div class="dokan-product-gallery">
                                    <div class="dokan-side-body" id="dokan-product-images">
                                                ...
                                                if ( $gallery ) {
                                                    foreach ($gallery as $image_id) {
                                                        ...
                                                        <li class="image" data-attachment_id="<?php echo $image_id; ?>">
                                                            ...
                                                            <a href="#" class="action-delete" title="<?php esc_attr_e( 'Delete image', 'unicase' ); ?>">&times;</a>
                                                        </li>
                                                        <?php
                                                    }
                                                }
                                        ...
                                        <a href="#" class="add-product-images dokan-btn dokan-btn-sm dokan-btn-success"><?php _e( '+ Add more images', 'unicase' ); ?></a>
                                    </div>
                                </div> <!-- .product-gallery -->
                            </div><!-- .content-half-part -->
                        ...
                        <div class="dokan-product-short-description">
                            <label for="post_excerpt" class="form-label"><?php _e( 'Short Description', 'unicase' ); ?></label>
                        ...
                        <div class="dokan-product-description">
                            <label for="post_content" class="form-label"><?php _e( 'Description', 'unicase' ); ?></label>
                        ...
                        <div class="dokan-product-inventory dokan-edit-row dokan-clearfix">
                            <div class="dokan-side-left">
                                <h2><?php _e( 'Inventory & Variants', 'unicase' ); ?></h2>

                                <p>
                                    <?php _e( 'Manage inventory, and configure the options for selling this product.', 'unicase' ); ?>
                                </p>
                            </div>

                            <div class="dokan-side-right">
                                <div class="dokan-form-group hide_if_variation" style="width: 50%;">
                                    <label for="_sku" class="form-label"><?php _e( 'SKU', 'unicase' ); ?> <span><?php _e( '(Stock Keeping Unit)', 'unicase' ); ?></span></label>
                                    <?php dokan_post_input_box( $post_id, '_sku' ); ?>
                                </div>

                                <div class="dokan-form-group hide_if_variation">
                                    <?php dokan_post_input_box( $post_id, '_manage_stock', array( 'label' => __( 'Enable product stock management', 'unicase' ) ), 'checkbox' ); ?>
                                </div>
                                ...
                                <div class="show_if_stock dokan-stock-management-wrapper dokan-form-group dokan-clearfix">
                                    ...
                                    <div class="dokan-w3 hide_if_variation">
                                        <label for="_stock" class="dokan-form-label"><?php _e( 'Quantity', 'unicase' ); ?></label>
                                        <input type="number" name="_stock" placeholder="<?php __( '1', 'unicase' ); ?>" value="<?php echo wc_stock_amount( $_stock ); ?>" min="0" step="1">
                                    </div>

                                    <div class="dokan-w3 hide_if_variation">
                                        <label for="_stock_status" class="dokan-form-label"><?php _e( 'Stock Status', 'unicase' ); ?></label>

                                        <?php dokan_post_input_box( $post_id, '_stock_status', array( 'options' => array(
                                            'instock'     => __( 'In Stock', 'unicase' ),
                                            'outofstock' => __( 'Out of Stock', 'unicase' ),
                                        ) ), 'select' ); ?>
                                    </div>

                                    <div class="dokan-w3 hide_if_variation">
                                        <label for="_backorders" class="dokan-form-label"><?php _e( 'Allow Backorders', 'unicase' ); ?></label>

                                        <?php dokan_post_input_box( $post_id, '_backorders', array( 'options' => array(
                                            'no'     => __( 'Do not allow', 'unicase' ),
                                            'notify' => __( 'Allow but notify customer', 'unicase' ),
                                            'yes'    => __( 'Allow', 'unicase' )
                                        ) ), 'select' ); ?>
                                    </div>
                                </div><!-- .show_if_stock -->

                                <div class="dokan-form-group">
                                    <?php dokan_post_input_box( $post_id, '_sold_individually', array('label' => __( 'Allow only one quantity of this product to be bought in a single order', 'unicase' ) ), 'checkbox' ); ?>
                                </div>
                                ...
                                <div class="dokan-divider-top dokan-clearfix downloadable downloadable_files hide_if_variation">
                                    <label class="dokan-checkbox-inline dokan-form-label" for="_downloadable">
                                        ...
                                        <?php _e( 'This is a downloadable product', 'unicase' ); ?>
                                    </label>
                                    ...
                                    <div class="dokan-side-body dokan-download-wrapper<?php echo ( $_downloadable == 'yes' ) ? '' : ' dokan-hide'; ?>">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th colspan="2">
                                                        ...
                                                        ?>"><?php _e( 'Add File', 'unicase' ); ?></a>
                                                    </th>
                                                </tr>
                                            </tfoot>
                                            <thead>
                                                <tr>
                                                    <th><?php _e( 'Name', 'unicase' ); ?> <span class="tips" title="<?php _e( 'This is the name of the download shown to the customer.', 'unicase' ); ?>">[?]</span></th>
                                                    <th><?php _e( 'File URL', 'unicase' ); ?> <span class="tips" title="<?php _e( 'This is the URL or absolute path to the file which customers will get access to.', 'unicase' ); ?>">[?]</span></th>
                                                    <th><?php _e( 'Action', 'unicase' ); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                        ...
                                        <div class="dokan-clearfix">
                                            <div class="content-half-part">
                                                <label for="_download_limit" class="form-label"><?php _e( 'Download Limit', 'unicase' ); ?></label>
                                                <?php dokan_post_input_box( $post_id, '_download_limit', array( 'placeholder' => __( 'e.g. 4', 'unicase' ) ) ); ?>
                                            </div><!-- .content-half-part -->

                                            <div class="content-half-part">
                                                <label for="_download_expiry" class="form-label"><?php _e( 'Download Expiry', 'unicase' ); ?></label>
                                                <?php dokan_post_input_box( $post_id, '_download_expiry', array( 'placeholder' => __( 'Number of days', 'unicase' ) ) ); ?>
                                            </div><!-- .content-half-part -->
                                        </div>
                        ...
                        <div class="dokan-other-options dokan-edit-row dokan-clearfix">
                            <div class="dokan-side-left">
                                <h2><?php _e( 'Other Options', 'unicase' ); ?></h2>
                            </div>

                            <div class="dokan-side-right">
                                <?php if ( $post_id ): ?>
                                    <div class="dokan-form-group">
                                        <label for="post_status" class="form-label"><?php _e( 'Product Status', 'unicase' ); ?></label>
                                        <?php if ( $post_status != 'pending' ) { ?>
                                            <?php $post_statuses = apply_filters( 'dokan_post_status', array(
                                                'publish' => __( 'Online', 'unicase' ),
                                                'draft'   => __( 'Draft', 'unicase' )
                                            ), $post ); ?>
                                ...
                                <div class="dokan-form-group">
                                    <label for="_visibility" class="form-label"><?php _e( 'Visibility', 'unicase' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, '_visibility', array( 'options' => array(
                                        'visible' => __( 'Catalog or Search', 'unicase' ),
                                        'catalog' => __( 'Catalog', 'unicase' ),
                                        'search'  => __( 'Search', 'unicase' ),
                                        'hidden'  => __( 'Hidden', 'unicase')
                                    ) ), 'select' ); ?>
                                </div>

                                <div class="dokan-form-group">
                                    <label for="_purchase_note" class="form-label"><?php _e( 'Purchase Note', 'unicase' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, '_purchase_note', array( 'placeholder' => __( 'Customer will get this info in their order email', 'unicase' ) ), 'textarea' ); ?>
                                </div>

                                <div class="dokan-form-group">
                                    <?php $_enable_reviews = ( $post->comment_status == 'open' ) ? 'yes' : 'no'; ?>
                                    <?php dokan_post_input_box( $post_id, '_enable_reviews', array('value' => $_enable_reviews, 'label' => __( 'Enable product reviews', 'unicase' ) ), 'checkbox' ); ?>
                                </div>
                        ...
                        <input type="hidden" name="dokan_add_product" value="<?php esc_attr_e( 'Save Product', 'unicase' ); ?>"/>
                        <input type="submit" name="dokan_add_product" class="dokan-btn dokan-btn-theme dokan-btn-lg btn-block" value="<?php esc_attr_e( 'Save Product', 'unicase' ); ?>"/>
