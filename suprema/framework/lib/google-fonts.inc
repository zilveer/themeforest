<?php
if ( ! function_exists( 'suprema_qodef_init_google_fonts_array' ) ) {
    function suprema_qodef_init_google_fonts_array() {

        global $suprema_qodef_fonts_array;
        $suprema_qodef_fonts_array =
            array(
                0   =>
                    array(
    ...
    add_action('after_setup_theme', 'suprema_qodef_init_google_fonts_array');
}