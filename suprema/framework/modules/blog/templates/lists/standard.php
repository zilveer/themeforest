<div class="qodef-blog-holder qodef-blog-type-standard <?php echo esc_attr($blog_classes)?>"   data-blog-type="<?php echo esc_attr($blog_type)?>" <?php echo esc_attr(suprema_qodef_set_blog_holder_data_params()); ?> >
	<?php
