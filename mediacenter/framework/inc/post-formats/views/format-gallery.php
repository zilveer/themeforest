<div id="cfpf-format-gallery-preview" class="cf-elm-block cf-elm-block-image" style="display: none;">
	<!-- <label><span><?php _e('Gallery Images', 'mediacenter'); ?></span></label> -->
	<div class="cf-elm-container">
		...
		<p class="none"><a href="#" class="button"><?php ($ids) ? _e('Edit Gallery', 'mediacenter') : _e('Add Images to Gallery', 'mediacenter'); ?></a></p>
