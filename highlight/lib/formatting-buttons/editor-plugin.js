...
var pexetoButtons=[
{
		...
		},
		{
			...
			title:'Button',
			allowSelection:false,
			fields:[{id:'text', name:'Text'},{id:'href', name:'Link URL'},{id:'style', name:'Style', values:['dark', 'light', 'green', 'blue', 'orange']}],
			generateHtml:function(obj){
				var buttonClass='';
				if(obj.style!='dark'){
					if(obj.style==='light'){
						...
						buttonClass='button-'+obj.style;
					}
				}
				return '<a class="button '+buttonClass+'" href="'+obj.href+'"><span>'+obj.text+'</span></a>';
			}
		},
		{
			id:'pexetoinfoboxes',
