 ...
 *
 *
 * @package 	proStore/library/shortcodes/tinymce/quotes/window.php
 * @file	 	1.0
 */
?>
<?php
...
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/library/shortcodes/tinymce/quotes/tinymce.js?1.1"></script>
<style type="text/css">
