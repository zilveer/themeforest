...
function lip_front_end_js() {
	wp_enqueue_script('love-it', get_template_directory_uri() . '/includes/plugins/love-it-pro/includes/js/love-it.js', array( 'jquery' ) );
	if(!is_user_logged_in()) {
		wp_enqueue_script( 'jquery-coookies', get_template_directory_uri() . '/includes/plugins/love-it-pro/includes/js/jquery.cookie.js', array( 'jquery' ) );
	}
