...
define( 'NOTIFIER_THEME_SHORTNAME', 'anthology' ); // The theme name
...
function update_notifier() {
	...
	<div id="no-details" title="Almost There">You haven't inserted your Marketplace username and API Key - please go to the <a href="<?php echo admin_url().'admin.php?page=functions.php'; ?>"><?php echo NOTIFIER_THEME_NAME; ?> Options</a> page and populate the required data in the "Theme Update" section.</div>
