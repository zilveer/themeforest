...
(function ($) {
    ...
    $.fn.addClass = function () {
        ...
        if (this.prop('tagName') == 'BODY' && arguments[0] == 'folded') {
    ...
    $(document).on('ready', function () {
        $.each($('.vp-wrap .vp-input'), function (index, elem) {
            console.log('ssss');
    ...
    $('.vp-menu-goto').each(function (i) {
        ...
        if (fields.length > 0)
            validation.push({name: href.trimChar('#'), fields: fields});
    });
