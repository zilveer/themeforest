...
add_action('after_setup_theme', 'hue_mikado_admin_map_init', 0);

function hue_mikado_admin_map_init() {

	do_action('hue_mikado_before_options_map');
	...
	do_action('hue_mikado_options_map');

	do_action('hue_mikado_after_options_map');
