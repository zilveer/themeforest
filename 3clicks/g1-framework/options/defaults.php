        ...
        function _options_page_html() {
            ...
            if(true === $this->args['show_import_export']) {
                ...
                echo ' <a href="'.add_query_arg(array(
                        'feed'      => urlencode( 'reduxopts-'.$this->args['opt_name'] ),
                        'action'    => 'download_options',
                        'secret'    => urlencode( md5(AUTH_KEY.SECURE_AUTH_KEY) )
                        ),
                        site_url()
                    ).'" id="redux-opts-export-code-dl" class="button-primary">Download All Options</a>';
                echo ' <a href="'.add_query_arg(array(
                        'feed'      => urlencode( 'reduxopts-'.$this->args['opt_name'] ),
                        'action'    => 'download_options',
                        'type'      => 'skin',
                        'secret'    => urlencode( md5(AUTH_KEY.SECURE_AUTH_KEY) )
                    ), site_url()).'" id="redux-skin-export-code-dl" class="button-primary">Download Skin</a>';
