...
<form class="woocommerce-shipping-calculator col-lg-4 col-md-6 col-xs-12" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

    <h2 class="p-font"><?php esc_html_e( 'Calculate Shipping', 'woocommerce' ); ?></h2>
		...
		<p class="form-row form-row-wide" id="calc_shipping_state_field">
			<?php
				...
				// Standard Input
					...
					?><input type="text" class="input-text" value="<?php echo esc_attr( $current_r ); ?>" placeholder="<?php esc_html_e( 'State / county', 'woocommerce' ); ?>" name="calc_shipping_state" id="calc_shipping_state" /><?php
