...
class SwiftPageBuilderLayoutButton implements SwiftPageBuilderTemplateInterface {
...
class SwiftPageBuilderTemplateMenuButton implements SwiftPageBuilderTemplateInterface {
    protected $params = Array();
    protected $id;
...
class SwiftPageBuilderElementButton implements SwiftPageBuilderTemplateInterface {
    protected $params = Array();
    protected $base;
...
class SwiftPageBuilderTemplateMenu implements SwiftPageBuilderTemplateInterface {
    protected $params = Array();
    ...
    public function output( $post = null ) {
        ...
        foreach($this->params as $id => $template) {
            if( is_array( $template) ) {
                $template_button = new SwiftPageBuilderTemplateMenuButton();
...
class SwiftPageBuilderTemplate_r extends SwiftPageBuilderAbstract {

    protected $templates = Array();

    public function getMenu() {
        $template_menu = new SwiftPageBuilderTemplateMenu();
...
class SwiftPageBuilderNavBar implements SwiftPageBuilderTemplateInterface {
    ...
    public function getColumnLayouts() {
        ...
        foreach ( WPBMap::getLayouts() as $layout ) {
            $layout_button = new SwiftPageBuilderLayoutButton();
    ...
    public function getContentLayouts() {
        ...
        foreach (WPBMap::getShortCodes() as $sc_base => $el) {
            $element_button = new SwiftPageBuilderElementButton();
    ...
    public function getTemplateMenu() {
        $template_r = new SwiftPageBuilderTemplate_r();
...
class SwiftPageBuilderLayout implements  SwiftPageBuilderTemplateInterface {
    protected $navBar;
    public function __construct() {

    }
    public function getNavBar() {
        if($this->navBar==null) $this->navBar = new SwiftPageBuilderNavBar();
        return $this->navBar;
    }
