...
if ( ! empty( $tabs ) ) : ?>
    ...
    <?php if(isset($edgt_options['woo_products_info_style']) && ($edgt_options['woo_products_info_style'])=="vertical_tabs"){?>
		<div class="edgt_tabs vertical tab_with_text left woocommerce-tabs">
