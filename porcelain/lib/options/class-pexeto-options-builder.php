...
class PexetoOptionsBuilder extends PexetoWidgetsBuilder{
	...
	public function print_heading() {
		...
		echo '</ul></div></div><div id="content" class="content-loading"><div id="header"><h3 id="theme_name">'.$this->themename.' v.'.$this->pexeto_version.'</h3><a class="more-button" href="http://themeforest.net/user/pexeto/portfolio">More Pexeto Themes &rarr;</a></div><div id="options_container">';
	}
