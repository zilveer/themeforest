...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <div class="entry-main-content">
	 <div class="entry-main-header">
		...
		?>
        <div class="entry-meta"> <span class="post-format"> <a class="entry-format" href="<?php echo esc_url( get_post_format_link( 'aside' ) ); ?>"><?php echo get_post_format_string( 'aside' ); ?></a> </span>
