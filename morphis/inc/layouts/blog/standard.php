		...
		<div class="three columns alpha clearfix">
			<ul class="entry-meta meta1 clearfix">
				...
				<li><img src="<?php echo get_template_directory_uri() . '/images/icons/glyphish/179-notepad.png'; ?>" class="post-format-icon" title="Standard Post Format"/></li>
				<?php endif; ?>
					...
					<?php if($featured_url != ''): ?>
						<div class="overlay squared half-bottom">
							<figure>								
								...
								<a class="icon-link" href="<?php the_permalink(); ?>" title="<?php _e( 'view post', 'morphis' ); ?>"></a>
								<a href="<?php the_permalink(); ?>" title="<?php echo $thumb_title; ?>">
									<img src="<?php echo $featured_url; ?>" alt="<?php echo $alt_text; ?>" title="<?php echo $thumb_title; ?>" class="full-pic-width" />
								</a>														
							</figure>
						</div>
					<?php endif; ?>
