...
.login label, .login form .input, .login input[type="text"], .ywsl-label {
...
<?php if( yit_get_option('splash-logo_image') ): $upload_dir = wp_upload_dir(); ?>
.login h1 a {
	...
	width: <?php echo yit_get_option('splash-container_width') ?>px;
	height: <?php echo yit_get_option('splash-logo_height') ?>px;
	float: left;
	margin-bottom: 0;
	padding-bottom: 15px;
}
