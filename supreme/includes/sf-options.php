...
//    );
    ...
    $args['opt_name'] = 'sf_supreme_options';
    ...
    // Default: Options
    $args['menu_title'] = __('Supreme Options', Redux_TEXT_DOMAIN);

    // Set a custom page title for the options page.
    // Default: Options
    $args['page_title'] = __('Supreme Theme Options', Redux_TEXT_DOMAIN);
    ...
    $sections[] = array(
    				...
    				'fields' => array(
    					array(
    						...
    						'sub_desc' => __('If enabled, the top bar will show with the menu on the left and social config on the right.', Redux_TEXT_DOMAIN),
    						'desc' => '',
    						'options' => array('1' => 'On','0' => 'Off'),
    						'std' => '1'
    						),
    					array(
    						...
    						'desc' => '',
    						'std' => "[social size='small' type='facebook,twitter,vimeo,youtube,dribbble' style='light']"
    						),
    					array(
    						'id' => 'logo_layout',
    						'type' => 'radio_img',
    					...
    					array(
    						'id' => 'header_ad_config',
    						'type' => 'textarea',
    						'title' => __('Header Advert Space', Redux_TEXT_DOMAIN),
    						'sub_desc' => "This box can be used to place in advert HTML / Shortcode, or text if you would prefer.",
    						'desc' => '',
    						'std' => ""
    						),
    					array(
    ...
    $sections[] = array(
    				...
    				'fields' => array(
    					...
    					array(
    						...
    						'desc' => '',
    						'std' => "&copy;[the-year] Supreme &middot; Built by <a href='http://www.swiftideas.net'>Swift Ideas</a> &middot; Powered by [wp-link]"
    						),
    					array(
    						'id' => 'show_backlink',
    						'type' => 'button_set',
	...
	$sections[] = array(
				'icon' => 'bullhorn',
				'icon_class' => 'icon-large',
				'title' => __('News Ticker Options', Redux_TEXT_DOMAIN),
				'desc' => __('<p class="description">These are the options for the news ticker which can be included at the top of created pages.</p>', Redux_TEXT_DOMAIN),
				'fields' => array(
					array(
						'id' => 'news_ticker_category',
						'type' => 'select',
						'title' => __('News Ticker Category', Redux_TEXT_DOMAIN),
						'sub_desc' => "Select the category for which the news ticker should show posts from.",
					...
					array(
						...
						'type' => 'text',
						'title' => __('Number of items to show', Redux_TEXT_DOMAIN),
						'sub_desc' => "The number of posts to show in the news ticker.",
						'desc' => '',
						'validate' => 'numeric',
						'std' => '10',
						'class' => 'mini'
   	...
   	$sections[] = array(
   					'icon' => 'star',
   					'icon_class' => 'icon-large',
   					'title' => __('Review Options', Redux_TEXT_DOMAIN),
   					'desc' => __('<p class="description">These are the options for the reviews within posts.</p>', Redux_TEXT_DOMAIN),
   					'fields' => array(
   						array(
   							'id' => 'review_format',
   							'type' => 'select',
   							'title' => __('Review Point Format', Redux_TEXT_DOMAIN),
   						...
   						array(
   							'id' => 'review_cat_1',
   							'type' => 'text',
   							'title' => __('Default Review Category 1', Redux_TEXT_DOMAIN),
   						...
   						array(
   							'id' => 'review_cat_2',
   							'type' => 'text',
   							'title' => __('Default Review Category 2', Redux_TEXT_DOMAIN),
   						...
   						array(
   							'id' => 'review_cat_3',
   							'type' => 'text',
   							'title' => __('Default Review Category 3', Redux_TEXT_DOMAIN),
   						...
   						array(
   							'id' => 'review_cat_4',
   							'type' => 'text',
   							'title' => __('Default Review Category 4', Redux_TEXT_DOMAIN),
    ...
    $sections[] = array(
   	...
   	$sections[] = array(
   					'icon' => 'comments-alt',
   					'icon_class' => 'icon-large',
   					'title' => __('Disqus Options', Redux_TEXT_DOMAIN),
   					'desc' => __('<p class="description">These are the options for the using the Disqus commenting system. If you would like to use it, please make sure you have it installed and activated.</p>', Redux_TEXT_DOMAIN),
   					'fields' => array(
   						array(
   							'id' => 'use_disqus',
   							'type' => 'button_set',
   							'title' => __('Use Disqus', Redux_TEXT_DOMAIN), 
   							'sub_desc' => __('Select this if you would like to use Disqus for comments on posts.', Redux_TEXT_DOMAIN),
   							'desc' => '',
   							'options' => array('1' => 'On','0' => 'Off'),
   							'std' => '0'
   							),
   						array(
   							'id' => 'disqus_shortname',
   							'type' => 'text',
   							'title' => __('The Disqus shortname', Redux_TEXT_DOMAIN),
   							'sub_desc' => "The unique identifier which you choose when setting up Disqus",
   							'desc' => '',
   							'std' => ''
   							)
   						)
    ...
    $tabs['documentation'] = array(
    				...
    				'content' => '<p>Documentation for Supreme is available here <a href="http://supreme.swiftideas.net/documentation/" target="_blank">here</a>.</p>'
    				);
    ...
    $tabs['support'] = array(
    				...
    				'content' => '<p>If you need support for Supreme, please visit our support site <a href="http://support.swiftideas.net" target="_blank">here</a>.</p>'
    				);				
    ...
    $tabs['translation_plugin'] = array(
    				...
    				'content' => '<p>Supreme is 100% translation and multi-lingual ready, and we recommend that you use the very popular WPML plugin.</p>
    				...
    				<ol>
    					<li>Open the /supreme/languages/ folder and duplicate the en_US.po file, then rename it to your desired language code. For example; for German you need to re-name it as de_DE.po for Spanish es_ES.po for Turkish tr_TR.po etc. You can find all the codes from this link <a href="http://codex.wordpress.org/WordPress_in_Your_Language" target="_blank">http://codex.wordpress.org/WordPress_in_Your_Language</a></li>
