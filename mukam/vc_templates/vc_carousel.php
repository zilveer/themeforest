		...
		if ( ! empty( $data ) )
			foreach ( $data as $block ) {
				...
				if ( $block->name === 'title' ) {
					...
					?>
<div class="carousel-icon"> <a href="<?php echo $post->image_link; ?>" data-rel="prettyPhoto" class="prettyPhoto lightzoom"> <i class="mukam-search"></i> </a> <a href="<?php echo $post->link; ?>" class="postlink"> <i class="mukam-link"></i> </a> </div>
					<?php				
	...
	<div class="wpb_wrapper">
		...
		<div id="<?php echo $carousel_id ?>" data-ride="vc_carousel"
				...
				<div class="vc_carousel-slideline">
					<div class="vc_carousel-slideline-inner">
						...
						<div class="vc_item vc_slide_<?php echo $post->post_type ?>"<?php echo $block_style ?>>
							<div class="vc_inner latest-item">
			...
			<a class="vc_left vc_carousel-control" href="#<?php echo $carousel_id ?>" data-slide="prev">
				<span class="icon-angle-left icon-3x"></span>
			</a>
