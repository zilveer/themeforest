<?php
namespace Hue\Modules\GoogleMap;
...
class GoogleMap implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(
            array(
                'name'                    => esc_html__('Google Map', 'hue'),
                'base'                    => $this->base,
                'category'                => 'by MIKADO',
                ...
                'params'                  => array(
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 1', 'hue'),
                        'param_name'  => 'address1',
                        'admin_label' => true
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 2', 'hue'),
                        'param_name'  => 'address2',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 3', 'hue'),
                        'param_name'  => 'address3',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 4', 'hue'),
                        'param_name'  => 'address4',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Address 5', 'hue'),
                        'param_name'  => 'address5',
                        'admin_label' => true,
                    ...
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Custom Map Style', 'hue'),
                        ...
                        'save_always' => true,
                        'description' => esc_html__('Enabling this option will allow Map editing', 'hue')
                    ),
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Frame', 'hue'),
                    ...
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => esc_html__('Color Overlay', 'hue'),
                        'param_name'  => 'color_overlay',
                        'description' => esc_html__('Choose a Map color overlay', 'hue'),
                        'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Saturation', 'hue'),
                        'param_name'  => 'saturation',
                        'description' => esc_html__('Choose a level of saturation (-100 = least saturated, 100 = most saturated)', 'hue'),
                        'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Lightness', 'hue'),
                        'param_name'  => 'lightness',
                        'description' => esc_html__('Choose a level of lightness (-100 = darkest, 100 = lightest)', 'hue'),
                        'dependency'  => Array('element' => 'custom_map_style', 'value' => array('true'))
                    ),
                    array(
                        'type'        => 'attach_image',
                        'heading'     => esc_html__('Pin', 'hue'),
                        'param_name'  => 'pin',
                        'description' => esc_html__('Select a pin image to be used on Google Map', 'hue')
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => esc_html__('Map Zoom', 'hue'),
                        'param_name'  => 'zoom',
                        'description' => esc_html__('Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)', 'hue')
                    ),
                    array(
                        'type'        => 'dropdown',
                        'heading'     => esc_html__('Zoom Map on Mouse Wheel', 'hue'),
                        ...
                        'save_always' => true,
                        'description' => esc_html__('Enabling this option will allow users to zoom in on Map using mouse wheel', 'hue')
                    ),
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__('Map Height', 'hue'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = hue_mikado_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
