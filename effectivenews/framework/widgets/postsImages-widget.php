...
class mom_widget_posts_images extends WP_Widget {
	function mom_widget_posts_images() {
		...
		parent::__construct('momizatPostsImages',__('Effective - Posts in Images','theme'),$widget_ops);
...
?>
		...
		?>
			...
			<?php if (mom_post_image() != false) { ?>
				 <li><a href="<?php the_permalink(); ?>" class="simptip-position-top simptip-movable" data-tooltip="<?php the_title(); ?>"><img src="<?php echo mom_post_image('small-wide'); ?>" data-hidpi="<?php echo mom_post_image('small-wide-hd'); ?>" alt="<?php the_title(); ?>"></a></li>
			<?php } ?>
