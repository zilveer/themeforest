<?php if (comments_open()) : ?>
	...
	<section id="comments">
		...
		<h3 class="comments-meta"><?php comments_open() ? printf(__('Comments (%s)', 'warp'), get_comments_number()) : _e('Comments are closed', 'warp'); ?><span class="article-dash"></span></h3>
		<?php endif; ?>
	...
	<?php endif; ?>
		...
		<div id="respond">
			...
			<h3><?php comment_form_title(__('Leave a comment', 'warp')); ?><span class="article-dash"></span></h3>
