...
//              }          
    ...
    function widget( $args, $instance )
    {
        ...
        $text = '<div class="text-image" style="text-align:'. $instance['align'] .'"><img src="' . $instance['image'] . '" alt="' . $instance['title'] . '" /></div>';

        $clear_text = yit_icl_translate( 'Widgets' , 'yiw' , 'widget_text_' .sanitize_title( $instance['text'] ) , apply_filters( 'widget_text', $instance['text'], $instance )  );
