...
function optionsframework_load_scripts() {
	...
	wp_enqueue_script('media-uploader', OPTIONS_FRAMEWORK_DIRECTORY.'js/of-medialibrary-uploader.js', array('jquery'));
	wp_enqueue_script('options-custom', OPTIONS_FRAMEWORK_DIRECTORY.'js/options-custom.js', array('jquery'));
wp_enqueue_script('uislider', OPTIONS_FRAMEWORK_DIRECTORY.'js/uislider.js', array('jquery'));
wp_enqueue_script('quicktip-script', OPTIONS_FRAMEWORK_DIRECTORY.'js/quicktip_script.js', array('jquery'));
wp_enqueue_script('jqueryUI', OPTIONS_FRAMEWORK_DIRECTORY.'/js/jquery-ui-1.8.14.custom.min.js', array('jquery'), '1.8.14', false);
      ...
      <form action="options.php" method="post">
         ...
         <div id="header">
            <div id="header_left">
			 ...
			 <a href="http://wizedesign.com" target="_blank"><div class="logo"></div></a>
         </div>
         <div class="clear"></div>
         <div id="main">
         ...
         <div class="of_admin_bar">
            <div id="bottom_left">
               <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'wizedesign' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'wizedesign' ) ); ?>' );" />
            </div>
            <div id="bottom_right">
               <input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'wizedesign' ); ?>" />
            </div>
         </div>
         <div class="clear"></div>
      </form>
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
		'parent' => 'appearance',
		'id' => 'of_theme_options',
		'title' => __( 'Theme Options', 'clubber'),
