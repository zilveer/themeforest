...
<?php 
    ...
    $main_column_class = ($canon_options_post['use_buddypress_sidebar'] == "checked") ? "col-3-4" : "col-1-1";
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class="outter-wrapper body-wrapper">       
            <div class="wrapper clearfix">
                ...
                <!-- SIDEBAR -->
                <?php if ($canon_options_post['use_buddypress_sidebar'] == "checked") { get_sidebar('buddypress'); } ?> 
