...
<div class="inner">
	...
	?>
	<div class="one_fourth <?php echo $last_class; ?> portfolio4_wrapper">
	<div class="one_fourth gallery4 portfolio_type <?php echo $last_class; ?>">
		<?php 
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_item->ID; ?>" class="portfolio_desc portfolio4 <?php echo $last_class; ?>">
            <h7 class="cufon"><?php echo $portfolio_item->post_title; ?></h7>
        </div>
	</div>
	<?php
		}
