...
class wm_customize
{
    ...
    public function live_preview()
    {
        if(AWE_DEBUG==true)
            ...
            $min="";
        wp_enqueue_script(
            'wm-customizer', get_template_directory_uri() . '/assets/customize/js/livepreview'.$min.'.js', array(  'jquery', 'customize-preview' ),'',true );
    ...
    public function loading_script()
    {
        if(AWE_DEBUG==true)
            ...
            $min="";
        wp_enqueue_script( 'wm-customizer-js', get_template_directory_uri().'/assets/customize/js/customizer'.$min.'.js', array(), null, true);
        wp_dequeue_script( 'jquery-ui');
        wp_enqueue_style(  'wm-customizer-styles', get_template_directory_uri() . '/assets/customize/css/customizer.css');
    }
    ...
    public function begin_sub_section($section,$id,$label,$priority,$name='')
    {
    ...
    {   
        ...
        $this->begin_sub_section('awe_theme_intro_screen',"intro_data_settings",__('Data Settings',LANGUAGE),1,"intro-data-settings");
        ...
        $this->end_sub_section('awe_theme_intro_screen','intro_data_settings',__('Background Settings',LANGUAGE),3);

        /* Introduction Background settings */
        $this->begin_sub_section('awe_theme_intro_screen',"intro_background_settings",__('Background Settings',LANGUAGE),21,"intro-background-settings");
        ...
        $this->end_sub_section('awe_theme_intro_screen','intro_background_settings',__('Background Settings',LANGUAGE),23);
        ####### NAVIGATION ##########

        ######## BLOG HEADER SETTINGS #########
        $wp_customize->add_section('awe_theme_blog_header', array(
            'title'    => __('Blog header Screen', LANGUAGE),
            'priority' => 3,
        ));

        $this->begin_sub_section('awe_theme_blog_header',"blog_data_settings",__('Data Settings',LANGUAGE),1,"blog-data-settings");
        ...
        $this->wp_customize->add_control(new Introduction_Info($this->wp_customize, $name_option.'[blog_data]',array(
            ...
            'label' => 'Blog Header Info',
            'section' => 'awe_theme_blog_header',
            'priority'   => 3,
        )));
        $this->wp_customize->get_setting( $name_option.'[blog_data]' )->transport = 'postMessage';
        $this->end_sub_section('awe_theme_blog_header','blog_data_settings',__('Background Settings',LANGUAGE),3);

        /* Introduction Background settings */
        $this->begin_sub_section('awe_theme_blog_header',"blog_background_settings",__('Background Settings',LANGUAGE),21,"blog-background-settings");
        ...
        $this->wp_customize->add_control(new Introduction_Background_Blog($this->wp_customize, $name_option.'[blog_bg_data]',array(
        ...
        $this->end_sub_section('awe_theme_intro_screen','intro_background_settings',__('Background Settings',LANGUAGE),23);
        ####### NAVIGATION ##########
        $wp_customize->add_section('awe_theme_navigation', array(
            'title'    => __('Navigation Settings', LANGUAGE),
            'priority' => 3,
        ));
        ...
        //     'logo-center'  =>  'Style 1',
        //     'fixTop'  =>  'Style 2',
        //     'logo-center fixTop'   =>  'Style 3',

        // );

        // $wp_customize->add_setting($name_option.'[nav_style]', array(
        //     'default'           => $options['nav_style'],
        //     'capability'        => 'edit_theme_options',
        //     'type'              => 'option',

        // ));
        // $wp_customize->add_control($name_option.'[nav_style]', array(
        //     'label'    => __('Choose Style', LANGUAGE),
        //     'section'  => 'awe_theme_navigation',
        //     'settings' => $name_option.'[nav_style]',
        //     'type'    => 'select',
        //     'choices' => $nav_options,
        //     'priority'  =>  5,
        // ));
        // $this->wp_customize->get_setting( $name_option.'[nav_style]' )->transport = 'postMessage';
        ...
        /* Section Order */
        $this->begin_sub_section('awe_theme_section_settings',"sort_section_subtitle",__('Section Order',LANGUAGE),1);
        $this->add_description('awe_theme_section_settings','sort_section_desc',__('Change position display of each section as you want',LANGUAGE),2);
        ...
        $wp_customize->add_control( new Sortable_Section_Control($wp_customize, 'sort_section', array(
            ...
            'section'  => 'awe_theme_section_settings',
            'settings' => $name_option.'[sort_section]',
            'priority'   => 2,
        )));
        $wp_customize->get_setting( $name_option.'[sort_section]' )->transport = 'postMessage';
        $this->end_sub_section('awe_theme_section_settings','sort_section_subtitle',__('Section Order',LANGUAGE),3);
        ...
        foreach($headlines as $headline)
            ...
            /* Section */
                if($headline == 'idea'){
                    $this->begin_sub_section('awe_theme_section_settings',"section_".$headline,__(ucwords('Process'),LANGUAGE),$count++,$headline);
                }else{
                    $this->begin_sub_section('awe_theme_section_settings',"section_".$headline,__(ucwords($headline),LANGUAGE),$count++,$headline);
                }
                $count++;
                /* Display or not*/
                ...
                if(isset($options["{$headline}"]["display"])){
                    ...
                    $wp_customize->get_setting( "{$name_option}[{$headline}][display]" )->transport = 'refresh';
                ...
                if(isset($options["{$headline}"]["header"]) && $headline != 'twitter')
                    $this->add_sub_title('awe_theme_section_settings','header_'.$headline.'_subtitle',__('Header Settings',LANGUAGE),$count++);
                /* Header */
                if(isset($options["{$headline}"]["header"]["enable"]) && $headline != 'twitter'){
                ...
                if(isset($options["{$headline}"]["header"]["style"]) && $headline != 'twitter'){
                    $wp_customize->add_setting (
                ...
                /* Header Title */
                if(isset($options["{$headline}"]["header"]["title"]) && $headline != 'twitter'){
                    $wp_customize->add_setting (
                ...
                if(isset($options["{$headline}"]["content"]))
                    $this->add_sub_title('awe_theme_section_settings','content_'.$headline.'_subtitle',__('Content Settings',LANGUAGE),$count++);
                ...
                if(isset($options["{$headline}"]["content"]["style"]) && $headline != 'pricing'){
                    $wp_customize->add_setting (
                ...
                if(isset($options["{$headline}"]['button']))
                {
                    if(isset($options["{$headline}"]['button']['label'])){
                        $this->add_sub_title('awe_theme_section_settings',$headline.'_button',__('Button Settings',LANGUAGE),$count++);
                        $wp_customize->add_setting (
                ...
                //============== footer ===============//
                //var_dump($options[$headline]['footer']);
                if(isset($options["{$headline}"]['footer'])){
                    $this->add_sub_title('awe_theme_section_settings','footer_'.$headline.'_subtitle',__('Footer Settings',LANGUAGE),$count++);
                    ...
                    //======== Footer style ===========//
                    // if(isset($options["{$headline}"]["footer"]["style"])) :
                    // $wp_customize->add_setting("{$name_option}[{$headline}][footer][style]",array(
                    //     'default' => $options["{$headline}"]["footer"]["style"],
                    //     'capability' => 'edit_theme_options',
                    //     'type' => 'option'
                    // ));
                    // $wp_customize->add_control(
                    //     "{$name_option}[{$headline}][footer][style]",
                    //     array(
                    //         'label' => 'Footer Style',
                    //         'section' => 'awe_theme_section_settings',
                    //         'type' => 'select',
                    //         'choices' => $options[$headline]['footer']['style_options'],
                    //         'settings' => "{$name_option}[{$headline}][footer][style]",
                    //         'priority' => $count++,
                    // ));
                    // $wp_customize->get_setting( "{$name_option}[{$headline}][footer][style]" )->transport = 'postMessage';
                    // endif;
                ...
                if(isset($options["{$headline}"]["parallax"])){
                    $this->add_sub_title('awe_theme_section_settings','parallax_'.$headline.'_subtitle',__('Parallax Settings',LANGUAGE),$count++);
                ...
                if(isset($options["{$headline}"]["overlay"])){
                    ...
                    $this->add_sub_title('awe_theme_section_settings','overlay_'.$headline.'_subtitle',__('Overlay Settings',LANGUAGE),$count++);
                ...
                $this->end_sub_section('awe_theme_section_settings','sub_section_'.$headline.'',__(ucwords($headline),LANGUAGE),$count++);
...
if (class_exists('WP_Customize_Control'))
{
        ...
        public function render_content()
        {
            ...
            <label class="select-number-items-slider" <?php if($values['enable']==0):?> style="display: none"<?php endif;?>>
                ...
                <select class="number-items-slider">
                    <?php for($i=1;$i<6;$i++):?>
                    <option <?php selected($values['num'],$i);?> value="<?php echo $i;?>"><?php echo $i;?></option>
                    <?php endfor;?>
                </select>
                <br>
            </label>
    ...
    class Parallax_Input_hidden extends WP_Customize_Control{
        public $type = 'parallax-input';
        public $name;

        public function render_content() {
            ?>
            <label class="<?php echo $this->name;?>">
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <div class="awe-style-color-custom <?php if($options['style_color']=='custom'):?>choose<?php endif;?>">
                    <input type="text" class="<?php if($this->class) echo $this->class;else echo 'style-color-custom-picker';?>" <?php $this->link(); ?> value="<?php echo $this->value(); ?>">
                </div>
    ...
    class AWE_Theme_Default_Style_Color_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <input class="awe-style-color" type="hidden" style="width:100%;" <?php $this->link(); ?> value="<?php echo $this->value(); ?>">
            </label>
        <?php
        }
    }
        ...
        public function render_content()
        {
            ...
            <label>
                ...
                <ul id="sortable">
                    ...
                    <li class="ui-state-default" data-name="<?php echo $section;?>"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span><?php echo ucwords($section);?></li>
                                <?php endforeach;?>

                </ul>
                <a class="section-order-reset" href="#">Reset Order</a>
                <input type="hidden" class="section-order" style="width:100%;" <?php $this->link(); ?> value="<?php echo $this->value(); ?>">
            </label>
                    ...
                    <?php foreach($styles as $group=>$animates):?>
                        <optgroup label="<?php echo $group;?>">
                          <?php foreach($animates as $animate):?>
                              <option <?php selected($animate,$this->value());?> value="<?php echo $animate;?>"><?php echo $animate;?></option>
                          <?php endforeach;?>
                        </optgroup>
                    <?php endforeach;?>
                </select>
