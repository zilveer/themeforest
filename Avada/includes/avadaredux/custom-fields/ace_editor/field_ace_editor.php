			...
			public function enqueue() {
				if ( ! wp_style_is( 'avadaredux-field-ace-editor-css' ) ) {
					wp_enqueue_style(
						...
						trailingslashit( get_template_directory_uri() ) . 'includes/avadaredux/custom-fields/ace_editor/field_ace_editor.css',
						array(),
						false,
						'all'
					);
				...
				if ( ! wp_script_is( 'ace-editor-js' ) ) {
					wp_enqueue_script(
						'ace-editor-js',
						trailingslashit( get_template_directory_uri() ) . 'includes/avadaredux/custom-fields/ace_editor/ace.js',
						array( 'jquery' ),
						false,
						true
					);
				...
				if ( ! wp_script_is( 'avadaredux-field-ace-editor-js' ) ) {
					wp_enqueue_script(
						...
						trailingslashit( get_template_directory_uri() ) . 'includes/avadaredux/custom-fields/ace_editor/field_ace_editor.js',
