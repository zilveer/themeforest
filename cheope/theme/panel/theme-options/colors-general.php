...
function yit_container_background_style( $array ) {
    $array['selectors'] = '.boxed #wrapper, .faq-title, .faq-item, .faq-title.active, ul.products li.product.grid .product-thumbnail';    
    return $array;
}
