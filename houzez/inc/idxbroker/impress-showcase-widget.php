...
class Impress_Showcase_Widget extends \WP_Widget
{
    ...
    public function __construct(\IDX\Idx_Api $idx_api)
    {
        ...
        parent::__construct(
            ...
            'HOUZEZ: IMPress Property Showcase', // Name
            array(
        ...
        if (true == $instance['use_rows']) {
            ...
            switch ($number_columns) {
                case 0:
                    ...
                    $column_class = 'col-lg-12 col-sm-12';
                    break;
                case 1:
                    /*$column_class = 'columns small-12 large-12';*/
                    $column_class = 'col-lg-12 col-sm-12';
                ...
                case 2:
                    ...
                    $column_class = 'col-sm-12 col-md-6 col-lg-6';
                    break;
                case 3:
                    /*$column_class = 'columns small-12 medium-4 large-4';*/
                    $column_class = 'col-sm-12 col-md-4 col-lg-4';
                    break;
                case 4:
                    /*$column_class = 'columns small-12 medium-3 large-3';*/
                    $column_class = 'col-sm-12 col-md-3 col-lg-3';
                    break;
            }
        }
    ...
    public function widget($args, $instance)
    {
        ...
        if (empty($instance)) {
            $instance = $instance = $this->defaults;
        }
    ...
    <?php }?>
        ...
        <p>
            ...
            <select class="widefat" id="<?php echo $this->get_field_id('listings_per_row');?>" name="<?php echo $this->get_field_name('listings_per_row')?>">
                <option <?php selected($instance['listings_per_row'], '1');?> value="1">1</option>
