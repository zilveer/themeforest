 ...
 */
 ...
 jQuery(document).ready(function(){
	...
	jQuery("input.upload-font-button").click(function(){
		...
		font_name_box = jQuery(this).parents('#font-item').find("#bkp_upload_font");
	...
	//background combobox
	jQuery('#bkp_background_style').change(function(){
		if(jQuery(this).val() == 'Pattern'){
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_pattern').slideDown();
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_custom').slideUp();
		}else if(jQuery(this).val() == 'Custom Image'){
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_pattern').slideUp();
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_custom').slideDown();		
		}else{
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_pattern').slideUp();
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_custom').slideUp();
		}
	});
	jQuery('#bkp_background_style').each(function(){
		if(jQuery(this).val() == 'Pattern'){
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_pattern').css('display','block');
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_custom').css('display','none');
		}else if(jQuery(this).val() == 'Custom Image'){         
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_pattern').css('display','none');
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_custom').css('display','block');		
		}else{                                                  
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_pattern').css('display','none');
			jQuery(this).parents('.panel-body').siblings('.body-bkp_background_custom').css('display','none');
		}
