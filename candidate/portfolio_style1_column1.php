<?php
// Template Name: MediaSortable Column1
?>
		...
		<section class="section full-width-bg gray-bg">
			...
			<div class="row">
				...
				<?php if ( have_posts() ) while ( have_posts() ) : the_post(); 
					...
					<!-- media Post -->
					<div class="col-lg-12 col-md-12 col-sm-12 mix <?php echo esc_attr($category); ?>" data-nameorder="<?php echo esc_attr($title1); ?>" data-dateorder="<?php  echo esc_attr($post->post_date); ?>">
						...
						$des = candidat_get_the_excerpt_max_charlength(40); 
