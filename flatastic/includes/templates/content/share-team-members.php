...
if (!mad_custom_get_option('share-team-members-enable'))
	return;
...
<div class="share-links-wrapper v_centered">
	...
	<div class="share-links">
		...
		<?php if (mad_custom_get_option('share-team-members-facebook')): ?>
			<a href="http://www.facebook.com/sharer.php?m2w&amp;s=100&amp;p&#091;url&#093;=<?php echo $permalink ?>&amp;p&#091;images&#093;&#091;0&#093;=<?php echo $image ?>&amp;p&#091;title&#093;=<?php echo $title ?>" <?php echo $extra_attr ?> title="<?php esc_html_e('Facebook', 'flatastic') ?>" class="share-facebook"><?php esc_html_e('Facebook', 'flatastic') ?></a>
		<?php endif; ?>

		<?php if (mad_custom_get_option('share-team-members-twitter')): ?>
		...
		<?php if (mad_custom_get_option('share-team-members-linkedin')): ?>
		...
		<?php if (mad_custom_get_option('share-team-members-googleplus')): ?>
		...
		<?php if (mad_custom_get_option('share-team-members-pinterest')): ?>
		...
		<?php if (mad_custom_get_option('share-team-members-vk')): ?>
		...
		<?php if (mad_custom_get_option('share-team-members-tumblr')): ?>
		...
		<?php if (mad_custom_get_option('share-team-members-reddit')): ?>
			<a href="http://www.reddit.com/submit?url=<?php echo $permalink ?>&amp;title=<?php echo $title ?>" <?php echo $extra_attr ?> title="<?php _e('Reddit', 'flatastic') ?>" class="share-reddit"><?php _e('Reddit', 'flatastic') ?></a>
		<?php endif; ?>

		<?php if (mad_custom_get_option('share-team-members-xing')): ?>
