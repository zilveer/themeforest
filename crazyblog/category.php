...
$title = (crazyblog_set( $general_settings, 'cat_page_title' )) ? crazyblog_set( $general_settings, 'cat_page_title' ) : "";
$bg = (crazyblog_set( $general_settings, 'cat_title_section_bg' )) ? 'background: url(' . crazyblog_set( $general_settings, 'cat_title_section_bg' ) . ')' : "";

$show_banner = (crazyblog_set( $general_settings, 'cat_page_title_section' )) ? crazyblog_set( $general_settings, 'cat_page_title_section' ) : crazyblog_set( $general_settings, 'cat_page_title_section' );
$sidebar = (crazyblog_set( $general_settings, 'cat_page_sidebar' )) ? crazyblog_set( $general_settings, 'cat_page_sidebar' ) : "";
$layout = (crazyblog_set( $general_settings, 'cat_sidebar_layout' )) ? crazyblog_set( $general_settings, 'cat_sidebar_layout' ) : "";
$cols = ($layout != "full" && $sidebar ) ? "col-md-8" : 'col-md-12';
$limit = crazyblog_set( $general_settings, 'cat_character_limit' );
...
<?php if ( $show_banner ) : ?>
	<div class="pagetop" style="<?php echo esc_attr( $bg ); ?>">
		<div class="page-name">
			<div class="container">
				<span><?php echo esc_html( $wp_query->queried_object->name ); ?></span>
						...
						<div class="texty-style">
							<div class="masonary">
								...
								if ( have_posts() ) : while ( have_posts() ) : the_post();
										...
										$innter_col = ($format == 'gallery') ? 'col-md-12' : crazyblog_set( $general_settings, 'cat_post_column' );
										$gridCol = crazyblog_set( $general_settings, 'cat_post_column' );
										...
										<div class="<?php echo esc_attr( $innter_col ) ?>">
											...
											<div <?php post_class( 'texty-post ' . $no_image ); ?>>
												<div class="texty-post-img">
														...
														if ( !empty( $gal_ids ) ) {
															...
															if ( count( $ids ) > 0 ) {
																...
																foreach ( $ids as $id ) {
																	...
																	echo '<img src = "' . crazyblog_set( $src, '0' ) . '" alt = "" />';
																}
																echo '</div>';
													...
													<?php if ( crazyblog_set( $general_settings, 'cat_post_author' ) == 'show' ) : ?>
												...
												<div class="texty-post-detail">
													<?php if ( crazyblog_set( $general_settings, 'cat_post_category' ) == 'show' ) : ?>
														<div class="categories">
															<?php echo crazyblog_get_post_categories( get_the_ID() ); ?>
														</div>
													<?php endif; ?>
													<h2><a title="" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
													<?php if ( crazyblog_set( $general_settings, 'cat_post_date' ) == 'show' || crazyblog_set( $general_settings, 'cat_post_author' ) == 'show' ) : ?>
														<ul class="meta">
															<?php if ( crazyblog_set( $general_settings, 'cat_post_date' ) == 'show' ) : ?>
													...
													<?php if ( crazyblog_set( $general_settings, 'cat_post_comments' ) == 'show' || crazyblog_set( $general_settings, 'cat_post_view' ) == 'show' || crazyblog_set( $general_settings, 'cat_post_social_share' ) == 'show' ) : ?>
														<div class="post-info">
															<?php if ( crazyblog_set( $general_settings, 'cat_post_comments' ) == 'show' ) : ?>
																<span class="view"><i class="fa fa-comments"></i><span><?php echo crazyblog_restyle_text( get_comments_number( get_the_ID() ) ) ?></span></span>
															<?php endif; ?>
															<?php if ( crazyblog_set( $general_settings, 'cat_post_view' ) == 'show' ) : ?>
																<span class="view"><i class="fa fa-eye"></i><span><?php echo crazyblog_restyle_text( $view ) ?></span></span>
															<?php endif; ?>
															<?php if ( crazyblog_set( $general_settings, 'cat_post_social_share' ) == 'show' ) : ?>
																<span>
