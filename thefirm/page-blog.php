...
?>
	<?php if ($eet_option['eetcnt_blog'] == 'Navigation with Arrows' ) { ?>
		<img src="<?php echo get_template_directory_uri(); ?>/images/loader2.gif" alt="Loading..." class="loaderblog lblgtop" />
...
<?php } ?>
	...
	<div class="postwrap"><div id="post-<?php the_ID(); ?>" <?php post_class(); ?> ></div>
		...
		<?php $thumb = get_post_thumbnail_id(); $image = vt_resize( $thumb,'' , 240, 175, true ); ?>
			...
			<div class="postcontentshort">
				<div class="postcontentwrap">
					...
					<span><?php the_time('M j, Y') ?></span><span> &#124; <?php the_author(); ?></span><span> &#124; <?php the_category(', ') ?></span><span> &#124; <?php comments_number('No Comments','1 Comment','% Comments'); ?> </span>
