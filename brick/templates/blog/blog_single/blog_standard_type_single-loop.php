...
if (isset($qode_options['enable_social_share'])&& ($qode_options['enable_social_share']) =="yes"){
    if (isset($qode_options['post_types_names_post'])&& $qode_options['post_types_names_post'] =="post"){
        if (isset($qode_options['blog_single_show_social_share'])) {
...
if (isset($qode_options['blog_single_show_ql_icon'])) {
    $blog_show_ql_icon = $qode_options['blog_single_show_ql_icon'];
}
                 ...
                 <div class="post_text">
                    <div class="post_text_inner">         
						...
						<?php if($blog_show_author == "yes" || $blog_show_date == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>	
							<div class="post_info">
								<?php qode_post_info(array('date' => $blog_show_date, 'author' => $blog_show_author, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like));
			...
			<div class="post_content_holder">				
                ...
                <div class="post_text">
                    <div class="post_text_inner">
						...
						<?php
							the_content();
							if(isset($qode_options['blog_single_show_social_share']) && $qode_options['blog_single_show_social_share'] == "yes" && $blog_social_share_type == "list") {
							echo do_shortcode('[no_social_share_list]'); // XSS OK
						}; ?>		
                    </div>
                </div>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="post_content_holder">
                <div class="post_text_columns">
					<div class="post_text<?php echo esc_attr($background_image_html_class); ?>" <?php qode_inline_style($background_image_html); ?>>
						<div class="post_text_inner">
