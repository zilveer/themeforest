...
if ( have_posts() ) :
    while ( have_posts() ) : the_post();
        ...
        <div itemprop="description" class="entry entry-content<?php echo $the_content_class; ?>">
            ...
            <?php if( is_single() || is_home() ) { if( !has_post_format('chat') ){ if( bdayh_get_option( 'social_sharing_box_home' ) || bdayh_get_option( 'social_sharing_box' )) { ?>
            ...
            <?php if( is_page() ) { if( bdayh_get_option( 'social_sharing_box_page' ) ) { ?>
