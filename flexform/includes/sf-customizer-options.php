	...
	*/
	...
	function sf_customize_register($wp_customize) {
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'topbar_text_hover_color', array(
			'label'   => __( 'Top Bar Text Hover Color', 'swiftframework' ),
			'section' => 'header_styling',
			'settings'   => 'topbar_text_hover_color',
			'priority'       => 3,
		) ) );
	...
	function sf_customize_preview() {
		...
		wp.customize('accent_color',function( value ) {
			value.bind(function(to) {
				...
				$('#copyright a,.portfolio-item .portfolio-item-permalink,.read-more-link,.blog-item .read-more,.blog-item-details a,.author-link,.comment-meta .edit-link a,.comment-meta .comment-reply a,#reply-title small a,ul.member-contact,ul.member-contact li a,span.dropcap2,.wpb_divider.go_to_top a,.love-it-wrapper .loved,#header-translation p a,.caption-details-inner .details span > a,.caption-details-inner .chart span,.caption-details-inner .chart i,#swift-slider .flex-caption-large .chart i,#swift-slider .flex-caption-large .loveit-chart span,#swift-slider .flex-caption-large a,.ui-tabs .ui-tabs-nav li.ui-tabs-active a,.wpb_accordion .wpb_accordion_section > h3.ui-state-active a,.ui-accordion h3.ui-accordion-header.ui-state-active .ui-icon').css('color', to ? to : '' );
