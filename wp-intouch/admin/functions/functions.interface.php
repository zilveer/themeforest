...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page( THEMENAME, 'InTouch Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
...
function of_ajax_callback() 
{
	...
	elseif ($save_type == 'save')
	{
		...
		ct_generate_options_css($smof_data); //generate static css file		
