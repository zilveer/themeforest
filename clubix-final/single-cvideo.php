    ...
    <div class="container">
        <div class="row">
            <div class="breadcrumb-container clearfix">
                ...
                <!-- BREADCRUMB TITLE -->
                <h1><?php _e('Videos', LANGUAGE_ZONE) ?></h1>
                            ...
                            <div class="filter-container photos-container">
                                ...
                                <?php if ( have_posts() ) : ?>
                                    ...
                                    <?php while ( have_posts() ) : the_post(); ?>
                                        ...
                                        <?php
                                        $images = rwmb_meta( "{$prefix}video_gallery", array('type' => 'image_advanced', 'size' => 'album_list_1') );
                                        ...
                                        foreach($images as $image):
                                            ...
                                            <article class="<?php echo $album_class; ?>">
                                                <figure>
                                                    <a href="<?php echo $video_url; ?>" rel="prettyPhoto[gallery]" class="back-face">
                                                        <h5>
