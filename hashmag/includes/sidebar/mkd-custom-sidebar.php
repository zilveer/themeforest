...
if (!class_exists('HashmagMikadoSidebar')) {

    class HashmagMikadoSidebar
    {
        ...
        function __construct() {
            ...
            $this->title = esc_html__('Custom Widget Area', 'hashmag');
        ...
        function template_add_widget_field() {
            ...
            echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__('Enter Name of the new Widget Area', 'hashmag') . "' name='mkd-add-widget' /></span>";
            echo "\n    <input class='button' type='submit' value='" . esc_html__('Add Widget Area', 'hashmag') . "' />";
            echo "\n    " . $nonce;
            echo "\n  </form>";
            echo "\n</script>\n";
        }
        ...
        function add_sidebar_area() {
            if (!empty($_POST['mkd-add-widget'])) {
                ...
                $name = rtrim($this->get_name($_POST['mkd-add-widget']));
        ...
        function register_custom_sidebars() {
            ...
            $args = apply_filters('hashmag_mikado_custom_widget_args', $args);
