<?php
/*
Template Name: Revolution Slider Template
*/
?>

<?php get_header(); global $smof_data; ?>
<!-- Main Content Starts HERE -->
<?php $revShortcode = $smof_data['uploaded_favicon']; ?>

<!-- Revolution Slider -->
<?php if ($smof_data['offline_favicon'] && !empty($revShortcode)): ?>
	<?php echo do_shortcode($revShortcode); ?>
<?php endif ?>
