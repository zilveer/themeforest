...
function woothemes_tumblog_uploader_custom_fields($pID,$id,$std,$desc){
    ...
    $uploader .= '&nbsp;<label>'.__('Link to attachment', LANGUAGE_ZONE).'&nbsp;<input type="radio" value="attachment" name="link_to_'.$id.'"'. checked($link_to, 'attachment', false). ' /></label>';
    $uploader .= '&nbsp;<label>'.__('Link to post', LANGUAGE_ZONE).'&nbsp;<input type="radio" value="post" name="link_to_'.$id.'"'. checked($link_to, 'post', false). ' /></label>';
    if ( $href ) 
