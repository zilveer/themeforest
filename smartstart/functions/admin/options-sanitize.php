...
function of_sanitize_code($input) {
	return $input;
}

add_filter( 'of_sanitize_code', 'of_sanitize_code' );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'ss_framework'),
		'repeat-x'  => __('Repeat Horizontally', 'ss_framework'),
		'repeat-y'  => __('Repeat Vertically', 'ss_framework'),
		'repeat'    => __('Repeat All', 'ss_framework'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'ss_framework'),
		'top center'    => __('Top Center', 'ss_framework'),
		'top right'     => __('Top Right', 'ss_framework'),
		'center left'   => __('Middle Left', 'ss_framework'),
		'center center' => __('Middle Center', 'ss_framework'),
		'center right'  => __('Middle Right', 'ss_framework'),
		'bottom left'   => __('Bottom Left', 'ss_framework'),
		'bottom center' => __('Bottom Center', 'ss_framework'),
		'bottom right'  => __('Bottom Right', 'ss_framework')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'ss_framework'),
		'fixed'  => __('Fixed in Place', 'ss_framework')
		);
...
function of_recognized_font_faces() {
	$default = array(
		...
		'GillSans, Calibri, Trebuchet, sans-serif'                                               => 'GillSans',
