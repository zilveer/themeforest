...
-------------------------------------------------------------------------- */
add_shortcode("soundcloud", "wize_soundcloud_shortcode");
/**
 ...
 */
function wize_soundcloud_shortcode($atts, $content = null) {
...
function soundcloud_oembed_params_callback($match) {
    ...
    return 'src="' . esc_url($url['scheme']) . '://' . $url['host'] . $url['path'] . '?' . $query;
}
/**
...
function soundcloud_shortcode_options() {
    if (!current_user_can('manage_options')) {
        wp_die(esc_html__('You do not have sufficient permissions to access this page.', 'wizedesign'));
    }
?>
<div class="wrap">
...
?>" /> (color hex code e.g. ff6699)<br />
    ...
    esc_html_e('Save Changes', 'wizedesign');
?>" />
      </p>
