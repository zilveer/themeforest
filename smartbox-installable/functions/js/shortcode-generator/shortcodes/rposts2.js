desShortcodeMeta={
	attributes:[
		...
		customMakeShortcode: function(b){
			...
			if (b.maxChars != ""){
				return "[rposts2 title='" + b.title + "' categories='" + b.postsCategories + "' total='" + b.total + "' scroller='"+b.rpScroller+"' posts_per_row='"+b.postsPerRow+"' max_chars='"+b.maxChars+"' orderby='" + b.order_by + "' order='" + b.order + "' link_to_blog='"+b.link_to_blog+"' title_to_blog_link='"+b.title_to_blog_link+"' autoplay='"+b.autoplay_enabled+"' autoplay_speed='"+b.autoplay_speed+"']";
			} else {
				return "[rposts2 title='" + b.title + "' categories='" + b.postsCategories + "' total='" + b.total + "' scroller='"+b.rpScroller+"' posts_per_row='"+b.postsPerRow+"' orderby='" + b.order_by + "' order='" + b.order + "' link_to_blog='"+b.link_to_blog+"' title_to_blog_link='"+b.title_to_blog_link+"' autoplay='"+b.autoplay_enabled+"' autoplay_speed='"+b.autoplay_speed+"']";	
			}
