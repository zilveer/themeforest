...
<p>
    <label for="<?php echo $widget->get_field_id('twitter'); ?>"><?php _e('Twitter Username', 'cardealer') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('facebook'); ?>"><?php _e('Facebook Username', 'cardealer') ?>:</label>
