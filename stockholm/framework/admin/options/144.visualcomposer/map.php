...
$visualComposerPage = new QodeAdminPage('19', 'Visual Composer');
...
$visualComposerPage->addChild('panel2', $panel2);
	...
	$panel2->addChild('group5', $group5);
		...
		$group5->addChild('row2', $row2);
			...
			$vc_grid_portfolio_filter_text_transform = new QodeField("selectblanksimple","vc_grid_portfolio_filter_text_transform","","Text Transform","This is some description",$options_texttransform);
			...
			$vc_grid_portfolio_filter_font_style = new QodeField("selectblanksimple","vc_grid_portfolio_filter_font_style","","Font Style","This is some description",$options_fontstyle);
			$row2->addChild("vc_grid_portfolio_filter_font_style",$vc_grid_portfolio_filter_font_style);
			$vc_grid_portfolio_filter_font_weight = new QodeField("selectblanksimple","vc_grid_portfolio_filter_font_weight","","Font Weight","This is some description",$options_fontweight);
