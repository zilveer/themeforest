...
if ( !function_exists( 'morning_records_template_testimonials_3_theme_setup' ) ) {
	add_action( 'morning_records_action_before_init_theme', 'morning_records_template_testimonials_3_theme_setup', 1 );
	function morning_records_template_testimonials_3_theme_setup() {
		morning_records_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 3/', 'morning-records'),
...
// Template output
if ( !function_exists( 'morning_records_template_testimonials_3_output' ) ) {
	function morning_records_template_testimonials_3_output($post_options, $post_data) {
		$show_title = true;
