...
function theme_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'version'            => '4.12.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher.8
    ...
    $config = array(
        'id'           => 'craftsman',             // Unique ID for hashing notices for multiple instances of TGMPA.
