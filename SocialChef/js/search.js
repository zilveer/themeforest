		...
		init : function() {
			...
			$('.add_search_ingredient').on('click', function(e) {
				...
				if (ingredientName.length > 0) {
					...
					$(".added-ingredients").append("<div class='f-row'><input type='text' class='added-ingredient' name='ing[]' value='" + ingredientName + "' /><button id='added_ingredient_" + ingredientIndex + "' class='remove remove_search_ingredient'>-</button></div>");
