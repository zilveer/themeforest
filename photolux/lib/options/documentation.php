...
array(
"type" => "documentation",
"text" => '<p> Please note that there is a detailed documentation 
			that comes with the theme - it includes detailed instructions about how to use and set up 
			every aspect of the theme.</p>
			<div class="doc-btn "><a href="http://pexetothemes.com/docs/photolux/?src=pexpanel" target="_blank"> Access Online Documentation </a></div>
<br/><br/>
