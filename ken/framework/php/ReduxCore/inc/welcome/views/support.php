<div class="wrap about-wrap" xmlns="http://www.w3.org/1999/html">
    <h1><?php _e( 'Redux Framework - Support', 'mk_framework' ); ?></h1>

    <div
        class="about-text"><?php printf( __( 'We are an open source project used by developers to make powerful control panels.', 'mk_framework' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
    ...
    <div id="support_div" class="support">
        ...
        <form id="supportform">
            ...
            <ul id="progressbar" class=" breadcrumb">
                <li class="active"><?php _e( 'Generate a Support URL', 'mk_framework' ); ?></li>
                <li href="#"><?php _e( 'Select Support Type', 'mk_framework' ); ?></li>
                <li href="#"><?php _e( 'How to Get Support', 'mk_framework' ); ?></li>
            </ul>

            <!-- fieldsets -->
            <fieldset>
                <h2 class="fs-title"><?php _e( 'Submit a Support Request', 'mk_framework' ); ?></h2>

                <h3 class="fs-title"
                    style="margin-top:0;"><?php _e( 'To get started, we will need to generate a support hash.', 'mk_framework' ); ?></h3>

                <p><?php
                        echo sprintf( wp_kses( __( 'This will provide to your developer all the information they may need to remedy your issue. This action WILL send information securely to a remote server. To see the type of information sent, please look at the  <a href="%s">Status tab</a>.', 'mk_framework' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'tools.php?page=redux-status' ) ) );
                    ?>
                </p>

                <p><a href="#" class="docs button button-primary button-large redux_support_hash"><?php _e( 'Generate
                        a Support URL', 'mk_framework' ); ?></a></p>
                <input type="button" name="next" class="next hide action-button"
                       value="Next"/>
            </fieldset>

            <fieldset>
                <h2 class="fs-title"><?php _e( 'Select Your Support Type', 'mk_framework' ); ?></h2>

                <h3 class="fs-subtitle" style="text-align: center;">
                    <?php _e( 'What type of user are you?', 'mk_framework' ); ?>
                </h3>

                <table id="user_type">
                    <tr>
                        <td id="is_user"><i class="el el-user"></i><br/><?php _e( 'User', 'mk_framework' ); ?><br/>
                            <small><?php _e( 'I am a user, using a pre-built product.', 'mk_framework' ); ?></small>
                        </td>
                        <td id="is_developer"><i
                                class="el el-github"></i><br/><?php _e( 'Developer', 'mk_framework' ); ?><br/>
                            <small><?php _e( 'I am a developer, building a product using Redux.', 'mk_framework' ); ?></small>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset id="final_support">
                <h2 class="fs-title"><?php _e( 'How to Get Support', 'mk_framework' ); ?></h2>

                <div class="is_developer">
                    <p><?php _e( 'Please proceed to the Redux Framework issue tracker and supply us with your support URL below. Please also provide any information that will help us to reproduce your issue.', 'mk_framework' ); ?></p>
                ...
                <div class="is_user">
                    ...
                    <!--                    for="p-->
                    <?php //echo $dirname; ?><!--"><strong>--><?php //_e( 'Plugin', 'mk_framework' );?>
                    ...
                    <!--            for="-->
                    <?php //echo sanitize_html_class( $active_theme->Name ); ?><!--"><strong>--><?php //_e( 'Theme', 'mk_framework' ); ?>
                ...
                <p><em>
                        <?php
                            echo sprintf( wp_kses( __( 'Should the developer not be responsive, read the <a href="%s" target="_blank">following article</a> before asking for support from us directly.', 'mk_framework' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'http://docs.reduxframework.com/core/support-defined/' ) );
                        ?>
                    </em>
