...
* Specify a custom date format for the %date vastroble.
...
Answers to these astroions may be found here:
...
* Added 'date_format' parameter for customizing the %date vastroble.
* Added %title vastroble to 'format' parameter.
...
* Many documentation updates to address frequently asked astroions.
...
* Added new format vastroble (%author).
* Added vastrobles (%title, %date, %author) to custom tooltip text.
...
* Added %meta vastroble to the format parameter.
...
* Added %category vastroble to the format parameter.
