		...
		<?php if ( !empty($entries) ): ?>
			...
			<div class="related-posts">
				...
				<h2 class="m_bottom_20">
					<?php _e('Related Articles', 'flatastic'); ?>
				</h2>

				<?php $zoom_image = mad_custom_get_option('zoom_image', ''); ?>
...
//							$this_post = array();
							$id = get_the_ID();
//							$this_post['post_link'] = get_permalink($id);
								...
								<?php if ( has_post_thumbnail() ):
									...
									<div class="m_bottom_15">
										<div class="image-overlay <?php echo esc_attr($zoom_image); ?>">
											<a class="single-image entry-media photoframe" href="<?php echo esc_url(get_the_permalink()) ?>" title="<?php the_title(); ?>">
												<?php echo MAD_HELPER::get_the_post_thumbnail($id, '450*285', $thumbnail_atts); ?>
											</a>
										</div>
									</div>
