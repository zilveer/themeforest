...
<div id="item-actions">
	...
	<?php if ( bp_group_is_visible() ) : ?>
		...
		if ( bp_group_has_moderators() ) :
			...
			<h3><?php esc_html_e( 'Group Mods' , 'veda' ); ?></h3>
...
<div id="item-header-content">
	...
	<span class="activity"><?php printf( __( 'active %s', 'veda' ), bp_get_group_last_active() ); ?></span>
	...
	<h3><?php esc_html_e( 'Group Admins', 'veda' ); ?></h3>
