 ...
 */
if (!class_exists('HashmagMikadoStickyNavigationWalker')) {
	class HashmagMikadoStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$angle_icon   = '';
				if($depth !== 0) {
					$angle_icon = '<i class="mkdf_menu_arrow ion-ios-arrow-right"></i>';
				}
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<span class="mkdf_menu_arrow ion-ios-arrow-down"></span>';
				}
