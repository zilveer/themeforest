...
add_action( 'tgmpa_register', 'qode_register_js_composer_plugins' );
/**
 ...
 */
function qode_register_js_composer_plugins() {
    /**
...
if (class_exists('WPBakeryVisualComposerAbstract')) {
	function qodeRequireVcExtend(){
		require_once locate_template('/extendvc/extend-vc.php');
	}
	add_action('init', 'qodeRequireVcExtend',10);
}
