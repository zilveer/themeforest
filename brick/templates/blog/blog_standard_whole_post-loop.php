...
if (isset($qode_options['blog_standard_type_show_categories'])){
	$blog_show_categories = $qode_options['blog_standard_type_show_categories'];
}

$blog_show_comments = "yes";
if (isset($qode_options['blog_standard_type_show_comments'])){
    $blog_show_comments = $qode_options['blog_standard_type_show_comments'];
}
$blog_show_author = "yes";
if (isset($qode_options['blog_standard_type_show_author'])){
    $blog_show_author = $qode_options['blog_standard_type_show_author'];
}
$blog_show_like = "yes";
if (isset($qode_options['blog_standard_type_show_like'])) {
    $blog_show_like = $qode_options['blog_standard_type_show_like'];
}
$blog_show_ql_icon_mark = "yes";
$blog_title_holder_icon_class = "";
if (isset($qode_options['blog_standard_type_show_ql_mark'])) {
    $blog_show_ql_icon_mark = $qode_options['blog_standard_type_show_ql_mark'];
}
...
$blog_show_date = "yes";
if (isset($qode_options['blog_standard_type_show_date'])) {
    $blog_show_date = $qode_options['blog_standard_type_show_date'];
}
$blog_show_social_share = "no";
$blog_social_share_type = "dropdown";
if(isset($qode_options['blog_standard_type_select_share_option'])){
	$blog_social_share_type = $qode_options['blog_standard_type_select_share_option'];
}
if (isset($qode_options['enable_social_share'])&& ($qode_options['enable_social_share']) =="yes"){
    if (isset($qode_options['post_types_names_post'])&& $qode_options['post_types_names_post'] =="post"){
        if (isset($qode_options['blog_standard_type_show_share'])&& $blog_social_share_type == "dropdown") {
            $blog_show_social_share = $qode_options['blog_standard_type_show_share'];
        }
    }
}

$blog_ql_background_image = "no";
if(isset($qode_options['blog_standard_type_ql_background_image'])){
	$blog_ql_background_image = $qode_options['blog_standard_type_ql_background_image'];
}
...
if (isset($qode_options['blog_standard_type_read_more_button'])) {
    $blog_show_read_more_button = $qode_options['blog_standard_type_read_more_button'];
}
                    ...
                    <div class="post_text_inner">         
						...
						<?php
							...
							if($blog_show_read_more_button == "yes"){?>
								<a href="<?php the_permalink(); ?>" target="_self" class="qbutton small read_more_button">Read More</a>
						<?php } ?>
						<?php if(isset($qode_options['blog_standard_type_show_share']) && $qode_options['blog_standard_type_show_share'] == "yes" && $blog_social_share_type == "list") {
