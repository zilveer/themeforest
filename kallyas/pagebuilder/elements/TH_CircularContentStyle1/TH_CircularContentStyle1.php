	...
	function options()
	{
				...
				'general' => array(
					...
					'options' => array(
						array (
							...
							"description" => __( "Select an image for this Slide. Recommended size 340px x 180px .", 'zn_framework' ),
							"id"          => "ww_slide_image",
							"std"         => "",
							"type"        => "media"
						),
		...
		$options = array (
			...
			'help' => znpb_get_helptab( array(
				'video'   => 'http://support.hogash.com/kallyas-videos/#2Q_KC-SrYL4',
				'docs'    => 'http://support.hogash.com/documentation/circular-content-style-1/',
				'copy'    => $uid,
				'general' => true,
			)),
