...
if ( $order ) : ?>
	...
	<?php if ( $order->has_status( 'failed' ) ) : ?>
		...
		<p><?php _e( 'Unfortunately your order cannot be processed as the originating bank/merchant has declined your transaction.', 'wpdance' ); ?></p>
	...
	<?php else : ?>
		...
		<p><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Thank you. Your order has been received.', 'wpdance' ), $order ); ?></p>

		<ul class="order_details">
			<li class="order">
				<?php _e( 'Order:', 'wpdance' ); ?>
			...
			<li class="total">
				<?php _e( 'Total:', 'wpdance' ); ?>
				<strong><?php echo $order->get_formatted_order_total(); ?></strong>
			</li>
			<?php if ( $order->payment_method_title ) : ?>
			<li class="method">
				<?php _e( 'Payment method:', 'wpdance' ); ?>
