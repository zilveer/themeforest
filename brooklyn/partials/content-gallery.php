...
?>
    ...
    <?php else : ?>
        ...
        <div class="entry-content clearfix">
            ...
            <?php if( ot_get_option( 'blog_use_ut_gallery', 'on' ) == 'on' ) : ?>
                
                <?php 
                
                /* remove gallery shortcode from content since all images are already present inside the slider */
                $content = get_the_content( '<span class="more-link">' . esc_html__( 'Read more', 'unitedthemes' ) . '<i class="fa fa-chevron-circle-right"></i></span>' );
