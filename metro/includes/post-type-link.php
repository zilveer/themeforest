...
if ( is_singular() ) { // single post mode
	$link=get_post_meta($post->ID, OM_THEME_SHORT_PREFIX.'link_url', true);
	...
	<div <?php post_class('post-full'); ?> id="post-<?php the_ID(); ?>">
		...
		<div class="post-text">
			<?php if($link) { ?><p class="post-title-link"><a href="<?php echo $link ?>" target="_blank"><?php echo str_replace('http://','',$link) ?></a></p><?php } ?>
