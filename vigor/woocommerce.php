...
?>
	...
	?>
		...
		<?php if(isset($edgt_options['woo_products_enable_full_width_template'])&& $edgt_options['woo_products_enable_full_width_template']=="yes" && !is_singular('product')){ ?>
