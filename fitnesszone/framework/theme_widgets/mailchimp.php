...
class MY_Mailchimp extends WP_Widget {
	...
	function __construct() {
		$widget_options = array("classname"=>'mailchimp', 'description'=>__('Use this widget to add a mailchimp newsletter to your site.', 'iamd_text_domain'));
...
<?php   else:
	...
	function widget($args, $instance) {
		...
		echo '<input type="email" required name="dt_mc_emailid" id="dt_mc_emailid" placeholder="'.__('Enter Email', 'iamd_text_domain').'" />';
