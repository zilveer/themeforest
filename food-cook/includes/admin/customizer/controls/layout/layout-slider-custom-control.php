 ...
 */
class Layout_Slider_Custom_Control extends WP_Customize_Control
{
      ...
      public function render_content()
       {	                                                   
  		...
  		<label>
  			...
  			<input id="<?php echo $this->id; ?>_input" class="input_df_slider_text" type="text" value="<?php echo $this->value(); ?>" <?php $this->link(); ?> readonly="readonly">
  		</label>
