<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
			...
			echo sprintf( __('If you like <strong>Redux</strong> please leave us a <a href="%s" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thank you from Redux in advance!','redux-framework'), 'https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform' );
        }
        ...
        public function admin_menus() {
            ...
            remove_submenu_page( 'themes.php', 'redux-getting-started' );
