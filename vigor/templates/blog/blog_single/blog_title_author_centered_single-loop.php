...
if(isset($edgt_options['blog_single_select_share_option'])){
	$blog_social_share_type = $edgt_options['blog_single_select_share_option'];
}
                ...
                <div class="post_text">
                    <div class="post_text_inner">
						...
						<?php if($blog_show_date == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>		
							<div class="post_info">
								<?php edgt_post_info(array('date' => $blog_show_date, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like)); 
								if($blog_social_share_type == "dropdown"){
									edgt_post_info(array('share' => $blog_show_social_share));			
								}
								?>
							</div>
						<?php } ?>		
						<?php if(isset($edgt_options['blog_single_show_social_share']) && $edgt_options['blog_single_show_social_share'] == "yes" && $blog_social_share_type == "list") {?>
                ...
                <div class="post_text<?php echo esc_attr($background_image_html_class); ?>" <?php edgt_inline_style($background_image_html); ?>>
                    <div class="post_text_inner">
						...
						<?php if($blog_show_author == "yes" || $blog_show_date == "yes" || $blog_show_social_share == "yes" || $blog_show_categories == "yes" || $blog_show_comments == "yes" || $blog_show_like == "yes") { ?>
							<div class="post_info">
								<?php edgt_post_info(array('date' => $blog_show_date, 'author' => $blog_show_author, 'category' => $blog_show_categories, 'comments' => $blog_show_comments, 'like' => $blog_show_like));
								if($blog_social_share_type == "dropdown"){
									edgt_post_info(array('share' => $blog_show_social_share));			
								}
								?>
