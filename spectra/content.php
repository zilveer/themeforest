    ...
    <div class="entry">
       <header class="entry-header">
            ...
            <div class="entry-meta">
                <div class="meta-posted-by anim-css" data-delay="100"><?php _e( 'Posted by: ', SPECTRA_THEME ) ?> <?php the_author_link(); ?></div>
        ...
        <div class="entry-media content-image featured-image anim-css" data-delay="100">
