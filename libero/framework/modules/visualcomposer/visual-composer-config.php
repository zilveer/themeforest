...
if ( ! function_exists('libero_mikado_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function libero_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'libero_mikado_configure_visual_composer');

}


if ( ! function_exists('libero_mikado_configure_visual_composer_grid_elemets') ) {
	...
	function libero_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'libero_mikado_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('libero_mikado_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function libero_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'libero_mikado_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
    ...
    class WPBakeryShortCode_mkd_Info_Table extends WPBakeryShortCodesContainer {}
    class WPBakeryShortCode_mkd_Vertical_Marquee extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_mkd_Fullwidth_Slider_Holder extends WPBakeryShortCodesContainer {}
}
...
/*** Row ***/
if ( ! function_exists('libero_mikado_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function libero_mikado_vc_row_map()
	{
		...
		vc_add_param('vc_row', array(
			...
			'value' => array(
				'Default' => '',
				'Light' => 'mkd-light-header',
				'Dark' => 'mkd-dark-header'
			),
        ...
        vc_add_param('vc_row_inner', array(
            'type' => 'textfield',
            'class' => '',
            'heading' => 'Row Overlap - Top (px)',
            'param_name' => 'overlap_top',
            'value' => '',
            'description' => 'Enter the amount of pixels you would like this row to overlap the row above it'
        ));

        vc_add_param('vc_row_inner', array(
            'type' => 'textfield',
            'class' => '',
            'heading' => 'Row Overlap - Bottom (px)',
            'param_name' => 'overlap_bottom',
            'value' => '',
            'description' => 'Enter the amount of pixels you would like this row to overlap the row below it'
        ));
	}

	add_action('vc_after_init', 'libero_mikado_vc_row_map');
}
