...
function solopine_load_scripts() {
	...
	wp_enqueue_style('default_headings_font', 'http://fonts.googleapis.com/css?family=Oswald:400,700');
	wp_enqueue_style('default_para_font', 'http://fonts.googleapis.com/css?family=Crimson+Text:400,700,400italic,700italic');
	wp_enqueue_style('default_body_font', 'http://fonts.googleapis.com/css?family=Open+Sans:400italic,700italic,400,700&subset=cyrillic,latin');
...
if ( function_exists('register_sidebar') ) {
	...
	register_sidebar(array(
		...
		'after_title' => '</h4>',
		'description' => 'Use the Instagram Slider widget here. IMPORTANT: For best result select "Thumbnails without borders" under "Template" and set number of images to 8 and number of columns to 8.',
	));
}
