                ...
                ?>
                    ...
                    <div <?php echo $id_container ?>class="rm_option rm_input rm_text<?php echo $class_dep ?>">
                        ...
                        <input name="<?php yiw_option_name( $value['id'] ); ?>" 
							   ...
							   value="<?php echo esc_html( stripslashes_deep( yiw_get_option( $value['id'], $value['std'] ) ) ); ?>"
							   <?php endif ?>
														...
														<tbody>
															...
															<tr>
																<td align="left" colspan="3" class="rm_upload">
																	...
																	<input type="text" alt="<?php _e('Image URL', 'yiw') ?>" class="ss-Image" name="<?php yiw_option_name( $value['id'] ); ?>[<?php echo $id ?>][image_url]" value="<?php echo isset( $field['image_url'] ) ? $field['image_url'] : '' ?>" />
															...
															<tr>
																<td align="left" colspan="3">
																	...
																	<input type="text" alt="<?php _e('URL Video', 'yiw') ?>" name="<?php yiw_option_name( $value['id'] ); ?>[<?php echo $id ?>][url_video]" value="<?php if( isset( $field['url_video'] ) ) echo stripslashes_deep( $field['url_video'] ) ?>" />
																</td>
															</tr>              
															<?php break; 
                                                                default :
