									...
									<div class="tr-blogfw">
										...
										<div class="thepostcont">
											<div class="post-single-stuff">
										    	...
										    	<div class="the_content">
											    	<?php 
											    		the_content();
											    		$args = array(
															'before'           => '<div class="navigation" style="margin-top: 0px;"><div class="des-pages"><span class="pages current">' . __('Post Pages:', 'smartbox') . '</span>',
															'after'            => '</div></div>',
															'link_before'      => '<div class="postpagelinks">',
															'link_after'       => '</div>',
															'next_or_number'   => 'number',
															'nextpagelink'     => __('Next page','smartbox'),
															'previouspagelink' => __('Previous page','smartbox'),
															'pagelink'         => '%',
															'echo'             => 1
														); 
											    		wp_link_pages($args); 
										    ...
										    <nav id="nav-below" role="article">
												...
												<div class="nav-previous"><?php if (!function_exists('icl_object_id')) previous_post_link( '%link', '%title <span class="meta-nav">' . get_option('smartbox_previous_text') . '</span>' ); else previous_post_link( '%link', '%title <span class="meta-nav">' . __('Older Entries','smartbox') . '</span>' ); ?></div>
												<div class="nav-next"><?php if (!function_exists('icl_object_id')) next_post_link( '%link', '%title <span class="meta-nav">' . get_option('smartbox_next_text') . '</span>' ); else next_post_link( '%link', '%title <span class="meta-nav">' . __('Newer Entries','smartbox') . '</span>' ); ?></div>
											</nav><!-- #nav-below -->
