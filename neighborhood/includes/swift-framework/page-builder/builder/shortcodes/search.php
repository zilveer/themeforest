...
SPBMap::map( 'search_widget', array(
    ...
    "params"	=> array(
    	array(
    	    "type" => "textfield",
    	    "heading" => __("Input placeholder text", "swiftframework"),
    	    "param_name" => "search_input_text",
    	    "value" => "Search",
    	    "description" => __("Enter the text that appearas as default in the search input.", "swiftframework")
    	),
    	array(
    	    "type" => "dropdown",
    	...
    	array(
    	    "type" => "dropdown",
    	    "heading" => __("Border above widget", "swiftframework"),
    	    "param_name" => "pb_border_top",
    	    "value" => array(__('No', "swiftframework") => "no", __('Yes', "swiftframework") => "yes"),
    	    "description" => __("Add a top border to the widget.", "swiftframework")
    	),
    	array(
    	    "type" => "textfield",
