...
define( 'NOTIFIER_THEME_NAME', 'Gridler' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'gridler' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://update.swishthemes.com/notifier-gridler.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
