...
class Pyre_Latest_Portfolio_Media_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'pyre_homepage_media-port', 'description' => 'Latest Service Posts');
		...
		parent::__construct('pyre_homepage_media-widget-port', 'Home: Service Posts ', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
	 ...
	 ?>
		...
		<div class="<?php echo esc_attr(  $args['widget_id'] ); ?> service-posts-home<?php if($checkbox_pro): ?> light-fonts-pro<?php endif; ?>" <?php if($widget_bg): ?>style="background-color:<?php echo esc_attr( $widget_bg ); ?>;"<?php endif; ?>>
	...
	function form($instance)
	{
		...
		$defaults = array('title' => 'Our Services', 'summary_text' => 'Years of Expertise', 'posts' => 3, 'columns' => 3, 'portfolioslug' => '', 'link_text' => '', 'link_link' => '', 'widget_bg' => '#ffffff', 'widget_bg_img' => '', 'checkbox_pro' => '1', 'link_icon' => '');
		...
		<p>
			<label for="<?php echo $this->get_field_id('portfolioslug'); ?>"><?php _e( 'Service Category Slug <br>(Leave blank to pull all posts)', 'progression' ); ?>:</label>
