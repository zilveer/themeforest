...
//            console.log(encodeURIComponent(JSON.stringify(introduction)));
        ...
        function update_introduction_bg(parent)
        {
            ...
            api.instance(input_hidden).set( encodeURIComponent(JSON.stringify(intro_bg_data)) );
            //console.log(introSave.val());
        ...
        function delImage(){
            $('.js-del').click(function(){
                var array = [];
                var parent = $(this).parent().parent();
                var parent_change = $(this).parent().parent().parent().parent().parent();
                $(this).parent().remove();
        ...
        $(".intro-bg-slider-remove-multi-img").remove_multi_upload_image({
            ...
            callback: function(e){
                ...
                var parent = e.current.parent().parent().parent().parent().parent();
                update_introduction_bg(parent);
            }
        });
        ...
        /************* SECTION SCRIPTS ****************/
            ...
            $(".enable-parallax").on("click",function(){
                var input_parallax = $(this).closest(".customize-sub-content").find("input.section-parallax"),
                    options_parallax = {};
            ...
            $(".parallax-upload-img").upload_single_image({
                instance:false,
                callback:function(e){
                    var input_parallax = e.current.closest(".customize-sub-content").find("input.section-parallax"),
                        options_parallax = {};
                    if(input_parallax.val()!='' && input_parallax.val()!=undefined)
                        options_parallax = JSON.parse(input_parallax.val());
