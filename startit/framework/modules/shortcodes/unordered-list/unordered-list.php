<?php
namespace QodeStartit\Modules\UnorderedList;
...
class UnorderedList implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
        ...
        $html .= '<div class="qodef-unordered-list '.$list_item_classes.'" '.  qode_startit_get_inline_style($list_style).'>';
