...
$('.mom_media_meta_wrap_$rndn .remove_media_meta').live('click', function() {
	...
	$(this).hide();
			...
			<div class="media_meta_preview"><img src="'.$meta.'" alt=""><input type="text" '.$id.$name.$val.' style="visibility: hidden; height:0;"/><a class="remove_media_meta hide fa-icon-remove"></a></div>
		    </div>';
