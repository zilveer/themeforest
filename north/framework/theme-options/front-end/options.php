...
<!--					<h2><?php echo THEMENAME; ?></h2>-->
			...
			<div id="panel-tab-title">
				...
				<button id="of_save" type="button" class="button-primary of-save"><?php _e('Save All Changes', 'veented_backend');?></button>
				</div>
			</div>
		...
		<div class="save_bar"> 
			...
			<img style="display:none" src="<?php echo ADMIN_DIR; ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
			<button id="of_save" type="button" class="button-primary of-save"><?php _e('Save All Changes', 'veented_backend');?></button>			
			<button id="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Options Reset', 'veented_backend');?></button>
