...
function of_style_only(){
	...
	wp_enqueue_style('chosen', ADMIN_DIR . 'assets/css/chosen.css');
...
function of_load_only() 
{
	...
	wp_enqueue_script('jquery-input-mask', ADMIN_DIR .'assets/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ), '', true);
	wp_enqueue_script('tipsy', ADMIN_DIR .'assets/js/jquery.tipsy.js', array( 'jquery' ), '' ,true);
	wp_enqueue_script('cookie', ADMIN_DIR . 'assets/js/cookie.js', 'jquery', '', true);
	wp_enqueue_script('toggles', ADMIN_DIR .'assets/js/toggles.min.js', array( 'jquery' ), '', true);
	wp_enqueue_script('smof', ADMIN_DIR .'assets/js/smof.js', array( 'jquery' ), '', true);
	wp_enqueue_script('chosen', ADMIN_DIR .'assets/js/chosen.jquery.min.js', array( 'jquery' ), '', true);
