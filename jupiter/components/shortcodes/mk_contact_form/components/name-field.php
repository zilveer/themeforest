...
<div class="mk-form-row <?php echo $column_width; ?>">
	...
	<?php endif; ?>
	<input placeholder="<?php _e( 'Your Name', 'mk_framework' ); ?>" type="text" required="required" name="name" class="text-input s_txt-input" value="" tabindex="<?php echo $view_params['tab_index']; ?>" />
</div>
