<?php
add_action( 'tgmpa_register', 'my_theme_register_revolution_slider' );
/**
 ...
 */
if (!function_exists('my_theme_register_revolution_slider')) {
    function my_theme_register_revolution_slider() {
        ...
        $plugins = array(
            ...
            array(
                'name'     				=> esc_html__('Revolution Slider', 'qode'), // The plugin name
