...
?>
    ...
    <div id="<?php echo $slider_id ?>" <?php $slider->item_class('swiper_container masterslider ms-skin-default') ?> style="<?php echo $height_inline; ?>" data-autoplay="<?php echo $autoplay ?>" data-interval="<?php echo $interval ?>" data-height="<?php echo $height ?>" >
