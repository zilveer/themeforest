...
if(is_array($portfolio_tags) && count($portfolio_tags)) {
	...
	<div class="info portfolio_single_tags">
		<<?php echo esc_attr($portfolio_info_tag);?> class="info_section_title" <?php qode_inline_style($portfolio_info_style); ?>><?php _e('Tags', 'qode') ?></<?php echo esc_attr($portfolio_info_tag);?>>
		<span class="category">
