	...
	*/
	...
	$goodlayers_menu = array(			
		...
		__('Overall Elements', 'gdl_back_office') => array(
			__('Header Area', 'gdl_back_office')=>'gdl_panel_header_area',
		...
		__('Elements Color', 'gdl_back_office') => array(
			__('Navigation / Header', 'gdl_back_office')=>'gdl_panel_navigation',
			...
			__('Additional Elements 1', 'gdl_back_office')=>'gdl_panel_additional_elements_1',
		...
		__('Slider Setting', 'gdl_back_office') => array(
			...
			__('Custom Slider', 'gdl_back_office')=>'gdl_panel_custom_slider')
	);
	...
	$goodlayers_element = array(
		...
		'gdl_panel_font' => array(
			__('HEADER FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_header_font', 'default'=>'- Merriweather Cufon',
			...
			__('SLIDER FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_slider_font', 'default'=>'- Merriweather Cufon'),				
			...
			__('STUNNING TEXT FONT', 'gdl_back_office')=>array('type'=>'font-combobox','name'=>THEME_SHORT_NAME.'_stunning_text_font', 'default'=>'- Merriweather Cufon',
		...
		//Overall Elements
		'gdl_panel_header_area' => array(	
			__('PAGE DEFUALT HEADER', 'gdl_back_office') => array('type'=>'upload','name'=>THEME_SHORT_NAME.'_page_header'),
			__('POST DEFAULT HEADER', 'gdl_back_office') => array('type'=>'upload','name'=>THEME_SHORT_NAME.'_post_header'),
			__('PORTFOLIO DEFAULT HEADER', 'gdl_back_office') => array('type'=>'upload','name'=>THEME_SHORT_NAME.'_portfolio_header'),
			__('ARCHIVE DEFAULT HEADER', 'gdl_back_office') => array('type'=>'upload','name'=>THEME_SHORT_NAME.'_archive_header'),
			__('404 DEFAULT HEADER', 'gdl_back_office') => array('type'=>'upload','name'=>THEME_SHORT_NAME.'_404_header'),
		),
		
		'gdl_panel_logo' => array( 
			__('LOGO', 'gdl_back_office')=>array('type'=>'upload','name'=>THEME_SHORT_NAME.'_logo'), 
			__('LOGO TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_top_margin','default'=>'15',
				'description'=>'Input number to set the top space of the logo. The minimum value is 1.'), 
			__('LOGO LEFT MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_left_margin','default'=>'25'),
			__('LOGO BOTTOM MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_logo_bottom_margin','default'=>'12',
				'description'=>'Input number to set the bottom space of the logo. The minimum value is 1.'),
			__('NAVIGATION TOP MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_navigation_top_margin','default'=>'13',
				'description'=>'Input number to set the top space of the navigation. The minimum value is 1.'), 			
			__('NAVIGATION RIGHT MARGIN', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_navigation_right_margin','default'=>'25'),
		),

		'gdl_panel_social_network' => array( 	
			__('ENABLE SOCIAL NETWORK', 'gdl_back_office')=>array('type'=>'radioenabled','name'=>THEME_SHORT_NAME.'_enable_social_network'),			
			__('BOTTOM SPACE', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_social_wrapper_bottom', 'default'=>'27',
				'description'=>'Set the bottom sapce of the social icons when the bottom slider ( and slider ) is off'),					
		...
		'gdl_panel_navigation' => array(
			__('MAIN NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text','default'=>'#ffffff',
				'description'=>'This is the text color of the main navigation in the normal state.'),
			__('MAIN NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_hover','default'=>'#d4d4d4',
				'description'=>'This is the text color of the main navigation in "hover" state.'),
			__('MAIN NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_main_navigation_text_current','default'=>'#ffffff',
				'description'=>'This is the text color of the main navigation in "current page" state.'),		
			__('SUB NAVIGATION TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text','default'=>'#e6e6e6'),
			__('SUB NAVIGATION TEXT HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_hover','default'=>'#999999'),
			__('SUB NAVIGATION TEXT CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sub_navigation_text_current','default'=>'#999999'),
			__('HEADER BOTTOM LINE BACKGROUND', 'gdl_back_office') => array( 'type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_header_bottom_line', 'default'=>'#e7e7e7',
				'description'=>'When the top slider is enabled, this color will be ignored and the top slider bottom line background will be used instead.' ),
			__('TOP SLIDER BOTTOM LINE BACKGROUND', 'gdl_back_office') => array( 'type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_top_slider_bottom_line', 'default'=>'#43392b'),
			__('UNDER SLIDER BACKGROUND', 'gdl_back_office') => array( 'type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_under_slider_background', 'default'=>'#2d2418'),			
			__('UNDER SLIDER TITLE', 'gdl_back_office') => array( 'type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_under_slider_title', 'default'=>'#ffffff'),			
			__('UNDER SLIDER CONTENT', 'gdl_back_office') => array( 'type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_under_slider_cotent', 'default'=>'#b5ab9e'),			
			__('UNDER SLIDER LINK', 'gdl_back_office') => array( 'type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_under_slider_link', 'default'=>'#ffffff'),			
			__('UNDER SLIDER LINK HOVER', 'gdl_back_office') => array( 'type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_under_slider_link_hover', 'default'=>'#ffffff'),			
		),		
		...
		'gdl_panel_body' => array(	
			__('ICON STYLE','gdl_back_office')=>array(
				...
				'description'=>'This option will change all of the icon in this theme( except footer and header ) to use dark/light version.'),
			__('PAGE TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_title_color','default'=>'#ffffff', 
				'This is the color of the header area of the page where the image are resides.'),
			__('PAGE TITLE SHADOW', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_title_shadow','default'=>'#2b360e'), 
			__('PAGE CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_page_caption_color','default'=>'#ffffff'),
			...
			__('TITLE BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_header_title_background','default'=>'#f3f3f3',
				'description'=>'This is the background color of header title elements. Ex. Blog header title'),
			__('SIDEBAR TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_sidebar_title_color','default'=>'#494949'),
			__('CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_content_color','default'=>'#777777'),
			...
			__('LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_color','default'=>'#4f4f4f',
				'description'=>'This color effects all of the link color in this theme.'),
			__('LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_link_hover_color','default'=>'#8a8a8a',
		...
		'gdl_panel_footer' => array(	
			...
			__('FOOTER LINK COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_color','default'=>'#ffffff',
				'description'=>'This color changes all of the link color inside footer in normal state.'),
			__('FOOTER LINK HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_link_hover_color','default'=>'#cfcfcf',
				'description'=>'This is the link color of footer frame in "hover" state.'),
			__('FOOTER TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_title_color','default'=>'#ffffff'),	
			__('FOOTER CONTENT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_color','default'=>'#cfc2ae'),	
			__('FOOTER CONTENT INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_content_info_color','default'=>'#aba395',
				'description' =>'The content info is the color of the post date( in post/portfolio widget ) and twitter widget'),	
			__('FOOTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_background','default'=>'#2f261a'),
			__('FOOTER TOP BAR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_footer_top_bar','default'=>'#43392b',
				'description'=>'This is the little bar color over the footer. Change it to match with the theme style.'),
			__('FOOTER DIVIDER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_divider_color', 'default'=>'#3f362a'),
			__('FOOTER INPUT BOX TEXT', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_text', 'default'=>'#ccc2b6',
				'description' =>'This footer input box comes from search widget and contact form widget, you can change it to fit theme styles.'),
			__('FOOTER INPUT BOX BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_background', 'default'=>'#362d20'),
			__('FOOTER INPUT BOX BORDER', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_input_border', 'default'=>'#362d20'),
			__('FOOTER BUTTON COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_color', 'default'=>'#423626',
				'description' =>'This color is for the submit button of contact widget.'),
			__('FOOTER BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_footer_button_text', 'default'=>'#8f8982'),
			__('COPYRIGHT TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_copyright_text', 'default'=>'#808080'),
			__('COPYRIGHT BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker', 'name'=>THEME_SHORT_NAME.'_copyright_background', 'default'=>'#1f1911'),
		...
		'gdl_panel_slider' => array(
			...
			__('SLIDER CAPTION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_slider_caption_color','default'=>'#b5b5b5'),	
		),
			
		'gdl_panel_blog_port' => array(
			__('PORT TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_color','default'=>'#303030',
				'description'=>'This is the portfolio thumbnail title color.'),
			__('PORT TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_title_hover_color','default'=>'#4d4d4d',
				'description'=>'This is the portfolio thumbnail title color in "hover" state.'),
			__('PORT FILTER BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_background','default'=>'#f5f5f5'),
			__('PORT FILTER TEXT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_text','default'=>'#838383'),
			__('PORT FILTER HOVER', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_text_hover','default'=>'#1c1c1c'),
			__('PORT FILTER CURRENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_port_filter_text_current','default'=>'#1c1c1c'),
			__('BLOG TITLE COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_color','default'=>'#303030',
				'description'=>'This is the blog thumbnail title color except the blog in WIDGET style.'),
			__('BLOG TITLE HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_title_hover_color','default'=>'#4d4d4d',
				'description'=>'This is the blog thumbnail title color in "hover" state.'),
			__('BLOG INFO COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_post_info_color','default'=>'#7b7b7b',
		...
		'gdl_panel_additional_elements_1' => array(
			...
			__('STUNNING TEXT CAPTION BACKGROUND', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_stunning_text_caption_background','default'=>'#f3f3f3'),
			__('TESTIMONIAL TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_text','default'=>'#aaaaaa'),
			__('TESTIMONIAL TEXT AUTHOR COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_author','default'=>'#000000'),
			__('TESTIMONIAL TEXT POSITION COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_testimonial_position','default'=>'#7f7f7f'),				
			__('TWITTER ITEM CONTENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_twitter_item_content','default'=>'#898989'),	
			__('TWITTER ITEM DATE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_twitter_item_date','default'=>'#464646'),	
		),	
		
		'gdl_panel_additional_elements_2' => array(			
			__('FEATURE MEDIA TITLE', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_featured_media_title','default'=>'#202020'),
			__('FEATURE MEDIA CAPTION', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_featured_media_caption','default'=>'#858585'),
			__('FEATURE MEDIA CONTENT', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_featured_media_content','default'=>'#828282'),
			...
			__('BUTTON BACKGROUND COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_background_color','default'=>'#e9d424',
			...
			__('BUTTON TEXT COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_text_color','default'=>'#786d14',
			...
			__('BUTTON TEXT HOVER COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_button_text_hover_color','default'=>'#786d14',
			...
			__('BUTTON SHADOW COLOR', 'gdl_back_office')=>array('type'=>'colorpicker','name'=>THEME_SHORT_NAME.'_elements_shadow','default'=>'#888888',
		...
		'gdl_panel_blog_port_translator' => array(
			__('READ MORE (BLOG)', 'gdl_back_office')=>array('type'=>'inputtext','name'=>THEME_SHORT_NAME.'_translator_continue_reading','default'=>'Read More'),
