...
class Woo_Widget_Subscribe extends WP_Widget {
	...
	function Woo_Widget_Subscribe () {
		...
		/* Create the widget. */
		 WP_Widget::__construct( 'woo_subscribe', __('Dahz - Subscribe / Connect', 'woothemes' ), $widget_ops, $control_ops );
   ...
   /*----------------------------------------
	...
	function form ( $instance ) {
        ...
        <p>
	   	...
	   	<!-- Widget Disable In Posts: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'form' ); ?>"><?php _e( 'Disable in Posts', 'woothemes' ); ?></label>
	   	</p>
	   	<!-- Widget Disable In Pages: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'form' ); ?>"><?php _e( 'Disable in Pages', 'woothemes' ); ?></label>
	   	</p>
<?php
	} // End form()
