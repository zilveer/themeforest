...
if ( !function_exists( 'houzez_save_property_status_meta_fields' ) ) :
	function houzez_save_property_status_meta_fields( $term_id ) {
		...
		if ( isset( $_POST['fave'] ) ) {
			...
			houzez_update_property_status_colors( $term_id, $houzez_meta['color'], $houzez_meta['color_type'] );
		}

	}
endif;

add_action( 'edited_property_status', 'houzez_save_property_status_meta_fields', 10, 2 );
add_action( 'create_property_status', 'houzez_save_property_status_meta_fields', 10, 2 );
