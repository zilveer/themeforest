...
?>
#toolbar{position:fixed; z-index:3; right:10px; top:10px; padding:5px; background:url(<?php echo get_template_directory_uri(); ?>/js/fullscreen/fs_img_g_bg.png);}
...
#thumbnails_wrapper{opacity:0;z-index:2; position:fixed; bottom:0; width:100%; background:url(<?php echo get_template_directory_uri(); ?>/js/fullscreen/empty.gif); /* stupid ie needs a background value to understand hover area */}
...
.nextImageBtn{right:20px; background:#000 url(<?php echo get_template_directory_uri(); ?>/js/fullscreen/nextImgBtn.png) center center no-repeat;}
.prevImageBtn{left: 50px; background:#000 url(<?php echo get_template_directory_uri(); ?>/js/fullscreen/prevImgBtn.png) center center no-repeat;}
-->
</style>
...
<div id="preloader"><img src="<?php echo get_template_directory_uri(); ?>/js/fullscreen/ajax-loader_dark.gif" width="32" height="32" /></div>
		...
		<?php
			foreach($all_photo_arr as $key => $photo)
			{
			    ...
			    if(!empty($photo->guid))
			    {
			    	...
			    	$small_image_url = get_template_directory_uri().'/timthumb.php?src='.$image_url[0].'&amp;h=50&amp;w=50&amp;zc=1';
			    }
		?>
    	<div class="content">
