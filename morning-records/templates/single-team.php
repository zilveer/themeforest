...
if ( !function_exists( 'morning_records_template_single_team_theme_setup' ) ) {
	add_action( 'morning_records_action_before_init_theme', 'morning_records_template_single_team_theme_setup', 1 );
	function morning_records_template_single_team_theme_setup() {
		morning_records_add_template(array(
			'layout' => 'single-team',
			'mode'   => 'team',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single Team member', 'morning-records'),
...
// Template output
if ( !function_exists( 'morning_records_template_single_team_output' ) ) {
	function morning_records_template_single_team_output($post_options, $post_data) {
