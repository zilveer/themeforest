                ...
                if ( ! empty ( $this->args['opt_name'] ) ) {
                    ...
                    if ( true == $this->args['dev_mode'] ) {
                        ...
                        if ( true == $this->args['update_notice'] ) {
                            //add_action( 'admin_init', array( $this, '_update_check' ) ); PIRENKO
                        }
                    }
...
// __construct()
            ...
            private function set_default_args() {
                $this->args = array(
                    ...
                    'dev_mode'                  => false,//PIRENKO
                    'system_info'               => false,
                    'disable_tracking'          => true,//PIRENKO
                    'templates_path'            => '',
...
// show()
            ...
            private function _default_cleanup() {
                ...
                if (false) {//Redux_Helpers::isLocalHost() || ( Redux_Helpers::isWpDebug() ) PIRENKO
