    ...
    class yit_text_image extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            if( function_exists( 'icl_translate' ) ) {
                $instance['text'] = icl_translate( 'Widgets', 'widget_text_image_content_' . sanitize_title( $instance['text'] ), $instance['text'] );
            } else  {
                $instance['text'] = yit_wpml_string_translate( 'Widgets' , 'widget_text_image_content_' . sanitize_title( $instance['text'] ) , $instance['text'] ) ;
            }
