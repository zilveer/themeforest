...
$video_post_format_meta_box = suprema_qodef_add_meta_box(
	array(
		'scope' =>	array('post'),
...
$qodef_video_embedded_container = suprema_qodef_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
...
$qodef_video_self_hosted_container = suprema_qodef_add_admin_container(
	array(
		'parent' => $video_post_format_meta_box,
