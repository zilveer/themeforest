...
<div id="comments-list" class="comments">
	<h2><?php comments_number(__('0 Comments', "swiftframework"), __('1 Comment', "swiftframework"), __('% Comments', "swiftframework") ); ?></h2>
...
<?php if ( 'open' == $post->comment_status ) : ?>
	<div id="respond-wrap">
		<h2><a href="#" id="add-comment"><?php _e("Add comment", "swiftframework"); ?></a></h2>
		<?php 
			...
			$comments_args = array(
			    ...
			    'cancel_reply_link'    => __( 'Cancel reply', 'swiftframework' ),
