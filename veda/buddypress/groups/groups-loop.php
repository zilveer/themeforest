	...
	<?php while ( bp_groups() ) : bp_the_group(); ?>
		...
		<li <?php bp_group_class(); ?>>
			...
			<div class="item">
				...
				<div class="item-meta"><span class="activity"><?php printf( __( 'active %s', 'veda' ), bp_get_group_last_active() ); ?></span></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'There were no groups found.', 'veda' ); ?></p>
	</div>
