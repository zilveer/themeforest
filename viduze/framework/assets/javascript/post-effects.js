...
jQuery(document).ready(function(){ 
	...
	jQuery("select#post-option-inside-video-types").triggerHandler("change");
	jQuery('select#post-option-inside-video-types').change(function(){
		var selected_option = jQuery(this).children("option:selected").val();
		if(selected_option == 'Video File'){
			jQuery(this).parents("div#inside-thumbnail-video").children('div#inside-thumbnail-video-url,div#inside-thumbnail-video-code').slideUp();
			jQuery(this).parents("div#inside-thumbnail-video").children('div#inside-thumbnail-video-file').slideDown();
		}else if(selected_option == 'Video URL'){
			jQuery(this).parents("div#inside-thumbnail-video").children('div#inside-thumbnail-video-file,div#inside-thumbnail-video-code').slideUp();
			jQuery(this).parents("div#inside-thumbnail-video").children('div#inside-thumbnail-video-url').slideDown();
		}else if(selected_option == 'Video Code'){
			jQuery(this).parents("div#inside-thumbnail-video").children('div#inside-thumbnail-video-url,div#inside-thumbnail-video-file').slideUp();
			jQuery(this).parents("div#inside-thumbnail-video").children('div#inside-thumbnail-video-code').slideDown();
		}	
