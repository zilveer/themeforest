...
if (isset($edgt_options['blog_split_column_show_categories'])){
	$blog_show_categories = $edgt_options['blog_split_column_show_categories'];
}

$blog_show_comments = "no";
if (isset($edgt_options['blog_split_column_show_comments'])){
	$blog_show_comments = $edgt_options['blog_split_column_show_comments'];
}

$blog_show_author = "yes";
if (isset($edgt_options['blog_split_column_show_author'])){
	$blog_show_author = $edgt_options['blog_split_column_show_author'];
}
$blog_show_like = "no";
if (isset($edgt_options['blog_split_column_show_like'])) {
	$blog_show_like = $edgt_options['blog_split_column_show_like'];
}

$blog_show_ql_icon_mark = "yes";
$blog_title_holder_icon_class = "";
if (isset($edgt_options['blog_split_column_show_ql_mark'])) {
	$blog_show_ql_icon_mark = $edgt_options['blog_split_column_show_ql_mark'];	
}
...
$blog_show_date = "yes";
if (isset($edgt_options['blog_split_column_show_date'])) {
	$blog_show_date = $edgt_options['blog_split_column_show_date'];
}

$blog_social_share_type = "dropdown";
if(isset($edgt_options['blog_split_column_select_share_option'])){
	$blog_social_share_type = $edgt_options['blog_split_column_select_share_option'];
}
...
if (isset($edgt_options['enable_social_share'])&& $edgt_options['enable_social_share'] =="yes"){
	if (isset($edgt_options['post_types_names_post'])&& $edgt_options['post_types_names_post'] =="post"){
		if (isset($edgt_options['blog_split_column_show_share']) && $blog_social_share_type == "dropdown") {
			$blog_show_social_share = $edgt_options['blog_split_column_show_share'];
		}
	}
}
				...
				<div class="post_content_column text-wrapper">
					<div class="post_text">
						<div class="post_text_inner">
							...
							<?php
								edgt_excerpt();
								edgt_read_more_button('blog_split_column_read_more_button');
							?>
							<?php if(isset($edgt_options['blog_split_column_show_share']) && $edgt_options['blog_split_column_show_share'] == "yes" && $blog_social_share_type == "list") {?>
