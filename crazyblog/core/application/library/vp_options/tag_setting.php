...
class crazyblog_Tag_setting_menu {

	public $title = 'Tags Settings';
	...
	public function crazyblog_menu() {
		...
		$return = array(
			array(
				'type' => 'section',
				'title' => esc_html__( 'Tag Page Settings', 'crazyblog' ),
				'name' => 'tag_page_settings',
				'fields' => array(
					array(
						'type' => 'toggle',
						'name' => 'tag_page_title_section',
						'label' => esc_html__( 'Show Title Section', 'crazyblog' ),
						'description' => esc_html__( 'Enable to show Tag page title section', 'crazyblog' ),
					),
					array(
						'type' => 'textbox',
						'name' => 'tag_page_title',
						'label' => esc_html__( 'Page Title', 'crazyblog' ),
						'description' => esc_html__( 'Enter the title for tag page', 'crazyblog' ),
						'dependency' => array(
							'field' => 'tag_page_title_section',
					...
					array(
						...
						'label' => esc_html__( 'Tag Page Layout', 'crazyblog' ),
						'description' => esc_html__( 'Choose the layout for tag pages', 'crazyblog' ),
						'items' => array(
							array(
								'value' => 'left',
					...
					array(
						...
						'description' => esc_html__( 'Select sidebar to show at tag page', 'crazyblog' ),
						'items' => crazyblog_get_sidebars( true ),
						'dependency' => array(
							'field' => 'tag_sidebar_layout',
							'function' => 'vp_dep_sidebar_boolean',
						),
					),
					array(
						'type' => 'select',
						'name' => 'tag_post_column',
		...
		return apply_filters( 'crazyblog_vp_opt_tag_', $return );
	}
