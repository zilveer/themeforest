...
function wp_pagenavi($before = '', $after = '') {
	...
	if (!is_single()) {
		...
		if($max_page > 1 || intval($pagenavi_options['always_show']) == 1) {
			...
			echo $before.'<div class="karma-pages">'."\n";
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','truethemes_localize');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo;','truethemes_localize');
	$pagenavi_options['last_text'] = __('&raquo;','truethemes_localize');
	$pagenavi_options['next_text'] = __('&raquo;','truethemes_localize');
	$pagenavi_options['prev_text'] = __('&laquo;','truethemes_localize');
	$pagenavi_options['dotright_text'] = __('...','truethemes_localize');
	$pagenavi_options['dotleft_text'] = __('...','truethemes_localize');
