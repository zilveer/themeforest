                ...
                while( $test_posts->have_posts() )
                {
                    ...
                    echo '<li>';
                        echo '<div>';
                            ...
                            echo '<img width="64" height="62" title="Testimonials" alt="Testimonials" class="thumbnail wp-post-image" src="' . YIT_THEME_ASSETS_URL . '/images/testimonial.png">';
            ...
            $script = "<script type=\"text/javascript\">
                jQuery(document).ready(function($){
                    ...
                    if ( typeof $.browser !== 'undefined' ) {
                        animation = $.browser.msie || $.browser.opera ? 'fade' : '$test_fx';
                    }
