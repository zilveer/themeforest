    ...
    <footer class="jx-ievent-footer-1 jx-ievent-footer-section jx-ievent-container">      	
        ...
        <div class="jx-ievent-footer-widget">        
        	<div class="container">        	
                    ...
                    <div class="jx-ievent-footer-logo"><img src="<?php echo esc_url($ievent_data['footer-logo']); ?>" alt="<?php bloginfo('name'); ?>" class="logo" /></div>
					<?php endif; ?>
                    <!-- EOF Logo -->
                    
					<?php if ( !function_exists( 'dynamic_sidebar' ) || !dynamic_sidebar('ievent-footer-1') ) ?>
                    
                    </div>
                    <!-- Widget#1 -->
                    
                    <div class="four columns"><?php if ( !function_exists( 'dynamic_sidebar' ) || !dynamic_sidebar('ievent-footer-2') ) ?></div>
                    <!-- Widget#1 -->
                    
                    <div class="four columns"><?php if ( !function_exists( 'dynamic_sidebar' ) || !dynamic_sidebar('ievent-footer-3') ) ?></div>
                    <!-- Widget#1 -->
                    
                    <div class="four columns"><?php if ( !function_exists( 'dynamic_sidebar' ) || !dynamic_sidebar('ievent-footer-4') ) ?></div>
                    <!-- Widget#1 -->
            </div>
        </div>
		<!-- EOF Widgets -->		
