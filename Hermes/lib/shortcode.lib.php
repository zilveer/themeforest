...
function home_portfolios_func($atts, $content) {
	...
	foreach($recent_portfolios_arr as $key => $recent_portfolio)
	{
		...
		$image_url = '';						
		if(has_post_thumbnail($recent_portfolio->ID, 'large'))
		{
		...
		switch($portfolio_type)
		{
			case 'External Link':
			default:
				$return_html.= '<div class="portfolio4_shadow">';
				$return_html.= '<a title="'.$recent_portfolio->post_title.'" href="'.$permalink_url.'"><div class="overlay_detail">
							<div>
							    <img src="'.get_stylesheet_directory_uri().'/images/icon_zoom.png" alt=""/><br/>
							</div>
						</div><img src="'.get_stylesheet_directory_uri().'/timthumb.php?src='.$image_url[0].'&amp;h=118&amp;w=197&amp;zc=1" alt="" class="" width="197" height="118"/></a>';
				$return_html.= '</div>';
			break;
			// end external link
			...
			case 'Image':
				$return_html.= '<div class="portfolio4_shadow">';
				$return_html.= '<a title="'.$recent_portfolio->post_title.'" href="'.$image_url[0].'" class="img_frame"><div class="overlay_detail">
							<div>
							    <img src="'.get_stylesheet_directory_uri().'/images/icon_zoom.png" alt=""/><br/>
							</div>
						</div><img src="'.get_stylesheet_directory_uri().'/timthumb.php?src='.$image_url[0].'&amp;h=118&amp;w=197&amp;zc=1" alt="" class="" width="197" height="118"/></a>';
			...
			case 'Youtube Video':
				$return_html.= '<div class="portfolio4_shadow">';
				$return_html.= '<a title="'.$recent_portfolio->post_title.'" href="#video_'.$portfolio_video_id.'" class="lightbox_youtube"><div class="overlay_detail">
							<div>
							    <img src="'.get_stylesheet_directory_uri().'/images/icon_play.png" alt=""/><br/>
							</div>
						</div><img src="'.get_stylesheet_directory_uri().'/timthumb.php?src='.$image_url[0].'&amp;h=118&amp;w=197&amp;zc=1" alt="" class="" width="197" height="118"/></a>';
				$return_html.= '</div>';
				
				$return_html.= '<div style="display:none;">
							    <div id="video_'.$portfolio_video_id.'" style="width:640px;height:385px">
							        
							        <object type="application/x-shockwave-flash" data="http://www.youtube.com/v/'.$portfolio_video_id.'" style="width:640px;height:385px" wmode="transparent">
			        		    		<param name="movie" value="http://www.youtube.com/v/'.$portfolio_video_id.'" />
			    			    	</object>
			...
			case 'Vimeo Video':
				...
				$return_html.= '<div style="display:none;">
							    <div id="video_'.$portfolio_video_id.'" style="width:601px;height:338px">
							    
							        <object width="601" height="338" data="http://vimeo.com/moogaloop.swf?clip_id='.$portfolio_video_id.'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=ffffff&amp;fullscreen=1" type="application/x-shockwave-flash">
							        	<param name="wmode" value="transparent" />
			  				    		<param name="allowfullscreen" value="true" />
			  				    		<param name="allowscriptaccess" value="always" />
			  				    		<param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id='.$portfolio_video_id.'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=ffffff&amp;fullscreen=1" />
							    	</object>
		...
		$return_html.= '<div class="portfolio_desc" style="width:200px;margin-top:10px"><strong>'.$recent_portfolio->post_title.'</strong><br/><br/><span>'.pp_substr(strip_tags(strip_shortcodes($recent_portfolio->post_content)), 120).'</span></div>';
...
add_shortcode('home_portfolios', 'home_portfolios_func');
