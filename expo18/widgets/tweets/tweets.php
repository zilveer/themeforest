...
class om_widget_tweets extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$tweets = $connection->get('https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name='.$instance['username'].'&count='.$instance['postcount'].($instance['retweets']?'&include_rts=true':''));
