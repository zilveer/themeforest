 ...
 */
add_action( 'tgmpa_register', 'my_theme_register_select_twitter_feed' );
/**
 ...
 */
function my_theme_register_select_twitter_feed() {
    /**
    ...
    $plugins = array(
        ...
        array(
            'name'			=> esc_html__('Select Twitter Feed', 'qode'), // The plugin name
