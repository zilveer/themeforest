...
<div id="qode_shortcode_form_wrapper">
    <form id="qode_shortcode_form" name="qode_shortcode_form" method="post" action="">
		...
		<div class="input">
            <label>Icon (Only for 'With Icon' type)</label><br><br><br>
        ...
        <div class="input">
            <label>Box Padding (top right bottom left) px</label>
            <input name="box_padding" id="box_padding" value="" maxlength="20" size="12" />
        </div>
        <div class="input">
            <label>Default Text Font Size</label>
            <input name="text_size" id="text_size" value="" maxlength="55" size="55" />
        </div>
        <div class="input">
