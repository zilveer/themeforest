 ...
 */
add_action( 'widgets_init', 'ancora_widget_most_viewed_load' );

/**
 * Register our widget.
 */
function ancora_widget_most_viewed_load() {
	register_widget('ancora_widget_most_viewed');
}

/**
 * popular and commented Widget class.
 */
class ancora_widget_most_viewed extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_most_viewed', 'description' => __('The most popular and most commented blog posts (extended)', 'ancora'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'ancora_widget_most_viewed');

		/* Create the widget. */
		parent::__construct( 'ancora_widget_most_viewed', __('Ancora - Most Viewed Posts', 'ancora'), $widget_ops, $control_ops );
	}
