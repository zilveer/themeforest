...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','buler'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','buler'),
		'last_text' => __('Last &raquo;','buler'),
		'next_text' => __('&raquo;','buler'),
		'prev_text' => __('&laquo;','buler'),
		'dotright_text' => __('...','buler'),
		'dotleft_text' => __('...','buler'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
