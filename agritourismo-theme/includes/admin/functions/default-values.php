<?php
	...
	if ( is_admin() && isset($_GET['activated'] ) && $pagenow == 'themes.php' ) {
		...
		$banner = '	<a href="http://www.orange-themes.com" target="_blank"><img src="'.get_template_directory_uri().'/images/no-banner728x90.jpg" alt="" /></a>';
		...
		update_option(THEME_NAME.'_shopping_cart ', "on");
		...
		update_option(THEME_NAME.'_color_1', '3c1805');
		update_option(THEME_NAME.'_color_2', 'e6dfba');
		update_option(THEME_NAME.'_color_3', '4c5c12');
		update_option(THEME_NAME.'_google_font_2', 'Coustard');
		update_option(THEME_NAME.'_google_font_1', 'Ropa Sans');
		update_option(THEME_NAME.'_font_size_1', '19');
		...
		update_option(THEME_NAME.'_shop_count', "8");
		...
		update_option(THEME_NAME.'_post_btn', "on");
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_template_directory(). '/includes/lib/plugins/layersliderwp-5.6.8.installable.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
