...
<ul id="bbp-forum-<?php bbp_forum_id(); ?>" <?php bbp_forum_class(null, 'single-forum'); ?>>
	...
	<li class="bbp-forum-topic-count">
		<div><span class="number"><?php bbp_forum_topic_count(); ?></span> <?php _e('topics', 'nanomag'); ?></div>
		<div><?php echo (bbp_show_lead_topic() 
				? '<span class="number">' . bbp_get_forum_reply_count() . '</span> ' . __('replies', 'nanomag') 
				: '<span class="number">' . bbp_get_forum_post_count() . '</span> ' . __('posts', 'nanomag')); ?></li>
