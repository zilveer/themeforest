...
if(get_field('page_subheader_layout', $page_id) == 'Fullwidth Background' && get_field('header_type', $page_id) == 'Transparent') :
	$alt_logo = false;
endif;
...
<header <?php tdp_attr( 'header' ); ?>>
	...
	<?php if(get_field('page_subheader_layout', $page_id ) == 'Fullwidth Background') : ?>

		<div id="subheader" <?php tdp_attr( 'subheader' ); ?>>

			<?php if(get_field('background_image_color_overlay', $page_id )) : ?>
			...
			<div class="container" id="overlay-content">
				<div class="row clearfix">
					...
					<?php if(get_field('sub_header_subtitle', $page_id )) : ?>
					<h2><?php the_field('sub_header_subtitle', $page_id ); ?></h2>
					<?php endif; ?>
					
					<h1 <?php tdp_attr( 'entry-title' ); ?>><?php the_field('sub_header_title', $page_id );?></h1>
	...
	<div id="subheader-static">
		<div class="container">
			...
			<?php if(get_field('add_custom_title_&_subtitle', $page_id )) : ?>
