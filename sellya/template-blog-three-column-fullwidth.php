<?php
/**
Template Name: Blog 3 Columns Fullwidth
 * @package Sellya
 * @subpackage Sellya
 */
...
<div class="row">
	<div class="span12" id="content">
		<div class="row-fluid">
			<div class="blog blog-3-column-full">
            <?php 
			...
			if ( have_posts() ) : ?>        					
                    ...
                    <?php $eclass = $i%3 == 0 ? 'span4 span-first-child':'span4'?>
                    
                    <div id="post-<?php the_ID(); ?>" <?php post_class($eclass)?>>
                    
                    	<div class="span12">
                        	<a href="<?php the_permalink();?>" rel="bookmark" title="<?php the_title();?>">
                            	<?php the_post_thumbnail(array(287,162));?>
                            </a>                            
                            <div class="span12">
