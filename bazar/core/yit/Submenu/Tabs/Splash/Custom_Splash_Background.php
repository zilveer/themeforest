 ...
 * @since 1.0.0
 */
class YIT_Submenu_Tabs_Splash_Custom_Splash_Background extends YIT_Submenu_Tabs_Abstract {
    /**
     * Default fields
     * 
     * @var array
    ...
    public function init() {  
        return array(
            ...
            30 => array(
                ...
                'std' => apply_filters( 'yit_splash-bg_image_std', YIT_IMAGES_URL . '/backgrounds/splash/01.jpg' )
            ),
            ...
            35 => array(
                ...
                'std' => apply_filters( 'yit_splash-bg_color_std', '#ffffff' )
            ),
                    	
            40 => array(
                'id' => 'splash-bg_image_repeat', 
                'type' => 'select',
                ...
                'std' => apply_filters( 'yit_splash-bg_image_repeat_std', 'repeat' )
            ),
                    	
            50 => array(
                'id' => 'splash-bg_image_position', 
                'type' => 'select',
                ...
                'std' => apply_filters( 'yit_splash-bg_image_position_std', 'top left' )
            ),
                    	
            60 => array(
                'id' => 'splash-bg_image_attachment', 
                'type' => 'select',
                ...
                'std' => apply_filters( 'yit_splash-bg_image_attachment_std', 'scroll' )
            ),
