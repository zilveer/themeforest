...
<div id="qode_shortcode_form_wrapper">
    <form id="qode_shortcode_form" name="qode_shortcode_form" method="post" action="">
        ...
        <div class="input">
            <label>Button Top Gradient</label>
            <div class="colorSelector"><div style=""></div></div>
            <input name="button_top_gradient" id="button_top_gradient" value="" maxlength="12" size="12" />
        </div>
        <div class="input">
            <label>Button Bottom Gradient</label>
            <div class="colorSelector"><div style=""></div></div>
            <input name="button_bottom_gradient" id="button_bottom_gradient" value="" maxlength="12" size="12" />
        </div>
        <div class="input">
