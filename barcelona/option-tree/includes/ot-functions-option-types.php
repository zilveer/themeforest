    ...
    echo '<div class="format-setting type-colorpicker ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">'; 
        ...
        echo '<div class="option-tree-ui-colorpicker-input-wrap">';
          ...
          $std = $field_std ? 'data-default-color="' . esc_attr( $field_std ) . '"' : '';
      ...
      echo '<div class="format-setting-inner">';
        ...
        if ( ! empty( $ids ) ) {
          ...
          foreach( $ids as $id ) {
            ...
            echo '<li><img  src="' . esc_url( $thumbnail[0] ) . '" width="75" height="75" /></li>';
    ...
    echo '<div class="format-setting type-link-color ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        $ot_recognized_link_color_fields = apply_filters( 'ot_recognized_link_color_fields', array(
          'link'    => esc_html_x( 'Standard', 'color picker', 'option-tree' ),
          'hover'   => esc_html_x( 'Hover', 'color picker', 'option-tree' ),
          'active'  => esc_html_x( 'Active', 'color picker', 'option-tree' ),
          'visited' => esc_html_x( 'Visited', 'color picker', 'option-tree' ),
          'focus'   => esc_html_x( 'Focus', 'color picker', 'option-tree' )
        ), $field_id );
        ...
        foreach( $ot_recognized_link_color_fields as $type => $label ) {
          ...
          if ( array_key_exists( $type, $ot_recognized_link_color_fields ) ) {
            ...
            echo '<div class="option-tree-ui-colorpicker-input-wrap">';
              ...
              /* set default color */
              $std = isset( $field_std[ $type ] ) ? 'data-default-color="' . esc_attr( $field_std[ $type ] ) . '"' : '';

              /* input */
              echo '<input type="text" name="' . esc_attr( $field_name ) . '[' . $type . ']" id="' . esc_attr( $field_id ) . '-picker-' . $type . '" value="' . esc_attr( $color ) . '" class="hide-color-picker ' . esc_attr( $field_class ) . '" ' . $std . ' />';
  ...
  function ot_type_list_item( $args = array() ) {
    ...
    echo '<div class="format-setting type-list-item ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        echo '<input type="hidden" name="' . esc_attr( $field_id ) . '_settings_array" id="' . esc_attr( $field_id ) . '_settings_array" value="' . esc_attr( ot_encode( serialize( $field_settings ) ) ) . '" />';
