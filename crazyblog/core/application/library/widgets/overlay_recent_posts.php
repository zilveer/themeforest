...
class crazyblog_overlay_recent_posts_Widget extends WP_Widget {

	function __construct() {
		parent::__construct( /* Base ID */'crazyblog-overlay-recent-posts', /* Name */ esc_html__( 'CrazyBlog Overlay Recent Posts', 'crazyblog' ), array( 'description' => esc_html__( 'This widget is used to show blog recent posts in overlay style.', 'crazyblog' ) ) );
	}
	...
	function form( $instance ) {
		$title = ($instance) ? esc_attr( crazyblog_set( $instance, 'title' ) ) : "Overlay Recent Post";
