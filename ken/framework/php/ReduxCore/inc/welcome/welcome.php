    ...
    class Redux_Welcome {
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = __( "Support hash could not be generated. Please try again later.", 'mk_framework' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            add_management_page(
                __( 'Welcome to Redux Framework', 'mk_framework' ), __( 'Redux Framework', 'mk_framework' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            add_management_page(
                __( 'Redux Framework Changelog', 'mk_framework' ), __( 'Redux Framework Changelog', 'mk_framework' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Get Support', 'mk_framework' ), __( 'Get Support', 'mk_framework' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            add_management_page(
                __( 'Redux Extensions', 'mk_framework' ), __( 'Redux Extensions', 'mk_framework' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            add_management_page(
                __( 'The people that develop Redux Framework', 'mk_framework' ), __( 'The people that develop Redux Framework', 'mk_framework' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            add_management_page(
                __( 'Redux Framework Status', 'mk_framework' ), __( 'Redux Framework Status', 'mk_framework' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-about' ), 'tools.php' ) ) ); ?>">
                    <?php _e( "What's New", 'mk_framework' ); ?>
                </a>
                <a class="nav-tab <?php echo $selected == 'redux-extensions' ? 'nav-tab-active' : ''; ?>"
                   href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'redux-extensions' ), 'tools.php' ) ) ); ?>">
                    <?php _e( 'Extensions', 'mk_framework' ); ?>
                </a>
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'mk_framework' ), $contributor->login ) )
                );
