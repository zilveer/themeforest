...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
	    ['1/4','element1-4',1/4,['Videos-Tab-Widget','Featured-Videos','Search-Widget','Twitter-Widget','Social-Media-Widget','Gallery','Column','Contact-Form','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Price-Item']],
		['1/3','element1-3',1/3,['Videos-Tab-Widget','Featured-Videos','Search-Widget','Twitter-Widget','Social-Media-Widget','Gallery','Column','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['1/2','element1-2',1/2,['Latest-Videos','Category-Videos','Top-Video','Search-Widget','Twitter-Widget','Social-Media-Widget','Gallery','Contact-Form','Column','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Price-Item','Product-Onsale']],
		['2/3','element2-3',2/3,['Videos-Tab-Widget','Featured-Videos','Latest-Videos','Category-Videos','Top-Video','Gallery','Column','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Price-Item']],
		['3/4','element3-4',3/4,['Videos-Tab-Widget','Featured-Videos','Top-Video','Latest-Videos','Category-Videos','Top-Video', 'Gallery','Column','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Price-Item']],
		['1/1','element1-1',1,['Videos-Tab-Widget','Featured-Videos','Top-Video','Latest-Videos','Category-Videos','Top-Video','Search-Widget','Twitter-Widget','Social-Media-Widget','Gallery','Widget','Column','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Contact-Form','Price-Item']]
	];
	...
	jQuery('select#page-option-top-slider-types').change(function(){
		if(jQuery(this).val()=='No Slider'){
			...
			jQuery(this).parents('.meta-body').siblings('#video-slider-wrapper').slideUp();
		}else if(jQuery(this).val()=='Video Slider'){
			jQuery(this).parents('.meta-body').siblings('#cp-top-slider-wrapper').slideUp();
			jQuery(this).parents('.meta-body').siblings('#cp-layer-slider-wrapper').slideUp();
			jQuery(this).parents('.meta-body').siblings('#video-slider-wrapper').slideDown();	
	...
	jQuery('select#page-option-top-widget-style').change(function(){
		if(jQuery(this).val()=='Style 2'){
			jQuery(this).parents('.meta-body').siblings('#widget-style-wrapper-1').slideUp();
			jQuery(this).parents('.meta-body').siblings('#widget-style-wrapper-2').slideDown();
		}else if(jQuery(this).val()=='Style 1'){
			jQuery(this).parents('.meta-body').siblings('#widget-style-wrapper-1').slideUp();
			jQuery(this).parents('.meta-body').siblings('#widget-style-wrapper-2').slideDown();
		}else{
			jQuery(this).parents('.meta-body').siblings('#widget-style-wrapper-2').slideDown();
