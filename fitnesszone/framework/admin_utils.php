...
function dt_theme_default_option() {
	$general = array (
			...
			'options-for-question' => array(__('What are all benefits of Gym?', 'iamd_text_domain'), __('What are the types of Gym?', 'iamd_text_domain'), __('Which time to start Gym?', 'iamd_text_domain'), ''),
			"bottom-phoneno-content" => '953 224 2235 221',
			"copyright-text" => '&copy; 2016 - Fitness Zone. Design: <a href="http://themeforest.net/user/designthemes" title="">Design Themes</a>',
			"currency-symbol" => "$",
