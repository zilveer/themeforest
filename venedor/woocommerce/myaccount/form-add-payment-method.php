    ...
    <div id="payment" class="woocommerce-Payment">
        ...
        <div class="form-row button-row">
            <?php wp_nonce_field( 'woocommerce-add-payment-method' ); ?>
                <input type="submit" class="woocommerce-Button woocommerce-Button--alt button pt-right alt" id="place_order" value="<?php esc_attr_e( 'Add Payment Method', 'woocommerce' ); ?>" />
