<?php
namespace QodeStartit\Modules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html = qode_startit_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
	...
	private function getElementsHolderItemClass($params) {
		...
		if ($params['hover_animation'] !== 'default') {
			$element_holder_item_class[] = 'qodef-'. $params['hover_animation'];
		}
