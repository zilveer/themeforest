...
class Woocommerce_Dropdown_Cart extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="shopping_cart_header">
			<a class="header_cart" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"><i class="fa fa-shopping-cart"></i><span class="header_cart_span"><?php echo $woocommerce->cart->cart_contents_count; ?></span></a>
