...
if ( !class_exists ( 'ReduxFramework_slides' ) ) {
    ...
    class ReduxFramework_slides {
        ...
        public function render () {
            ...
            echo '<div class="redux-slides-accordion" data-new-content-title="' . esc_attr ( sprintf ( __ ( 'New Service', 'redux-framework' ), $this->field[ 'content_title' ] ) ) . '">';
            ...
            if ( $x == 0 ) {
                echo '<div class="redux-slides-accordion-group"><fieldset class="redux-field" data-id="' . $this->field[ 'id' ] . '"><h3><span class="redux-slides-header">' . esc_attr ( sprintf ( __ ( 'New Service', 'redux-framework' ), $this->field[ 'content_title' ] ) ) . '</span></h3><div>';
            ...
            echo '</div><a href="javascript:void(0);" class="button redux-slides-add button-primary" rel-id="' . $this->field[ 'id' ] . '-ul" rel-name="' . $this->field[ 'name' ] . '[title][]' . $this->field['name_suffix'] .'">' . sprintf ( __ ( 'Add Service', 'redux-framework' ), $this->field[ 'content_title' ] ) . '</a><br/>';
        }
