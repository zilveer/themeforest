<?php
/*
Template Name: Blog: Title & Author (Centered)
*/
?>
<?php get_header(); ?>
<?php
...
if(isset($edgt_options['blog_title_author_centered_content_position'])){
	$blog_content_position = $edgt_options['blog_title_author_centered_content_position'];
}
...
if(isset($edgt_options['blog_title_author_centered_number_of_chars']) && $edgt_options['blog_title_author_centered_number_of_chars']) {
    edgt_set_blog_word_count(esc_attr($edgt_options['blog_title_author_centered_number_of_chars']));
}
