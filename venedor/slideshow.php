...
if ($slideshow_type != 'none') :
    ...
    <div class="post-slideshow-wrap <?php echo $layout ?>">
        <div id="post-slideshow-<?php echo $post->ID ?>" class="post-slideshow owl-carousel">
            <?php $attachment_image = wp_get_attachment_image_src(get_post_thumbnail_id(), $attach_size); ?>
            ...
            ?>
                <?php $attachment_image = wp_get_attachment_image_src($attachment_new_id, $attach_size); ?>
