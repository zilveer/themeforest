                ...
                <div class="archive archive-1 post-archive main-box-for-load-more ">
                    ...
                    <div class="row">
                        <div class="fave-loop-wrap">
                            <div class="fave-post latest-video">
                                ...
                                <div class="<?php echo $css_classes; ?>">
                                    <div class="thumb big-thumb">
                                        ...
                                        <div class="slide-image-wrap">
                                            ...
                                            <img class="featured-image"  width="<?php echo $img_width; ?>" height="<?php echo $img_height; ?>" src="<?php echo fave_featured_image( get_the_ID(), $img_width, $img_height, true, true, true ); ?>" alt="<?php the_title(); ?>">
