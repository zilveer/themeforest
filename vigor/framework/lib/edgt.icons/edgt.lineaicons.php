...
class EdgeIconsLineaIcons implements iIconCollection {
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = EDGE_ROOT . "/css/linea-icons/style.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="edgt_icon_linea_icon ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
