...
define( 'NOTIFIER_THEME_NAME', 'modello' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'cb-modello' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://cb-theme.com/demo/modello/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
