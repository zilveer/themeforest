...
class sidebar_generator {
	...
	public static function admin_menu(){
		...
		add_theme_page(  __('Custom Sidebars', 'nanomag'),  __('Custom Sidebars', 'nanomag'), 'manage_options', 'sidebar_generator.php', array('sidebar_generator','admin_page'));
	...
	public static function admin_page(){
		...
		<div class="wrap">
			<h2><?php _e('Custom Sidebars','nanomag'); ?></h2>
			<br />
			...
			<table class="widefat page" id="sbg_table" style="width:600px;">
				...
				<?php
					...
					?>
					<tr>
						<td colspan="3"><?php _e('No Sidebars defined', 'nanomag'); ?></td>
					</tr>
					<?php
				}
				?>
		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>
	<?php _e('Select the custom sidebar, leave unselected to use the default sidebar', 'nanomag'); ?>
					</p>
					<ul>
					<?php 
