...
<div class="inner">
	...
	<div class="element classic4_cols">
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_ID; ?>" class="portfolio_desc portfolio4 filterable">
            <h6 class="cufon"><?php echo get_the_title(); ?></h6>
            <p><?php echo pp_substr(strip_tags(pp_strip_shortcodes(get_the_content())), 80); ?></p>
        </div>
	</div>
	<?php
		echo $clear_br;
