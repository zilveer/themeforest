...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Site Layout', 'themeva-admin'),
		'desc' => '',
		'id' => 'wide_layout',
		'std' => '',
		'type' => 'select',
		'options' => array(
			'enable' => __('Wide', 'themeva-admin'),
			'wide_boxed' => __('Wide + Boxed Content', 'themeva-admin'),
			'' => __('Boxed', 'themeva-admin')
		)	
	);		
	...
	$options[] = array(
		...
		'plac' => __('Default is 2', 'themeva-admin'),
		'id' => 'sidebars_num',
	...
	$options[] = array(
		'name' => __('Header Layout', 'themeva-admin'),
		'desc' => '',
		'id' => 'header_layout',
		'std' => 'left',
		'type' => 'select',
		'options' => array(
			...
			'top-lr' => __('Top: Logo Left | Menu Right', 'themeva-admin'),
			'top-cc' => __('Top: Logo Center | Menu Center', 'themeva-admin'),	
			'top-rl' => __('Top: Logo Right | Menu Left', 'themeva-admin'),
		)	
	);	

	$options[] = array(
		'name' => __('Collapse Header', 'themeva-admin'),
		'id' => 'collapse_menu',
		'std' => 'disable',
		'type' => 'radio',
		'options' => array(
			'disable' => __('Off', 'themeva-admin'),
			'collapse-menu' => __('Desktop & Mobile', 'themeva-admin'),
			'collapse-menu-mobile' => __('Mobile', 'themeva-admin')
		)	
	);

	$options['header_tagline'] = array(
