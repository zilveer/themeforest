...
?>
	...
	<div id="bbp-author-favorites" class="bbp-author-favorites">
		<h2 class="entry-title"><?php _e( 'Favorite Forum Topics', 'mk_framework' ); ?></h2>
		<div class="bbp-user-section">
			...
			<?php else : ?>
				...
				<p><?php bbp_is_user_home() ? _e( 'You currently have no favorite topics.', 'mk_framework' ) : _e( 'This user has no favorite topics.', 'mk_framework' ); ?></p>
