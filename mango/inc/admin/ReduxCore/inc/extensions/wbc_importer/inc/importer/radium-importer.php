...
d    /**
    ...
    public function process_imports() {
	  ...
	  // Set imported menus to registered theme locations
            ...
            if ($menus) {
                ...
                foreach($menus as $menu) { // assign menus to theme locations
                    ...
                    } else if( $menu->name == 'Home footer 1' ) {

                        $locations['footer_menu'] = $menu->term_id;

                    } else if( $menu->name == 'Header 14 Side Menu' ) {

                        $locations['header_14_menu'] = $menu->term_id;

                    }  else if( $menu->name == 'Demo21 Primary Menu' ) {
      ...
      $wbc_home_pages = array(
          'Demo1'  => 'Home Version 1',
          'Demo2'  => 'Home Version 2',
          'Demo3'  => 'Home Version 3',
          'Demo4'  => 'Home Version 4',
          'Demo5'  => 'Home Version 5',
          'Demo6'  => 'Home Version 6',
          'Demo7'  => 'Home Version 7',
          'Demo8'  => 'Home Version 8',
          'Demo9'  => 'Home Version 9',
          'Demo10' => 'Home Version 10',
          'Demo11' => 'Home Version 11',
          'Demo12' => 'Home Version 12',
          'Demo13' => 'Home Version 13',
          'Demo14' => 'Home Version 14',
          'Demo15' => 'Home Version 15',
          'Demo16' => 'Home Version 16',
          'Demo17' => 'Home Version 17',
          'Demo18' => 'Home Version 18',
          'Demo19' => 'Home Version 19',
          'Demo20' => 'Home Version 20',
		  'Demo21' => 'Home Version 21',
						
		  );

        $current_demo = get_option("mango_demo_content");
      		// Set reading options

            $homepage = get_page_by_title( $wbc_home_pages[$current_demo] );

            $posts_page = get_page_by_title( 'Blog' );

            if ($posts_page->ID && $homepage->ID ) {
		...
		if( class_exists( 'WooCommerce' ) ){
			...
			if ($shoppage->ID) {
				...
				update_option('woocommerce_shop_page_id', $shoppage->ID); // Shop Page

			}

			if ($cartpage->ID) {

				update_option('woocommerce_cart_page_id', $cartpage->ID); // Cart Page

			}

			if ($checkoutpage->ID) {

				update_option('woocommerce_checkout_page_id', $checkoutpage->ID); // Cart Page

			}

			if ($myaccountpage->ID) {

				update_option('woocommerce_myaccount_page_id', $myaccountpage->ID); // Cart Page
		...
		update_option('blogdescription', 'Responsive Multipurpose WordPress Theme' );
