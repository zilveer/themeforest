<div class="wrap about-wrap">
    ...
    <div id="redux-message" class="updated">
        <h4><?php esc_html_e( 'What is Redux Framework?', 'redux-framework' ); ?></h4>
        ...
        <p class="submit">
            <a class="button-primary" href="<?php echo 'http://';?>reduxframework.com"
               target="_blank"><?php esc_html_e( 'Learn More', 'redux-framework' ); ?></a>
        </p>
    </div>

    <div class="changelog">

        <h2><?php esc_html_e( 'New in this Release', 'redux-framework' ); ?></h2>
