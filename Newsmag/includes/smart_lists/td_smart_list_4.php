        ...
        $buffy .= '<div class="td-item">';
            ...
            $first_img_info = wp_get_attachment_image_src($item_array['first_img_id'], 'thumbnail');
                ...
                if (!empty($first_img_info[0])) {
                    ...
                    $buffy .= '<figure class="td-sml4-image-and-caption td-slide-smart-list-figure' . $smart_list_lightbox . '">
                                    <a class="td-sml4-link-to-image" href="' . $first_img_all_info['src'] . '" data-caption="' . esc_attr($first_img_caption, ENT_QUOTES) . '">
                ...
                if(!empty($item_array['description'])) {
                    $buffy .= '<div class="td-number-and-title"><h2><span class="td-sml4-nr">' . $current_item_number. '</span><span class="td-sml4-current-item-nr">' . $smart_list_4_title . '</span> </h2></div>
