...
get_header(); 
	...
	<div id="white_content">
		...
		<div style="width:100% !important;" class="post-listing" <?php echo $postlistingstyle; ?>>
			...
			<?php
			    ...
			    while ( have_posts() ) : 
			    	...
			    	the_post();	 ?>
				    	...
				    	<article style="width: 95.5%;left:1%;" id="post-<?php the_ID(); ?>" class="<?php $pc = get_post_class(); foreach($pc as $p) echo $p." "; ?> post<?php if ($sidebar == "left") echo " fifteen columns"; ?>" <?php if ($sidebar == "left") echo "style='float:right;'"; ?>>
