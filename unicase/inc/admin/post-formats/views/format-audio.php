<div class="cf-elm-block" id="cfpf-format-audio-fields" style="display: none;">
	<!-- <label for="cfpf-format-audio-embed"><?php esc_html_e('Audio URL (oEmbed) or Embed Code', 'unicase'); ?></label>
	...
	<div id="postbox-container-postformat" class="postbox-container">
		<!-- <div class="meta-box-sortables ui-sortable"> -->
			...
			<div id="meta-box-postformat-video" class="postbox" style="display: block;">
				...
				<h3><span><?php esc_html_e('Audio Options', 'unicase'); ?></span></h3>
				
				<div class="inside">

					<p style="padding:10px 0 0 0;"><?php esc_html_e('Enter the paths to your audio files in the fields below', 'unicase'); ?></p>
							...
							<tr>
								<th>
									<label for="postformat_audio_mp3">
										<strong><?php esc_html_e('MP3 File URL', 'unicase'); ?></strong>
										<span><?php esc_html_e('URL to an .mp3 file', 'unicase'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_audio_ogg">
										<strong><?php esc_html_e('OGA File URL', 'unicase'); ?></strong>
										<span><?php esc_html_e('URL to an .oga or .ogg file', 'unicase'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_audio_embedded">
										<strong><?php esc_html_e('Embedded Audio', 'unicase'); ?></strong>
										<span><?php esc_html_e('Add embedded audio formats.', 'unicase'); ?></span>
									</label>
								</th>
								<td>
