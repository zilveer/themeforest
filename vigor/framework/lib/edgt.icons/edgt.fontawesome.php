...
class EdgeIconsFontAwesome implements iIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = EDGE_ROOT . "/css/font-awesome/css/font-awesome.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<i class="edgt_icon_font_awesome fa ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></i>';
