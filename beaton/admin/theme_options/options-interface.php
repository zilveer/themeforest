    ...
    foreach ($options as $value) {
        ...
        switch ($value['type']) {
            ...
            case 'typography':
                ...
                // Font Weight
                $output .= '<select class="of-typography of-typography-style" name="' . $option_name . '[' . $value['id'] . '][style]" id="' .  esc_attr( $value['id'] ) . '_style">';
            ...
            case "heading":
                ...
                $menu .= '<li><a id="' . esc_attr($jquery_click_hook) . '-tab" title="' . esc_attr($value['name']) . '" href="' . esc_attr('#' . $jquery_click_hook) . '"><img src="' . get_template_directory_uri() . '/admin/theme_options/images/' . esc_html($value['icon']) . '" width="16" height="16" border="0" align="left"> &nbsp;' . esc_html($value['name']) . '</a></li>';
