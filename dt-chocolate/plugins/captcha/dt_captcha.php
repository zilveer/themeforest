...
//            Dt_Captcha::$label_form = $options['captcha_label_form'];
    ...
    function generate_captcha() {
        ...
        $number_string = array(); 
        $number_string[0] = __( 'null', LANGUAGE_ZONE );
        $number_string[1] = __( 'one', LANGUAGE_ZONE );
        $number_string[2] = __( 'two', LANGUAGE_ZONE );
        $number_string[3] = __( 'three', LANGUAGE_ZONE );
        $number_string[4] = __( 'four', LANGUAGE_ZONE );
        $number_string[5] = __( 'five', LANGUAGE_ZONE );
        $number_string[6] = __( 'six', LANGUAGE_ZONE );
        $number_string[7] = __( 'seven', LANGUAGE_ZONE );
        $number_string[8] = __( 'eight', LANGUAGE_ZONE );
        $number_string[9] = __( 'nine', LANGUAGE_ZONE ); 
        // In letters presentation of numbers 11 -19
        $number_two_string = array();
        $number_two_string[1] = __( 'eleven', LANGUAGE_ZONE );
        $number_two_string[2] = __( 'twelve', LANGUAGE_ZONE );
        $number_two_string[3] = __( 'thirteen', LANGUAGE_ZONE );
        $number_two_string[4] = __( 'fourteen', LANGUAGE_ZONE );
        $number_two_string[5] = __( 'fifteen', LANGUAGE_ZONE );
        $number_two_string[6] = __( 'sixteen', LANGUAGE_ZONE );
        $number_two_string[7] = __( 'seventeen', LANGUAGE_ZONE );
        $number_two_string[8] = __( 'eighteen', LANGUAGE_ZONE );
        $number_two_string[9] = __( 'nineteen', LANGUAGE_ZONE );
        // In letters presentation of numbers 10, 20, 30, 40, 50, 60, 70, 80, 90
        $number_three_string = array();
        $number_three_string[1] = __( 'ten', LANGUAGE_ZONE );
        $number_three_string[2] = __( 'twenty', LANGUAGE_ZONE );
        $number_three_string[3] = __( 'thirty', LANGUAGE_ZONE );
        $number_three_string[4] = __( 'forty', LANGUAGE_ZONE );
        $number_three_string[5] = __( 'fifty', LANGUAGE_ZONE );
        $number_three_string[6] = __( 'sixty', LANGUAGE_ZONE );
        $number_three_string[7] = __( 'seventy', LANGUAGE_ZONE );
        $number_three_string[8] = __( 'eighty', LANGUAGE_ZONE );
        $number_three_string[9] = __( 'ninety', LANGUAGE_ZONE );
        ...
        if( 2 == $rand_input ) {
            ...
            if( $array_math_expretion[2] < 10 )
                ...
                if ( get_bloginfo( 'language', 'Display' ) == "nl-NL" ) {
                    $str_math_expretion .= " ".( 0 != $array_math_expretion[2] % 10 ? $number_string[ $array_math_expretion[2] % 10 ]. __( "and", LANGUAGE_ZONE ) : '').$number_three_string[ $array_math_expretion[2] / 10 ];
                } else {
        ...
        $str_math_expretion = str_replace( '<input', '<input class="validate[required] i-h"', $str_math_expretion );
