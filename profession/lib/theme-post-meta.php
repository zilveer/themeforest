...
class BlogPostMeta extends PostMeta
{
	...
	function GetMetaKeys()
	{
		return array('content_type',
					'post_image_1' => array('type'=>'upload'),
					'post_image_2' => array('type'=>'upload'),
					'post_image_3' => array('type'=>'upload'),
					'post_image_4' => array('type'=>'upload'),
					'post_image_5' => array('type'=>'upload'),
					'post_image_6' => array('type'=>'upload'),
					'post_image_7' => array('type'=>'upload'),
					'post_image_8' => array('type'=>'upload'),
					'post_image_9' => array('type'=>'upload'),
					'post_image_10' => array('type'=>'upload'),
