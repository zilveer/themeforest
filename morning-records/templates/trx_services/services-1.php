...
if ( !function_exists( 'morning_records_template_services_1_theme_setup' ) ) {
	add_action( 'morning_records_action_before_init_theme', 'morning_records_template_services_1_theme_setup', 1 );
	function morning_records_template_services_1_theme_setup() {
		morning_records_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'morning-records'),
...
// Template output
if ( !function_exists( 'morning_records_template_services_1_output' ) ) {
	function morning_records_template_services_1_output($post_options, $post_data) {
