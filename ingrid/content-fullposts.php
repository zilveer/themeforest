	...
	print '
		<header>
			...
			if(get_post_format() == 'link'){
				...
				print '<h1><a href="'.get_permalink().'" title="'; the_title_attribute(); print '">'.get_the_title().'</a></h1>';
			}
			...
			<div class="info">
				...
				<p class="sep">&nbsp;</p>
				<p><i class="fa fa-comment"></i> <a href="'.get_permalink().'">'; comments_number( __('0 COMMENT','ingrid'), __('1 COMMENT','ingrid'), __('% COMMENTS','ingrid') ); print '</a></p>
				<p class="sep">&nbsp;</p>
