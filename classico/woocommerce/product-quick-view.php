            ...
            <div class="row">
	            ...
	            <?php if (etheme_get_option('quick_images') != 'none'): ?>
	                <div class="col-lg-6 col-sm-6 product-images">
		                <?php if (etheme_get_option('quick_images') == 'slider'): ?>
		                	...
		                	?>
		                <?php else: ?>
		                	<?php the_post_thumbnail( $post->ID, apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ), array( 'title' => $image_title ) ); ?>
		                <?php endif; ?>
                ...
                <div class="col-lg-<?php if (etheme_get_option('quick_images') != 'none'): ?>6<?php else: ?>12<?php endif; ?> col-sm-6 product-information">
                    <div class="product-navigation clearfix">
						<h4 class="zlarge-h meta-title"><span><?php _e('Product Description', ET_DOMAIN); ?></span></h4>
					</div>
					...
					<?php if (etheme_get_option('product_link')): ?>
			        	<a href="<?php the_permalink(); ?>" class="show-full-details"><?php _e('Show full details', ET_DOMAIN); ?></a>
					<?php endif; ?>
