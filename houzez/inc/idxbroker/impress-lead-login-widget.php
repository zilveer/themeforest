...
class IMPress_Lead_Login_Widget extends \WP_Widget
{
    ...
    public function __construct(\IDX\Idx_Api $idx_api)
    {
        ...
        parent::__construct(
            ...
            __('HOUZEZ: IMPress Lead Login', 'houzez'), // Name
            array(
                'description' => __('Lead login form', 'houzez'),
                'classname' => 'houzez-impress-idx-login-widget',
            )
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        <form action="<?php echo $this->idx_api->subdomain_url();?>ajax/userlogin.php" class="impress-lead-login" method="post" target="<?php echo $target?>" name="leadLoginForm">
            ...
            <div class="form-group">
                <input class="form-control" required id="impress-widgetEmail" type="email" name="email" placeholder="<?php esc_html_e('Enter your email address', 'houzez'); ?>">
            </div>
            <div class="form-group">
                <input class="form-control" id="impress-widgetPassword" type="hidden" name="password" value="">
            </div>
            <input class="btn btn-orange btn-block" id="impress-widgetLeadLoginSubmit" type="submit" name="login" value="<?php esc_html_e('Log In', 'houzez');?>">
        </form>
