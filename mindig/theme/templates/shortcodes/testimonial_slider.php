...
$show_border = ( $show_border == 'yes') ? '' : 'no-border';
?>

<div class="testimonials-slider <?php echo esc_attr( $show_border . $vc_css ); ?>">
    <?php if ( $is_slider ): ?>
        <ul class="testimonial-content owl-slider" data-slidespeed="<?php echo $speed ?>" data-pagination="<?php echo $pagination ?>" data-paginationspeed="<?php echo $paginationspeed ?>" data-navigation="<?php echo $navigation ?>" data-singleitem="true" data-autoplay="<?php echo $autoplay ?>" >
    <?php else: ?>
