...
<?php
    ...
    if ($canon_options['dev_mode'] == "checked") {
        if (isset($_GET['main_custom_center'])) { $canon_options_frame['main_custom_center'] = wp_filter_nohtml_kses($_GET['main_custom_center']); }
    ...
    <div class="outter-wrapper header-container <?php if ($canon_options_frame['use_sticky_header'] == 'checked') { echo "canon_sticky"; } ?>">
        ...
        <div class="wrapper">
            <header class="clearfix centered">
                ...
                <?php get_template_part('inc/templates/header/template_header_element_' . $canon_options_frame['main_custom_center']); ?>
