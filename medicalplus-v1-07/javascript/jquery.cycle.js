...
jQuery(window).load(function(){
	...
	if( personnal_widget.length > 0 ){
		personnal_widget.each(function(){
			var personnal_nav = jQuery(this).siblings('.custom-sidebar-title').find('.personnal-widget-navigation');
	...
	// personnal item
	var personnal_item = jQuery('.gdl-carousel-personnal .personnel-carousel-item-wrapper');
	if( personnal_item.length > 0 ){
		personnal_item.each(function(){
			var personnal_nav = jQuery(this).siblings('.personnal-navigation');
			gdl_cycle_resize(jQuery(this));
			jQuery(this).cycle({ fx: 'fade', slideResize: 1, fit: true, width: '100%', // timeout: 4000, speed: 1000,
				prev: personnal_nav.children('.personnal-prev'), next: personnal_nav.children('.personnal-next') });
		});
	}	
	
	// responsive case
	jQuery(window).resize(function(){ 
		if( personnal_item ){ gdl_cycle_resize(personnal_item); }
