...
//options
include_once ELATED_FRAMEWORK_MODULES_ROOT_DIR.'/header/options-map/header-map.inc';
...
//header types
include_once ELATED_FRAMEWORK_MODULES_ROOT_DIR.'/header/types/header-type2.php';
...
//custom styles
include_once ELATED_FRAMEWORK_MODULES_ROOT_DIR.'/header/custom-styles/header.inc';
