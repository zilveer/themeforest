...
/*-----------------------------------------------------------------------------------*/
	...
	function __construct() {
    	$widget_ops = array(
			...
			'description' => esc_attr__('Display a list of carousel post.', 'nanomag')
		);
    	parent::__construct('rec-carousel-posts', esc_attr__('jellywp: Carousel Posts', 'nanomag'), $widget_ops);
	}
