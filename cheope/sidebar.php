...
<!-- START SIDEBAR -->
<div id="sidebar-<?php echo sanitize_title( yit_get_choosen_sidebar() ) ?>" class="span<?php echo is_page_template( 'home.php' ) && yit_get_option( 'home-sidebar-width' ) == '2' ? 2 : 3 ?> sidebar group">
    <?php
