<?php
	...
	function gdl_add_cufon() {
		...
		if($used_font != 'default -'){
			if($all_font[$used_font]['type'] == 'Cufon'){
				echo "Cufon.replace(jQuery('div.navigation-wrapper, div.header-navigation-wrapper'), {fontFamily: '" . $used_font . "' , hover: true});";
				echo "jQuery('div.navigation-wrapper, div.header-navigation-wrapper').css('visibility', 'visible');";
			}
		}		
