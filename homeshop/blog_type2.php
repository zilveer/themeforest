   ...
   <div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12">
		   ...
		   ?>
		    ...
		    <div class="col-lg-12 col-md-12 col-sm-12">      	
				<div <?php post_class('blog-item blog_style_2'); ?> >
					...
					<div class="blog-info" style="min-height:290px;">
						...
						<p class="post-description"  style="margin-top:30px;"><?php the_excerpt_max_charlength(40); ?></p>
						
					
					
					
					
					<div class="product-actions blog-actions" style="position: absolute; right: 40px; bottom: 50px;">
