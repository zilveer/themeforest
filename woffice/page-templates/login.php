...
if (is_user_logged_in()) : 	
	...
	// Second landing :
	$login_layout = ( function_exists( 'fw_get_db_settings_option' ) ) ? fw_get_db_settings_option('login_layout') : '';
	...
	<body <?php body_class($login_layout); ?>>
		...
		<div id="page-wrapper">
			<div id="content-container">
				...
				$login_revslider = ( function_exists( 'fw_get_db_settings_option' ) ) ? fw_get_db_settings_option('login_revslider') : '';
				?>
		...
		<script type="text/javascript">
			if (jQuery('#success-register').length > 0) {
				...
				<?php $register_autoredirect = (function_exists('fw_get_db_settings_option')) ? fw_get_db_settings_option('register_autoredirect') : '';
