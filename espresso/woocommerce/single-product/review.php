...
<li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<?php echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '48' ), '' ); ?>
		...
		<div class="comment-text">
			...
			<?php else : ?>
				...
				<p class="meta">
					<strong itemprop="author"><?php if (get_user_meta( $comment->user_id, 'nickname', true )): echo get_user_meta( $comment->user_id, 'nickname', true ); else : comment_author(); endif; ?></strong> <?php
