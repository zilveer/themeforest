...
$prefix = 'g5plus_';
$g5plus_header_customize_current = 'nav';
...
if ($enable_header_customize == '1') {
	...
	$header_customize_nav_separate = rwmb_meta($prefix . 'header_customize_nav_separate');
	...
	if (isset($g5plus_options['header_customize_nav_separate']) && ($g5plus_options['header_customize_nav_separate'] == '1')){
		$header_customize_class[] = 'header-customize-separate';
	}
}
?>
