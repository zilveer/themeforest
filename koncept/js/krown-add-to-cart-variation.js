...
/*!
 * Variations Plugin - from 11 Feb 2015
 */
;(function ( $, window, document, undefined ) {
	...
	$.fn.wc_variations_image_update = function( variation ) {
		...
		if ( variation && variation.image_link && variation.image_link.length > 1 ) {

			var src = variation.image_link,
				alt = variation.image_title;

			if ( $flexslider.length ) {

				$flexslider.find('li img').each(function(){
					if ( $(this).attr('src') === variation.image_link ) {
