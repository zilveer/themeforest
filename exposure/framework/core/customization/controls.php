 ...
 */
if( ! class_exists('THB_Divider_Control') ) {
 ...
 * @see WP_Customize_Control
 */
if( ! class_exists('THB_FontFamily_Control') ) {
...
if( ! class_exists('THB_TextVariant_Control') ) {
 ...
 * @see WP_Customize_Control
 */
if( ! class_exists('THB_FontSize_Control') ) {
 ...
 * @see WP_Customize_Control
 */
if( ! class_exists('THB_FontLineHeight_Control') ) {
 ...
 * @see WP_Customize_Control
 */
if( ! class_exists('THB_FontLetterSpacing_Control') ) {
 ...
 * @see WP_Customize_Control
 */
if( ! class_exists('THB_FontWeight_Control') ) {
 ...
 * @see WP_Customize_Control
 */
if( ! class_exists('THB_FontCase_Control') ) {
 ...
 * @see WP_Customize_Control
 */
if( ! class_exists('THB_FontStyle_Control') ) {
...
if ( ! class_exists('THB_BackgroundRepeat_Control') ) {
...
if( ! class_exists('THB_BackgroundPosition_Control') ) {
...
if( ! class_exists('THB_BackgroundAttachment_Control') ) {
