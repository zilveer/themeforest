...
add_ux_builder_shortcode( 'blog_posts', array(
    ...
    'presets' => array(
        array(
            'name' => __( 'Normal' ),
            'content' => '[blog_posts style="normal" columns="3" image_height="56.25%"]'
        ),
        array(
            'name' => __( 'Bounce' ),
        ...
        array(
            'name' => __( 'Push' ),
            'content' => '[blog_posts style="push" columns="3" badge_style="circle-inside" image_height="75%"]'
        ),
        array(
            'name' => __( 'Vertical' ),
            'content' => '[blog_posts style="vertical" slider_nav_style="simple" slider_nav_position="outside" columns="2" depth="2" image_height="89%" image_width="43"]'
        ),
        array(
            'name' => __( 'Overlay' ),
