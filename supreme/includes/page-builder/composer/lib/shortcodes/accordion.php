...
class WPBakeryShortCode_VC_Accordion extends WPBakeryShortCode {
    ...
    public function __construct($settings) {
        ...
        SwiftPageBuilder::getInstance()->addShortCode( array( 'base' => 'vc_accordion_tab' ) );
    }

    protected function content( $atts, $content = null ) {
        wp_enqueue_script('jquery-ui-accordion');
        $widget_title = $type = $interval = $width = $el_position = $el_class = '';
        //
        extract(shortcode_atts(array(
            'widget_title' => '',
            'type'	=> 'standard',
        ...
        $output .= "\n\t".'<div class="wpb_accordion '. $type .' wpb_content_element '.$width.$el_class.' not-column-inherit">'; //data-interval="'.$interval.'"
