...
if ( !function_exists( 'morning_records_template_services_4_theme_setup' ) ) {
	add_action( 'morning_records_action_before_init_theme', 'morning_records_template_services_4_theme_setup', 1 );
	function morning_records_template_services_4_theme_setup() {
		morning_records_add_template(array(
			'layout' => 'services-4',
			'template' => 'services-4',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 4/', 'morning-records')
		));
	}
}

// Template output
if ( !function_exists( 'morning_records_template_services_4_output' ) ) {
	function morning_records_template_services_4_output($post_options, $post_data) {
