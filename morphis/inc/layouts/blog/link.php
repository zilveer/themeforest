		...
		<div class="three columns alpha clearfix">
			<ul class="entry-meta meta1 clearfix">
				...
				<li><img src="<?php echo get_template_directory_uri() . '/images/icons/glyphish/203-link.png'; ?>" class="post-format-icon" title="<?php _e( 'Link Post Format', 'morphis' ); ?>"/></li>
				<?php endif; ?>
		...
		<?php endif; ?>		
			...
			<div class="post-body">				
				...
				<h2 class="entry-title"><a href="<?php echo $postformat_link; ?>" title="<?php printf( esc_attr( __( 'Permalink to %s', 'morphis' ) ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" class="link-format" target="_blank"><?php the_title(); ?> &rarr;</a></h2>			
