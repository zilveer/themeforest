...
class NHP_Options{
	...
	*/
	function __construct($sections = array(), $args = array(), $extra_tabs = array()){
		...
		$defaults['footer_credit'] = __('<span id="footer-thankyou">Webnus web development group. Visit us on <a href="http://themeforest.net/user/WEBNUS/" target="_blank">Themeforest</a>  </span>', 'nhp-opts');
					...
					echo '<ul id="nhp-opts-group-menu">';
						...
						if(true === $this->args['show_import_export']){
							echo '<li id="import_export_default_section_group_li" class="nhp-opts-group-tab-link-li">';
									echo '<a href="javascript:void(0);" id="import_export_default_section_group_li_a" class="nhp-opts-group-tab-link-a" data-rel="import_export_default"><img src="'.$this->url.'img/admin-import.png" /> <span>'.__('Import / Export', 'nhp-opts').'</span></a>';
							echo '</li>';
							echo '<li class="divide">&nbsp;</li>';
						}//if
						...
						echo '<div id="import_export_default_section_group'.'" class="nhp-opts-group-tab">';
							...
							echo '<div id="nhp-opts-import-link-wrapper">';
								...
								echo '<div class="nhp-opts-section-desc">';
									...
									echo '<p class="description" id="import-link-description">'.apply_filters('nhp-opts-import-link-description',__('Select Template and hit Import to load the options.', 'nhp-opts')).'</p>';
								
								echo '</div>';

								echo '<select id="import-link-value" name="'.$this->args['opt_name'].'[import_link]">
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/rose.txt">Rose</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/jasmine.txt">Jasmine</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/violet.txt">Violet</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/orchid.txt">Orchid</option>
											<option value="'.get_template_directory_uri() . '/inc/dummy-data/planner.txt">Planner</option>
										</select>';
