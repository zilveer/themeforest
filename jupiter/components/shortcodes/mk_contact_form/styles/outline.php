...
echo mk_get_shortcode_view('mk_contact_form', 'components/name-field', true, array('tab_index' => $view_params['id']++, 'phone' => $view_params['phone']));

if($view_params['phone'] == 'true') {
    echo mk_get_shortcode_view('mk_contact_form', 'components/phone-field', true, array('tab_index' => $view_params['id']++, 'phone' => $view_params['phone'])); 
} 

echo mk_get_shortcode_view('mk_contact_form', 'components/email-field', true, array('tab_index' => $view_params['id']++, 'phone' => $view_params['phone']));
