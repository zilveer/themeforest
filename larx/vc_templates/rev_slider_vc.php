...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_revslider_element wpb_content_element1' . $el_class, $this->settings['base'], $atts );
...
if (isset($GLOBALS['th_nav_position']) && $GLOBALS['th_nav_position'] == 'bottom' ) {
