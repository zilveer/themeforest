...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            'classname' => 'clearfix',
            'description' => esc_attr__('Display post in tab by select category', 'nanomag')
        );
        parent::__construct('tab-post-widget', esc_attr__('jellywp: Tab post Widget', 'nanomag'), $widget_ops);
    }
