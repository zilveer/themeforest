...
class YIT_Submenu_Tabs_Theme_option_Colors_General extends YIT_Submenu_Tabs_Abstract {
    ...
    public function init() {  
        return array(        	                   	
            ...
            30 => array(
                'id' => 'bg_image', // per farlo conincidere con i metabox
                'type' => 'upload',
            ...
            40 => array(
                'id' => 'bg_image_repeat', // per farlo conincidere con i metabox
                'type' => 'select',
            ...
            50 => array(
                'id' => 'bg_image_position', // per farlo conincidere con i metabox
                'type' => 'select',
            ...
            60 => array(
                'id' => 'bg_image_attachment', // per farlo conincidere con i metabox
                'type' => 'select',
