...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page( 'wp_nuvo', 'Theme Options', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
...
function of_load_only()
{
    ...
    wp_enqueue_script( 'preset-js', ADMIN_DIR .'assets/js/action.js', array() );
    //wp_enqueue_script( 'google-fonts', ADMIN_DIR .'assets/js/google.fonts.js', array(),'1.0.0');
