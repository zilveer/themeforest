<?php
class DistinctiveThemes_Commented_Posts_Widget extends WP_Widget {
  function DistinctiveThemes_Commented_Posts_Widget() { 
    parent::WP_Widget(false, $name = 'DistinctiveThemes Commented Posts Widget'); 
  }
    ...
    <div class="dt-recent-post clearfix">                               
      ...
      <div class="recentex eightcol last">
        <h3 class="portfolio-widget-title"><a href="<?php $link = the_permalink(); echo esc_url($link); ?>"><?php $title = the_title(); echo esc_attr($title); ?></a></h3>
            ...
            <span class="clearme"><i class="fa fa-comments meta-icon"></i><?php comments_number(__( '0', 'albus' ), __( '1', 'albus' ), __( '%', 'albus' ) ); ?> Comments To Date</span>
...
<?php }} ?>
<?php add_action('widgets_init', create_function('', 'return register_widget("DistinctiveThemes_Commented_Posts_Widget");')); ?>