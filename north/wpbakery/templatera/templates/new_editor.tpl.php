			...
			<div class="vc_column">
				<div id="vc_tabs-templatera" class="vc_panel-tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
					<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
						<li><a href="#tabs-templatera-tabs-1"><?php _e('My templates','js_composer'); ?></a></li>
						<li><a href="#tabs-templatera-tabs-2"><?php _e('Default templates','js_composer'); ?></a></li>
					</ul>
					...
					<div id="tabs-templatera-tabs-2">
						<div class="vc_col-md-12 vc_column inside">
							...
							<div class="wpb_element_label"><?php _e('Load Template','js_composer'); ?></div>
							<span class="description"><?php _e('Append default template to the current layout','js_composer'); ?></span>
							<ul id="vc_default-template-list" class="wpb_templates_list">
								<?php foreach($templates as $template): ?>
								<li class="wpb_template_li"><a href="#" data-template_name="<?php echo str_replace('.json','',basename($template['filename'])); ?>"><?php _e($template['name'],'js_composer'); ?></a></li>
								<?php endforeach; ?>
							</ul>
						</div>
					</div>
