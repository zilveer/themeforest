...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
		['1/4','element1-4',1/4,['Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Twitter','Price-Item','Feature-Media']],
		['1/3','element1-3',1/3,['Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Twitter','Price-Item','Feature-Media']],
		['1/2','element1-2',1/2,['Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Twitter','Price-Item','Feature-Media']],
		['2/3','element2-3',2/3,['Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Twitter','Price-Item']],
		['3/4','element3-4',3/4,['Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Twitter','Price-Item']],
		['1/1','element1-1',1  ,['Column','Gallery','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Twitter','Price-Item','Feature-Media','Stunning-Text','Contact-Form']]
	];
	...
	jQuery('input:button.upload_image_button_meta').click(function() {
		...
		.on('select', function() {
			...
			example_image.html('<img src=' + attachment.url + ' />');
	...
	jQuery("div.combobox #page-option-item-testimonial-display-type").change(function(){
		...
		if(jQuery(this).val() == 'Specific Testimonial'){
	...
	jQuery("div.combobox #page-option-item-testimonial-display-type").each(function(){
		var gdl_category = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-testimonial-category");
		var gdl_specific = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-testimonial-specific");
		if(jQuery(this).val() == 'Testimonial Category' || jQuery(this).val() == 'Testimonial Widget'){
	...
	jQuery("div.combobox #page-option-item-feature-media-type").change(function(){
		...
		var gdl_video = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-feature-media-video");
		if(jQuery(this).val() == 'Image'){	
			gdl_video.parents(".meta-body").slideUp();
			gdl_image.slideDown();
		}else{
			gdl_image.slideUp();
			gdl_video.parents(".meta-body").slideDown();	
		}
	});
	jQuery("div.combobox #page-option-item-feature-media-type").each(function(){
		...
		var gdl_video = jQuery(this).parents(".meta-body").siblings(".meta-body").find("#page-option-item-feature-media-video");
		if(jQuery(this).val() == 'Image'){
			gdl_video.parents(".meta-body").css('display','none');
			gdl_image.css('display','block');	
		}else{
			gdl_image.css('display','none');
			gdl_video.parents(".meta-body").css('display','block');
		}
	});	
	...
	// Bind Bottom Slider
	jQuery('select#page-option-enable-bottom-slider').change(function(){
		if(jQuery(this).val()=='No'){
			jQuery(this).parents('.meta-body').siblings('.bottom-slider-option').slideUp();
		}else{
			jQuery(this).parents('.meta-body').siblings('.bottom-slider-option').slideDown();
		}
	});
	jQuery('select#page-option-enable-bottom-slider').each(function(){
		if(jQuery(this).val()=='No'){
			jQuery(this).parents('.meta-body').siblings('.bottom-slider-option').css('display', 'none');
		}else{
			jQuery(this).parents('.meta-body').siblings('.bottom-slider-option').css('display', 'block');
		}
	});	
