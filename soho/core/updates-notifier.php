...
if (GT3_THEME_UPDATES_NOTIFIER_ENABLE == true) {
    ...
    if (gt3_un_get_option('update_notify_system_showing') == 'true') {
        function gt3_wp_admin_area_notice()
        {
            ...
            <b>There is a new version of <img src="http://gt3themes.com/demo/images/' . GT3_THEMENAME . '.jpg">' . $themename . ' available.</b> To update the theme, please follow this link <a href="http://themeforest.net/downloads" target="_blank">Download Update</a>.</p>
