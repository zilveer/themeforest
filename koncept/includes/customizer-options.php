...
function krown_customizer( $wp_customize ) {
	...
	class Krown_Customize_Textarea_Control extends WP_Customize_Control {
	...
	$wp_customize->remove_section( 'static_front_page');
	 ...
	 $wp_customize->add_section('blog-portfolio', array(
		'title' => 'Portfolio',
		'priority' => 15
	));
	...
	$wp_customize->add_setting(
		'krown_menu_style', array(
			'default' => 'menu-one',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_menu_style', 
		array(
			'label' => 'Menu style',
			'section' => 'nav',
			'settings' => 'krown_menu_style',
			'type' => 'select',
			'choices' => array(
				'menu-one' => 'Full',
				'menu-two' => 'Sidebar',
				'menu-three' => 'Minimal',
				'menu-three classic' => 'Classic'
			),
			'priority' => 11
		)
	);
	...
	$wp_customize->add_setting(
		'krown_menu_sticky', array(
			'default' => 'no-sticky',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_menu_sticky', 
		array(
			'label' => 'Sticky header',
			'section' => 'nav',
			'settings' => 'krown_menu_sticky',
			'type' => 'select',
			'choices' => array(
				'no-sticky' => 'Disabled',
				'sticky' => 'Enabled'
	...
	$wp_customize->add_setting(
		'krown_menu_text', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_menu_text', 
		array(
			'label' => 'Menu text',
			'description' => 'Only available for the full & sidebar styles',
			'section' => 'nav',
			'settings' => 'krown_menu_text',
			'type' => 'textarea',
			'priority' => 13
		)
	);
	...
	$wp_customize->add_setting(
		'krown_blog_page', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_blog_page', 
		array(
			'label' => 'Select default blog page',
			'section' => 'blog',
			'settings' => 'krown_blog_page',
			'type' => 'dropdown-pages',
			'priority' => 1
		)
	);
	...
	$wp_customize->add_setting(
		'krown_shop_page', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_shop_page', 
		array(
			'label' => 'Select default shop page',
			'section' => 'shop',
			'settings' => 'krown_shop_page',
			'type' => 'dropdown-pages',
			'priority' => 1
		)
	);
	...
	$wp_customize->add_setting(
		'krown_shop_columns', array(
			'default' => 'four',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_shop_columns', 
		array(
			'label' => 'Shop grid columns',
			'section' => 'shop',
			'settings' => 'krown_shop_columns',
			'type' => 'select',
			'choices' => array(
				'four' => 'Four',
				'three' => 'Three',
	...
	$wp_customize->add_setting(
		'krown_shop_style', array(
			'default' => 'masonry',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_shop_style', 
		array(
			'label' => 'Shop grid style',
			'section' => 'shop',
			'settings' => 'krown_shop_style',
			'type' => 'select',
			'choices' => array(
				'fixed' => 'Regular',
				'masonry' => 'Masonry'
	...
	$wp_customize->add_setting(
		'krown_shop_per', array(
			'default' => '12',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_shop_per', 
		array(
			'label' => 'Products per page',
			'section' => 'shop',
			'settings' => 'krown_shop_per',
			'type' => 'text',
			'priority' => 4
		)
	);
	...
	$wp_customize->add_setting(
		'krown_shop_cart', array(
			'default' => 'show',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_shop_cart', 
		array(
			'label' => 'Cart icon',
			'section' => 'shop',
			'settings' => 'krown_shop_cart',
			'type' => 'select',
			'choices' => array(
				'show' => 'Show',
				'hide' => 'Hide'
	...
	$wp_customize->add_setting(
		'krown_shop_related', array(
			'default' => 'show',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_shop_related', 
		array(
			'label' => 'Related products',
			'section' => 'shop',
			'settings' => 'krown_shop_related',
			'type' => 'select',
			'choices' => array(
				'show' => 'Show',
				'hide' => 'Hide'
	...
	$wp_customize->add_setting(
		'krown_portfolio_page', array(
			'default' => 'enabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_portfolio_page', 
		array(
			'label' => 'Select default portfolio page',
			'section' => 'blog-portfolio',
			'settings' => 'krown_portfolio_page',
			'type' => 'dropdown-pages'
		)
	);
	...
	$wp_customize->add_setting(
		'krown_portfolio_unlimited', array(
			'default' => 'disabled',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_portfolio_unlimited', 
		array(
			'label' => 'Unlimited portfolios',
			'section' => 'blog-portfolio',
			'settings' => 'krown_portfolio_unlimited',
			'type' => 'select',
			'choices' => array(
				'disabled' => 'Disabled',
				'enabled' => 'Enabled'
	...
	$colorsArray = array(
		...
		array(
			...
			'description' => 'It is used in only a few places. It should be a slightly darker version of the main color',
			'default' => '#9e8348',
			'setting' => 'main2'
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_quotes', array(
			'default' => 'Raleway',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_quotes', 
		array(
			'label' => 'Quotes Font',
			'section' => 'typography',
			'settings' => 'krown_type_quotes',
			'type' => 'select',
			'choices' => $google_fonts_simple,
			'priority' => 3 
		)
	...
	$wp_customize->add_setting(
		'krown_type_sets_cyrillic', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_cyrillic',
		array(
			'type' => 'checkbox',
			'label' => 'Load "cyrillic" subset',
			'setting' => 'krown_type_sets_cyrillic',
			'section' => 'typography',
			'priority' => 20
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_cyrillic-extended', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_cyrillic-extended',
		array(
			'type' => 'checkbox',
			'label' => 'Load "cyrillic extended" subset',
			'setting' => 'krown_type_sets_cyrillic-extended',
			'section' => 'typography',
			'priority' => 21
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_devenagari', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_devenagari',
		array(
			'type' => 'checkbox',
			'label' => 'Load "devenagari" subset',
			'setting' => 'krown_type_sets_devenagari',
			'section' => 'typography',
			'priority' => 22
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_greek', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_greek',
		array(
			'type' => 'checkbox',
			'label' => 'Load "greek" subset',
			'setting' => 'krown_type_sets_greek',
			'section' => 'typography',
			'priority' => 23
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_greek-extended', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_greek-extended',
		array(
			'type' => 'checkbox',
			'label' => 'Load "greek extended" subset',
			'setting' => 'krown_type_sets_greek-extended',
			'section' => 'typography',
			'priority' => 24
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_khmer', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_khmer',
		array(
			'type' => 'checkbox',
			'label' => 'Load "khmer" subset',
			'setting' => 'krown_type_sets_khmer',
			'section' => 'typography',
			'priority' => 25
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_latin', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_latin',
		array(
			'type' => 'checkbox',
			'label' => 'Load "latin" subset',
			'setting' => 'krown_type_sets_latin',
			'section' => 'typography',
			'priority' => 26
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_latin-extended', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_latin-extended',
		array(
			'type' => 'checkbox',
			'label' => 'Load "latin extended" subset',
			'setting' => 'krown_type_sets_latin-extended',
			'section' => 'typography',
			'priority' => 27
		)
	);
	...
	$wp_customize->add_setting(
		'krown_type_sets_vietnamese', array(
			'default' => '',
			'type' => 'option',
			'capability' => 'edit_theme_options'
		)
	);
	$wp_customize->add_control('krown_type_sets_vietnamese',
		array(
			'type' => 'checkbox',
			'label' => 'Load "vietnamese" subset',
			'setting' => 'krown_type_sets_vietnamese',
			'section' => 'typography',
			'priority' => 28
		)
	);
