...
$theme_info .= '<p class="ct_theme-theme-data description theme-uri">' . __('<strong>Support forum:</strong> ', 'ct_theme') . '<a href="http://support.themewoodmen.createit.pl" target="_blank">http://support.themewoodmen.createit.pl</a></p>';
