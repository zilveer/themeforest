	...
	class YIT_Testimonials_Widget extends WP_Widget {
	    ...
	    function widget( $args, $instance ) {
	       ...
	       // wp_enqueue_script( 'yit-testimonial' );
	        ...
	        $test_navigation          = isset( $instance['test_navigation'] ) ? $instance['test_navigation'] : false;
	        ...
	        if ( $test_posts->have_posts() ) {
	            ...
	            $class_slider="slides masterslider ms-skin-default";
	            $class_single="ms-slide";
	            ...
	            $out .= '<ul id="slide_' . $widget_id . '" class="'.$class_slider.'"  data-paginationspeed="' . $test_pagination_speed_fx . '" data-navigation="' . $test_navigation . '" data-singleitem="true" data-autoplay="' . $test_auto_play . '">';
	            while ( $test_posts->have_posts() ) {
	                $test_posts->the_post();

	                $out .= '<li class="clearfix '.$class_single.'">';
	               ...
	               // $out .= '</div>';
	                ...
	                if ( has_post_thumbnail() ) {
	                    $out .= '<div class="image-container">' . yit_image( "post_id=".get_the_ID()."&size=testimonial-thumb&output=img&alt=".get_the_title(),false ) . '</div>';
	                }
	                ...
	                $out .= '<div class="name-testimonial">' . get_the_title()  . '</div>';
	                $out .= '<div class="website">' . $website . '</div>';
