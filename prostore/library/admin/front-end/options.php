 ...
 *
 *
 * @package 	proStore/library/admin/front-end/options.php
 * @file	 	1.0
 */
?>
...
<h2></h2>
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div class="logo">
				<h2><?php //echo THEMENAME; ?>Admin Panel v1.0</h2>
			</div>
		...
		<div id="info_bar">
			...
			<a>
				<div id="expand_options" class="expand" title="Expand panel">Expand</div>
			</a>
			...
			<button id="of_save" type="button" class="button-primary">
				<?php _e('Save All Changes','prostore-theme');?>
			</button>
		...
		<div class="save_bar"> 
			...
			<img style="display:none" src="<?php echo ADMIN_DIR; ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
			<button id ="of_save" type="button" class="button-primary"><?php _e('Save All Changes','prostore-theme');?></button>			
			<button id ="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Options Reset','prostore-theme');?></button>
