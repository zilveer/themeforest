...
<div style="display:none;">
  <div itemscope itemtype="http://data-vocabulary.org/Review">
    ...
    <?php _e('Reviewed by', 'theme'); ?><span itemprop="reviewer"><?php echo get_the_author_meta( 'display_name' ); ?></span> <?php _e('on', 'theme'); ?>
    ...
    <?php _e('Rating', 'theme'); ?>: <span itemprop="rating"><?php echo $stars; ?></span>
  </div>
</div>
