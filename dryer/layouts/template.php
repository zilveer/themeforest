...
<div class="wrapper wrap-shadow clearfix">
		<header id="header">
		...
		<?php endif; ?>
		<?php if ($this['modules']->count('footer-left + debug + footer-right') || $this['config']->get('warp_branding')) : ?>
...
<div class="totop text-center clearfix">
