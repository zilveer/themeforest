...
class Nav_Menu_Images_Admin extends Nav_Menu_Images {
	...
	public function enqueue_scripts() {
		...
		// Enqueue old script
		wp_enqueue_script( 'nmi-scripts', ET_CODE_3D_URI . 'menu-images/assets/js/nmi.js', array( 'media-upload', 'thickbox' ), '1', true );
		...
		if ( version_compare( $wp_version, '3.5', '>=' ) ) {
			wp_enqueue_media();
			wp_enqueue_script( 'nmi-media-view', ET_CODE_3D_URI . 'menu-images/assets/js/media-view.js', array( 'jquery', 'media-editor', 'media-views', 'post' ), '1.1', true );
		}
