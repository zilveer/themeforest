<?php
/*
Template Name: Portfolio - Full - 5 columns portrait
*/
get_header(); ?>
        	...
        	<div class="page page-full portfolio-columns portfolio-portrait-columns">
                ...
                <section id="filtrable">
                    ...
                    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                        ...
                        <?php endforeach; ?>
                        <article class="project project-five-columns clearfix <?php echo $project_category; if ( $k%5 == 0 ) echo ' project-last'; ?>">
								...
								<?php if( $dt_projectImagebehaviour == 'readmore' ): ?>
                                    <div class="project-image">
                                        <a class="post-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
                                            ...
                                            <img src="<?php resizeimage($thumbnail_src,156,204,$dt_ProjectImageCrop); ?>" alt="<?php the_title(); ?>" />
                                        </a>                     
                                    </div>       
                                <?php endif; ?>
                        ...
                        <?php if($k%5==0) echo '<div class="row-sep"></div>'; $k++; ?>
                    <?php endwhile;endif;?>
                </section> 
