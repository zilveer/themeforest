...
if( !class_exists( 'Simple_System_Info' ) ) {
    ...
    class Simple_System_Info {
        ...
        public function get( $show_inactive = false, $id = 'system-info-box', $class = null ) {
            ...
            $return = '<textarea style="width:600px;height:500px;" readonly="readonly" onclick="this.focus(); this.select()" id="' . $id . '"' . ( $class != null ? ' class="' . $class . '"' : '' ) . ' title="To copy the system info, click below and press Ctrl+C (PC) or Cmd+C (Mac).">';
