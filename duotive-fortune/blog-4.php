<?php
/*
Template Name: Blog - Type 4
*/
	get_header();
?>
	<?php $blogs = blog_require();?>
    <?php $pagination = get_option('dt_BlogPaginationType4'); ?>    
	...
	<?php foreach ( $blogs as $blog) :?> 
		<?php if ( is_page($blog->PAGE)): ?>
        	<?php $blog_ids = $blog->CATEGORIES; ?> 
                ...
                ?>
                	<article id="post-<?php the_ID(); ?>" <?php post_class('post post-type-4 clearfix'); ?>>
                    	<div class="post-content clearfix">
                            <h4><a href="<?php the_permalink(); ?>" title="<?php dt_Permalink.the_title_attribute( 'echo=0' ); ?>" rel="bookmark"><?php the_title(); ?></a></h4>                        
