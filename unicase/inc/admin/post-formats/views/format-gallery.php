<div id="cfpf-format-gallery-preview" class="cf-elm-block cf-elm-block-image" style="display: none;">
	<!-- <label><span><?php esc_html_e('Gallery Images', 'unicase'); ?></span></label> -->
	<div class="cf-elm-container">
		...
		<p class="none"><a href="#" class="button"><?php ($ids) ? esc_html_e('Edit Gallery', 'unicase') : esc_html_e('Add Images to Gallery', 'unicase'); ?></a></p>
