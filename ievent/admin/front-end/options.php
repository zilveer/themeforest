<div class="wrap" id="of_container">
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="info_bar">
			...
			<button id ="of_save" type="button" class="button-primary"><?php esc_html_e('Save All Changes','ievent');?></button>			
			<button id ="of_reset" type="button" class="button submit-button reset-button ievent-top-reset" ><?php esc_html_e('Options Reset','ievent');?></button>
