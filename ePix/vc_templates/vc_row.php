...
if( !empty( $min_height ) && $row_height != 'full_height'  )
{
...
if ( ! empty( $parallax ) ) {
	...
	$css_classes[] = 'vc_general vc_parallax parallax vc_parallax-' . $parallax;
...
if( !empty( $min_height ) && $row_height != 'full_height' )
{
	...
	$output .= '<div class="parallax-wrap">';
	$output .= '<div class="parallax-content" style="height:'. $min_height .'px">';
