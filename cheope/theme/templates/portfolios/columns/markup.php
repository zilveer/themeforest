                        ...
                        <?php
                            ...
                            while ( yit_have_works() ) :
								...
								*/
                                ...
                                list( $thumbnail_url, $thumbnail_width, $thumbnail_height ) = wp_get_attachment_image_src( $image_id, "thumb_portfolio_{$columns}cols" );
                        ...
                        <li <?php yit_work_class( $classes ) ?>>
                            ...
                            <?php if ( ! empty( $image_url ) ) : ?>
							  	<div class="picture_overlay">
							  		<?php echo wp_get_attachment_image( $image_id, "thumb_portfolio_{$columns}cols" ); ?>
