...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<p class="form-row">
		...
		<label for="rememberme" class="inline">
			<input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php _e( 'Remember me', 'yiw' ); ?>
		</label>
	</p>
	<p class="lost_password">
		<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'yiw' ); ?></a>
	</p>
