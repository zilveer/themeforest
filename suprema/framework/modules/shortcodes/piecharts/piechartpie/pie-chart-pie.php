...
class PieChartPie implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => esc_html__('Select Pie Chart 2 (Pie)', 'suprema'),
			'base' => $this->getBase(),
			'category' => 'by SELECT',
	...
	public function render($atts, $content = null) {
		...
		$html = suprema_qodef_get_shortcode_module_template_part('templates/pie-chart-pie', 'piecharts/piechartpie', '', $params);
