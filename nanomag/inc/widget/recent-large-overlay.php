...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_attr__('Display post with text overlay on menu or widget.', 'nanomag')
        );
        parent::__construct('recent-post-large-overlay-style', esc_attr__('jellywp: Recent post large text overlay', 'nanomag'), $widget_ops);
    }
