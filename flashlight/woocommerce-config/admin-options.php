...
if(!get_option('avia_woocommerce_column_count')) avia_woocommerce_set_defaults();


//add new options to the page settings
add_filter('woocommerce_page_settings','avia_woocommerce_page_settings_filter');
...
{  
	...
	$options[] = array(
		'name' => 'Product Count',
        'type' => 'title',
        'desc' => 'The following settings allow you to choose how many items should appear on your default blog overview page and your product archive pages.<br/><small>Notice: These options are added by the <strong>'.THEMENAME.' Theme</strong> and wont appear on other themes</small>',
        'id'   => 'column_options'
	);
