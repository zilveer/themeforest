...
class WPBakeryShortCode_posts_carousel extends WPBakeryShortCode {
    ...
    protected function content($atts, $content = null) {
		    ...
		    $title = $category = $item_class = $excerpt_length = $width = $exclude_categories = $el_class = $output = $filter = $items = $el_position = '';
    		...
    		if( have_posts() ) {
    			...
    			while ( have_posts() ) {
    				...
    				if ($thumb_type == "video") {
    					...
    					$image = aq_resize( $thumb_img_url, 274, 205, true, false);
