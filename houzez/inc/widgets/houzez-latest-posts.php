	...
	**/
	public function __construct() {
		...
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Show latest posts by category', 'houzez' ), ) // Args
		);
				...
				<?php if( $qy_latest->have_posts() ): while( $qy_latest->have_posts() ): $qy_latest->the_post(); $i++; ?>
					...
					<div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p><?php echo houzez_get_excerpt(7); ?> </p>
                            <a href="<?php the_permalink(); ?>" class="read"><?php esc_html_e( 'Read more', 'houzez' ); ?> <i class="fa fa-caret-right"></i></a>
                        </div>
                    </div>
