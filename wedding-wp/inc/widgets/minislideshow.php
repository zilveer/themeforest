...
class WebnusMiniSlideShowWidget extends WP_Widget{

	function __construct(){

		$params = array(
		'description'=> 'Webnus MiniSlideShow Widget',
		'name'=> 'Webnus-MiniSlideShow'
		);
	...
	public function form($instance){
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_id($textboxes) ?>">Slide #<?php echo $i; ?> Image URL: </label>
		<input
		type="text"
		class="widefat"
		id="<?php echo $this->get_field_id($textboxes) ?>"
		name="<?php echo $this->get_field_name($textboxes) ?>"
