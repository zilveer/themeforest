<?php
// Template Name: MediaSortable Column2
?>
		...
		<section class="section full-width-bg gray-bg">
			...
			<div class="row">
				...
				<?php if ( have_posts() ) while ( have_posts() ) : the_post(); 
					...
					<!-- media Post -->
					<div class="col-lg-6 col-md-6 col-sm-6 mix <?php echo esc_attr($category); ?>" data-nameorder="<?php echo esc_attr($title1); ?>" data-dateorder="<?php  echo esc_attr($post->post_date); ?>">
