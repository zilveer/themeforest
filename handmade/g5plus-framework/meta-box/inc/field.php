...
if ( ! class_exists( 'RWMB_Field ' ) )
{
	class RWMB_Field
	{
		...
		{
			$text = apply_filters( 'rwmb_add_clone_button_text', esc_html__( '+', 'meta-box' ), $field );
		...
		{
			$text = apply_filters( 'rwmb_remove_clone_button_text', esc_html__( '&#8211;', 'meta-box' ), $field );
		...
		static function meta( $post_id, $saved, $field )
		{
			...
			$meta   = g5plus_get_post_meta( $post_id, $field['id'], $single );
		...
		static function get_value( $field, $args = array(), $post_id = null )
		{
			...
			{
				$single = $field['clone'] || ! $field['multiple'];
				$value  = g5plus_get_post_meta( $post_id, $field['id'], $single );
