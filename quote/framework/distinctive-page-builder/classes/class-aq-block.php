	...
	class AQ_Block {
	 	...
	 	function after_form($instance) {
	 		...
	 		$block_saving_id = 'aq_blocks[aq_block_'.$number.']';
	 			...
	 			echo '<div class="block-control-actions clearfix"><a href="#" class="delete"><i class="el-icon-trash"></i> Delete</a> <a href="#" class="close"><i class="el-icon-remove"></i> Close</a></div>';
	 	...
	 	function before_block($instance) {
	 		...
	 		//echo apply_filters( 'aqpb_before_block', $instance );
	 		
	 		echo '<div id="aq-block-'.$template_id.'-'.$number.'" class="aq-block aq-block-'.$id_base.' aq_'.$size.' '.$column_class.' clearfix animated">';
	 	}
	 	...
	 	function after_block($instance) {
	 		...
	 		//echo apply_filters( 'aqpb_after_block', $instance );	 		
	 		echo '</div>';	
	 	}
