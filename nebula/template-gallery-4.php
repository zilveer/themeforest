    ...
    <div class="inner">
    	...
    	<?php
	        ...
	        foreach($all_photo_arr as $photo_id)
	        {
	        	...
	        	$current_image_arr = wp_get_attachment_image_src($photo_id, 'gallery_4');
    	...
    	<div class="element">
		    ...
		    <div class="one_fourth gallery4 filterable gallery_type animated<?php echo $key+1; ?>" data-id="post-<?php echo $key+1; ?>">
    		<?php 
