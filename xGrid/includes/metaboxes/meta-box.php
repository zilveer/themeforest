...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	if ( ! defined( 'RWMB_URL' ) )
    define( 'RWMB_URL', get_template_directory_uri().'/includes/metaboxes/' );
	define( 'RWMB_JS_URL', trailingslashit( RWMB_URL . 'js' ) );
	define( 'RWMB_CSS_URL', trailingslashit( RWMB_URL . 'css' ) );

	// Plugin paths, for including files
	if ( ! defined( 'RWMB_DIR' ) )
		define( 'RWMB_DIR', get_template_directory().'/includes/metaboxes/' );
	...
	class RW_Meta_Box
	{
		...
		static function admin_print_styles()
		{
			...
			//wp_enqueue_style( 'bd_css', get_template_directory().'/includes/metaboxes/css/admin-style.css', RWMB_VER );
			wp_enqueue_script( 'rwmb-clone', RWMB_JS_URL .'/clone.js', RWMB_VER );
			wp_enqueue_script( 'rwmb-plupload', RWMB_JS_URL .'/plupload-image.js', RWMB_VER );
			//wp_enqueue_script( 'rwmb-color', get_template_directory().'/includes/metaboxes/js/color.js', RWMB_VER );
			wp_enqueue_script( 'rwmb-metajs', RWMB_JS_URL .'/metajs.js', RWMB_VER );
		}
		...
		**************************************************/
		...
		public function show()
		{
			...
			foreach ( $this->fields as $field )
			{
				...
				echo "<div id='item-{$id}' class='{$class}'>{$html}</div>";
			}
