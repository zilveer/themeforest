...
<div id="content">
		...
		<div id="blog-header"><h1><?php echo __( 'Tag Archives:', 'satori' ).' <span>'.single_tag_title( '', false ).'</span>'; ?></h1></div><!--.postHeaderTitle--><div class="clearleft"></div>
		<?php if(tag_description() != "" ) { ?><div class="post-wrapper"><?php echo tag_description(); /* displays the tag's description from the Wordpress admin */ ?></div><?php } else { } ?>
		<div class="clear"></div>
