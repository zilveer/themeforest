...
(function($) {
	...
	$("#maincontent").hammer().on('swiperight',function(event){
    	toggleOverlay();
    });
	
	$("#auranavwrapper").hammer().on('swipeleft',function(event){
    	toggleOverlay();
    });
	
	$("#auralogobar").hammer().on('swiperight',function(event){
    	toggleOverlay();
    });
	
    $("#maincontent div.flexslider").hammer().on("swiperight", function(event) {
