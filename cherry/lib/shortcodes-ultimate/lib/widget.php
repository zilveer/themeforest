	...
	if ( !class_exists( 'Shortcodes_Ultimate_Widget' ) ) {
		...
		class Shortcodes_Ultimate_Widget extends WP_Widget {
			...
			function Shortcodes_Ultimate_Widget() {
				/* Widget settings. */
				$widget_ops = array( 'classname' => 'shortcodes-ultimate', 'description' => __( 'Special Shortcodes widget', 'shortcodes-ultimate' ) );

				/* Widget control settings. */
				$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'shortcodes-ultimate' );

				/* Create the widget. */
				$this->WP_Widget( 'shortcodes-ultimate', __( 'Shortcodes Widget', 'shortcodes-ultimate' ), $widget_ops, $control_ops );
			}
