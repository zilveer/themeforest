...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_attr__('Display a list of recent post with no background.', 'nanomag')
        );
        parent::__construct('home-main-post-white-style', esc_attr__('jellywp: main post images white', 'nanomag'), $widget_ops);
    }
