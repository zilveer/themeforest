...
// Don't duplicate me!
if ( ! class_exists( 'ReduxFramework_customizer_info' ) ) {

	/**
	 * Main ReduxFramework_info class
	 * @since       1.0.0
	 */
	class ReduxFramework_customizer_info {
		...
		public function enqueue() {
			...
			wp_enqueue_style( 'redux-field-info-css', $this->extension_url . 'field_info.css', time(), true );
		}
	}
}