        ...
        class ReduxFramework_dimensions {
            ...
            function render() {
                ...
                if ( $this->field['width'] === true ) {
                    ...
                    echo '<input type="text" class="redux-dimensions-input redux-dimensions-width mini' . $this->field['class'] . '" placeholder="' . esc_html__( 'Width', 'redux-framework' ) . '" rel="' . $this->field['id'] . '-width" value="' . filter_var( $this->value['width'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( $this->field['height'] === true ) {
                    ...
                    echo '<input type="text" class="redux-dimensions-input redux-dimensions-height mini' . $this->field['class'] . '" placeholder="' . esc_html__( 'Height', 'redux-framework' ) . '" rel="' . $this->field['id'] . '-height" value="' . filter_var( $this->value['height'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
                ...
                if ( isset( $this->field['units'] ) && $this->field['units'] !== false ) {
                    ...
                    echo '<select data-id="' . $this->field['id'] . '" data-placeholder="' . esc_html__( 'Units', 'redux-framework' ) . '" class="redux-dimensions redux-dimensions-units select' . $this->field['class'] . '" original-title="' . esc_html__( 'Units', 'redux-framework' ) . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '[units]' . '">';
