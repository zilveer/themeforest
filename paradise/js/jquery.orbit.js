            ...
            function lock() { 
				...
				if(options.captions) {
                	...
                	.children('span')
					 ...
					 function setCaption() {
						var _captionLocation = images.eq(activeImage).attr('alt'); //get ID from alt tag on image
						...
						caption.parent().animate({"bottom" : 0-_captionHeight}, options.captionAnimationSpeed, function() {
							caption
								.css('bottom', -1000)
								.attr('id',"#"+_captionLocation) // Add ID caption
								.html(_captionHTML); // Change HTML in Caption
							Cufon.replace ('.orbit-caption h3', { hover: { textShadow: '1px 1px rgba(0, 0, 0, 0.3)' }, textShadow: '1px 1px rgba(0, 0, 0, 0.3)' });
							caption
								.css('display', 'block')
								.css({bottom: 0-(caption.height() + 20)});

//							alert(_captionHTML);
							if(_captionHTML != null)
								caption.parent().animate({"bottom" : 0}, options.captionAnimationSpeed);
