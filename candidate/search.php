...
<section id="content">	
			...
			<section class="section page-heading ">
				<h1 class="entry-title" ><?php printf( __( 'Search Results for: %s', 'candidate' ), '' . get_search_query() . '' ); ?></h1>
			...
			<div class="row">
				...
				<?php 
					if ( !have_posts() ) : ?>
						...
						<p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'candidate' ); ?></p>
					...
					<div <?php post_class('blog-post animate-onscroll '); ?> >
						...
						<div class="post-content">
							...
							<div class="post-header">
								<h2><a href="<?php echo absint(get_permalink()); ?>"><?php echo esc_html($title1); ?></a></h2>
								<div class="post-meta">
							...
							<div class="post-exceprt">
								...
								<?php if($format == 'link'){ ?>
								<blockquote class="iconic-quote link-quote"><a href="<?php echo get_meta_option('custom_link_meta_box', $post_id); ?>"><?php candidat_the_excerpt_max_charlength(40); ?></a></blockquote>
								<?php } ?>
