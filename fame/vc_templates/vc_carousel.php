            ...
            foreach($data as $block) {
                ...
                if($block->name === 'title') {
                    ...
                    if($block->mode === 'custom') {
                        ...
                        $settings[] = $block->mode;
                        $post->content = wpautop(get_the_content());
                    }
                }
                if(isset($block->link)) {
                    if($block->link === 'post') {
...
<div class="<?php echo apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base']) ?>">
    <div class="wpb_wrapper">
        ...
        <div id="<?php echo $carousel_id ?>" data-ride="vc_carousel" data-wrap="<?php echo $wrap==='yes' ? 'true' : 'false' ?>" data-interval="<?php echo $autoplay == 'yes' ? $speed : 0 ?>" data-auto-height="true" data-mode="<?php echo $mode ?>" data-partial="<?php echo $partial_view === 'yes' ? 'true' : 'false' ?>" data-per-view="<?php echo $slides_per_view ?>" data-hide-on-end="<?php echo $autoplay == 'yes' ? 'false' : 'true' ?>" class="vc_carousel vc_slide">
            ...
            <div class="vc_carousel-inner">
                <div class="vc_carousel-slideline"><div class="vc_carousel-slideline-inner">
                ...
                <div class="vc_item vc_slide_<?php echo $post->post_type ?>"<?php echo $block_style ?>>
                    <?php if($post->post_type === A13_CUSTOM_POST_TYPE_WORK || $post->post_type === A13_CUSTOM_POST_TYPE_GALLERY) : ?>
                        <div class="vc_inner g-item">
