	...
	<div class="products" id="able-list">
		...
		if( have_posts() ) {
			while( have_posts() ) {
				...
				?>
				<div class="col-md-3 col-sm-6 property mix mix_all">
					<div class="product-item">
						<div class="imagewrapper">
							<a href="<?php the_permalink();?>"><?php PGL_Addon_Estate::the_post_thumbnail();?></a>
                        ...
                        <?php if(!$isShowCase):?>
                            <div class="col-md-12 col-sm-12">
								<span class="line-top"><?php _e('Purpose', PGL) ?> <span class="pull-right"><?php echo get_post_meta( $post->ID, 'estate_purpose', TRUE )=="sale"?__('Sale', PGL):__('Rent', PGL); ?></span></span>
							</div>
                        <?php endif;?>
							<?php
							 $html =  PGL_Addon_Estate::display_default_fields($post->ID, 12);
