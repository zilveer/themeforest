    ...
    class WPH_Widget extends WP_Widget
    {
        ...
        */
        ...
        function create_field_text( $key, $out = "" )
        {
            ...
            $out .= 'id="' . esc_attr( $key['_id'] ) . '" name="' . esc_attr( $key['_name'] ) . '" value="' . esc_attr__( $value, 'smartfood' ) . '" ';
            ...
            if ( isset( $key['desc'] ) )
                $out .= '<br/><small style="padding-left:0px;" class="description">'.esc_html( $key['desc'] ).'</small>';
        ...
        function create_field_select( $key, $out = "" )
        {
            ...
            $selected = isset( $key['value'] ) ? $key['value'] : $key['std'];
                ...
                foreach ( $key['fields'] as $field => $option ) 
                {
                    ...
                    $out .= '<option value="' . esc_attr__( $option['value'], 'smartfood' ) . '" ';
        ...
        */
        ...
        function create_field_message( $key, $out = "" )
        {

            $out = null;

            if ( isset( $key['desc'] ) )
                $out .= esc_html( $key['desc'] );
        ...
        */
        ...
        function create_field_label( $name = "", $id = "" ) {
            return '<strong><label for="' . esc_attr( $id ). '">' . esc_html( $name ) . ':</label></strong>';
        }
