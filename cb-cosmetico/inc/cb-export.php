...
$stringer_options = $wpdb->get_results("SELECT option_name, option_value FROM $wpdb->options WHERE option_name REGEXP '^cb_'");


// output the header
$filename = 'stringer.options.' . str_replace("http://","",get_option('siteurl')) . "." . date('Y-m-d') . '.xml';
