			...
			<div class="container clear">
				<div class="grid2 first mpage">
					<?php foreach($arr1 as $barr){
						echo '<h5 class="vfont">' . get_the_title($barr) . '</h5><div class="mdiv"><a href="'. get_permalink($barr) .'">';
				...
				<div class="grid2 mpage">
					<?php foreach($arr2 as $carr){
						...
						echo '<h5 class="vfont">' . get_the_title($carr) . '</h5><div class="mdiv"><a href="'. get_permalink($carr) .'">';
