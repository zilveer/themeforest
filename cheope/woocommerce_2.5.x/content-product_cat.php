...
if ( get_option('woocommerce_responsive_images') == 'yes' ) {
    ...
    if ( yit_get_sidebar_layout() == 'sidebar-no' ) {
            if ( $product_width >= 0   && $product_width < 120 ) { $li_class[] = 'span1'; $woocommerce_loop['columns'] = 12; }
        elseif ( $product_width >= 120 && $product_width < 220 ) { $li_class[] = 'span2'; $woocommerce_loop['columns'] = 6;  }
        elseif ( $product_width >= 220 && $product_width < 320 ) { $li_class[] = 'span3'; $woocommerce_loop['columns'] = 4;  }
        elseif ( $product_width >= 320 && $product_width < 470 ) { $li_class[] = 'span4'; $woocommerce_loop['columns'] = 3;  }
        elseif ( $product_width >= 470 && $product_width < 620 ) { $li_class[] = 'span6'; $woocommerce_loop['columns'] = 2;  }
        else $is_span = false;

    } elseif ( yit_get_option( 'shop-sidebar-width' ) == '3' || ( isset( $yit_is_page ) && $yit_is_page && !is_front_page() ) && ! is_shop() ) {
            if ( $product_width >= 0   && $product_width < 150 ) { $li_class[] = 'span1'; $woocommerce_loop['columns'] = 12; }
        elseif ( $product_width >= 150 && $product_width < 620 ) { $li_class[] = 'span3'; $woocommerce_loop['columns'] = 3;  }
        else $is_span = false;

    } elseif ( yit_get_option( 'shop-sidebar-width' ) == '2' ) {
            if ( $product_width >= 0   && $product_width < 120 ) { $li_class[] = 'span1'; $woocommerce_loop['columns'] = 12; }
        elseif ( $product_width >= 120 && $product_width < 320 ) { $li_class[] = 'span2'; $woocommerce_loop['columns'] = 5;  }
        elseif ( $product_width >= 320 && $product_width < 520 ) { $li_class[] = 'span5'; $woocommerce_loop['columns'] = 2;  }
        else $is_span = false;
    }
}
...
// first and last
    if ( $woocommerce_loop['loop'] % $woocommerce_loop['columns'] == 0 )         $li_class[] = 'last';
elseif ( ( $woocommerce_loop['loop'] - 1 ) % $woocommerce_loop['columns'] == 0 ) $li_class[] = 'first';
?>
