...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="variations_form cart" method="post" enctype='multipart/form-data'>
	...
	<div class="single_variation_wrap" style="display:none;">
		...
		<div class="variations_button">
			...
			<button type="submit" class="button small <?php echo of_get_option('blog_button_color'); ?> alt"><?php echo apply_filters('single_add_to_cart_text', __('Add to cart', 'woocommerce'), $product->product_type); ?></button>
		</div>
	</div>
