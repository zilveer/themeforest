...
if ( ! function_exists('suprema_qodef_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function suprema_qodef_configure_visual_composer() {
	...
	add_action('vc_after_init', 'suprema_qodef_configure_visual_composer');

}


if ( ! function_exists('suprema_qodef_configure_visual_composer_grid_elemets') ) {
	...
	function suprema_qodef_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'suprema_qodef_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('suprema_qodef_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function suprema_qodef_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'suprema_qodef_configure_visual_composer_frontend_editor');
}
...
/*** Row ***/
if ( ! function_exists('suprema_qodef_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function suprema_qodef_vc_row_map()
	{
	...
	add_action('vc_after_init', 'suprema_qodef_vc_row_map');
}
