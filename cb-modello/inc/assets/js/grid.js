...
var Grid = (function() {
    ...
    function initItemsEvents( $items ) {
        $items.children( 'a' ).on( 'click', function(e) {
           ...
           if(current==0)hidePreview();
           showPreview( $item );
                 false;

                } );
        $items.parent().parent().on( 'click', 'span.og-close', function() {
            hidePreview();
            return false;
        } )
    }
    ...
    Preview.prototype = {
        create : function() {
           ...
           // this.$item.append( this.getEl() );
            ...
            $('.og-expander').width(windw);
            var leftmi=windw-960; leftmi=leftmi/2; leftmi=-Math.abs(leftmi);
            $('.og-expander').css('margin-left',leftmi);
