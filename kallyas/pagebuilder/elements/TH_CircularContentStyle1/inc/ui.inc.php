        ...
        <div class="kl-slideshow-inner <?php echo $this->opt('size','container');?> kl-slideshow-safepadding">
            <div class="row">
                <div class="ca-container" data-count="<?php echo $countitm; ?>">
                    ...
                    <div class="ca-wrapper ca-st1" data-autoplay="<?php echo $this->opt('ww_slider_autoplay') == 1 ? 1:0 ; ?>" data-timout="<?php echo $this->opt('ww_slider_timeout', 9000) ?>" data-max="<?php echo $this->opt('ww_slider_max','3'); ?>" data-height="<?php echo $this->opt('ww_slider_height', '450'); ?>">
