...
if (!function_exists( 'mad_share_team_members_this' )) {
	function mad_share_team_members_this() {
		mad_get_template( "/content/share-team-members.php" );
	}
}
...
if (!function_exists( 'mad_header_search' )) {
	function mad_header_search() {
		mad_get_template( '/header/search.php' );
	}
}
...
if (!function_exists( 'mad_header_logo_type_3' )) {
	function mad_header_logo_type_3() {
		mad_get_template( '/header/logo-type-3.php' );
	}
}
