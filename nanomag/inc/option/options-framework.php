...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page( esc_attr__('Theme Options', 'nanomag'), esc_attr__('Theme Options', 'nanomag'), 'edit_theme_options', 'options-framework','optionsframework_page' );
...
function optionsframework_load_scripts( $hook ) {
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => esc_attr__( 'Clear','nanomag' ),
			'defaultString' => esc_attr__( 'Default', 'nanomag' ),
			'pick' => esc_attr__( 'Select Color', 'nanomag' )
		);
...
<input type="submit" class="button-primary top-button" name="update" value="<?php esc_attr_e( 'Save Options', 'nanomag' ); ?>" />
	   </div>
        </div>
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'nanomag' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'nanomag' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'nanomag' ) ); ?>' );" />
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', esc_attr__( 'Default options restored.', 'nanomag' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', esc_attr__( 'Options saved.', 'nanomag' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => esc_attr__( 'Theme Options', 'nanomag' ),
