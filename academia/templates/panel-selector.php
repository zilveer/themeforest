...
<div id="panel-style-selector">
    <div class="panel-wrapper">
        ...
        <div class="panel-selector-header"><?php esc_html_e('Style Selector','g5plus-academia');?></div>
        <div class="panel-selector-body clearfix">
            <section class="panel-selector-section clearfix">
                <h3 class="panel-selector-title"><?php esc_html_e('Primary Color','g5plus-academia'); ?></h3>
            ...
            <section class="panel-selector-section clearfix">
                <h3 class="panel-selector-title"><?php esc_html_e('Layout','g5plus-academia'); ?></h3>
                <div class="panel-selector-row clearfix">
                    <a data-type="layout" data-value="wide" href="#" class="panel-selector-btn"><?php esc_html_e('Wide','g5plus-academia'); ?></a>
                    <a data-type="layout" data-value="boxed" href="#" class="panel-selector-btn"><?php esc_html_e('Boxed','g5plus-academia'); ?></a>
                </div>
            </section>

            <section class="panel-selector-section clearfix">
                <h3 class="panel-selector-title"><?php esc_html_e('Background','g5plus-academia'); ?></h3>
                <div class="panel-selector-row clearfix">
            ...
            <section class="panel-selector-section clearfix">
                <div class="panel-selector-row clearfix">
                    <a id="panel-selector-reset" href="#" class="panel-selector-btn"><?php esc_html_e('Reset','g5plus-academia'); ?></a>
                    <a data-mode="off" id="panel-selector-rtl" href="#" class="panel-selector-btn"><?php esc_html_e('RTL On','g5plus-academia'); ?></a>
                </div>
            </section>
        </div>
    </div>
