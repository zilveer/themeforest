		...
		if ( $attachment->post_type == 'attachment' ) {
			...
			if($meta == "true") {
				...
				if($imagedata['image_meta']['camera'])
					$metadata .= __('camera', LANGUAGE_ZONE)            . ": ". $imagedata['image_meta']['camera'] . " ";
				if($imagedata['image_meta']['aperture'])
					$metadata .= __('aperture', LANGUAGE_ZONE)          . ": F". $imagedata['image_meta']['aperture'] . " ";
				if($imagedata['image_meta']['focal_length'])
					$metadata .= __('focal_length', LANGUAGE_ZONE)      . ": ". $imagedata['image_meta']['focal_length'] . "mm ";
				if($imagedata['image_meta']['iso'])
					$metadata .= __('ISO', LANGUAGE_ZONE)      . ": ". $imagedata['image_meta']['iso'] . " ";
				if($imagedata['image_meta']['shutter_speed']) {
					...
					$metadata .= __('shutter_speed', LANGUAGE_ZONE)     . ": " . $speed . " ";
				}
				if($imagedata['image_meta']['created_timestamp'])
					$metadata .= __('created_timestamp', LANGUAGE_ZONE) . ": ". date('Y:m:d H:i:s', $imagedata['image_meta']['created_timestamp']);
			}
