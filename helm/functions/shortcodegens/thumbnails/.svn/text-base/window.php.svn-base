...
<form name="mtheme_type" action="#">
	<!-- style_panel -->
	<fieldset>
		<legend>Thumnail Size</legend>
		<select id="thumbnail_type" name="thumbnail_shortcode">
	...
	<fieldset>
	<legend>Populate Thumbnails from another page</legend>
	<p>Enter Page ID ( Leave Blank for Current Page )</p>
	<input id="thumbnail_page" name="thumbnail_page" type="text" style="width:145px">
	</fieldset>
