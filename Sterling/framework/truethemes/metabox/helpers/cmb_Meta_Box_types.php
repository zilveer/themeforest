...
class cmb_Meta_Box_types {
	...
	public static function file_list( $field, $meta, $object_id ) {
		...
		echo '<input class="cmb_upload_button button button-primary cmb_upload_list" type="button" value="'. __( 'Add or Upload File', 'cmb' ) .'" />', self::desc( $field['desc'], true );
	...
	public static function file( $field, $meta, $object_id, $object_type ) {
		...
		echo '<input class="cmb_upload_button button button-primary" type="button" value="'. __( 'Add or Upload File', 'cmb' ) .'" />';
