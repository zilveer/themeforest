...
<head>
    ...
    <title><?php _e( 'Product Comparison', 'flatastic' ) ?></title>
	...
	<link rel="stylesheet" href="<?php echo MAD_BASE_URI . 'css/font-awesome.min.css' ?>" />
    <link rel="stylesheet" href="<?php echo MAD_COMPARE_URI ?>/colorbox.css"/>
    <link rel="stylesheet" href="<?php echo MAD_COMPARE_URI ?>/jquery.dataTables.css"/>
...
<h2>
	...
	<?php if ( ! $is_iframe ) : ?><a class="close" href="#"><?php esc_html_e( 'Close window [X]', 'flatastic' ) ?></a><?php endif; ?>
</h2>
...
<table class="compare-list" cellpadding="0" cellspacing="0"<?php if ( empty( $products ) ) echo ' style="width:100%"' ?>>
    ...
    <?php if ( empty( $products ) ) : ?>
        ...
        <tr class="no-products">
            <td><?php _e( 'No products added in the compare table.', 'flatastic' ) ?></td>
        </tr>
                    ...
                    <td class="<?php echo $product_class; ?>"><?php
                        ...
                        switch( $field ) {
                            ...
                            case 'add-to-cart':
								...
								echo '<a class="remove" href="' . esc_url(add_query_arg( 'redirect', 'view', $this->remove_product_url( $product->id ) )) . '" data-product_id="' . $product->id .'">'. __('Remove', 'flatastic') .'</a>';
								echo '</div>';
                                break;
