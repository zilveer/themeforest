...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'circolare'),
		'repeat-x'  => __('Repeat Horizontally', 'circolare'),
		'repeat-y'  => __('Repeat Vertically', 'circolare'),
		'repeat'    => __('Repeat All', 'circolare'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'circolare'),
		'top center'    => __('Top Center', 'circolare'),
		'top right'     => __('Top Right', 'circolare'),
		'center left'   => __('Middle Left', 'circolare'),
		'center center' => __('Middle Center', 'circolare'),
		'center right'  => __('Middle Right', 'circolare'),
		'bottom left'   => __('Bottom Left', 'circolare'),
		'bottom center' => __('Bottom Center', 'circolare'),
		'bottom right'  => __('Bottom Right', 'circolare')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'circolare'),
		'fixed'  => __('Fixed in Place', 'circolare')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'circolare'),
		'italic'      => __('Italic', 'circolare'),
		'bold'        => __('Bold', 'circolare'),
		'bold italic' => __('Bold Italic', 'circolare')
		);
