...
if ( ! WC()->cart->applied_coupons ) {
    $info_message = apply_filters( 'woocommerce_checkout_coupon_message', __( 'Have a coupon?', 'north' ) . ' <a href="#" class="showcoupon">' . __( 'Click here to enter your code', 'north' ) . '</a>' );
