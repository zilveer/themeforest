...
class NHP_Options_date extends NHP_Options{	
	...
	*/
	function render(){
		...
		echo '<input type="text" id="'.esc_attr($this->field['id']).'" name="'.esc_attr($this->args['opt_name'].'['.$this->field['id'].']').'" value="'.esc_attr($this->value).'" class="'.$class.' nhp-opts-datepicker" />';
