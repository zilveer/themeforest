...
echo apply_filters( 'woocommerce_loop_add_to_cart_link',
	sprintf( '<a rel="nofollow" href="%s" data-quantity="%s" data-product_id="%s" data-product_sku="%s" data-added_to_cart_text="' . kalium_woocmmerce_get_i18n_str( 'Added to cart' ) . '" class="%s">%s</a>',
