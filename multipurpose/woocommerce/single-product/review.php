	...
	<div id="comment-<?php comment_ID(); ?>" class="comment_container">
		...
		<div class="comment-author vcard">
			<?php if ( $comment->comment_approved == '0' ) : ?>
				<p class="comment-meta"><em><?php _e( 'Your comment is awaiting approval', 'woocommerce' ); ?></em></p>
			<?php else : ?>
				<?php echo get_avatar( $comment, apply_filters( 'woocommerce_review_gravatar_size', '32' ), '', get_comment_author() ); ?>
