	                    ...
	                    <input type="text" id="edit-menu-item-anchor-<?php echo esc_attr($item_id); ?>" class="widefat code edit-menu-item-anchor" name="menu-item-anchor[<?php echo esc_attr($item_id); ?>]" value="<?php echo esc_attr( $item->anchor ); ?>" />
							...
							<p class="field-custom description description-wide">
								...
								?>
									<label for="edit-menu-item-nolink-<?php echo esc_attr($item_id); ?>">
										<input type="checkbox" id="edit-menu-item-nolink-<?php echo esc_attr($item_id); ?>" class="code edit-menu-item-custom" name="menu-item-nolink[<?php echo esc_attr($item_id); ?>]" value="nolink" <?php echo esc_attr($value); ?> />
							...
							<p class="field-custom description description-wide">
								...
								?>
									<label for="edit-menu-item-hide-<?php echo esc_attr($item_id); ?>">
										<input type="checkbox" id="edit-menu-item-hide-<?php echo esc_attr($item_id); ?>" class="code edit-menu-item-custom" name="menu-item-hide[<?php echo esc_attr($item_id); ?>]" value="hide" <?php echo esc_attr($value); ?> />
							...
							<p class="field-custom description description-thin description-thin-custom">
								...
								<select id="edit-menu-item-icon<?php echo esc_attr($item_id); ?>" name="menu-item-icon[<?php echo esc_attr($item_id); ?>]">
									...
									?>
									<option value="<?php echo esc_attr($key); ?>" <?php if(esc_attr($item->icon) == $key){echo 'selected="selected"';} ?>><?php echo esc_html($key); ?></option>
									<?php
									}
									?>
								</select>
