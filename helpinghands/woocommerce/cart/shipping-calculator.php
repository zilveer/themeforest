...
<div class="col-md-4">
	<div class="sd-shipping-calculator">

<?php do_action( 'woocommerce_before_shipping_calculator' ); ?>

<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<p><a href="#" class="shipping-calculator-button"><?php _e( 'Shipping Calculator', 'woocommerce' ); ?> <span><i class="fa fa-angle-double-down"></i></span></a></p>
	...
	<section class="shipping-calculator-form">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button sd-link-trans"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
