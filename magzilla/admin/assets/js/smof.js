...
jQuery(document).ready(function($){
	...
	$(".myoff").click(function(e) {
        $("#section-site_top_strip_color").slideDown();
		$("#section-site_top_strip_image").slideUp();
    });
	
	$(".myon").click(function(e) {
        $("#section-site_top_strip_color").slideUp();
		$("#section-site_top_strip_image").slideDown();
    });
