...
/*
  Class: HueMikadoIconCollections
...
class HueMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new HueMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new HueMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new HueMikadoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new HueMikadoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new HueMikadoLinearIcons('Linear Icons', 'linear_icon'));
        $this->addIconCollection('simple_line_icons', new HueMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new HueMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getSocialVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false, $exclude = '') {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon pack', 'hue'),
    ...
    public function getWidgetIconParams() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack', 'hue'),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome'      => esc_html__('Font Awesome', 'hue'),
                'font_elegant'      => esc_html__('Font Elegant', 'hue'),
                'ion_icons'         => esc_html__('Ion Icons', 'hue'),
                'simple_line_icons' => esc_html__('Simple Line Icons', 'hue')
            )
        );
    ...
    public function getIconCollectionIcons(iHueMikadoIconCollection $collection) {
...
$hue_IconCollections = HueMikadoIconCollections::get_instance();