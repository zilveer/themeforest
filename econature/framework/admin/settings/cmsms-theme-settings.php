...
function cmsms_form_field_fn($args = array()) {
	...
	case 'wpml':
		...
		$config['box_title'] = 'Multilingual Econature';
		$config['name'] = 'Econature'; //name of theme/plugin 
		$config['box_description'] = 'Econature theme is fully compatible with WPML - the WordPress Multilingual plugin. WPML lets you add languages to your existing sites and includes advanced translation management.'; 
