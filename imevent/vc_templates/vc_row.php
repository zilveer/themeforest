...
$section_id_html = ($section_id!='')?'id='.$section_id:'';


$output .= '<div ' . implode( ' ', $wrapper_attributes ) .' '. $section_id_html. '>';


if($parallax){ $output .= '<div class="patter_bg" style="background-color:'.$ova_bg_pattern.'" ></div>'; }
