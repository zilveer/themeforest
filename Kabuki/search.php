...
<div id="content" class="search">
		...
		<div id="blog-header"><h1><?php _e('Search results for', 'satori'); echo ' "'; the_search_query(); echo '"'; ?></h1></div><!--.postHeaderTitle-->
	...
	<?php endwhile; else: ?>
		...
		<div class="no-results">
			<h4><?php _e('No Results', 'satori'); ?></h4>
			<p><?php _e('Nothing has been found for your query. Please try again using other keywords.', 'satori'); ?></p>
			<?php get_search_form(); /* outputs the default Wordpress search form */ ?><div class="clearboth"></div>
