...
$output .= "\n\t\t".'<ul class="accordion'.(isset($width) ? $width : '').$el_class . ($top_margin!="none" ? ' ' . $top_margin : '') .'" data-collapsible='.$collapsible.'  data-vc-disable-keydown="' . ( esc_attr( ( 'yes' == $disable_keyboard ? 'true' : 'false' ) ) ) . '" data-active-tab="'.$active_tab.'">';
