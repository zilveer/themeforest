...
if (have_posts()) :
	...
	<section class="columns post-list masonry m4">
		<?php
		$options = array('hierarchical' => false, 'parent' => 0);
		...
		<div class="filters">
			...
			<ul>
				...
				<li><a href="<?php echo get_category_link($cat->term_id); ?>"><?php echo esc_attr($cat->name); ?></a></li>
				<?php endforeach; ?>
			</ul>
		</div>
		<?php endif; ?>
