...
class Bootstrap_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$classes[] = ( is_object($args) && $args->has_children ) ? 'dropdown' : '';
		...
		$attributes .= ( is_object($args) && $args->has_children )      ? ' class="disabled dropdown-toggle" data-toggle="dropdown"' : '';
		...
		$item_output .= ( $depth == 0 && is_object($args) && $args->has_children ) ? ' <b class="caret"></b></a>' : '</a>';
