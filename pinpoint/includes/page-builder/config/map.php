...
WPBMap::map( 'impact_text', array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => array(__("Yes", "js_composer") => "yes", __("No", "js_composer") => "no"),
            "description" => __("Include a dotted top border to the impact text.", "js_composer")
        ),
        array(
            "type" => "dropdown",
            ...
            "value" => array(__("Yes", "js_composer") => "yes", __("No", "js_composer") => "no"),
            "description" => __("Include a dotted bottom border to the impact text.", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "js_composer"),
...
WPBMap::map( 'vc_gmaps',  array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "param_name" => "full_width",
            "value" => array(__('No', "js_composer") => "no", __('Yes', "js_composer") => "yes"),
            "description" => __("Select this if you want the map to be the full width of the page container.", "js_composer")
        ),
        array(
            "type" => "textfield",
