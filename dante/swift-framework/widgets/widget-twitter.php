...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('username'); ?>"><?php _e('Your Twitter username:', 'swift-framework-admin'); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('posts'); ?>"><?php _e('Display how many tweets?', 'swift-framework-admin'); ?></label>
