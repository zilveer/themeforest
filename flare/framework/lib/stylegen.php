...
class BTP_Colorgen {
	public static function get_light_color( BTP_Color $color ) {
		
	}
	
	public static function get_dark_color( BTP_Color $color ) {
		
	}
	
	public static function get_warm_color( BTP_Color $color ) {
		
	}
	
	public static function get_light_gradient( BTP_Color $color ) {
		
	}
	
	public static function get_dark_gradient( BTP_Color $color ) {
	 ...
	 * 	  
	 * @param 			BTP_Color $color
	 * @return			array An array of 2 colors
	 */
	public static function get_warm_gradient( BTP_Color $color ) {
		$from = clone $color;
	...
	public static function get_tone_color( BTP_Color $color, $delta = 10, $breakpoint = 50) {
		$out = clone $color;
