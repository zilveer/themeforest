...
class WP_Widget_Wd_Layered_Nav extends WP_Widget {
	 ...
	 * @return void
	 */
	function WP_Widget_Wd_Layered_Nav() {
		...
		if ( count( $terms ) > 0 ) {
			...
			if ( $display_type == 'dropdown' ) {
				...
				if ( $current_tax && $taxonomy == $current_tax ) {
					...
					echo '<option value="">' . sprintf( __( 'Any %s', 'wpdance' ), wc_attribute_label( $taxonomy ) ) .'</option>';
					...
					$woocommerce->add_inline_js("
						...
						jQuery('#dropdown_layered_nav_$taxonomy_filter').change(function(){
							...
							location.href = '" . esc_url( preg_replace( '%\/page/[0-9]+%', '', esc_url( add_query_arg('filtering', '1', remove_query_arg( array( 'page', 'filter_' . $taxonomy_filter ) ) ) ) ) ) . "&filter_$taxonomy_filter=' + jQuery('#dropdown_layered_nav_$taxonomy_filter').val();
