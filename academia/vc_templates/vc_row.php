 ...
 */
$str_el_id=$layout = $overlay_set = $overlay_image = $overlay_color = $overlay_opacity = $el_class = $full_height = $parallax_speed_bg = $parallax_speed_video = $full_width = $equal_height = $flex_row = $columns_placement = $content_placement = $parallax = $parallax_image = $css = $el_id = $video_bg = $video_bg_url = $video_bg_parallax = '';
$output = $after_output = '';
...
wp_enqueue_script('g5plus_vc_extend_js', G5PLUS_THEME_URL . 'assets/vc-extend/js/vc_extend' . $min_suffix_js . '.js', array(), false, true);
wp_enqueue_style('g5plus_vc_extend_css', G5PLUS_THEME_URL . 'assets/vc-extend/css/vc-customize' . $min_suffix_css . '.css', array(), false);
...
$output .= '<div' . $str_el_id . ' class="' . $layout . g5plus_get_css_animation($css_animation) . '" ' . g5plus_get_style_animation($duration, $delay) . '>';
