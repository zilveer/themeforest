...
$nextID = isset($pages[$current+1]) ? $pages[$current+1] : $current;

?>

<div class="postwrap postwrap-search">
    <h2><?php printf(__('Search Results for <i>%s</i>', 'bebel'), get_search_query()); ?></h2>
</div>
