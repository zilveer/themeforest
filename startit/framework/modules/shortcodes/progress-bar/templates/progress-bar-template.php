<div class="qodef-progress-bar">
	...
	<div class="qodef-progress-content-outer " <?php echo qode_startit_get_inline_style($bar_style)?>>
		<div data-percentage=<?php echo esc_attr($percent)?> class="qodef-progress-content" <?php echo qode_startit_get_inline_style($bar_active_style)?> ></div>
	</div>
</div>	