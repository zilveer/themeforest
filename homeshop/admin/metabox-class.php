				...
				if ( $attachments )
				{
					foreach ( $attachments as $attachment_id ) {
						echo '<li class="image" data-attachment_id="' . $attachment_id . '">
							...
							<ul class="actions">
								<li><a href="#" class="delete" title="' . __( 'Delete image', 'homeshop' ) . '">' . __( 'Delete', 'homeshop' ) . '</a></li>
							</ul>
						</li>';
					}
				}
			...
			jQuery(document).ready(function($){
				...
				jQuery('.add_slider_images').on( 'click', 'a', function( event ) {
					...
					slider_gallery_frame = wp.media.frames.downloadable_file = wp.media({
						...
						title: '<?php _e( 'Add Images to Gallery', 'homeshop' ); ?>',
						button: {
							text: '<?php _e( 'Add to gallery', 'homeshop' ); ?>',
						},
						multiple: true
					});
							...
							if ( attachment.id ) {
								...
								$slider_images.append('\
									<li class="image" data-attachment_id="' + attachment.id + '">\
										...
										<ul class="actions">\
											<li><a href="#" class="delete" title="<?php _e( 'Delete image', 'homeshop' ); ?>"><?php _e( 'Delete', 'homeshop' ); ?></a></li>\
										</ul>\
									</li>');
							}
