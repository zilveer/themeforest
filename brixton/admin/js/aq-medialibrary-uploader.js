	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
          ...
          if (itemurl.match(image)) {
            btnContent = '<a class="aq-uploaded-image" href="'+itemurl+'"><img id="image_'+imgID+'" class="aq-option-image" src="'+itemurl+'" alt="" /></a>';
          } else {
          ...
          $('#' + formfield).siblings('.'+imgID).fadeIn().html(btnContent);
		  alert(imgID)
