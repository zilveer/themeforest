		<div class="three columns alpha clearfix">
			<ul class="entry-meta meta1 clearfix">
				...
				<?php if($select_skin == 'dark'): ?>
					<li><img src="<?php echo get_template_directory_uri() . '/images/icons/glyphish/45-movie-1.png'; ?>" class="post-format-icon" title="Video Post Format"/></li>
				<?php endif; ?>
				<li><span><?php _e( 'by', 'morphis' ); ?> <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'View all posts by %s', 'morphis' ), get_the_author() ) ); ?>" rel="author"><?php echo get_the_author(); ?></a></li>
