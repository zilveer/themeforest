 ...
 * @subpackage Example
 * @version    2.6.1 for child theme Quasar for publication on ThemeForest
...
add_action( 'tgmpa_register', 'quasar_register_required_plugins' );
 ...
 */
function quasar_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'               => 'Rock Form Builder', // The plugin name.
			'slug'               => 'rock-form-builder', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/plugins/rock-form-builder.zip', // The plugin source.
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/plugins/prettyphoto-media.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
	 ...
	 */
	$config = array(
		'id'           => 'quasar',                 // Unique ID for hashing notices for multiple instances of TGMPA.
