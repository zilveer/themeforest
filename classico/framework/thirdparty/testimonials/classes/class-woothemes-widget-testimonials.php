...
class Woothemes_Widget_Testimonials extends WP_Widget {
	...
	public function __construct() {
		...
		$this->woothemes_widget_description = __( 'Recent testimonials on your site.', ET_DOMAIN );
		$this->woothemes_widget_idbase = 'woothemes_testimonials';
		$this->woothemes_widget_title = __( 'Testimonials', ET_DOMAIN );
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title (optional):', ET_DOMAIN ); ?></label>
			<input type="text" name="<?php echo $this->get_field_name( 'title' ); ?>"  value="<?php echo $instance['title']; ?>" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" />
		</p>
		<!-- Widget Limit: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Limit:', ET_DOMAIN ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'size' ); ?>"><?php _e( 'Image Size (in pixels):', ET_DOMAIN ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'order' ); ?>"><?php _e( 'Order Direction:', ET_DOMAIN ); ?></label>
		...
		<!-- Widget Display Navigation: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'navigation' ); ?>"><?php _e( 'Display Control Navigation', ET_DOMAIN ); ?></label>
	   	</p>
		<!-- Widget Display Author: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_author' ); ?>"><?php _e( 'Display Author', ET_DOMAIN ); ?></label>
	   	</p>
		<!-- Widget Display Avatar: Checkbox Input -->
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_avatar' ); ?>"><?php _e( 'Display Avatar', ET_DOMAIN ); ?></label>
	   	</p>
       	...
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'display_url' ); ?>"><?php _e( 'Display URL', ET_DOMAIN ); ?></label>
	   	</p>
	   	<!-- Widget Category: Select Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php _e( 'Category:', ET_DOMAIN ); ?></label>
			<?php
				$dropdown_args = array( 'taxonomy' => 'testimonial-category', 'class' => 'widefat', 'show_option_all' => __( 'All', ET_DOMAIN ), 'id' => $this->get_field_id( 'category' ), 'name' => $this->get_field_name( 'category' ), 'selected' => $instance['category'] );
				wp_dropdown_categories( $dropdown_args );
			?>
		</p>
		<!-- Widget ID: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'specific_id' ); ?>"><?php _e( 'Specific ID (optional):', ET_DOMAIN ); ?></label>
		...
		<p><small><?php _e( 'Display a specific testimonial, rather than a list.', ET_DOMAIN ); ?></small></p>
<?php
	} // End form()
	...
	protected function get_orderby_options () {
		return array(
					'none' => __( 'No Order', ET_DOMAIN ),
					'ID' => __( 'Entry ID', ET_DOMAIN ),
					'title' => __( 'Title', ET_DOMAIN ),
					'date' => __( 'Date Added', ET_DOMAIN ),
					'menu_order' => __( 'Specified Order Setting', ET_DOMAIN ),
					'rand' => __( 'Random Order', ET_DOMAIN )
					);
	...
	protected function get_order_options () {
		return array(
					'ASC' => __( 'Ascending', ET_DOMAIN ),
					'DESC' => __( 'Descending', ET_DOMAIN )
					);
