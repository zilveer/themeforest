			...
			<div class="rtmedia-single-meta rtm-single-meta">
				...
				<?php if ( $rt_ajax_request ) { ?>
					...
					<div class="rtm-single-meta-contents<?php if ( is_user_logged_in() ) echo " logged-in"; ?>">
						...
						<div class="rtmedia-media-description rtm-more"><?php echo strip_tags( rtmedia_description( $echo = false ) ); ?></div>
						<!-- Monarch -->
				...
				<?php } else { // else for if ( $rt_ajax_request ) ?>
					...
					<div class="rtmedia-media-description more"><?php rtmedia_description(); ?></div>
					<!-- Monarch -->
