				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<div class="bbp-submit-wrapper">
							<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_merge_topic_submit" name="bbp_merge_topic_submit" class="button submit btn btn-theme"><?php _e( 'Submit', 'bbpress' ); ?></button>
						</div>
					</div>
