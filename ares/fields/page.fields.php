...
$page_postmetas = 
	array (
		...
		*/
		array("section" => "Select Sidebar", "id" => "page_sidebar", "type" => "select", "title" => "Select this page's sidebar to display (require Page Sidebar template)", "items" => $theme_sidebar),
		/*
...
function page_create_meta_box() {
	...
	if ( function_exists('add_meta_box') && isset($page_postmetas) && count($page_postmetas) > 0 ) {  
		add_meta_box( 'page_metabox', 'Page Options', 'page_new_meta_box', 'page', 'side', 'low' );  
	}
