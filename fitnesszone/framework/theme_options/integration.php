        ...
        <div id="integration-general">
        	<?php $integration_general = array( 
					array(
						...
						"tooltip"=>		__('Any code you place here will appear in the head section of every page of your site. This code wrapped between &lt;script&gt; &lt;/script&gt; tags.','iamd_text_domain'),
					...
					array(
						...
						"tooltip"=>		__('You can paste your Google Analytics or other website tracking codes in this box. This code wrapped between &lt;script&gt; &lt;/script&gt; tags.','iamd_text_domain'), 
						"textarea"=>	"body-code",
