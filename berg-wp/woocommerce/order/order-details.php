...
?>
<h2 class="h3"><?php _e( 'Order Details', 'woocommerce' ); ?></h2>
...
<header>
	<h2 class="h3"><?php _e( 'Customer details', 'woocommerce' ); ?></h2>
</header>
...
<?php endif; ?>
		...
		<header class="title">
			<h3 class="h4"><?php _e( 'Billing Address', 'woocommerce' ); ?></h3>
		</header>
		<address>
			<?php
...
<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && get_option( 'woocommerce_calc_shipping' ) !== 'no' ) : ?>
	...
	<div class="col-2 col-sm-6">
		...
		<header class="title">
			<h3 class="h4"><?php _e( 'Shipping Address', 'woocommerce' ); ?></h3>
		</header>
		<address>
			<?php
