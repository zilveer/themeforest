...
$options = array(
    ...
    // Profession
    array('name' => __('Job Position','tfuse'),
        'desc' => __('Enter the job position','tfuse'),
        'id' => TF_THEME_PREFIX . '_profession',
        'value' => '',
        'type' => 'text'
    ),
    array('name' => __('Twitter Username','tfuse'),
        'desc' => __('Enter the twitter username','tfuse'),
        'id' => TF_THEME_PREFIX . '_twitter_username',
        'value' => '',
        'type' => 'text'
    ),
