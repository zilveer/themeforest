...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_accordion wpb_content_element1 ' . $el_class . ' not-column-inherit', $this->settings['base'], $atts );
...
$output .= '<div class="panel-group text-left" id="accordion" role="tablist" aria-multiselectable="true">';
