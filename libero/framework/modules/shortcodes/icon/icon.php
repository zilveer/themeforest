...
class Icon implements ShortcodeInterface {
            ...
            'params'                    => array_merge(
                ...
                array(
                    ...
                    array(
                        ...
                        'description' => esc_html__('Please insert border radius(Rounded corners) in px. For example: 4 ', 'libero'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = libero_mikado_get_shortcode_module_template_part('templates/icon', 'icon', '', $params);
