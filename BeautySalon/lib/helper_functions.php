...
/**
* @package   corporative
* @author    BDThemes http://www.bdtheme.com
* @copyright Copyright (C) bdthemes
*/


add_action('admin_head', 'bdt_theme_admin_style');

function bdt_theme_admin_style() {
  echo '<style>
    .rs-update-notice-wrap, .sb-update-notice-wrap {
...
function _HEX2RGB($hexStr, $returnAsString = false, $seperator = ','){
    ...
    function _RGBA($hex, $opacity){
        return 'rgba(' . _HEX2RGB($hex, true) . ','.$opacity.')';
    }