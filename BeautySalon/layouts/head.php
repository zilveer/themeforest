...
<?php endif; ?>
<?php if($this['config']->get('favicon')): ?> 
    <link rel="shortcut icon" href="<?php echo $this['config']->get('favicon');?>" />
<?php else : ?>
    <link rel="shortcut icon" href="<?php echo $this['path']->url('theme:favicon.ico');?>">
<?php endif; ?>
<?php if($this['config']->get('appleTouchIcon')): ?> 
    <link rel="apple-touch-icon-precomposed" href="<?php echo $this['config']->get('appleTouchIcon');?>">
<?php else : ?>
