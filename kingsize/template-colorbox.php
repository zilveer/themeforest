		...
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<!-- End Breadcrumbs -->
				  ...
				  <!-- END PAGE CONTENT HERE -->	
				   ...
				   <?php	
					$checkPasswd = false; //validating the password
									...
									<div class="<?php echo $div_layout;?> space-bottom mobile-fullwidth">
										<div class="row">
											<div class="twelve columns pV0H5">
												<a class="<?php echo $class_gal;?>" href="<?php echo wp_get_attachment_url($attachment->ID);?>" title="<?php if($data["wm_gallery_titles_colorbox"] == "Enable Colorbox Titles") echo $post_title;  ?>">
												<?php //lazy loader
												if($data["wm_lazyloader_option"] == "Enable Lazyloader") : ?>
												<img class="lazy" data-original="<?php echo $url_post_img?>" src="<?php echo get_template_directory_uri().'/images/loading.gif';?>"  alt="<?php  if($data["wm_gallery_titles_colorbox"] == "Enable Colorbox Titles") echo $post_alt;  ?>" title="<?php  if($data["wm_gallery_titles_colorbox"] == "Enable Colorbox Titles") echo $attachment->post_title;?>">
												<?php else : ?>
												<img src="<?php echo $url_post_img;?>" alt="<?php  if($data["wm_gallery_titles_colorbox"] == "Enable Colorbox Titles") echo $post_alt;  ?>" title="<?php  if($data["wm_gallery_titles_colorbox"] == "Enable Colorbox Titles") echo $attachment->post_title;?>">
												<?php endif;?>
												</a>
											</div>
										</div>
