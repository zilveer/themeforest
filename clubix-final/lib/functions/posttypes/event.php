...
class EventPostType {
    ...
    public function zen_pt_init() {
        ...
        $labels = array(
            ...
            'singular_name'         => __('Event', LANGUAGE_ZONE_ADMIN),
            'add_new'               => __('Add new', LANGUAGE_ZONE_ADMIN),
            'add_new_item'          => __('Add new event', LANGUAGE_ZONE_ADMIN),
            'edit_item'             => __('Edit Event', LANGUAGE_ZONE_ADMIN),
            'new_item'              => __('New Event', LANGUAGE_ZONE_ADMIN),
            'view_item'             => __('View Event', LANGUAGE_ZONE_ADMIN),
            'search_items'          => __('Search Events', LANGUAGE_ZONE_ADMIN),
            'not_found'             => __('No events found.', LANGUAGE_ZONE_ADMIN),
            'not_found_in_trash'    => __('No events found in trash.', LANGUAGE_ZONE_ADMIN),
            'parent_item_colon'     => ''
        );
