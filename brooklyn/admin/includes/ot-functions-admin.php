...
if ( ! function_exists( 'ot_admin_styles' ) ) {
  ...
  function ot_admin_styles() {
	...
	wp_enqueue_style( 'ot-fontawesome-css', '//maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css' , false );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    wp_enqueue_script( 
        'ot-cookie-js', OT_URL . 'assets/js/jquery.ckie.js', 
        array( 'jquery' ), 
    OT_VERSION );
    
    wp_enqueue_style(
        'ut-minicolors-css',
        THEME_WEB_ROOT . '/admin/assets/vendor/minicolors/css/jquery.minicolors.css'
    );
        
    wp_enqueue_script(
        'ut-minicolors-js', 
        THEME_WEB_ROOT .'/admin/assets/vendor/minicolors/js/jquery.minicolors.min.js', 
        array('jquery')
    );
    
    
    wp_enqueue_script( 
        'ot-admin-js', OT_URL . 'assets/js/ot-admin.js', 
        array( 'jquery', 'jquery-ui-tabs', 'jquery-effects-core', 'jquery-effects-blind', 'jquery-effects-slide', 'jquery-ui-sortable', 'media-upload', 'thickbox' , 'underscore', 'ut-minicolors-js' ), 
        OT_VERSION 
    );
    ...
    $localized_array = array( 
      ...
      'upload_text'           => esc_html__( 'Send to OptionTree', 'option-tree' ),
