<?php
class rt_generate_product_carousel_class extends RTThemePageLayoutOptions{
	#
	...
	function rt_generate_product_carousel($theGroupID,$theTemplateID,$options,$randomClass){
			...
			$options = array (
					...
					array(
							...
							"id" => $theTemplateID.'_'.$theGroupID."_product_carousel[values][heading]", 
							"value"=> $heading,
							"type" => "text"
					), 
					...
					array(
							...
							"id" => $theTemplateID.'_'.$theGroupID."_product_carousel[values][heading_icon]", 
					...
					array(
							...
							"id" 	=> $theTemplateID.'_'.$theGroupID."_product_carousel[values][categories][]",
					...
					array(
							...
							"id" => $theTemplateID.'_'.$theGroupID."_product_carousel[values][list_orderby]", 
					...
					array(
							...
							"id" => $theTemplateID.'_'.$theGroupID."_product_carousel[values][list_order]", 
					...
					array(
							"name" 	=> __("Crop Image",'rt_theme_admin'),
							"id" 	=> $theTemplateID.'_'.$theGroupID."_product_carousel[values][crop]",
							"check_desc" 	=> __("Enable (if checked) cropping for product images",'rt_theme_admin'),
							"type" 	=> "checkbox",
							"class"	=> $randomClass,
							"value"	=> $crop,
							"default"	=> "on",
					...
					array(
							...
							"id" => $theTemplateID.'_'.$theGroupID."_product_carousel[values][style]",
							"options" =>	array(
					...
					array(
							...
							"id" 	=> $theTemplateID.'_'.$theGroupID."_product_carousel[values][max_item]",
							"min"	=> "1",
							"max"	=> "200",
							"class"	=> $randomClass,
							"value"	=> $max_item,
					...
					array(
							...
							"id" => $theTemplateID.'_'.$theGroupID."_product_carousel[values][item_width]",
							"options" =>	array(
										5 => "1/5", 
										4 => "1/4",
										3 => "1/3",
