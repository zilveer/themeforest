...
class Pyre_Latest_Menu_Media_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'pyre_homepage_media-menu', 'description' => 'Latest Portfolio Posts');
		...
		parent::__construct('pyre_homepage_media-widget-menu', 'Home: Portfolio Posts ', $widget_ops, $control_ops);
	}
	...
	function form($instance)
	{
		...
		$defaults = array('title' => 'Featured Work', 'summary_text' => 'We take pride in our work', 'posts' => 3, 'columns' => 3, 'portfolioslug' => '', 'link_text' => 'View Portfolio', 'link_link' => '#', 'widget_bg' => '#2e2e42', 'widget_bg_img' => '', 'checkbox_pro' => '1', 'link_icon' => 'fa-briefcase');
		...
		<p>
			<label for="<?php echo $this->get_field_id('portfolioslug'); ?>"><?php _e( 'Portfolio Category Slug<br>(Leave blank to pull all posts)', 'progression' ); ?>:</label>
