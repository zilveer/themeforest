...
if ( $custom_hover_background_color ) {
	...
	generate_custom_style( ".post-{$portfolio_item_id} .item-box .thumb .hover-state .likes .like-btn > *", "color: {$custom_hover_background_color} !important;" );
}
...
if ( $box_size ) {
	...
	$mobile_image = get_laborator_show_image_placeholder( $post_thumbnail_id, $mobile_image_size );
...
// Item Thumbnail
$image = get_laborator_show_image_placeholder( $post_thumbnail_id, apply_filters( 'kalium_portfolio_loop_thumbnail_size', $portfolio_image_size, 'type-2' ), '' );
