...
/**** MAIN RIGHT */
add_action( 'zn_head__main_right', 'zn_header_main_menu', 1 ); // MAIN NAVIGATION
add_action( 'zn_head__main_right', 'zn_header_calltoaction', 2 ); // CALL TO ACTION BUTTON
add_action( 'zn_head__main_right', 'zn_woocomerce_cart_init', 3 ); // CART PANEL
