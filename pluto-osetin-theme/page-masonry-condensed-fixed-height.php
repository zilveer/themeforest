<?php
/*
* Template Name: Masonry Fixed Height
*/
get_header(); ?>
<div class="main-content-w">
  ...
  <div class="main-content-i">
    ...
    <div class="content side-padded-content">
      ...
      <div id="primary-content" class="index-isotope v3" data-layout-mode="fitRows">
        <?php
      ...
      <?php if(os_get_next_posts_link($osetin_query)): ?>
        <div class="isotope-next-params" data-params="<?php echo os_get_next_posts_link($osetin_query); ?>" data-layout-type="v3" data-template-type="page-masonry-condensed-fixed-height"></div>
