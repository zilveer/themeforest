...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_attr__('No Repeat', 'nanomag'),
		'repeat-x'  => esc_attr__('Repeat Horizontally', 'nanomag'),
		'repeat-y'  => esc_attr__('Repeat Vertically', 'nanomag'),
		'repeat'    => esc_attr__('Repeat All', 'nanomag'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_attr__('Top Left', 'nanomag'),
		'top center'    => esc_attr__('Top Center', 'nanomag'),
		'top right'     => esc_attr__('Top Right', 'nanomag'),
		'center left'   => esc_attr__('Middle Left', 'nanomag'),
		'center center' => esc_attr__('Middle Center', 'nanomag'),
		'center right'  => esc_attr__('Middle Right', 'nanomag'),
		'bottom left'   => esc_attr__('Bottom Left', 'nanomag'),
		'bottom center' => esc_attr__('Bottom Center', 'nanomag'),
		'bottom right'  => esc_attr__('Bottom Right', 'nanomag')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_attr__('Scroll Normally', 'nanomag'),
		'fixed'  => esc_attr__('Fixed in Place', 'nanomag')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_attr__('Normal', 'nanomag'),
		'italic'      => esc_attr__('Italic', 'nanomag'),
		'bold'        => esc_attr__('Bold', 'nanomag'),
		'bold italic' => esc_attr__('Bold Italic', 'nanomag')
		);
