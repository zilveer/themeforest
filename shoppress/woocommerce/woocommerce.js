jQuery(document).ready(function(){
	...
	jQuery("ul.products").prepend(jQuery(".woocommerce-pagination"));
	

	/////////////////////////////////////// Product buttons ///////////////////////////////////////

	jQuery("ul.products li.product").hover(function() {
		jQuery(this).find(".product_buttons").stop().fadeTo("fast", 1);
	}, function() {
		jQuery(this).find(".product_buttons").stop().fadeTo("fast", 0);
	});
	...
	jQuery('ul.products li.product').each(function() {
		...
		jQuery(this).append('<a href="'+productlink+'" class="view_product_button">'+gp_script.viewproduct+'</a>');
	});
	...
	jQuery('ul.products li.product .button').each(function() {
		var newDiv = jQuery('<div/>').addClass('product_buttons');
    ...
    jQuery(".dropdowncart-contents").hide();
	jQuery(".cart-link").show();
	
	jQuery('.cart-link').live('click', function(e){
		e.preventDefault();
		jQuery(".dropdowncart-contents").slideToggle();	
	});
...
/* Add a box (mouseTrap) over the small image to trap mouse events.
		...
		*/
            $mouseTrap = jWin.parent().append(format("<div class='mousetrap' style=';z-index:997;position:absolute;width:%0px;height:%1px;left:%2px;top:%3px;\'></div>", sImg.outerWidth(), sImg.outerHeight(), 0, 0)).find(':last');
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
               ...
               if(summary.width() > zoomImage.width) {
                	w = zoomImage.width;
                } else {
                	w = summary.width();
                }
