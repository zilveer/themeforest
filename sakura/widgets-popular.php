...
foreach ($posts_sl as $post_item)
{
	...
	function widget_sakura_Popular_control() {
        ...
        // form posted?
		if ( $_POST['sakura_Twitter3-submit'] ) {
	...
	wp_register_sidebar_widget(9003, ('Sakura Theme Popular posts'), 'widget_sakura_Popular');

	// Register settings for use, 300x200 pixel form
	wp_register_widget_control(9003, ('Sakura Theme Popular posts'), 'widget_sakura_Popular_control', 250, 200);  
