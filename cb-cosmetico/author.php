...
<div id="middle">
	<div class="wrapper_p">
		<div class="wrapper_p head_title">
			...
			<?php printf(__('Author Archives: %s','cb-cosmetico'),"<span class='vcard'><a class='url fn n' href='".get_author_posts_url(get_the_author_meta('ID'))."' title='".esc_attr(get_the_author())."' rel='me'>".get_the_author()."</a></span>"); ?>
			</h1>
		</div>
