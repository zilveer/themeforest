...
<div id="buddypress">
	...
	<div class="item-list-tabs activity-type-tabs" role="navigation">
		<ul>
			...
			<li class="selected" id="activity-all"><a href="<?php bp_activity_directory_permalink(); ?>" title="<?php esc_attr_e( 'The public activity for everyone on this site.', 'buddypress' ); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'All Members %s', 'buddypress' ), bp_get_total_member_count() ) ); ?></a></li>
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_is_active( 'friends' ) ) : ?>
					...
					<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
						...
						<li id="activity-friends"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of my friends only.', 'buddypress' ); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'My Friends %s', 'buddypress' ), bp_get_total_friend_count( bp_loggedin_user_id() ) )); ?></a></li>
				...
				<?php if ( bp_is_active( 'groups' ) ) : ?>
					...
					<?php if ( bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
						...
						<li id="activity-groups"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_groups_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of groups I am a member of.', 'buddypress' ); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'My Groups %s', 'buddypress' ), bp_get_total_group_count_for_user( bp_loggedin_user_id() ) )); ?></a></li>
				...
				<?php if ( bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) ) : ?>
					...
					<li id="activity-favorites"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/favorites/'; ?>" title="<?php esc_attr_e( "The activity I've marked as a favorite.", 'buddypress' ); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'My Favorites %s', 'buddypress' ), bp_get_total_favorite_count_for_user( bp_loggedin_user_id() ) )); ?></a></li>
