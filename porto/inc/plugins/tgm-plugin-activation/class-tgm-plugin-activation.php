		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				if ( $this->is_tgmpa_complete() ) {
                    // edit for porto theme
                    echo '<p><a href="', esc_url( admin_url( 'admin.php?page=porto-plugins' ) ), '" target="_parent">', esc_html( $this->strings['return'] ), '</a></p>';
		...
		protected function activate_single_plugin( $file_path, $slug, $automatic = false ) {
			if ( $this->can_plugin_activate( $slug ) ) {
				...
				if ( is_wp_error( $activate ) ) {
                    ...
                    '<p><a href="', esc_url( admin_url( 'admin.php?page=porto-plugins' ) ), '" target="_parent">', esc_html( $this->strings['return'] ), '</a></p>';
					//echo '<div id="message" class="error"><p>', wp_kses_post( $activate->get_error_message() ), '</p></div>',
				...
				class TGMPA_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
					...
					public function bulk_footer() {
						...
						if ( $this->tgmpa->is_tgmpa_complete() ) {
                            ...
                            // edit for porto theme
							$update_actions['tgmpa_page'] = '<a href="' . esc_url( admin_url( 'admin.php?page=porto-plugins' ) ) . '" target="_parent">' . esc_html( $this->tgmpa->strings['return'] ) . '</a>';
