<?php
namespace QodeStartit\Modules\Blockquote;
...
class Blockquote implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = qode_startit_get_shortcode_module_template_part('templates/blockquote-template', 'blockquote', '', $params);
