...
if(!function_exists('qode_transparent_header_class')) {
	 ...
	 *
	 * @see qode_is_default_wp_template()
	 */
	function qode_transparent_header_class($classes) {
		...
		$is_archive 				= qode_is_default_wp_template();
...
if(!function_exists('qode_wide_first_level_menu_bkg_header_class')) {
	/**
	 ...
	 * @see qode_is_default_wp_template()
	 */
	function qode_wide_first_level_menu_bkg_header_class($classes) {
		global $qode_options;

		$qode_wide_first_level_menu_bkg_header_class = ((isset($qode_options['header_bottom_appearance']) && $qode_options['header_bottom_appearance'] == "fixed_hiding") || (isset($qode_options['header_bottom_appearance']) && $qode_options['header_bottom_appearance'] == "stick menu_bottom") ) && isset($qode_options['enable_menu_wide_background']) && $qode_options['enable_menu_wide_background'] == 'yes';
	...
	add_filter('qode_header_classes', 'qode_wide_first_level_menu_bkg_header_class');
}
...
if(!function_exists('qode_center_logo_class')) {
	...
	function qode_center_logo_class($classes) {
		...
		if((isset($qode_options['center_logo_image']) && $qode_options['center_logo_image'] == 'yes' && $qode_options['header_bottom_appearance'] !== "stick_with_left_right_menu") || (isset($qode_options['header_bottom_appearance']) && $qode_options['header_bottom_appearance'] == "fixed_hiding")) {
...
if(!function_exists('qode_header_style_on_scroll_class')) {
    /**
     * Function that adds header style class to header tag
     * @param array array of classes from main filter
     * @return array array of classes with added header style class
     */
    function qode_header_style_on_scroll_class($classes) {
        global $wp_query;
        global $qode_options;
        ...
        } else if(isset($qode_options['enable_header_style_on_scroll']) && $qode_options['enable_header_style_on_scroll'] == 'yes'){
            $classes[]= 'header_style_on_scroll';
        }
    ...
    add_filter('qode_header_classes', 'qode_header_style_on_scroll_class');
}
...
if(!function_exists('qode_header_menu_items_position_class')) {
    /**
     * Function that ajax header animation class to header tag
     * @param array array of classes from main filter
     * @return array of classes with added ajax header animation class
     */
    function qode_header_menu_items_position_class($classes) {
        global $qode_options;

        if(isset($qode_options['header_bottom_appearance']) && $qode_options['header_bottom_appearance'] == 'stick_with_left_right_menu' && isset($qode_options['menu_items_position'])){
            $classes[]= $qode_options['menu_items_position'];
        }

        return $classes;
    }

    add_filter('qode_header_classes', 'qode_header_menu_items_position_class');
}

if(!function_exists('qode_header_paspartu_alignment_class')) {
    /**
     * Function that adds paspartu alignment class to header tag
     * @param array array of classes from main filter
     * @return array of classes with added paspartu alignment class
     */
    function qode_header_paspartu_alignment_class($classes) {
        global $qode_options;

        if(isset($qode_options['paspartu_header_alignment']) && $qode_options['paspartu_header_alignment'] == 'yes' && isset($qode_options['paspartu']) && $qode_options['paspartu'] == 'yes'){
            $classes[]= 'paspartu_header_alignment';
        }
		
		if(isset($qode_options['paspartu_header_inside']) && $qode_options['paspartu_header_inside'] == 'yes' && isset($qode_options['paspartu']) && $qode_options['paspartu'] == 'yes'){
    ...
    add_filter('qode_header_classes', 'qode_header_paspartu_alignment_class');
}

if(!function_exists('qode_header_ajax_header_animation_class')) {
    /**
     * Function that ajax header animation class to header tag
     * @param array array of classes from main filter
     * @return array of classes with added ajax header animation class
     */
    function qode_header_ajax_header_animation_class($classes) {
        global $qode_options;
    ...
    add_filter('qode_header_classes', 'qode_header_ajax_header_animation_class');
}