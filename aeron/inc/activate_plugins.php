...
define( 'THEMENAME', 'Aeron' );

require_once dirname( __FILE__ ) . '/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'aeron_register_required_plugins' );

function aeron_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'force_activation' 		=> false, // If true,main_slider plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' 			=> '', // If set, overrides default API URL and points to an external URL
		),
		array(
