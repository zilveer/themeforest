...
if($category_page_template == "version_2") {

	get_template_part( 'taxonomy-event_loc-version-2', 'event' );
    exit;

} elseif($category_page_template == "version_3") {

	get_template_part( 'taxonomy-event_loc-version-3', 'event' );
    exit;
							...
							<div class="row">
								...
								<div class="col-sm-8">
									...
									<div class="full">
										...
										<h4><?php esc_html_e("Location", "themesdojo"); ?>: <?php printf( __( ' %s', '' ), '' . single_cat_title( '', false ) . '' );	?></h4>
					...
					<div class="col-sm-4">
						...
						<div class="widget-container widget_search">
							...
							<form id="td-filter-listings" type="post" action="" >
										...
										<input type="hidden" name="listingFormLoc" value="<?php echo esc_attr($term_id); ?>" />
