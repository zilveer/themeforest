...
<section id="content">	
			...
			<section class="section page-heading ">
				<h1 class="entry-title" ><?php printf( __( 'Category Archives: %s', 'candidate' ), '' . single_cat_title( '', false ) . '' ); ?></h1>
		...
		<section class="section full-width-bg gray-bg">
			...
			<div class="row">
				...
				<?php if( get_option('sense_settings_category_blog') && get_option('sense_settings_category_blog') == 'style1' ) { ?>
