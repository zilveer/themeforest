...
yit_add_portfolio_config( $portfolio_type, array(
    ...
    array(
        'name' => __( 'Activate Project Detail slide', 'yit' ),
        'id' => 'open_slide',
        'type' => 'onoff',
        'desc' => __( 'Select if you want to open the project into the same page or in a new page.', 'yit' )
    ),
	...
	array(
        ...
        'id' => 'background-color',
        'type' => 'colorpicker',
        'desc' => __( 'Background color of Project Detail Panel', 'yit' ),
		'std' => '#f1f4f5'
    ),
) );
