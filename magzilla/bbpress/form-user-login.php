...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form form-horizontal">
	<fieldset class="bbp-form">
		...
		<div class="bbp-username form-group">
			<label class="col-sm-2 control-label" for="user_login"><?php _e( 'Username', 'bbpress' ); ?>: </label>
		...
		<div class="bbp-password form-group">
			<label class="col-sm-2 control-label" for="user_pass"><?php _e( 'Password', 'bbpress' ); ?>: </label>
		...
		<div class="bbp-submit-wrapper form-group">
			...
			<button type="submit" tabindex="<?php bbp_tab_index(); ?>" name="user-submit" class="button submit user-submit btn btn-theme"><?php _e( 'Log In', 'bbpress' ); ?></button>
