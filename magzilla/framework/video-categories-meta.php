...
if ( !function_exists( 'fave_video_category_add_meta_fields' ) ) :
	function fave_video_category_add_meta_fields() {
		$fave_meta = fave_get_video_category_meta();
...
add_action( 'video-categories_add_form_fields', 'fave_video_category_add_meta_fields', 10, 2 );
...
if ( !function_exists( 'fave_video_category_edit_meta_fields' ) ) :
	function fave_video_category_edit_meta_fields( $term ) {
		$fave_meta = fave_get_video_category_meta( $term->term_id );
		$sidebars_lay = fave_get_sidebar_layouts( );
		$sidebars = fave_get_sidebars_list();
		$pagination = fave_get_pagination( true );
...
add_action( 'video-categories_edit_form_fields', 'fave_video_category_edit_meta_fields', 10, 2 );


if ( !function_exists( 'fave_save_video_category_meta_fields' ) ) :
	function fave_save_video_category_meta_fields( $term_id ) {
		...
		if ( isset( $_POST['fave'] ) ) {
			...
			update_option( '_fave_video_category_'.$term_id, $fave_meta );
...
add_action( 'edited_video-categories', 'fave_save_video_category_meta_fields', 10, 2 );
add_action( 'create_video-categories', 'fave_save_video_category_meta_fields', 10, 2 );
