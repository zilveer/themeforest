...
<div class="<?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base'], $atts ) ?>">
	<div class="wpb_wrapper">
		...
		<div id="<?php echo $carousel_id ?>" data-ride="vc_carousel"
			...
			<!-- Controls -->
			<a class="vc_left vc_carousel-control" href="#<?php echo esc_url($carousel_id); ?>" data-slide="prev">
				<span class="arrow-left-open"></span>
			</a>
			<a class="vc_right vc_carousel-control" href="#<?php echo esc_url($carousel_id); ?>" data-slide="next">
