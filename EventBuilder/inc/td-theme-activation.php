...
# Required Classes
#-----------------------------------------------------------------
include_once( THEME_DOCUMENT_ROOT . '/inc/lib/td-plugin-activation-class.php' );

#-----------------------------------------------------------------
# plugin requirements and recommendations
#-----------------------------------------------------------------
add_action( 'tgmpa_register', 'td_register_required_plugins' );

if ( ! function_exists( 'td_register_required_plugins' ) ) : 

    function td_register_required_plugins() {
        ...
        $plugins = array(
            ...
            array(
                ...
                'source'            => get_template_directory_uri() . '/inc/lib/plugins/layersliderwp-5.3.2.installable.zip', // The plugin source
                'required'          => true, // If false, the plugin is only 'recommended' instead of required
