...
<div class="mkd-team-item-wrapper">
    <div class="mkd-team <?php echo esc_attr($team_type) ?><?php echo esc_attr($box_class) ?><?php echo esc_attr($flip_class) ?>" <?php if($flip_on_hover != 'yes') { hue_mikado_inline_style($team_shadow_styles); } ?> >
        <?php if($flip_on_hover == 'yes') { ?>
            <div class="mkd-team-front" <?php hue_mikado_inline_style($team_shadow_styles); ?> >
        <?php } ?>
