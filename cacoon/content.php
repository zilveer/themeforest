	...
	<div class="span12">
		...
		?>
			<div class="met_blog_list_preview clearfix">
				<div class="met_blog_slider_wrap clearfix">
					<div class="met_blog_slider blog_slider_<?php the_ID() ?>">
			...
			<script>
				jQuery(window).load(function(){
					jQuery(".blog_slider_<?php the_ID() ?>").carouFredSel({
						responsive: true,
		...
		<div>
			<?php if ( is_search() ) : // Only display Excerpts for Search ?>
				<div class="entry-summary"><?php echo wp_trim_words(get_the_excerpt(),get_theme_mod('cacoon_blog_excerpt_limit','70'),'..'); ?></div>
			<?php else : ?>
				<div class="entry-content">
					<?php echo wp_trim_words(get_the_excerpt(),get_theme_mod('cacoon_blog_excerpt_limit','70'),'..'); ?>
		...
		<div class="met_blog_miscs clearfix">
			...
			<?php comments_popup_link( __( 'No Comment', 'metcreative' ), __( '1 Comment', 'metcreative' ), __( '% Comments', 'metcreative' ), 'met_blog_comment_count met_color2' ); ?>
			<?php endif; ?>
		</div>
	</div>
</div>