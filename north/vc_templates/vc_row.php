<?php
$output = $el_class = $bg_image = $bg_color = $bg_overlay_class = $bg_image_repeat = $section_class = $font_color = $padding = $margin_bottom = $css = $bg_rain = $video_bg = $vimeo = '';
$disable_element = '';
...
$output .= '<div class="'.$css_class.$bg_overlay_class.$parallax_class.'"'.$style.'>';
