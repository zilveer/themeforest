...
function optionsframework_init() {
	...
	if ( $optionsfile = locate_template( array('/framework/functions/options.php') ) ) {
		require_once($optionsfile);
	}
	else if (file_exists( dirname( __FILE__ ) . '/framework/functions/options.php' ) ) {
		require_once dirname( __FILE__ ) . '/framework/functions/options.php';
	}
