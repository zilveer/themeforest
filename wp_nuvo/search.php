...
<?php global $smof_data,$pagetitle; $blog_layout = cshero_generetor_blog_layout(); ?>
	<section id="primary" class="content-area<?php if($pagetitle == '1'){ echo ' cs-page-title-active';} ?>">
        <div class="container">
            <div class="row">
                    ...
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php if ( have_posts() ) : ?>
                            ...
                            <header class="page-header">
                                <h1 class="page-title"><?php printf( esc_html__( 'Search Results for: %s', 'wp_nuvo' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
                            </header><!-- .page-header -->
                            <?php endif; ?>
                            <?php /* Start the Loop */ ?>
