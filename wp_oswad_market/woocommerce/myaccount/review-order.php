...
<div id="order_review">
	...
	<!--<table class="shop_table"> 
		...
		<tfoot>
			...
			<tr class="discount">
				<th><?php _e( 'Cart Discount', 'wpdance' ); ?></th>
			...
			<?php if ( WC()->cart->needs_shipping() && WC()->cart->show_shipping() ) : ?>
				...
				<tr class="shipping">
					...
					<td><?php wc_get_template( 'cart/shipping-methods.php', array( 'available_methods' => $available_methods ) ); ?></td>
				</tr>
			...
			<tr class="discount">
				<th><?php _e( 'Order Discount', 'wpdance' ); ?></th>
			...
			<tr class="total">
				<th><strong><?php _e( 'Order Total', 'wpdance' ); ?></strong></th>
				<td>
					...
					<?php
						...
						if ( WC()->cart->tax_display_cart == 'incl' ) {
							...
							if ( ! empty( $tax_string_array ) ) {
								?><small class="includes_tax"><?php printf( __( '(Includes %s)', 'wpdance' ), implode( ', ', $tax_string_array ) ); ?></small><?php
							}
						}
					?>
				</td>
			...
			<?php
				...
				if ( ! empty( $available_gateways ) ) {
					...
					if ( ! WC()->customer->get_country() )
						echo '<p>' . __( 'Please fill in your details above to see available payment methods.', 'wpdance' ) . '</p>';
					else
						echo '<p>' . __( 'Sorry, it seems that there are no available payment methods for your state. Please contact us if you require assistance or wish to make alternate arrangements.', 'wpdance' ) . '</p>';
