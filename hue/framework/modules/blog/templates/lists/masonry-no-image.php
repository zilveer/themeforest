<?php hue_mikado_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
	<div class="mkd-blog-holder mkd-blog-type-masonry mkd-masonry-full-width mkd-masonry-no-image mkd-masonry-pagination-<?php echo hue_mikado_options()->getOptionValue('masonry_pagination'); ?>">
