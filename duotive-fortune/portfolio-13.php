<?php
/*
Template Name: Portfolio - Sidebar - 1 columns landscape
*/
get_header(); ?>
        	...
        	<div class="page portfolio-columns portofolio-columns-sidebar">
                ...
                <section id="filtrable">
                    ...
                    <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
                        ...
                        <?php endforeach; ?>
                        <article class="project project-one-column clearfix <?php echo $project_category; if ( $k%2 == 0 ) echo ' project-last'; ?>">
								...
								<?php if( $dt_projectImagebehaviour == 'readmore' ): ?>
                                    <div class="project-image">
                                        <a class="post-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
                                            ...
                                            <img src="<?php resizeimage($thumbnail_src,590,390,$dt_ProjectImageCrop); ?>" alt="<?php the_title(); ?>" />
                                        </a>                     
                                    </div>       
                                <?php endif; ?>
                            ...
                            <div class="project-content<?php echo $dt_ProjectColumnsNoImageClass; ?> clearfix">                                
                                <h4><a href="<?php the_permalink(); ?>" title="<?php echo dt_Permalink.the_title_attribute( 'echo=0' ); ?>" rel="bookmark"><?php the_title(); ?></a></h4>                         
                                <?php the_content(''); ?>
