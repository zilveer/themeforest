		...
		$shortcodes = array(
			...
			'display_posts' => array(
				...
				'atts' => array(
					'numberposts' => array(
						'values' => array( ),
						'desc' => __( 'Number of posts to display', 'shortcodes-ultimate' )
					),
					'category' => array(
						'values' => array( ),
						'desc' => __( 'Post category', 'shortcodes-ultimate' )
					),
					'offset' => array(
						'values' => array( ),
						'desc' => __( 'Number of posts to skip', 'shortcodes-ultimate' )
					),
					'order' => array(
						'values' => array( 
							'DESC',
						...
						'desc' => __( 'Display order', 'shortcodes-ultimate' )
					),
					'orderby' => array(
						'values' => array( 
						'date',
						...
						'desc' => __( 'Order by', 'shortcodes-ultimate' )
					),
					'post_type' => array(
						'values' => array( 
						'post',
						...
						'desc' => __( 'Post type to display', 'shortcodes-ultimate' )
					)
				),
				'usage' => '[display-posts tag="advanced" posts_per_page="20"]<br>[display-posts id="14,3"]<br>[display-posts category="must-read" posts_per_page="-1" include_date="true" order="ASC" orderby="title"]',
				'desc' => __( 'List of posts satisfying given parameters', 'shortcodes-ultimate' )
			),
			# table
			'table' => array(
				'name' => 'Table',
