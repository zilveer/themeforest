 ...
 */ ?>
<div id="pixlikes" class="metabox  pixlikes-box  <?php echo $display_only . ' ' . $class ?>"  <?php echo $data_id ?>>
	<span class="like-link"><i class="icon icon-heart"></i>
	<span class="likes-text">
		<span class="likes-count"><?php echo $likes_number ?></span>&nbsp;<?php _e('likes', 'pile') ?>
	</span>
	</span>
</div>