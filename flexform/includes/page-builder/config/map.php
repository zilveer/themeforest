...
WPBMap::map( 'vc_column_text', array(
    ...
    "params"	=> array(
    	...
    	array(
    	    ...
    	    "param_name" => "icon",
    	    "value" => "",
    	    "description" => __("Icon to the left of the title text. You can get the code from <a href='http://fontawesome.io/3.2.1/' target='_blank'>here</a>. E.g. fa-cloud", "js_composer")
    	),
        array(
            "type" => "textarea_html",
            "holder" => "div",
...
WPBMap::map( 'box', array(
    ...
    "params"	=> array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Custom background colour", "js_composer"),
            "param_name" => "custom_bg_colour",
            "value" => "",
            "description" => __("Provide a hex colour code here (include #). If blank, your chosen accent colour will be used.", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Custom text colour", "js_composer"),
            "param_name" => "custom_text_colour",
            "value" => "",
            "description" => __("Provide a hex colour code here (include #) if you want to override the default (#ffffff).", "js_composer")
        ),
        array(
            "type" => "dropdown",
            "heading" => __("Margin below widget", "js_composer"),
...
WPBMap::map( 'divider',  array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => array(__('No', "js_composer") => "no", __('Yes', "js_composer") => "yes"),
            "description" => __("Select yes if you'd like the divider to be full width (only to be used with no sidebars, and with Standard/Thin/Dotted divider types).", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "js_composer"),
...
WPBMap::map( 'blank_spacer',  array(
    ...
    "params"	=> array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Spacer ID", "js_composer"),
            "param_name" => "spacer_id",
            "value" => "",
            "description" => __("If you wish to add an ID to the spacer, then add it here. You can then use the id to deep link to this section of the page. NOTE: Make sure this is unique to the page!!", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "js_composer"),
...
WPBMap::map( 'vc_single_image', array(
    ...
    "params"	=> array(
		...
		array(
		    ...
		    "param_name" => "caption",
		    "value" => "",
		    "description" => __("If you would like a caption to be shown below the image, add it here.", "js_composer")
		)
    )
));
...
WPBMap::map( 'vc_tabs', array(
	...
	<div id="tab-1" class="row-fluid wpb_column_container wpb_sortable_container not-column-inherit">
		[vc_column_text width="1/1"] '.__('This is a text block. Click the edit button to change this text..', 'js_composer').' [/vc_column_text]
	</div>
...
//	"wrapper_class" => "clearfix",
    "params"	=> array(
        ...
        array(
            ...
            "value" => "",
            "description" => __("You can set the section that is active here by entering the number of the section here. NOTE: The first section would be 0, second would be 1, and so on. Leave blank for all sections to be closed by default.", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "js_composer"),
...
$size_arr = array(__("Normal", "js_composer") => "normal", __("Large", "js_composer") => "large");
...
WPBMap::map( 'vc_video', array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "param_name" => "full_width",
            "value" => array(__('No', "js_composer") => "no", __('Yes', "js_composer") => "yes"),
            "description" => __("Select this if you want the video to be the full width of the page container (leave the above size blank).", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "js_composer"),
...
WPBMap::map( 'vc_gmaps',  array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => array(__("No", "js_composer") => "no", __("Yes", "js_composer") => "yes"),
            "description" => __("If yes, the map will be displayed from screen edge to edge.", "js_composer")
        ),
        array(
            "type" => "textfield",
            "heading" => __("Extra class name", "js_composer"),
