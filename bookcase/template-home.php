    ...
    <div class="item" id="itemdiva<?php echo $counter; ?>">
        ...
        <div id="arrowa<?php echo $counter;?>" style="display:none;" class="posttext">
           ...
           <?php  $terms = get_the_terms( get_the_ID(), 'skills' );  ?>
            ...
            <a href="#"><img src="<?php echo get_template_directory_uri();?>/images/tag-icon.png" alt="Tags" /><span class="tooltip black right"><?php if ($terms != null) {$output = array(); foreach($terms as $term){$output[] = $term->name;} echo implode(', ', $output);  }else { echo __('No Tags', 'framework');}  ?></span></a>
