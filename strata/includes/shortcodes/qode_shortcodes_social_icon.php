...
<form id="qode_shortcode_form" name="qode_shortcode_form" method="post" action="">
	<div class="input">
		...
		<select name="type" id="type">
			<option value="circle_social">Circle</option>
			<option value="normal_social">Normal</option>
		</select>
    </div>
	<div class="input">
	...
	<div class="input">
	    <label>Top Gradient Background Color</label>
	    <div class="colorSelector"><div style=""></div></div>
	    <input name="top_gradient_background_color" id="top_gradient_background_color" value="" maxlength="12" size="12" />
	</div>
    <div class="input">
        <label>Bottom Gradient Background Color</label>
        <div class="colorSelector"><div style=""></div></div>
        <input name="bottom_gradient_background_color" id="bottom_gradient_background_color" value="" maxlength="12" size="12" />
    </div>
    <div class="input">
