	...
	function houzez_invoice_meta( $object, $box ) {
		...
		<?php if( $payment_status == 0 ) { ?>
			<div class="favethemes_meta_control">
				...
				if( $invoice_billion_for =='package' || $invoice_billion_for =='Package' ) {
					print '<div id="activate_package" class="houzez_activate_listing" data-invoice="'.$object->ID.'" data-item="'.esc_attr($fave_meta['invoice_item_id']).'">'.esc_html__('Wire Payment Received - Activate the purchase', 'houzez').'</div>';
				} else {
					print '<div id="activate_purchase_listing" class="houzez_activate_listing" data-invoice="'.$object->ID.'" data-item="'.esc_attr($fave_meta['invoice_item_id']).' " data-purchaseType="'.$purchase_type.'">'.esc_html__('Wire Payment Received - Activate the purchase', 'houzez').'</div>';
				}
				?>
			</div>
		<?php } ?>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				...
				<input class="fave-input-text-backend-small" type="hidden" name="fave[invoice_billion_for]" value="<?php echo esc_attr($fave_meta['invoice_billion_for']); ?>" />
			</div>
		</div>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				...
				<input class="fave-input-text-backend-small" type="hidden" name="fave[invoice_billing_type]" value="<?php echo esc_html($fave_meta['invoice_billing_type']); ?>" />
			</div>
		</div>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				<input class="fave-input-text-backend-small" type="text" name="fave[invoice_item_id]" value="<?php echo esc_attr($fave_meta['invoice_item_id']); ?>" />
			</div>
		</div>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				<input class="fave-input-text-backend-small" type="text" name="fave[invoice_item_price]" value="<?php echo esc_attr($fave_meta['invoice_item_price']); ?>" />
			</div>
		</div>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				<input class="fave-input-text-backend-small" type="text" name="fave[invoice_purchase_date]" value="<?php echo esc_attr($fave_meta['invoice_purchase_date']); ?>" />
			</div>
		</div>
		...
		<div class="favethemes_meta_control">
			...
			<div class="fave-inline-block-wrap">
				<input class="fave-input-text-backend-small" type="text" name="fave[invoice_buyer_id]" value="<?php echo esc_attr($fave_meta['invoice_buyer_id']); ?>" />
			</div>
		</div>
...
if ( !function_exists( 'houzez_save_invoices_metaboxes' ) ) :
	function houzez_save_invoices_metaboxes( $post_id, $post ) {
		...
		if ( isset( $_POST['fave_invoices_nonce'] ) ) {
			if ( !wp_verify_nonce( $_POST['fave_invoices_nonce'], __FILE__  ) )
				return;
		}
