 ...
 * @since 2.8.0
 */
if (!class_exists('Theme_Widget_Recent_Posts')) { 
class Theme_Widget_Recent_Posts extends WP_Widget {
	...
	public function __construct(){
		...
		parent::__construct('recent_posts', THEME_SLUG.' - '.__('Recent Posts', 'theme_admin'), $widget_ops);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts', 'striking-r') : $instance['title'], $instance, $this->id_base);
		...
		$query = array('showposts' => $number, 'nopaging' => 0, 'orderby'=> 'date', 'order'=>'DESC', 'post_status' => array('publish', 'private'), 'ignore_sticky_posts' => 1,'perm'=>'readable');
