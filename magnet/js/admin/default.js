...
$j(document).ready(function() {
	...
	var formfield;
	$j(document).on('click', '.slide_image,.parallax_image,.portfolioimg,.logo_image,.top_logo_image,.favicon_image,.pattern_background_image,.regular_background_image', function(event) {
