        ...
        return this.each(function() {
            ...
            if (!data.vals) { // new clock
                ...
                var left = Math.round(data.height / 10),
                        ulhtml = '<ul ><li>0</li></ul></div>',
                        style = ' ',
                        dhtml1 = '<div class="first"' + style + '>' + ulhtml,
                        dhtml2 = '<div' + style + '>' + ulhtml,
                        dotD = '<div class="colon day">:</div><span class="days">'+data.titleDays+'</span>',
                        dotH = '<div class="colon hrs">:</div><span>'+data.titleHours+'</span>',
                        dotM = '<div class="colon mnt">:</div><span>'+data.titleMinutes+'</span>',
                        dotS = '<span>'+data.titleSeconds+'</span>',
                        maxWidth = Math.round(data.width * 2 + 3),
                        captionSize = data.captionSize || Math.round(data.fontSize * 0.43);
                thtml = (data.displayCaptions ?
                        '<div class="hours counter">'+'$1' + dotH+'</div>'+'<div class="minutes counter">'+'$1' + dotM+'</div>'+'<div class="seconds counter">'+'$1' + dotS+'</div>'
                        :  '<div class="hours counter">'+'$1'+ dotH  +'</div>'+ '<div class="minutes counter">'+'$1' + dotM +'</div>'+ '<div class="seconds counter">'+ '$1' + dotS +'</div>'+ '<span class="clear"></span>'
                ...
                if (data.displayDays > 0) {
                    ...
                    thtml = (data.displayCaptions ?
                            '<div class="days counter">'+'$1' + dotD+'</div>'
                            : '<div class="days counter">'+'$1'+dotD+'</div>'+'<div class="days-clear"></div>').replace(
                            /\$1/, dhtml
                            ) + thtml;
                }
                $this.html(thtml);
