...
/**
 * YIT Seo submenu page
 * 
 * 
 * @since 1.0.0
 */

class YIT_Submenu_Seo extends YIT_Submenu_Abstract {
	...
	public function init() {
	    $this->_menu = apply_filters( 'yit_admin_menu_seo', array(
            'general' => __( 'Settings', 'yit' )
        ) );
        
        $this->_submenu = apply_filters( 'yit_admin_submenu_seo', array(
            'general' => array(
                'title_metas' => __( 'Title and metas', 'yit' ),
                'pages' => __( 'Pages', 'yit' ),
