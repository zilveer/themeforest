							...
							<div id="project-content-view">
								...
								<header id="project-meta">
									...
									<div class="row">
										...
										<?php do_action('woffice_before_project_meta'); ?>
										...
										<?php if (!empty($project_links)): ?>
											<div class="col-md-4">
												...
												<?php do_action('woffice_before_project_meta_links'); ?>
												...
												<?php do_action('woffice_after_project_meta_links'); ?>

											</div>
										<?php endif; ?>

										<?php do_action('woffice_after_project_meta'); ?>
