            ...
            public function render() {
                ...
                <script type="text/javascript">
                    jQuery( document ).ready(
                        function() {
                            jQuery( '#<?php echo sprintf('%s', $this->field['id']); ?>-marker' ).parents( 'tr:first' ).css( {display: 'none'} ).prev('tr' ).css('border-bottom','none');;
                            var group = jQuery( '#<?php echo sprintf('%s', $this->field['id']); ?>-marker' ).parents( '.redux-group-tab:first' );
