	...
	jQuery(".add_seo_group").click(function() {
		...
		if (group_name.length > 0) {
			...
			jQuery.post(ajaxurl, data, function(response) {
				...
				//***
				jQuery(".seo_groups_list").append('<li><a data-id="seo_group_' + seo_group_id + '" class="js_edit_seo_group" href="#">' + group_name + '</a><input type="hidden" value="' + group_name + '" name="seo_group[' + seo_group_id + '][name]"><a href="#" title="' + lang_delete + '" class="remove js_remove_seo_group" data-id="seo_group_' + seo_group_id + '"></a><a data-id="seo_group_' + seo_group_id + '" href="#" title="' + lang_edit + '" class="edit js_edit_seo_group"></a></li>');
