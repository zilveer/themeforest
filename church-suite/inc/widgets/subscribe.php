...
class webnus_subscribe_widget extends WP_Widget{
	...
	public function widget($args, $instance){
		...
		echo '<p>'.$subscribe_text.'</p><input placeholder="'.esc_html__('your email here..','webnus_framework').'" class="widget-subscribe-email" type="text" name="'.$email_name.'"/><button class="widget-subscribe-submit" type="submit">'.esc_html__('SUBSCRIBE ','webnus_framework').'</button></form>';
		echo $after_widget;
	} 
}
