			...
			menu: [
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[eltd_blockquote text="' + e.data.text + '" title_tag="' + e.data.title_tag + '" width="' + e.data.width + '"]');
							}
						});
					}
				},
				...
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent('[eltd_unordered_list style="' + e.data.style + '" animate="' + e.data.animate + '" font_weight="' + e.data.font_weight + '"]<ul><li>Lorem ipsum</li><li>Lorem ipsum</li><li>Lorem ipsum</li></ul>[/eltd_unordered_list]');
							}
						});
					}
				},
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								...
								ed.insertContent('[eltd_icon_list_item icon_pack="' + e.data.icon_pack + '" ' + icon_pack_prefix + '="' + e.data.icon + '" icon_size="' + e.data.icon_size + '" icon_color="' + e.data.icon_color + '" title="' + e.data.title + '" title_color="' + e.data.title_color + '" title_size="' + e.data.title_size + '"]');
							}
						});
					}
				},
