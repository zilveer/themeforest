...
if ($this['config']->get('responsive') == '1') {
...
$this['asset']->addFile('css', 'template:fonts/awesome.css');
...
if (($color = $this['config']->get('background')) && $this['path']->path("css:/background/$color.css")) { $this['asset']->addFile('css', "css:/background/$color.css"); }
...
$this['asset']->addFile('js', 'js:retina.js');
if ($this['config']->get('responsive') == '1') {
	$this['asset']->addFile('js', 'js:template-responsive.js');
}
else
{
