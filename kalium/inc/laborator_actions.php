...
function laborator_init() {
	...
	wp_register_style( 'main', THEMEASSETS . 'css/main.css', null, THEMEVERSION );

	// Icons used in Admin
	wp_register_style( 'font-awesome', THEMEASSETS . 'css/fonts/font-awesome/font-awesome-admin.css', null, THEMEVERSION );
	wp_register_style( 'font-flaticons', THEMEASSETS . 'css/fonts/flaticons-custom/flaticon-admin.css', null, THEMEVERSION );
	wp_register_style( 'font-lineaicons', THEMEASSETS . 'css/fonts/linea-iconfont/linea-iconfont-admin.css', null, THEMEVERSION );

	wp_register_style( 'style', get_template_directory_uri() . '/style.css', null, THEMEVERSION );


	// Scripts
	wp_register_script( 'bootstrap', THEMEASSETS . 'js/bootstrap.min.js', null, null, true );
	wp_register_script( 'joinable', THEMEASSETS . 'js/joinable.min.js', null, THEMEVERSION, true );
	
	wp_register_script( 'custom', THEMEASSETS . 'js/custom.min.js', null, THEMEVERSION, true );
		...
		// Light Gallery
		wp_register_script( 'light-gallery', THEMEASSETS . 'js/light-gallery/js/lightgallery-all.min.js', null, THEMEVERSION, true );
		
		wp_register_style( 'light-gallery', THEMEASSETS . 'js/light-gallery/css/lightgallery.min.css', null, THEMEVERSION );
		wp_register_style( 'light-gallery-transitions', THEMEASSETS . 'js/light-gallery/css/lg-transitions.min.css', THEMEVERSION, null );
		
		
		// Admin JS & CSS
		wp_register_script( 'admin-js', THEMEASSETS . 'js/admin-main.js', null, null );
		wp_register_style( 'admin-css', THEMEASSETS . 'css/admin/main.css', null, THEMEVERSION );
		
		// CSS Loaders
		wp_register_style( 'css-loaders', THEMEASSETS . 'css/css-loaders.css', null, THEMEVERSION );
...
function laborator_wp_enqueue_scripts() {
	...
	// Styles
	wp_enqueue_style( array( 'bootstrap', 'main' ) );
...
function kalium_register_required_plugins() {
	...
	$message = '<div class="notice notice-info is-dismissible" style="margin-top: 20px;">
		<p><strong>Note from Laborator:</strong> To ensure the latest version of <em>theme required</em> plugins, you must have the latest version of <strong>' . THEMENAME . '</strong> as well.</p>
		<p>Your current theme version is: <strong>' . THEMEVERSION . '</strong> – <a class="thickbox" href="http://laborator.co/theme-version-check.php?theme=' . basename( get_template_directory_uri() ) . '&version=' . THEMEVERSION . '&ts=' . time() . '&TB_iframe=true" title="Laborator Theme Version Checker" target="_blank">Click here to check if you have the latest version of this theme</a>.</p>
		<p style="font-size: 12px; color: #888;">If any of theme required plugins has released new update after the date that we released ' . THEMENAME . ' ' . THEMEVERSION . ', we will include the latest version of that plugin in the next update.</p>
	</div>';
...
$revSliderAsTheme = REV_SLIDER_AS_THEME;
