<?php
/**
 * Template Name: Portfolio 2 Columns Filterable
...
<div class="inner">
	...
	<?php
	    ...
	    { 
	?>
	    <?php echo pp_apply_content($obj_term->description); ?>
	<?php
	    }
	?>
	...
	?>
	<div class="element <?php echo $portfolio_item_set; ?> portfolio2filter_wrapper">
	
		<div class="one_half gallery2 filterable" data-id="post-<?php echo $key+1; ?>" data-type="<?php echo $portfolio_item_set; ?>">
		<?php 
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo $portfolio_item->ID; ?>" class="portfolio_desc portfolio2 filterable <?php echo $last_class; ?>">
