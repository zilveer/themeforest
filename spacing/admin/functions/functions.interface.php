...
function optionsframework_add_admin() {
	...
	$of_page = add_menu_page('Spacing', 'Theme Options', 'edit_theme_options', 'optionsframework','optionsframework_options_page');
	add_submenu_page( 'optionsframework', 'Manage Sidebars', 'Sidebar Manager', 'administrator', 'sidebar_manager', 'sidebar_manager_frontend' );
...
function sidebar_manager_frontend() { 
	...
	include_once( ADMIN_PATH . 'front-end/sidebar-manager.php' );
