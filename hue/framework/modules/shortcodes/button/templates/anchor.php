<a href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>" <?php hue_mikado_inline_style($button_styles); ?> <?php hue_mikado_class_attribute($button_classes); ?> <?php echo hue_mikado_get_inline_attrs($button_data); ?> <?php echo hue_mikado_get_inline_attrs($button_custom_attrs); ?>>
