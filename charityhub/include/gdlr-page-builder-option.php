					...
					array(
						...
						'content-item' => array(
							...
							'options' => array(
								...
								'accordion' => array(
									...
									'options'=>array(
										...
										'title-type'=> array(	
											...
											'options'=> array(
												'none'=> __('None' ,'gdlr_translate'),
												'icon'=> __('Title With Icon' ,'gdlr_translate'),
												'left'=> __('Left Align With Icon' ,'gdlr_translate'),
												'center'=> __('Center Align With Caption' ,'gdlr_translate')
											)
										),
										'icon'=> array(	
											'title'=> __('Icon' ,'gdlr_translate'),
											'type'=> 'text',
									...
									'options'=>array(
										...
										'blog-style'=> array(
											...
											'options'=> array(
												...
												'blog-grid-list' => __('Blog Grid List', 'gdlr_translate'),
									...
									'options'=>array(	
										'style'=> array(
											...
											'options'=> array(
												...
												'type-image'=> __('Image' ,'gdlr_translate'),	
											)
										),	
										'icon'=> array(
											'title'=> __('Icon Class' ,'gdlr_translate'),
										...
										'image'=> array(
											'title'=> __('Image Class' ,'gdlr_translate'),
											'type'=> 'upload',	
											'button'=> __('upload' ,'gdlr_translate'),	
											'wrapper-class'=>'style-wrapper type-image-wrapper'
										),
										'thumbnail-size'=> array(
											'title'=> __('Thumbnail Size' ,'gdlr_translate'),
											'type'=> 'combobox',
											'options'=> gdlr_get_thumbnail_list(),	
											'wrapper-class'=> 'type-wrapper type-image-wrapper'
										),
										'title'=> array(
											'title'=> __('Title' ,'gdlr_translate'),
											'type'=> 'text',						
								...
								'feature-media' => array(
									...
									'options'=>array(
										...
										'button-text'=> array(
											'title'=> __('Learn More Button Text' ,'gdlr_translate'),
											'type'=> 'text',
											'default'=> __('Learn More', 'gdlr_translate')
										),		
										'button-link'=> array(
											'title'=> __('Learn More Button Link' ,'gdlr_translate'),
											'type'=> 'text'
										),	
										'margin-bottom' => array(
											'title' => __('Margin Bottom', 'gdlr_translate'),
							...
							'page'=> array(
								...
								'skill-round' => array(
									'title'=> __('Skill Column', 'gdlr_translate'), 
									'type'=>'item',
									'options'=>array(
										'title'=> array(
											'title'=> __('Title' ,'gdlr_translate'),
								...
								'title' => array(
									...
									'options'=>array(		
										...
										'right-text'=> array(	
											'title'=> __('Title Right Text' ,'gdlr_translate'),
											'type'=> 'text',
											'default'=> __('Read More', 'gdlr_translate'),
											'wrapper-class'=>'title-type-wrapper left-wrapper center-wrapper icon-wrapper'
										),	
										'right-text-link'=> array(	
											'title'=> __('Title Right Text Link' ,'gdlr_translate'),
						...
						'media-item' => array(
							...
							'options' => array(
								...
								'post-slider' => array(
									'title'=> __('Post/Cause Slider', 'gdlr_translate'), 
									'type'=>'item',
									'options'=>array(	
										'post-type'=>array(
											'title'=> __('Post Type' ,'gdlr_translate'),
											'type'=> 'combobox',
											'options'=> array(
												'post'=> __('Post' ,'gdlr_translate'),
												'cause'=> __('Cause' ,'gdlr_translate'),
											)
										),
										'category'=> array(
											'title'=> __('Category' ,'gdlr_translate'),
											'type'=> 'multi-combobox',
											'options'=> gdlr_get_term_list('category'),
											'wrapper-class'=> 'post-type-wrapper post-wrapper',
											'description'=> __('You can use Ctrl/Command button to select multiple categories or remove the selected category. <br><br> Leave this field blank to select all categories.', 'gdlr_translate')
										),										
										'cause-category'=> array(
											'title'=> __('Cause Category' ,'gdlr_translate'),
											'type'=> 'multi-combobox',
											'options'=> gdlr_get_term_list('cause_category'),
											'wrapper-class'=> 'post-type-wrapper cause-wrapper',
											'description'=> __('You can use Ctrl/Command button to select multiple categories or remove the selected category. <br><br> Leave this field blank to select all categories.', 'gdlr_translate')
										),	
										'num-excerpt'=> array(
											'title'=> __('Num Excerpt (Word)' ,'gdlr_translate'),
