 ...
 * @since     2.0
 */
if ( ! function_exists( 'ot_type_typography2' ) ) {
  
  function ot_type_typography2( $args = array() ) {
 ...
 * @since     2.0
 */
if ( ! function_exists( 'ot_type_typography3' ) ) {
  
  function ot_type_typography3( $args = array() ) {
