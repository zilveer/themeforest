...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	...
	public function __construct() {
		$this->consumer_key = _sg('General')->getTweetConsumerKey();
		$this->consumer_secret = _sg('General')->getTweetConsumerSecret();
		$this->user_token = _sg('General')->getTweetUserToken();
		$this->user_secret = _sg('General')->getTweetUserSecret();
