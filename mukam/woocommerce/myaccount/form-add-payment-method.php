	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<input type="submit" class="woocommerce-Button woocommerce-Button--alt button alt buton b_inherit buton-2 buton-mini alt" id="place_order" value="<?php esc_attr_e( 'Add Payment Method', 'woocommerce' ); ?>" />
