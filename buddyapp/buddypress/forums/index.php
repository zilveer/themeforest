<div id="buddypress">
	...
	<form action="" method="post" id="forums-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" role="navigation">
			<ul>
				<li class="selected" id="forums-all"><a href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_forums_root_slug() ); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'All Topics %s', 'buddypress' ), bp_get_forum_topic_count() ) ); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_forum_topic_count_for_user( bp_loggedin_user_id() ) ) : ?>

					<li id="forums-personal"><a href="<?php echo trailingslashit( bp_loggedin_user_domain() . bp_get_forums_slug() . '/topics' ); ?>"><?php sq_add_wrapping_tag(sprintf( __( 'My Topics %s', 'buddypress' ), bp_get_forum_topic_count_for_user( bp_loggedin_user_id() ) )); ?></a></li>
