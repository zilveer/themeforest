...
if (!class_exists('MAD_SIDEBAR')) {
	...
	class MAD_SIDEBAR extends MAD_FRAMEWORK {
		...
		function __construct() {
		    ...
		    $this->title = MAD_THEMENAME ." ". __('Custom Widget Area', 'flatastic');
		...
		public function add_field() {
			...
			$output .= "\n  <h3>". $this->title ."</h3>";
			$output .= "\n    <p><input size='30' type='text' value='' placeholder = '". __('Enter Name for new Widget Area', 'flatastic') ."' name='form-add-widget' /></p>";
			$output .= "\n    <input class='button button-primary' type='submit' value='". __('Add Widget Area', 'flatastic') ."' />";
