...
?>
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?> sd-cart-totals">
	...
	<div class="wc-proceed-to-checkout">
		...
		<input type="submit" class="button sd-update-cart sd-link-trans" name="update_cart" value="<?php _e( 'Update Shopping Cart', 'woocommerce' ); ?>" />
