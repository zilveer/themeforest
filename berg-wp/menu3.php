...
?>
<section id="third-menu" class="section-scroll main-section menu <?php echo $stickyClass ;?>">
	<?php
	$termsArray = array();
	...
	<div class="container-fluid menu-content">
		...
		<div class="category-<?php echo $termsArray[$cat]['ID']; ?>" data-myorder="1">
			<div class="row">
				<div class="col-xs-12 menu-category no-bg-section-header sticky-header sticky-header first-header fixed visible">
