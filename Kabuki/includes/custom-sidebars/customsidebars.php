...
class CustomSidebars{
	...
	function addStyles($hook){
	        ...
	        wp_enqueue_script( 'cs_script', get_template_directory_uri() . '/includes/custom-sidebars/cs.js' );
            wp_enqueue_script('thickbox',null,array('jquery'));
            wp_enqueue_style('thickbox.css', '/'.WPINC.'/js/thickbox/thickbox.css', null, '1.0');
            }
	    wp_enqueue_style('cs_style', get_template_directory_uri().'/includes/custom-sidebars/cs_style.css' );
