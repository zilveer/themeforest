...
function vntd_cta($atts, $content=null) {
	...
	if($style != 'centered') {
		...
		$return .= '<div class="content-right white"><a href="'.$button1_url.'" target="' . esc_attr( $buttons_target ) . '" class="page-content-button scroll font-primary uppercase white">'.$button1_title.'</a>'.$button2.'</div>';
