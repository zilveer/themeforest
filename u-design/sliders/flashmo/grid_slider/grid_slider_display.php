...
?>
		...
		// <![CDATA[
		var flashvars = {};
		flashvars.xml_file = "<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/flashmo/grid_slider/load_config_xml.php";
		var params = {};
		params.wmode = "transparent";
		var attributes = {};
		attributes.id = "slider";
		swfobject.embedSWF("<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/flashmo/grid_slider/flashmo_224_grid_slider.swf", "flashmo_slider", "<?php echo $gs_image_width; ?>", "<?php echo $gs_image_height; ?>", "9.0.0", false, flashvars, params, attributes);
		// ]]>
	    </script>
	    <!-- embedding SWF -->
...
<?php		if ( !$gs_remove_3d_shadow == 'yes' ) : ?>
		    <div class="clear"></div>
		    <div id="gs-shadow" class="container_24"> </div>
<?php		endif; ?>
	    </div>
	    <!-- end gs-header -->
