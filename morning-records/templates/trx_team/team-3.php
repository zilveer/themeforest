...
if ( !function_exists( 'morning_records_template_team_3_theme_setup' ) ) {
	add_action( 'morning_records_action_before_init_theme', 'morning_records_template_team_3_theme_setup', 1 );
	function morning_records_template_team_3_theme_setup() {
		morning_records_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_side',*/
			'title'  => esc_html__('Team /Style 3/', 'morning-records'),
...
// Template output
if ( !function_exists( 'morning_records_template_team_3_output' ) ) {
	function morning_records_template_team_3_output($post_options, $post_data) {
		$show_title = true;
