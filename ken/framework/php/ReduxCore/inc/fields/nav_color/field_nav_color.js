...
(function( $ ) {
    ...
    redux.field_objects.nav_color = redux.field_objects.nav_color || {};
    ...
    redux.field_objects.nav_color.init = function( selector ) {

        if ( !selector ) {
            selector = $( document ).find( '.redux-container-nav_color:visible' );
        }
