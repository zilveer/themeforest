            ...
            <div class="breadcrumb-wrapper <?php if(dt_theme_option('general','header-top-bar') == "true") echo esc_attr('notop'); ?>">
                <div class="container">
                    <h1><?php
						...
						elseif(taxonomy_exists('product_cat')){ _e('Archive of : ', 'iamd_text_domain'); echo single_cat_title(); } ?></h1><?php
...
function dt_woocommerce_show_product_loop_sale_flash() {
	...
	if( $product->is_featured())
		$out .= '<div class="featured-tag"><div><i class="fa fa-thumb-tack"></i><span>'.__('Featured','iamd_text_domain').'</span></div></div>';
