...
//        }
        ...
        while ( $my_query->have_posts() ) {
            ...
            if ( $link != 'link_no' ) {
                if ( $link == 'link_post' ) {
                    ...
                    $link_image_start = '<a class="view" href="'.$p_link.'" title="'.the_title_attribute('echo=0').'" rel="gallery_'.$pretty_rel_random.'">';
                }
        ...
        $output .= ($title != '' ) ? "\n\t\t\t".'<h3 class="wpb_heading wpb_posts_slider_heading"><span>'.$title.'</span></h3>' : '';
