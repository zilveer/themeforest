...
<div class="inner">
	...
	<div id="portfolio_filter_wrapper" class="three_cols portfolio-content section content clearfix">
	<?php
		$key = 0;
	...
	<div class="element portfolio3filter_wrapper <?php echo $portfolio_item_set; ?>">
