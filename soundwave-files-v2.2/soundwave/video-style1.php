<?php
/*
Template Name: Video Style 1 (4 COLUMNS)
*/
?>
...
while ($wp_query->have_posts()):
    ...
    $cover          = wp_get_attachment_image_src($image_id, 'video-style1');
    $cover_large    = wp_get_attachment_image_src($image_id, 'photo-large');
    $no_cover       = get_template_directory_uri();
    echo '                                       
         <div class="vdpage1-col wz-last">
            <div class="vdpage1-cover">
    ...
    echo '
                  <div class="he-view">
                     <div class="bg a0" data-animate="fadeIn">
                        <a href="' . $video . '" class="vdpage1-link a2" data-animate="zoomIn" data-rel="prettyPhoto"></a>
                        <a href="' . $cover_large[0] . '" class="vdpage1-zoom a2" data-animate="zoomIn" data-rel="prettyPhoto-cover"></a>
                     </div>
                  </div>			
               </div>
            </div><!-- end .vdpage1-cover -->
