    ...
    jQuery.widget('blueimp.fileupload', {
        ...
        _addConvenienceMethods: function (e, data) {
            var that = this,
                getPromise = function (data) {
                    return jQuery.Deferred().resolveWith(that, [data]).promise();
                };
        ...
        _onDragOver: function (e) {
            ...
            if (dataTransfer) {
                ...
                if (jQuery.inArray('Files', dataTransfer.types) !== -1) {
        ...
        _initDataAttributes: function () {
            ...
            jQuery.each(
                jQuery(this.element[0].cloneNode(false)).data(),
                function (key, value) {
