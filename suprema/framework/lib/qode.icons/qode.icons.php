...
/*
  Class: SupremaQodefIconCollections
...
class SupremaQodefIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new SupremaQodefIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new SupremaQodefIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new SupremaQodefIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new SupremaQodefLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new SupremaQodefLinearIcons('Linear Icons', 'linear_icon'));
        $this->addIconCollection('simple_line_icons', new SupremaQodefSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new SupremaQodefDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iSupremaQodefIconCollection $collection) {
...
if ( ! function_exists( 'suprema_qodef_activate_theme_icons' ) ) {

    function suprema_qodef_activate_theme_icons() {
        global $suprema_qodef_IconCollections;

        $suprema_qodef_IconCollections = SupremaQodefIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'suprema_qodef_activate_theme_icons');
}