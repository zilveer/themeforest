<?php
namespace QodeStartit\Modules\PieCharts\PieChartDoughnut;
...
class PieChartDoughnut implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			'name' => 'Select Pie Chart 3 (Doughnut)',
			'base' => $this->getBase(),
			'category' => 'by SELECT',
	...
	public function render($atts, $content = null) {
		...
		$html = qode_startit_get_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
