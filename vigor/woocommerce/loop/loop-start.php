...
if(isset($edgt_options['woo_products_hover_list_type'])){
    $products_hover_list_type = $edgt_options['woo_products_hover_list_type'];
}
$class='';
...
$disable_space = '';
if(isset($edgt_options['woo_products_disable_space_between_products']) && $edgt_options['woo_products_disable_space_between_products']=='yes' ){
