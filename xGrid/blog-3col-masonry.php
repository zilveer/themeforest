<?php
// Template Name: Blog 3col Masonry With Out Sidebar

get_header();

if( bdayh_get_option( 'b_3col' ) ){
    $items_count    = bdayh_get_option( 'b_3col' );
} else {
    $items_count    = "12";
}
        ...
        <div class="blog-v1">
            <div class="posts-gird">
                <div id="container-grid" class="filterable-posts posts-gird-<?php echo $cols ?>" data-cols="<?php echo $cols ?>">
                    ...
                    $bdBlogCats = bdayh_get_option( 'custom_cat_3col' );
