...
$path = get_template_directory_uri().'/includes/contact-form/';

define( 'GRUNION_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );
define( 'GRUNION_PLUGIN_URL', $path );
...
function contact_form_shortcode( $atts, $content ) {
	...
	$r = "<div class='contact-form-wrapper' id='contact-form-$id'>\n";
