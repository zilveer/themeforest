<?php
namespace QodeStartit\Modules\VideoButton;
...
class VideoButton implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = qode_startit_get_shortcode_module_template_part('templates/video-button-template', 'videobutton', '', $params);
