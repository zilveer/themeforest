...
class crazyblog_Blog_setting_menu {
	...
	public function crazyblog_menu() {
		$return = array(
			array(
				'type' => 'section',
				'title' => esc_html__( 'Blog Page Settings', 'crazyblog' ),
				'name' => 'blog_page_settings',
				'fields' => array(
					array(
						'type' => 'toggle',
						'name' => 'blog_page_title_section',
						'label' => esc_html__( 'Show Title Section', 'crazyblog' ),
						'description' => esc_html__( 'Enable to show blog page title section', 'crazyblog' ),
					),
					array(
						'type' => 'textbox',
						'name' => 'blog_page_title',
						'label' => esc_html__( 'Page Title', 'crazyblog' ),
						'description' => esc_html__( 'Enter the title for blog page', 'crazyblog' ),
						'dependency' => array(
							'field' => 'blog_page_title_section',
					...
					array(
						...
						'label' => esc_html__( 'Blog Listing Layout', 'crazyblog' ),
						'description' => esc_html__( 'Choose the layout for blog pages', 'crazyblog' ),
						'items' => array(
							array(
								'value' => 'left',
								'label' => esc_html__( 'Blog with Left Sidebar', 'crazyblog' ),
								'img' => crazyblog_URI . 'core/duffers_panel/panel/public/img/2cl.png',
							),
							array(
								'value' => 'right',
								'label' => esc_html__( 'Blog with Right Sidebar', 'crazyblog' ),
					...
					array(
						...
						'description' => esc_html__( 'Select sidebar to show at blog listing page', 'crazyblog' ),
