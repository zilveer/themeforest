...
$order = rwmb_meta( "{$prefix}artists_order", $args = array(), get_the_ID() );
$orderby = rwmb_meta( "{$prefix}artists_order_by", $args = array(), get_the_ID() );
$posts_per_page = rwmb_meta( "{$prefix}artists_posts_per_page", $args = array(), get_the_ID() );
$category = rwmb_meta( "{$prefix}artists_category", array('type'=>'checkbox_list'), get_the_ID() );
$columns = rwmb_meta( "{$prefix}artists_columns", array(), get_the_ID() );
$album_class = '';
    ...
    <div class="container">
        <div class="row">
            <div class="breadcrumb-container clearfix">
                ...
                <!-- BREADCRUMB -->
                <?= clx_breadcrumbs_filter(ArtistPostType::get_instance()->postTypeTax, $category); ?>
                            ...
                            <div class="filter-container artists-container">
                                ...
                                $args = array(
                                    ...
                                    'tax_query'         => ( !empty($category) ? array(
                                            array(
                                                'taxonomy' => ArtistPostType::get_instance()->postTypeTax,
                                                'field' => 'id',
                                                'terms' => $category
                                            ),
                                        ) : false ),
