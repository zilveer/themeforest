...
?>
		...
		<div id="header-content" class="container_24">
			...
			<script type="text/javascript">
			    // <![CDATA[
			    var so = new SWFObject("<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/piecemaker_2/<?php echo $piecemaker_swf; ?>?random_number=<?php echo rand(1, 10000);?>", "piecemaker-slider", "1100", "455", "10");
			    so.addVariable("cssSource", "<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/piecemaker_2/piecemaker.css");
			    so.addVariable("xmlSource", "<?php echo esc_url( get_template_directory_uri() ); ?>/sliders/piecemaker_2/piecemaker.xml");
