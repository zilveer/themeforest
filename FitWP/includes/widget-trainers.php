<?php
/*
 * Plugin Name: DD Trainers Widget
 * Plugin URI: http://themeforest.net/user/DDStudios/portfolio
 * Description: A widget that displays recent trainers
 * Version: 1.0
 ...
 */
add_action( 'widgets_init', 'dd_trainers_widgets' );

/*
 * Register widget.
 */
function dd_trainers_widgets() {
	register_widget( 'DD_Trainers_Widget' );
}

/*
 * Widget class.
 */
class dd_trainers_widget extends WP_Widget {

	/* ---------------------------- */
	/* -------- Widget setup -------- */
	/* ---------------------------- */
	
	function DD_Trainers_Widget() {
	
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'dd_trainers_widget', 'description' => __('A widget that displays your latest trainers.', 'localization') );

		 /* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'dd_trainers_widget' );

		/* Create the widget. */
		$this->WP_Widget( 'dd_trainers_widget', __('DD Trainers Widget','localization'), $widget_ops, $control_ops );
	}
