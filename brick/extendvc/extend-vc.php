...
vc_add_param("vc_row", array(
	...
	"value" => array_merge(array('' => ''), qode_get_custom_sidebars()),
	"description" => "",
	"dependency" => Array('element' => "row_type", 'value' => array('content_menu'))
));
...
vc_add_param("vc_row",  array(
	"type" => "textfield",
	"heading" => "Duration of Animation(ms)",
...
function qode_add_open_prettyphoto() {
...
add_action('init', 'qode_add_open_prettyphoto',11);
...
vc_map( array(
	"name" =>  __( 'Elements Holder Item', 'qode' ),
...
vc_map( array(
	'name' => __( 'Bordered Elements Holder', 'qode' ),
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"param_name" => "item_padding",
			"value" => "",
			"description" =>  __("Please insert padding in format 0px 10px 0px 10px, default value is 0 0 0 0", 'qode')
		),
		array(
			"type" => "dropdown",
			"holder" => "div",
		...
		"params" => array_merge(
			array(
				...
				array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => "Title Bottom Padding (px)",
		...
		"params" => array_merge(
                    ...
                    array(
						...
						array(
							...
							"description" => __("Please insert button width in order to work with hover animation ", 'qode')
...
vc_map( array(
	...
	"base" => "no_counter",
	"category" => 'by Select',
	'admin_enqueue_css' => array(qode_get_skin_uri().'/assets/css/qodef-vc-extend.css'),
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "15,#ECAB71,Legend One; 35,#985214 ,Legend Two; 50,#e27d23,Legend Three",
				"description" => ""
			)
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "#e27d23,Legend One,1,5,10;#985214 ,Legend Two,3,7,20;#ECAB71,Legend Three,10,2,34"
			)
		)
) );
	...
	"params" => array_merge(
		...
		array(
			...
			array(
				...
				"value" => array(
					"None" => "none",
					"Border Outer" => "border_appear",
					"Border Inner" => "border_bckg_separate",
					"Enlarge Background" => "bckg_enlarge",
					"Fill From Center" => "bckg_change"
				),
				'save_always' => 'true',
				"description" => "Do not set border style attributes when using Border Outer or Border Inner",
				"dependency" => Array('element' => "type", 'value' => array('circle','square'))
			),
			array(
				"type" => "checkbox",
...
vc_map( array(
	...
	"params" => array_merge(
		...
		$qodeIconCollections->getSocialVCParamsArray(array(), '', false, array('linea_icons', 'simple_line_icons')),
		array(
			array(
				"type" => "dropdown",
				"holder" => "div",
		...
		"params" => array_merge(
                    array(
                        ...
                        array(
                            ...
                            "value" => "",
                            "description" => "Set left/right padding that will apply to content"
                        ),
                        array(
                            "type" => "dropdown",
                            "holder" => "div",
							...
							'save_always' => true,
                            "description" => "Set general alignment"
                        ),
						array(
							"type" => "dropdown",
							"class" => "",
                    ...
                    $qodeIconCollections->getVCParamsArray((array('element' => "show_icon", 'value' => array('always', 'on_hover'))), '', true),
                    array(
                        array(
                            "type" => "dropdown",
                            "holder" => "div",
