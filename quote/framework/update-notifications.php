...
define( 'NOTIFIER_XML_FILE', 'http://api.distinctivethemes.com/update-notifications/quote.xml' );  // path to notifier.xml
define( 'NOTIFIER_CACHE_INTERVAL', 6 ); // interval to refresh the xml in database with remote XML (default 6 hours)
define( 'NOTIFIER_THEMEFOREST_USERNAME', 'DistinctiveThemes' ); // your themeforest username
