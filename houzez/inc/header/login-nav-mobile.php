            ...
            <div class="account-dropdown">
                <ul>
                    <?php if( !empty($header_create_listing) && $header_create_listing != $home_link ) { ?>
                        <li> <a href="<?php echo esc_url( $header_create_listing );?>"> <i class="fa fa-plus-circle"></i><?php esc_html_e( 'Create Listing', 'houzez' ); ?></a></li>
                    <?php } ?>
                    <li> <a href="#" data-toggle="modal" data-target="#pop-login"> <i class="fa fa-user"></i> <?php esc_html_e( 'Sign In / Register', 'houzez' ); ?> </a></li>
                </ul>
            </div>
        </li>
    </ul>
