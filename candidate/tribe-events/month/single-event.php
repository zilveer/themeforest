...
<li>
	...
	<div class="event-popover">
		...
		<h6><a href="<?php tribe_event_link( $post ); ?>" style="color: #4174c5;"><?php the_title() ?></a></h6>
		<ul class="event-meta">
			<li><i class="icons icon-clock"></i> <?php esc_html_e( $start_time . $time_range_separator . $end_time ); ?></li>
			<li><i class="icons icon-location"></i> <?php if ( ! empty( $address ) ) echo '' . "$address "; ?></li>
		</ul>
		
		<img src="<?php echo $thumb_image_url[0]; ?>" alt="" class="align-left">
