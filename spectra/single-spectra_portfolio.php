 ...
 * File:			single-spectra_portfolio.php
 * =========================================================================================================================================
 *
 * @package spectra
 * @since 1.0.0
...
<div id="page">
	...
	<div class="container clearfix">
	    ...
	    <header class="content-header">
	        ...
	        <span class="sub-heading anim-css" data-delay="100"><?php echo get_the_term_list( $wp_query->post->ID, 'spectra_portfolio_cats', '', ' / ', '' ); ?></span>
