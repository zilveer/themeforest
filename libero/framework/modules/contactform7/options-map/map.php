...
if ( ! function_exists('libero_mikado_contact_form_7_options_map') ) {

	function libero_mikado_contact_form_7_options_map() {
		...
		$panel_contact_form_style_1 = libero_mikado_add_admin_panel(array(
		...
		$typography_text_group = libero_mikado_add_admin_group(array(
		...
		$typography_text_row1 = libero_mikado_add_admin_row(array(
		...
		$typography_text_row2 = libero_mikado_add_admin_row(array(
		...
		$typography_text_row3 = libero_mikado_add_admin_row(array(
		...
		$typography_label_group = libero_mikado_add_admin_group(array(
		...
		$typography_label_row1 = libero_mikado_add_admin_row(array(
		...
		$typography_label_row2 = libero_mikado_add_admin_row(array(
		...
		$background_border_group = libero_mikado_add_admin_group(array(
		...
		$background_border_row1 = libero_mikado_add_admin_row(array(
		...
		$background_border_row2 = libero_mikado_add_admin_row(array(
		...
		$background_border_row3 = libero_mikado_add_admin_row(array(
		...
		$padding_group = libero_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
		...
		$padding_row = libero_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = libero_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
		...
		$margin_row = libero_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = libero_mikado_add_admin_group(array(
		...
		$button_typography_row1 = libero_mikado_add_admin_row(array(
		...
		$button_typography_row2 = libero_mikado_add_admin_row(array(
		...
		$button_background_border_group = libero_mikado_add_admin_group(array(
		...
		$button_background_border_row1 = libero_mikado_add_admin_row(array(
		...
		$button_background_border_row2 = libero_mikado_add_admin_row(array(
		...
		$button_background_border_row3 = libero_mikado_add_admin_row(array(
		...
		$panel_contact_form_style_2 = libero_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
		...
		$panel_contact_form_style_3 = libero_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
	...
	add_action( 'libero_mikado_options_map', 'libero_mikado_contact_form_7_options_map',15);
