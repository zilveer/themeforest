...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.buildNextBackButtons = function() {
			...
			// Append elements to page GOODLAYERS MOD
			base.$direction_wrapper = $('<div class="anything-direction-wrapper"></div>');
			base.$direction_wrapper.append(base.$back);
			base.$direction_wrapper.append(base.$forward);
			base.$direction_wrapper.appendTo(base.$wrapper);
