...
if ( ! function_exists('hashmag_mikado_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function hashmag_mikado_fonts_options_map() {
		 ...
		 * Headings
		 */
		$panel_headings = hashmag_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => 'Headings'
		...
		//H1
		$group_heading_h1 = hashmag_mikado_add_admin_group(array(
		...
		$row_heading_h1_1 = hashmag_mikado_add_admin_row(array(
		...
		$row_heading_h1_2 = hashmag_mikado_add_admin_row(array(
		...
		//H2
		$group_heading_h2 = hashmag_mikado_add_admin_group(array(
		...
		$row_heading_h2_1 = hashmag_mikado_add_admin_row(array(
		...
		$row_heading_h2_2 = hashmag_mikado_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = hashmag_mikado_add_admin_group(array(
		...
		$row_heading_h3_1 = hashmag_mikado_add_admin_row(array(
		...
		$row_heading_h3_2 = hashmag_mikado_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = hashmag_mikado_add_admin_group(array(
		...
		$row_heading_h4_1 = hashmag_mikado_add_admin_row(array(
		...
		$row_heading_h4_2 = hashmag_mikado_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = hashmag_mikado_add_admin_group(array(
		...
		$row_heading_h5_1 = hashmag_mikado_add_admin_row(array(
		...
		$row_heading_h5_2 = hashmag_mikado_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = hashmag_mikado_add_admin_group(array(
		...
		$row_heading_h6_1 = hashmag_mikado_add_admin_row(array(
		...
		$row_heading_h6_2 = hashmag_mikado_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings = hashmag_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
		...
		//H1
		$group_responsive_heading_h1 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h1_1 = hashmag_mikado_add_admin_row(array(
		...
		//H2
		$group_responsive_heading_h2 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h2_1 = hashmag_mikado_add_admin_row(array(
		...
		//H3
		$group_responsive_heading_h3 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h3_1 = hashmag_mikado_add_admin_row(array(
		...
		//H4
		$group_responsive_heading_h4 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h4_1 = hashmag_mikado_add_admin_row(array(
		...
		//H5
		$group_responsive_heading_h5 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h5_1 = hashmag_mikado_add_admin_row(array(
		...
		//H6
		$group_responsive_heading_h6 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive_heading_h6_1 = hashmag_mikado_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings2 = hashmag_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
		...
		//H1
		$group_responsive2_heading_h1 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h1_1 = hashmag_mikado_add_admin_row(array(
		...
		//H2
		$group_responsive2_heading_h2 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h2_1 = hashmag_mikado_add_admin_row(array(
		...
		//H3
		$group_responsive2_heading_h3 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h3_1 = hashmag_mikado_add_admin_row(array(
		...
		//H4
		$group_responsive2_heading_h4 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h4_1 = hashmag_mikado_add_admin_row(array(
		...
		//H5
		$group_responsive2_heading_h5 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h5_1 = hashmag_mikado_add_admin_row(array(
		...
		//H6
		$group_responsive2_heading_h6 = hashmag_mikado_add_admin_group(array(
		...
		$row_responsive2_heading_h6_1 = hashmag_mikado_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = hashmag_mikado_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
				'title' => 'Text'
		...
		$group_text = hashmag_mikado_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> 'Paragraph',
		...
		$row_text_1 = hashmag_mikado_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$group_text_res1 = hashmag_mikado_add_admin_group(array(
		...
		$row_res_text_1 = hashmag_mikado_add_admin_row(array(
			'name'		=> 'row_text_1',
		...
		$group_text_res2 = hashmag_mikado_add_admin_group(array(
		...
		$row_res_text_2 = hashmag_mikado_add_admin_row(array(
			'name'		=> 'row_res_text_2',
		...
		$row_text_2 = hashmag_mikado_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_link = hashmag_mikado_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> 'Links',
		...
		$row_link_1 = hashmag_mikado_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		$row_link_2 = hashmag_mikado_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		hashmag_mikado_add_admin_field(array(
			...
			'options'		=> hashmag_mikado_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	...
	add_action( 'hashmag_mikado_options_map', 'hashmag_mikado_fonts_options_map', 2);
