...
<div class="table-responsive">
    ...
    <table class="table table-compare compare-list">
        ...
        <tbody>
            ...
            <tr>
                <th><?php echo esc_html__( 'Product', 'unicase' ); ?></th>
            ...
            <tr>
                <th><?php echo esc_html__( 'Price', 'unicase' ); ?></th>
                <?php foreach( $products as $key => $product ) : ?>
                <td>
            ...
            <tr>
                <th><?php echo esc_html__( 'Availability', 'unicase' ); ?></th>
                <?php foreach( $products as $key => $product ) : ?>
            ...
            <tr>
                <th><?php echo esc_html__( 'Description', 'unicase' ); ?></th>
                <?php foreach( $products as $key => $product ) : ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="<?php echo esc_url( $yith_woocompare->obj->remove_product_url( $product->id ) ); ?>" data-product_id="<?php echo esc_attr( $product->id ); ?>" class="remove-icon" title="<?php echo esc_attr( esc_html__( 'Remove', 'unicase' ) ); ?>"><i class="fa fa-times"></i></a>
                </td>
                <?php endforeach ?>
            </tr>
...
<?php else : ?>
    ...
    <div class="outer-bottom-vs outer-top-sm compare-empty">
        <h1 class="lead-title text-center cart-empty">
            <?php esc_html_e( 'No products were added to the compare table', 'unicase' ) ?>
        </h1>
        ...
        <p class="return-to-shop">
            <a class="wc-backward btn" href="<?php echo apply_filters( 'woocommerce_return_to_shop_redirect', get_permalink( wc_get_page_id( 'shop' ) ) ); ?>">
                ...
                <?php esc_html_e( 'Return To Shop', 'unicase' ) ?>
            </a>
        </p>
    </div>
