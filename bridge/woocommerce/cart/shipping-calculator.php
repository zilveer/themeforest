...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="shipping-calculator-button"><?php esc_attr_e( 'Calculate Shipping', 'woocommerce' ); ?><span>↓</span></a></h2>

	<section class="shipping-calculator-form" style="display:none;">

		<p class="form-row form-row-wide" id="calc_shipping_country_field">
			<select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state" rel="calc_shipping_state">
				<option value=""><?php esc_attr_e( 'Select a country&hellip;', 'woocommerce' ); ?></option>
				<?php
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button"><?php esc_attr_e( 'Update Totals', 'woocommerce' ); ?></button></p>
