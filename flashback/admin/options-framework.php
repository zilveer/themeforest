...
<div class="wrap">
	...
	<div class="inner-wrap">
		...
		<div id="top">
			...
			<a href="" id="logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/admin/images/logo.png" alt="Theme Name" /></a>
		...
		<div class="metabox-holder">
			...
			<div id="optionsframework" class="postbox">
				...
				<form action="options.php" method="post">
					...
					<div id="optionsframework-submit-2">
					
						<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Settings' ); ?>" />
						<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'shorti' ) ); ?>' );" />
						<div class="clear"></div>
