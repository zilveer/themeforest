...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<span class="cmsms_slider_post_format_img cmsms-icon-videocam-5"></span>
	<div class="cmsms_slider_post_cont">
	<?php
		if (!post_password_required()) {
			cmsms_thumb_rollover(get_the_ID(), 'project-thumb', true, true, true, false, $cmsms_post_video_type, $cmsms_post_video_link, $cmsms_post_video_links, false, true);
		}
