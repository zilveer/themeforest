    ...
    class ReduxFramework_extension_search {
      ...
      public function __construct( $parent ) {
        ...
        if (empty($this->extension_dir)) {
            $this->_extension_dir = trailingslashit(str_replace('\\', '/', THEME_DIR . 'g5plus-framework/option-extensions/extensions/search/'));
      ...
      function _enqueue() {
        ...
        wp_localize_script(
            'redux-extension-search-js', 
            'reduxsearch', 
            __('Type here to search for options', 'g5plus-handmade')
        );
