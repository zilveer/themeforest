<?php 
	...
	( get_option('menu_style','side') == 'side' ) ? $crop_width = 750 : $crop_width = 917;
	...
	foreach ( $attachments as $attachment ) :
		...
		echo '<div class="three_fourths"><div class="gallery-image">';
		...
		echo '</div></div><div class="one_fourth last">';
