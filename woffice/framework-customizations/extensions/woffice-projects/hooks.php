 ...
 */
function woffice_project_sync_eventON($post_id, $post) {
...
add_action('woffice_frontend_process_completed_success','woffice_project_sync_eventON', 100, 2 );
...
//add_action('publish_post','woffice_groups_sync_members', 20, 3 );
