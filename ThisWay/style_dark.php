...
.hoverWrapper .link{background: url('images/imageLink.jpg');}
.hoverWrapper .link:hover, .hoverWrapper .link:active{background-position:-104px 0;}
.hoverWrapper .modal{background: url('images/imageModal.jpg') -104px 0;}
...
#audioControls .next:link, #audioControls .next:visited{ background: url('images/audioControlRight.jpg') -104px 0 no-repeat;}
#audioControls .next:hover, #audioControls .next:active{ background: url('images/audioControlRight.jpg') 0 0 no-repeat;}
#audioControls .prev:link, #audioControls .prev:visited{ background: url('images/audioControlLeft.jpg') 0 0 no-repeat;}
#audioControls .prev:hover, #audioControls .prev:active{ background: url('images/audioControlLeft.jpg') -104px 0 no-repeat;}
#audioControls .pause:link, #audioControls .pause:visited{ background: url('images/bgControlPause.jpg') 0 -104px no-repeat;}
#audioControls .pause:hover, #audioControls .pause:active{ background: url('images/bgControlPause.jpg') 0 0 no-repeat;}
#audioControls .play:link, #audioControls .play:visited{ background: url('images/bgControlPlay.jpg') 0 0 no-repeat;}
#audioControls .play:hover, #audioControls .play:active{ background: url('images/bgControlPlay.jpg') 0 -104px no-repeat;}
...
#menuOpener{
	...
	font-family: <?php echo $headerFont; ?>;
	background:#ffcc00 url('images/opener-arrow.png') 60px center no-repeat;
	border-radius:0 20px 20px 0;
	color:#000;
}
#menuCloser{
...
#mainmenu ul > li > a{
	background: url('images/menuhover-bg.png') left top repeat-x; 
}
#mainmenu ul li ul li a:link,
#mainmenu ul li ul li a:visited{
	background: url('images/menuhover-bg2.png') left top repeat-x; 
	line-height:50px;
	height:50px;
}
...
#bgControl .next:link, #bgControl .next:visited{ background: url('images/bgControlRight.jpg') -104px 0 no-repeat;}
#bgControl .next:hover, #bgControl .next:active{ background: url('images/bgControlRight.jpg') 0 0 no-repeat;}
#bgControl .prev:link, #bgControl .prev:visited{ background: url('images/bgControlLeft.jpg') 0 0 no-repeat;}
#bgControl .prev:hover, #bgControl .prev:active{ background: url('images/bgControlLeft.jpg') -104px 0 no-repeat;}
#bgControl .pause:link, #bgControl .pause:visited{ background: url('images/bgControlPause.jpg') 0 -104px no-repeat;}
#bgControl .pause:hover, #bgControl .pause:active{ background: url('images/bgControlPause.jpg') 0 0 no-repeat;}
#bgControl .play:link, #bgControl .play:visited{ background: url('images/bgControlPlay.jpg') 0 0 no-repeat;}
#bgControl .play:hover, #bgControl .play:active{ background: url('images/bgControlPlay.jpg') 0 -104px no-repeat;}
#share{
...
#content h1.caption{
	background:url('images/header-arrow.png') 15px 17px no-repeat, url('images/header-pattern.png');
...
.meta-author:link, .meta-author:visited{ background:url('images/blogicon-author.jpg') 0 0 no-repeat;}
.meta-author:hover, .meta-author:active{ background-position: -104px 0;}
.meta-comments:link, .meta-comments:visited{ background:url('images/blogicon-comment.jpg') 0 0 no-repeat;}
.meta-comments:hover, .meta-comments:active{ background-position: -104px 0;}
.meta-tags:link, .meta-tags:visited{ background:url('images/blogicon-tag.jpg') 0 0 no-repeat;}
...
.meta-tips span{
	width:6px;
	height:20px;
	background:url('images/meta-right.png') left center no-repeat;
	position:absolute;
	right:-6px;
}
...
span.highlight{background-color:#ffcc00; color:#000; padding:0px 2px;}
...
#singleLeft .singleDate{ background:url('images/singleDate.png') left top no-repeat; }
#singleLeft .singleAuthor{ background:url('images/singleAuthor.png') left top no-repeat; }
#singleLeft .singleComments{ background:url('images/singleComments.png') left top no-repeat; }
#singleLeft .singleTags{ background:url('images/singleTags.png') left top no-repeat; }
/* Comments CSS*/
#comments h4{
	padding-bottom:20px;
}
...
#comments ol li li{
	padding-left:100px;
	background: url('images/comment-icon.png') 34px 34px no-repeat;
}
