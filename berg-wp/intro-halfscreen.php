...
<div class="intro-wrapper" <?php echo $customIntroColorStyle; ?>>
	<div class="section-intro section-intro-half" data-opacity-start="<?php echo $dataOpacityStart;?>" data-opacity-end="<?php echo $dataOpacityEnd;?>" <?php echo (!$contact) ? 'data-background="'.$img_url.'"' : '';?>>
		<?php if($contact == true) {
				...
				<div class="row">
					<div class="col-xs-12 col-md-10 col-md-offset-1">
						...
						<div style="<?php echo $txt_align ;?>" class="<?php echo $class_position ;?> parallax-element-second <?php echo (get_post_meta(berg_getPageId(),'intro_content_settings', true) == '') ? 'hidden':'';?>">
							...
							<?php //var_dump(YSettings::g('intro_content_settings')); ?>
						</div>
					</div>
				</div>
			</div>
