...
class PostRatings{
  ...
  */
  public static function app(){
    ...
    if(!(self::$instance instanceof self)){
      ...
      // localize
      load_plugin_textdomain(self::ID, false, get_template_directory_uri().'/post-ratings/lang');
  ...
  */
  ...
  final public function loadTemplate($_name, $_vars = array()){
    ...
    if(!$_located)
      $_located = get_template_directory() .'/post-ratings/templates/'.$_name.'.php';
  ...
  */
  public function CreateMenu(){
    add_theme_page(__('Post Ratings', self::ID), __('Post Ratings', self::ID), 'manage_options', self::ID, array($this, 'SettingsPage'), get_template_directory_uri(). '/rating/icon.png', 62);
  }
  ...
  */
  public function PluginSettingsLink($links, $file){
    ...
    if(get_template_directory_uri() . '/post-ratings/' === $file){
  ...
  */
  public function assets(){
    ...
    wp_enqueue_script(self::ID, get_template_directory_uri().'/post-ratings/post-ratings.js', array('jquery'), self::VERSION, true);
    ...
    $style = trailingslashit(get_template_directory_uri()).'post-ratings/post-ratings.css';
