...
if($category_page_template == "version_2") {
	...
	get_template_part( 'taxonomy-event_cat-version-2', 'event' );
    exit;

} elseif($category_page_template == "version_3") {

	get_template_part( 'taxonomy-event_cat-version-3', 'event' );
    exit;
							...
							<div class="row">
								...
								<div class="col-sm-8">
									...
									<div class="full">
										...
										<h4><?php esc_html_e("Category", "themesdojo"); ?>: <?php printf( __( ' %s', '' ), '' . single_cat_title( '', false ) . '' );	?></h4>
