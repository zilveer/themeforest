...
<?php
	...
	$args = array('post_type' => 'review', 'posts_per_page' => 9, 'paged' => $paged);
	$wp_query = new WP_Query( $args );
?>
            ...
            <div class="row">
            		...
            		<div class="col-md-9">
                        ...
                        <?php if ($wp_query->have_posts()): ?>
                		        ...
                		        <div class="posts-holder bunch blogpg pt30 reviews">
                		            ...
                		            <?php while($wp_query->have_posts()): $wp_query->the_post(); ?>
                                        <?php
                                            ...
                                            $rating = get_post_meta( get_the_ID(), 'newsstand_review_rating', 1, true );
                                        ?>
                            ...
                            <h4 style="padding: 15px;"><?php _e('There are no reviews to show.', 'newsstand'); ?></h4>
                        <?php endif ?>
