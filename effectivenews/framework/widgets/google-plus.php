...
'zu' => 'Zulu',
	...
	function mom_googleplus_Widget()
	{
		...
		parent::__construct('momizat-googlebadgebox', __('Effective - Google+ Badge Box','theme'), $widget_ops);
	}
...
<div class="mgw-cover"></div>
	...
	{
		$defaults = array('title' => __('Google+','theme'), 'page_url' => '', 'width' => '285', 'color_scheme' => 'light', 'gp_layout' => 'portrait', 'page_type' => 'profile', 'cover_photo' => 'on', 'tagline' => 'on', 'lang' => '');
