...
<p><?php esc_html_e( "Hello, a note has just been added to your order:", 'crazyblog' ); ?></p>

<blockquote><?php echo wpautop( wptexturize( $customer_note ) ) ?></blockquote>

<p><?php esc_html_e( "For your reference, your order details are shown below.", 'crazyblog' ); ?></p>
