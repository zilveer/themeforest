...
<?php if ( current_user_can( 'edit_topic_tags' ) ) : ?>
	...
	<div id="edit-topic-tag-<?php bbp_topic_tag_id(); ?>" class="bbp-topic-tag-form x-bbp-general-form">
		...
		<fieldset class="bbp-form" id="tag-rename">
			...
			<div class="bbp-template-notice">
				<p><?php _e( 'Leave the slug empty to have one automatically generated. Changing the slug affects its permalink. Any links to the old slug will stop working.', '__x__' ); ?></p>
			</div>
		...
		<?php if ( current_user_can( 'delete_topic_tags' ) ) : ?>
			...
			<fieldset class="bbp-form" id="delete-tag">
				...
				<div class="bbp-template-notice">
					<p><?php _e( 'Deleting a tag cannot be undone. This does not delete your topics. Only the tag itself is deleted. Any links to this tag will no longer function.', '__x__' ); ?></p>
				</div>
