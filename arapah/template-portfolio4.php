 ...
 * Description: A full-width template for Portfolio 4 Cols
 *
 * @package WordPress
	...
	<div class="container">
		...
		<div class="sixteen columns">
			<div class="gutter alpha omega">
				...
				<?php $post_query = array( 'cat' => of_get_option('ar-port-category'), 'posts_per_page' => 8, 'paged' => get_query_var('paged') ); ?>
					<div id="content">
							...
							<div class="portfolio four columns">
								<div class="margin">
									...
									<?php if ( has_post_thumbnail() ) {
										...
										echo get_the_post_thumbnail($post->ID, 'portf-4col-img' ); 
										echo '</a>';
									} else {
										echo '<img width="215" height="144" src="' . get_template_directory_uri() . '/images/thumbnail-default.jpg" />';
									}
									?>
									<h4 class="post-title"> 
