...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<p class="meta subtitle"><em><?php esc_attr_e( 'Your comment is awaiting approval', 'woocommerce' ); ?></em></p>

<?php } else { ?>

	<div class="box-name author left" itemprop="author"><?php comment_author(); ?></div> <?php
