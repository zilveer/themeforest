...
<?php get_header(); ?>
	<div id="content-wrapper">
		<div id="content">
			<?php $feat_post = get_option('mvp_feat_post_tags'); if ($feat_post == "Select a tag:") { ?>
			<?php } else { ?>
				<div id="featured-posts">
					<ul>
						<?php $recent = new WP_Query(array( 'tag' => get_option('mvp_feat_post_tags'), 'posts_per_page' => '4', 'ignore_sticky_posts' => '1' )); while($recent->have_posts()) : $recent->the_post(); $do_not_duplicate[] = $post->ID; if (isset($do_not_duplicate)) { ?>
							<li>
								<div class="featured-posts-img">
									...
									<div class="featured-posts-text">
										<span class="feat-posts-cat-contain"><h3><?php $category = get_the_category(); echo $category[0]->cat_name; ?></h3></span>
			...
			<div id="content-main">
				<div id="content-main-inner">
					...
					<?php if(get_option('mvp_home_layout') == 'Blog' || get_option('mvp_home_layout') == 'Widgets and Blog') { ?>
						<?php if(get_option('mvp_blog_layout') == 'list') { ?>
							<div class="widget-home-wrapper">
								<span class="home-header-wrap"><h4 class="widget-header"><?php echo get_option('mvp_blog_header'); ?></h3></span>
						...
						<?php } else if(get_option('mvp_blog_layout') == 'large') { ?>
							<div class="widget-home-wrapper">
								<span class="home-header-wrap"><h4 class="widget-header"><?php echo get_option('mvp_blog_header'); ?></h3></span>
