<?php get_header(); ?>
	...
	<div class="content-wrapper <?php echo $sidebar_class; ?>">  
		...
		<?php
			...
			echo __(get_post_meta($post->ID, 'post-option-caption', true), 'gdl_front_end');
			echo '</div>';
		...
		<?php 
			if ( have_posts() ){
				while (have_posts()){
					...
					echo '<div class="single-info-inner-wrapper blog-comment-wrapper">';
