 ...
 *
 *
 * @package 	proStore/woocommerce/cart/totals.php
 * @sub-package WooCommerce/Templates/cart/totals.php
 * @file		1.0
 * @file(Woo)	1.6.4
 */
?>
...
<div class="cart_totals <?php if ( $woocommerce->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<?php if ( ! $woocommerce->shipping->enabled || $available_methods || ! $woocommerce->customer->get_shipping_country() || ! $woocommerce->customer->has_calculated_shipping() ) : ?>
		...
		<h3><span class="alert-color"><em class="icon-money"></em><?php _e('Cart Totals', 'woocommerce'); ?></span></h3>
	...
	<?php elseif( $woocommerce->cart->needs_shipping() ) : ?>
		...
		<?php if ( ! $woocommerce->customer->get_shipping_state() || ! $woocommerce->customer->get_shipping_postcode() ) : ?>
			...
			<div class="woocommerce_info alert alert-box">
				<div class="icon-box">
					<span class="alert-color"><em class="icon-info"></em></span>
				</div>
		...
		<?php else : ?>
			<div class="woocommerce_error alert alert-box">
				<div class="icon-box">
					<span class="alert-color"><em class="icon-cancel"></em></span>
				</div>
