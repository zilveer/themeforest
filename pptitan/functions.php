<?php
//Get theme data
$theme_obj = wp_get_theme('pptitan');
...
define("THEMEDEMOURL", 'http://themes.themegoods2.com/titan');
...
$pp_include_from_skin_arr = array(SHORTNAME.'_font_color', SHORTNAME.'_link_color', SHORTNAME.'_hover_link_color', SHORTNAME.'_h1_font_color', SHORTNAME.'_button_bg_color', SHORTNAME.'_button_font_color', SHORTNAME.'_button_border_color', SHORTNAME.'_menu_font_color', SHORTNAME.'_submenu_font_color', SHORTNAME.'_menu_hover_font_color', SHORTNAME.'_menu_active_font_color', SHORTNAME.'_sidebar_font_color', SHORTNAME.'_sidebar_link_color', SHORTNAME.'_sidebar_hover_link_color', SHORTNAME.'_footer_font_color', SHORTNAME.'_footer_link_color', SHORTNAME.'_footer_hover_link_color', SHORTNAME.'_menu_bg_color', SHORTNAME.'_submenu_hover_font_color', SHORTNAME.'_submenu_bg_color', SHORTNAME.'_submenu_border_color', SHORTNAME.'_portfolio_hover_bg_color', SHORTNAME.'_portfolio_hover_font_color', SHORTNAME.'_menu_opacity_color', SHORTNAME.'_content_bg_color');
...
if ( function_exists( 'add_image_size' ) ) { 
	add_image_size( 'gallery_2', 470, 303, true );
	//add_image_size( 'gallery_3', 293, 219, true );
	add_image_size( 'gallery_4', 228, 147, true );
	add_image_size( 'gallery_a', 920, 9999, false );
	add_image_size( 'gallery_t', 174, 174, true );
	add_image_size( 'gallery_m', 310, 200, true );
	add_image_size( 'gallery_m2w', 630, 410, true );
	add_image_size( 'gallery_m2h', 310, 410, true );
	add_image_size( 'gallery_wall', 340, 280, true );
	add_image_size( 'gallery_m_fh', 340, 9999, false );
	add_image_size( 'gallery_3m', 306, 9999, false );
	add_image_size( 'project_s', 520, 520, true );
	add_image_size( 'blog', 610, 407, true );
	add_image_size( 'blog_f', 960, 470, true );
	add_image_size( 'blog_g', 260, 9999, false );
}
...
function pp_enqueue_front_page_styles() {
	...
	{
	    wp_enqueue_style("style.css", get_stylesheet_uri(), false, THEMEVERSION, "all");
	...
	if(isset($user_browser['name']) && $user_browser['name'] == 'Internet Explorer')
	{
		wp_enqueue_style("ie.css", get_template_directory_uri()."/css/ie.css", false, THEMEVERSION, "all");
	}
...
// Check if shiba library plugin install
include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
$is_gallery_active = is_plugin_active('shiba-media-library/shiba-media-library.php');
