...
extract( array(
    ...
    'pagination'     => $slider->get( 'config-pagination' ),
...
$slider_class = 'slider-parallax masterslider ms-skin-default';
if ( ! $is_primary ) {
...
<div id="<?php echo $slider_id ?>" <?php $slider->item_class( $slider_class ) ?> data-pagination="<?php echo $pagination  ?>" data-height="<?php echo $height  ?>" style="height: <?php echo $height; ?>px;" <?php echo $autoplay ?>>

	<div id="ms-<?php echo $slider_id ?>" class="masterslider-parallax">
		<?php while ( $slider->have_posts() ) : $slider->the_post() ?>
			...
			?>
			<div class="slider-parallax-item ms-slide" data-effect="<?php echo $effect ?>"> <?php echo do_shortcode( $parallax ) ?></div>
		<?php endwhile; ?>
	</div>
</div>
<?php
