...
class FW_Option_Type_Form_Builder_Item_Calendar extends FW_Option_Type_Form_Builder_Item
{
    /**
     * The item type
     * @return string
    ...
    private function get_uri( $append = '' ) {
        return fw_get_template_customizations_directory_uri( '/extensions/forms/includes/builder-items/' . $this->get_type() . $append );
    }
    /**
    ...
    public function get_thumbnails() {
        return array(
            array(
                'html' =>
                    '<div class="item-type-icon-title" data-hover-tip="' . __( 'Add a Calendar Field',
                        'fw' ) . '">' .
                    '<div class="item-type-icon">' .
                    '<img src="' . esc_attr( $this->get_uri( '/static/images/icon.png' ) ) . '" />' .
                    '</div>' .
                    '<div class="item-type-title">' . __( 'Calendar', 'fw' ) . '</div>' .
                    '</div>'
            )
        );
    }
    ...
    public function frontend_render( array $item, $input_value ) {
        ...
        return fw_render_view(
            $this->locate_path( '/views/view.php', get_template_directory() . '/framework-customizations/extensions/forms/includes/builder-items/calendar/view.php' ),
...
FW_Option_Type_Builder::register_item_type('FW_Option_Type_Form_Builder_Item_Calendar');