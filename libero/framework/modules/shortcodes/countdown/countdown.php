...
class Countdown implements ShortcodeInterface {
	...
	public function render($atts, $content = null)
	{
		...
		$html = libero_mikado_get_shortcode_module_template_part('templates/countdown-template', 'countdown', '', $params);
