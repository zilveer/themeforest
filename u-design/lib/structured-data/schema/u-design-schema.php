...
function run_after_udesign_theme_setup() {
    ...
    <?php                               if( $udesign_options['show_postmetadata_author'] == 'yes' ) :
                                            ...
                                            printf( __('%1$s On %2$s ', 'udesign'), '<span class="hide-author vcard author"><span class="fn">'.udesign_get_the_author_page_link().'</span></span>', '<span class="updated">'.get_the_date().'</span>' );
                                        endif; ?>
