...
class EdgeIconsFontElegant implements iIconCollection {
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = EDGE_ROOT . "/css/elegant-icons/style.min.css";
	}
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="edgt_icon_font_elegant ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
