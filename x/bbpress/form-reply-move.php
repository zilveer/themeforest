...
<div id="bbpress-forums">
	...
	<?php if ( is_user_logged_in() && current_user_can( 'edit_topic', bbp_get_topic_id() ) ) : ?>
		...
		<div id="move-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-move x-bbp-general-form">
				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<div class="bbp-template-notice error">
							<p><?php _e( '<strong>WARNING:</strong> This process cannot be undone. You can either make this reply a new topic with a new title, or merge it into an existing topic. If you choose an existing topic, replies will be ordered by the time and date they were created.', '__x__' ); ?></p>
						</div>
