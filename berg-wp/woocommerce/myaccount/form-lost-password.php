...
<form method="post" class="lost_reset_password">
    ...
    <?php if( 'lost_password' == $args['form'] ) : ?>
        ...
        <div class="form-row"><label for="user_login"><?php _e( 'Username or email', 'woocommerce' ); ?></label> <input class="input-text" type="text" name="user_login" id="user_login" /></div>
