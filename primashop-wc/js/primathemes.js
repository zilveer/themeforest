/**
 * Main PrimaShop Javascript, requires jQuery framework
 *
...
jQuery(document).ready(function($) {
	...
	// Clone Menu to Slidebar
	$( "#menu-primary" ).clone().appendTo( ".sb-slidebar.sb-left" ).removeClass('menu-primary sf-menu').addClass('menu-slidebar');
	// Menu
	$('ul.sf-menu').superfish(); 
	// Slidebars
	$.slidebars();
	// Quote
	$('.ps-quote').addClass('ps-quote-js').prepend('<span class="ps-quote-before">&#8220;</span><span class="ps-quote-after">&#8221;</span>');
	// Tabs
	$(".ps-tab_content").hide();
	$("ul.ps-tabs li:first-child").addClass("active").show();
	$(".ps-tab_content:first-child").show();
	$("ul.ps-tabs li").click(function() {
		$(this).parent().children().removeClass("active"); 
		$(this).addClass("active");
		$(this).parent().parent().find(".ps-tab_content").hide(); 
	...
	$(".ps-toggle-trigger").click(function(){
		...
		if ( $(this).hasClass("ps-toggle-min") ) {
			$(this).removeClass("ps-toggle-min"); 
		}
		else {
			$(this).addClass("ps-toggle-min"); 
		}
		if ( $(this).hasClass("accordion") ) {
			$(".ps-toggle-trigger.accordion").not($(this)).removeClass("active ps-toggle-min").next().slideUp(); 
		}
		return false; 
	});
	// fitVids
	$("#container").fitVids(); 
	// Remove padding and margin of the latest element on featured header
	$("#header-featured .margin, #header-featured .margin .ps-column-col").each(function() {
		$(this).children().last().css('marginBottom','0px'); 
	});
	// Reload main stylesheet on IE8 to always show font icons 
	if ($.browser.msie && 8 == parseInt($.browser.version)) {
		$(function() {
			var $ss = $('#style-theme-css');
			$ss[0].href = $ss[0].href;
		});
	}	
});
...
jQuery(document).on("scroll",function(){
	if( jQuery(document).scrollTop() > 100 ) {
		jQuery("body.header-sticky-yes").removeClass("header-sticky-inactive").addClass("header-sticky-active");
	}
	else {
		jQuery("body.header-sticky-yes").removeClass("header-sticky-active").addClass("header-sticky-inactive");
	}
});
