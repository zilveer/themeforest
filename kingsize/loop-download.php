									 ...
									 //Sidebar enabled	
										...
										if(has_post_thumbnail()): // POST has thumbnail
											...
											if($show_image_lightbox=='enable')
												echo '<div class="blog_img"><a href="'.$org_img_url.'" class="image lightbox_blog" title="'.strip_tags($title_image).'" rel="gallery"><img src="'.$image[0].'" title="'.strip_tags($title_image).'" alt="'.strip_tags($title_image).'" width="'.$image[1].'" height="'.$image[2].'"/></a></div>';
											else 
												echo '<div class="blog_img"><a href="'.get_permalink().'" class="image lightbox_not" title="'.strip_tags($title_image).'"><img src="'.$image[0].'" title="'.strip_tags($title_image).'" alt="'.strip_tags($title_image).'" width="'.$image[1].'" height="'.$image[2].'"/></a></div>';
