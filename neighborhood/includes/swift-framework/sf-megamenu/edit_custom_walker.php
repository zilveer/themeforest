        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
            ...
            <div class="sf-menu-options">
                ...
                <?php if ( $depth == 0 ) { ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-megamenu-<?php echo $item_id; ?>"><?php _e( 'Enable Mega Menu', "swiftframework" ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-megamenucols-<?php echo $item_id; ?>"><?php _e( 'Mega Menu Columns', "swiftframework" ); ?></label>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-is-naturalwidth-<?php echo $item_id; ?>"><?php _e( 'Natural Width Mega Menu', "swiftframework" ); ?>
                    ...
                    <!--<p class="field-custom description description-wide">
                        <label
                            for="edit-menu-is-altstyle-<?php echo $item_id; ?>"><?php _e( 'Alternative Style Mega Menu', "swiftframework" ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-hideheadings-<?php echo $item_id; ?>"><?php _e( 'Hide Mega Menu Headings', "swiftframework" ); ?>
                ...
                <p class="field-custom description description-wide">
                    <label
                        for="edit-menu-loggedinvis-<?php echo $item_id; ?>"><?php _e( 'Visible only when logged in', "swiftframework" ); ?>
                ...
                <p class="field-custom description description-wide">
                    <label
                        for="edit-menu-loggedoutvis-<?php echo $item_id; ?>"><?php _e( 'Visible only when logged out', "swiftframework" ); ?>
                ...
                <?php if ( $depth == 0 ) { ?>
                    ...
                    <!--<p class="field-custom description description-wide">
                        <label
                            for="edit-menu-menuitembtn-<?php echo $item_id; ?>"><?php _e( 'Button Style Menu Item', "swiftframework" ); ?>
                ...
                <p class="field-custom description description-thin"
                   style="height: auto;overflow: hidden;width: 50%;float: none;">
                    <label
                        for="edit-menu-item-icon-<?php echo $item_id; ?>"><?php _e( 'Menu Icon (Gizmo / Font Awesome)', "swiftframework" ); ?>
                ...
                <?php if ( $depth == 1 ) { ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-megatitle-<?php echo $item_id; ?>"><?php _e( 'Mega Menu No Link Title', "swiftframework" ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-nocolumnspacing-<?php echo $item_id; ?>"><?php _e( 'No Menu Column Spacing (for custom html column)', "swiftframework" ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-item-icon-<?php echo $item_id; ?>"><?php _e( 'Custom HTML Column Width (optional)', "swiftframework" ); ?>
                    ...
                    <p class="field-custom description description-wide">
                        <label
                            for="edit-menu-item-htmlcontent-<?php echo $item_id; ?>"><?php _e( 'Custom HTML Column (within Mega Menu)', "swiftframework" ); ?>
            ...
            <div class="menu-item-actions description-wide submitbox">
                ...
                <a class="item-delete submitdelete deletion" id="delete-<?php echo $item_id; ?>" href="<?php
                    ...
                    ?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e( 'Cancel', "swiftframework" ); ?></a>
            </div>
