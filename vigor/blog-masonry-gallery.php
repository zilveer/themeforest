...
if(isset($edgt_options['blog_masonry_gallery_content_position'])){
	$blog_content_position = $edgt_options['blog_masonry_gallery_content_position'];
}
...
if(isset($edgt_options['blog_masonry_gallery_number_of_chars'])&& $edgt_options['blog_masonry_gallery_number_of_chars'] != "") {
	edgt_set_blog_word_count(esc_attr($edgt_options['blog_masonry_gallery_number_of_chars']));
}

$category_filter = "no";
if(isset($edgt_options['blog_masonry_gallery_filter'])){
	$category_filter = $edgt_options['blog_masonry_gallery_filter'];
}
