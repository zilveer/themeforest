...
add_action( 'tgmpa_register', 'magzilla_register_required_plugins' );
/**
 ...
 */
function magzilla_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Favethemes theme Functionality', // The plugin name
			'slug'     				=> 'favethemes-theme-functionality', // The plugin slug (typically the folder name)
			'source'   				=> FAVE_FRAMEWORK . '/plugins/favethemes-theme-functionality.zip', // The plugin source
		...
		array(
			...
			'source'   				=> FAVE_FRAMEWORK . '/plugins/js_composer.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			'name'     				=> 'Login With Ajax', // The plugin name
			'slug'     				=> 'login-with-ajax', // The plugin slug (typically the folder name)
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		)
