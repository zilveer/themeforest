...
if ( ! class_exists( 'RWMB_Field ' ) )
{
	class RWMB_Field
	{
		...
		static function show( $field, $saved )
		{
			...
			// Display label and input in DIV and allow user-defined php to be appended
		...
		{
			return '<a href="#" class="rwmb-button button-primary add-clone">' . __( '+', 'flatastic' ) . '</a>';
		}
		...
		{
			return '<a href="#" class="rwmb-button button remove-clone">' . __( '&#8211;', 'flatastic' ) . '</a>';
		}
