...
class mtheme_Popular_Posts extends WP_Widget {
	...
	function mtheme_Popular_Posts() {
		...
		$this->WP_Widget('popular_posts', MTHEME_NAME.' - '.__('Popular Posts', 'mthemelocal'), $widget_ops);
...
<?php else:?>
					<img src="<?php echo MTHEME_PATH;?>/images/icons/post_thumbnail.png" width="95" height="65" title="<?php the_title();?>" alt="<?php the_title();?>"/>
