...
<?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) : ?>
	...
	<p class="buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="button wc-forward box-name"><?php _e( 'View Cart', 'woocommerce' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="button checkout wc-forward box-name"><?php _e( 'Checkout', 'woocommerce' ); ?></a>
	</p>
