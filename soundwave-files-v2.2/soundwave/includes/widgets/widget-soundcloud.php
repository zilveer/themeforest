...
class SoundCloud_Widget extends WP_Widget {
    ...
    function SoundCloud_Widget() {
        ...
        $widget_opts = array(
            ...
            'description' => __('Display your SoundCloud.', 'wizedesign')
        );
        $this->WP_Widget('soundcloud-widget', __('SOUNDWAVE - SoundCloud', 'wizedesign'), $widget_opts);
    }
    /*--------------------------------------------------*/
    /* DISPLAY THE WIDGET
    /*--------------------------------------------------*/
