...
if ( function_exists( 'add_image_size' ) ) { 
	...
	add_image_size( 'gallery_a', 830, 9999, true );
...
?>
	...
	<div id="message" class="error fade">
	<p style="line-height:1.5em"><strong>
		The path <?php echo $data_dir; ?> is not writable, please login with your FTP account and make it writable (chmod 777) otherwise you can't use image uploader.
	</p></strong>
	</div>
...
?>
	...
	<div id="<?php echo $value['id']; ?>_wrapper" style="width:380px;font-size:11px;">
		<img src="<?php echo get_stylesheet_directory_uri(); ?>/data/<?php echo get_option( $value['id'] ); ?>" style="max-width:350px"/><br/><br/>
