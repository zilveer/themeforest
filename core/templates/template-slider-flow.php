...
?>
<a id="fancy_gallery<?php echo $key; ?>" href="<?php echo $full_image_url[0]; ?>" rel="gallery" <?php if(!empty($pp_display_image_title)) { ?> title="<?php echo $photo->post_title; ?>" <?php } ?>><img src="<?php echo get_template_directory_uri(); ?>/images/white_slider_handle.png" /></a>
<?php
}
?>
</div>
...
imf.create("imageFlow", '<?php echo get_template_directory_uri(); ?>/imageFlowXML.php', 0.6, 0.4, 0, 10, 8, 4);
