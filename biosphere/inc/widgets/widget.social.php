...
class DD_Social_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		/* Start - Widget Content */
			...
			echo '<ul class="social-icons">';
				...
				if ( $youtube != '' ) {
					echo '<li><a href="' . $youtube . '"><img src="' . get_template_directory_uri() . '/images/icons/youtube.png' .'" /></a></li>';
				}
	...
	public function form( $instance ) {
		...
		if ( isset( $instance['youtube'] ) ) { $youtube = $instance['youtube' ]; } else { $youtube = ''; }
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'deviantart' ); ?>">DeviantArt</label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'vimeo' ); ?>">Youtube</label> 
