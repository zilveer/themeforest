 ...
 *
 *
 * @package 	proStore/library/shortcodes/tinymce/pricing/window.php
 * @file	 	1.0
 */
?>
<?php
...
<head>
<title>Pricing Tables Shortcode Generator</title>
<meta http-equiv="Content-Type" content="<?php bloginfo('html_type'); ?>; charset=<?php echo get_option('blog_charset'); ?>" />
<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-includes/js/tinymce/tiny_mce_popup.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-includes/js/tinymce/utils/mctabs.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-includes/js/tinymce/utils/form_utils.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/library/shortcodes/tinymce/pricing/tinymce.js?1.1"></script>
<style type="text/css">
...
<form name="mtheme_pricing" action="#">
	<!-- style_panel -->
	<fieldset>
		<legend>Pricing table accent color</legend><p> (Colors defined in Admin panel > Styling & Colors > Accent colors)</p>
	...
	<fieldset>
		...
		<p>The selected table will be larger</p>
		<select id="pricing_selected" name="pricing_selected">
