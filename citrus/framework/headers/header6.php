...
<div id="header-wrapper">
    <header id="header" class="<?php echo $header.' dt-toggle-header'; ?>">
        ...
        <div id="toggle-panel">
            <a id="toggle" href="#"><i class="fa fa-minus"></i></a>
        </div> 
    
        <!--logo starts-->
        <div id="logo" class="toggle-menu">
			<?php
			$blog_title = dttheme_blog_title();
            if( dttheme_option('general', 'logo') ):
				$dark_layout = dttheme_option('general','enable-dark-layout');
                ...
                $img_name_retina = ($dark_layout != '') ? 'logo@2x-dark' : 'logo@2x';
                $retina_url = dttheme_option('general','retina-logo-url');
                $retina_url = !empty($retina_url) ? $retina_url : IAMD_BASE_URL."images/{$img_name}.png";
                ...
                ?>
                <a href="<?php echo home_url();?>" title="<?php echo $blog_title;?>">
                    <img class="normal_logo" src="<?php echo $url;?>" alt="<?php echo $blog_title; ?>" title="<?php echo $blog_title; ?>" id="dt_togglelogo" />
                    <img class="retina_logo" src="<?php echo $retina_url;?>" alt="<?php echo $blog_title;?>" title="<?php echo $blog_title; ?>" style="width:<?php echo $width; ?>; height:<?php echo $height; ?>;" id="dt_retina_togglelogo" />
                </a><?php
            else:?>
                <h2><a href="<?php echo home_url();?>" title="<?php echo $blog_title;?>"><?php echo do_shortcode(get_option('blogname')); ?></a></h2><?php
            endif;?>
