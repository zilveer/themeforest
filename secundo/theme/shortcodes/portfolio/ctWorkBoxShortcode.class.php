 ...
 * Work box shortcode
 */
class ctWorkBoxShortcode extends ctShortcodeQueryable implements ICtShortcodeSingleQueryable {
	...
	public function handle($atts, $content = null) {
		...
		$html = '[shadow_box]
					<div class="row-fluid">
						...
						<div class="span6">
							<h3><a href="' . $link . '" class="vmedium vorange">' . $title . '</a></h3>' . $catsHtml . '<p>' . $summary . '</p>
						</div>
					</div>
				[/shadow_box]';
