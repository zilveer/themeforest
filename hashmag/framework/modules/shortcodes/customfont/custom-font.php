<?php
namespace Hashmag\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Mikado Custom Font', 'hashmag'),
				'base' => $this->getBase(),
				'category' => 'by MIKADO',
				...
				'params' => array(
					...
					array(
						...
						"value" => hashmag_mikado_get_font_style_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
						...
						"value" => hashmag_mikado_get_font_weight_array(),
						"save_always" => true
					),
					array(
						"type" => "textfield",
					...
					array(
						...
						"value" => hashmag_mikado_get_text_transform_array(),
                        'save_always'	=> true,
						"description" => ""
					),
					array(
	...
	public function render($atts, $content = null) {
		...
		$html = hashmag_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
