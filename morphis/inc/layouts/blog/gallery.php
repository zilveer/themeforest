		...
		<div class="three columns alpha clearfix">
			<ul class="entry-meta meta1 clearfix">
				...
				<li><img src="<?php echo get_template_directory_uri() . '/images/icons/glyphish/202-slides.png'; ?>" class="post-format-icon" title="<?php _e( 'Gallery Post Format', 'morphis' ); ?>"/></li>
				<?php endif; ?>
