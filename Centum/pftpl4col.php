		...
		<div <?php post_class('four columns portfolio-item'); ?> id="post-<?php the_ID(); ?>" >
			...
			if($type == 'video' && $videothumbtype == 'video') {
				...
				if($videoembed) {
					...
					$post_embed = $wp_embed->run_shortcode('[embed  width="280" ]'.$videolink.'[/embed]') ;
			...
			<div class="item-description alt">
				...
				$short_excerpt = string_limit_words($excerpt,ot_get_option('centum_portfolio_word_count',11));
