...
<div class="intro-wrapper" <?php echo $customIntroColorStyle; ?>>
	<div class="section-intro " data-opacity-start="<?php echo $dataOpacityStart;?>" data-opacity-end="<?php echo $dataOpacityEnd;?>" <?php echo (!$contact) ? 'data-background="'.$img_url.'"' : '';?>>
		<?php
		if ($contact == true) {
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-md-10 col-md-offset-1">
						...
						<div style="<?php echo $txt_align ;?>" class="parallax-element-second <?php echo (get_post_meta(berg_getPageId(),'intro_content_settings', true) == '') ? 'hidden':'';?>"><?php echo apply_filters('the_content', get_post_meta(berg_getPageId(), 'intro_content_settings', true)); ?> </div>
					</div>
				</div>
			</div>
		</div>
