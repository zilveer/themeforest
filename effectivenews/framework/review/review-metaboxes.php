...
<div class="mom_meta_control">
    <div class="mom_meta_note"><p><?php _e('To add the <strong>review</strong> inside the post just type <code>[review]</code> in any where or use the editor review button, or use the page builder','theme'); ?></p></div>
   ...
   <?php $mb->the_field('review_box_units'); ?>
        ...
        <div class="mom_tiny_input">
            <select name="<?php $mb->the_name(); ?>">
                <option value="percent" <?php $mb->the_select_state('percent'); ?>><?php _e('Percent', 'theme'); ?></option>
                <option value="points" <?php $mb->the_select_state('points'); ?>><?php _e('Points', 'theme'); ?></option>
            </select>
        </div> <!--input-->
        <div class="clear"></div>
    </div> <!--mom_meta_item-->
   ...
   <?php $mb->the_field('review_box_title'); ?>
        ...
        <div class="mom_tiny_input">
            <input type="text" id="<?php $mb->the_name(); ?>" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>" placeholder="<?php _e('Review Overview', 'theme'); ?>">
        </div> <!--input-->
        <div class="clear"></div>
    </div> <!--mom_meta_item-->
   ...
   <?php $mb->the_field('review_description'); ?>
        ...
        <div class="mom_tiny_input">
            <?php wp_editor(html_entity_decode($mb->get_the_value()), 'review_desc', array('teeny' => true, 'textarea_name' =>$mb->get_the_name(), 'media_buttons'=> false)); ?>
        </div> <!--input-->
        <div class="clear"></div>
    </div> <!--mom_meta_item-->
   ...
   <?php $mb->the_field('review_summary'); ?>
        ...
        <div class="mom_tiny_input">
            <?php wp_editor(html_entity_decode($mb->get_the_value()), 'review_summary', array('teeny' => true, 'textarea_name' =>$mb->get_the_name(), 'media_buttons'=> false)); ?>
        </div> <!--input-->
        <div class="clear"></div>
    </div> <!--mom_meta_item-->
        <div class="mom_tiny_form_element">
   <?php $mb->the_field('review_score_title'); ?>
    ...
    <h2 class="mom_meta_subtitle"><?php _e('Review Review Criterias', 'theme'); ?></h2>
    ...
    <?php $mb->the_group_open(); ?>
        <div class="rs-criteria">
            ...
            <div class="cr-input cr-name"><label><?php _e('Name', 'theme'); ?></label><input type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"></div>
            <?php $mb->the_field('cr_score'); ?>
            <div class="cr-input cr-score">
                <label><?php _e('Score', 'theme'); ?></label>
	    ...
	    ?>
            ...
            <div class="cr-input cr-colors">
                ...
                <div class="crc-input"><label><?php _e('Background', 'theme'); ?></label><div class="mom_color_meta_wrap"  data-id="<?php $mb->the_index(); ?>" data-name="<?php $mb->the_name(); ?>"><input class="mom_meta_color" type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"></div></div>
                <?php $mb->the_field('cr_txt'); ?>
                <div class="crc-input"><label><?php _e('Text', 'theme'); ?></label><div class="mom_color_meta_wrap"  data-id="<?php $mb->the_index(); ?>" data-name="<?php $mb->the_name(); ?>"><input class="mom_meta_color" type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"></div></div>
            </div> 
