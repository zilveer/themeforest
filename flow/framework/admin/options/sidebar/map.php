...
if ( ! function_exists('flow_elated_sidebar_options_map') ) {

	function flow_elated_sidebar_options_map() {
		...
		$panel_widgets = flow_elated_add_admin_panel(
			array(
				'page'  => '_sidebar_page',
				'name'  => 'panel_widgets',
				'title' => 'Widgets'
		...
		$group_sidebar_padding = flow_elated_add_admin_group(array(
			'name'		=> 'group_sidebar_padding',
			'title'		=> 'Padding',
			'parent'	=> $panel_widgets
		));

		$row_sidebar_padding = flow_elated_add_admin_row(array(
	...
	add_action( 'flow_elated_options_map', 'flow_elated_sidebar_options_map', 11);
