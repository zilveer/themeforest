...
<li class="<?php bp_activity_css_class(); ?> dd-bp-wrapper-secondary" id="activity-<?php bp_activity_id(); ?>">

	<div class="activity-avatar dd-bp-avatar">
	...
	<div class="activity-content clearfix">
		...
		<div class="activity-header clearfix dd-bp-header">
		...
		<?php if ( bp_activity_has_content() ) : ?>
			...
			<div class="activity-inner clerfix">
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-content">
						<div class="ac-textarea">
							<textarea id="ac-input-<?php bp_activity_id(); ?>" class="ac-input" name="ac_input_<?php bp_activity_id(); ?>" placeholder="<?php _e( 'EXPRESS YOURSELF', 'dd_string' ); ?>"></textarea>
						</div>
