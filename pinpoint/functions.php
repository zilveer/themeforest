<?php
	...
	$PinpointUpdateChecker = new ThemeUpdateChecker(
	    'pinpoint',
	    'https://kernl.us/api/v1/theme-updates/5669b5f0c965b8ee77f02605/'
	);
	...
	function sf_enqueue_scripts() {
	    ...
	    wp_register_script('flexslider', get_template_directory_uri() . '/js/jquery.flexslider-min.js', 'jquery', NULL, TRUE);
	    wp_register_script('isotope', get_template_directory_uri() . '/js/jquery.isotope.min.js', 'jquery', NULL, TRUE);
	    wp_register_script('hoverIntent', get_template_directory_uri() . '/js/jquery.hoverIntent.min.js', 'jquery', NULL, TRUE);
	    wp_register_script('easing', get_template_directory_uri() . '/js/jquery.easing.1.3.js', 'jquery', NULL, TRUE);
	    wp_register_script('jcarousel', get_template_directory_uri() . '/js/jquery.jcarousel.min.js', 'jquery', NULL, TRUE); 
	    wp_register_script('jqueryUI', get_template_directory_uri() . '/js/jquery-ui-1.9.2.custom.min.js', 'jquery', NULL, TRUE);
		wp_register_script('fancybox', get_template_directory_uri() . '/js/jquery.fancybox.pack.js', 'jquery', NULL, TRUE);
	    ...
	    wp_register_script('respond', get_template_directory_uri() . '/js/respond.min.js', 'jquery', NULL, TRUE);
	    wp_register_script('functions', get_template_directory_uri() . '/js/functions.js', 'jquery', NULL, TRUE);
	...
	*	WooCommerce Functions		       	     	* 
	...
	function sf_custom_login_logo() {
		...
		if ($custom_logo) {		
		echo '<style type="text/css">
		    .login h1 a { background-image:url('. $custom_logo .') !important; width: 100%; height: 95px!important; background-size: auto; }
		</style>';
		} else {
		echo '<style type="text/css">
		    .login h1 a { background-image:url('. get_template_directory_uri() .'/images/custom-login-logo.png) !important; height: 95px!important; width: 100%; background-size: auto; }
		</style>';
		}
	}
