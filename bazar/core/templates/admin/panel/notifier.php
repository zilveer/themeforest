...
$screenshot = $ct->get_screenshot(); ?>    
    ...
    <div class="wrap">
        ...
        <h2><?php echo $name ?> Theme Updates</h2>
        <div id="message" class="updated below-h2"><p><strong>A new version of <?php echo $name; ?> is available for download.</strong> You have installed version <?php echo $version; ?> installed. Update to version <?php echo yit_get_model('notifier')->getXml()->latest; ?>.</p></div>

        <img style="float: left; margin: 0 20px 20px 0; border: 1px solid #ddd; max-width:300px;" src="<?php echo $screenshot ?>" />
        ...
        <?php echo yit_get_model('notifier')->getXml()->changelog ?>
