 ...
 *
 * Class HueMikadoWidget
 */
abstract class HueMikadoWidget extends WP_Widget {
	/**
	...
	public function form($instance) {
		if(is_array($this->params) && count($this->params)) {
			...
			<p><?php esc_html_e('There are no options for this widget.', 'hue'); ?></p>
		<?php }
	}
...
$hue_Framework = HueMikadoFramework::get_instance();
$mkdSkinManager                 = new HueMikadoSkinManager();
$hue_Framework->setSkin($mkdSkinManager->getSkin());
