...
<div class="inner">
	...
	<div class="one_fourth portfolio4 <?php echo $last_class; ?>">
	...
	<br class="clear"/>
	<div class="portfolio_desc" style="height:130px;">
	    <div class="portfolio_header">
	    	<h6 class="cufon"><?php echo $portfolio_item->post_title?></h6>
	    </div>
	    <span>
	    <?php echo pp_substr(strip_tags(strip_shortcodes($portfolio_item->post_content)),60); ?>																	
	    </span>
	</div>
