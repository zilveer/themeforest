...
?>
<div class="choose-icon-font" style="display: none">
<div class="md-popup popup-medium"><!-- To change dimension of the popup by adding class .popup-big, .popup-meidum, .popup-small, -->
    <div class="md-popup-inner">

        <div class="md-popup-inner-header">
            <h3 class="md-popup-title">Choose Icon: <i id="current-icon" class=""></i></h3>
            <!-- <a href="#close" class="md-popup-close">X</a> -->
            <a class="media-modal-close md-popup-close" title="Close" href="#"><span class="media-modal-icon"></span></a>
        </div><!-- /.popup-header -->

        <div class="md-popup-inner-content list-font-icon bo-tb-fa">
        ...
        <div class="md-popup-inner-footer">
            <a href="#save" class="md-popup-save button button-primary button-large">Save</a>
        </div><!-- /.popup-footer -->

    </div><!-- /.md-popup-inner -->
</div><!-- /.md-popup -->
<div class="md-popup-overlap"></div>
</div>
