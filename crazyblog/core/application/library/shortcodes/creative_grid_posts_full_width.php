...
class crazyblog_creative_grid_posts_full_width_VC_ShortCode extends crazyblog_VC_ShortCode {

	public static function crazyblog_creative_grid_posts_full_width_vc( $atts = null, $contents = '' ) {

		if ( $atts == 'crazyblog_Shortcodes_Map' ) {

			return array(
				"name" => esc_html__( "Creative Grid Posts Full Width", 'crazyblog' ),
				"base" => "crazyblog_creative_grid_posts_full_width_outpupt",
				"icon" => crazyblog_URI . '',
	...
	public static function crazyblog_creative_grid_posts_full_width_outpupt( $atts, $contents = null ) {
		...
		if ( $query->have_posts() ) {
			echo '<div class="creative-blog"><div class="row">';
				        ...
				        $(window).scroll(function () {
				            if ($(window).scrollTop() == $(document).height() - $(window).height()) {
				                if (!jQuery("div#loaded").hasClass("laod_ajax") && !jQuery("div#loaded").hasClass("infinite_end")) {
				                    infinite_scroll(
				                            ".creative-blog > .row div.col-md-4",
				                            ".creative-blog > .row",
				                            "post",
				                            "'.esc_js( $number ).'",
				                            "'.esc_js( $cat ).'",
