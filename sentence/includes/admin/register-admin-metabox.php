...
$boxes = array( 
	array( 'title' =>  'Portfolio Layout', 'id'=>'layout' , 'page'=>array('portfolio'), 'context'=>'side', 'priority'=>'low' ),
...
$elements = array(
		...
		array(	
					"slug"	=> "layout",
					"name" 	=> "Choose a single entry Portfolio Layout",
					"desc" 	=> "Choose a portfolio layout depending on your picture orientation",
					"id" 	=> "layout",
					"type" 	=> "select",
					"std" 	=> "Landscape",
					"no_first"=>true,
					"subtype" => array( 'Landscape (Fullwidth image on top of entry)' => "Landscape",
										'Portrait (Slideshow and content next to each other)' => "Portrait"
										)),
