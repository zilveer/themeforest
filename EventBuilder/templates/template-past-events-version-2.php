					...
					<div class="col-sm-12">
						...
						<div class="item-block-content">
							...
							<form id="td-filter-listings" type="post" action="" >
								...
								<input type="hidden" name="action" value="tdPastEventsFilterForm" />
								<?php wp_nonce_field( 'tdPastEventsFilter_html', 'tdPastEventsFilter_nonce' ); ?>
