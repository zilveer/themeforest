<?php
/*
Template Name: Food Menu Squares With Images
*/
...
?>
<section id="menu" class="section-scroll main-section menu menu-grid <?php echo $stickyClass ;?>">
	<?php
	$termsArray = array();
	...
	<?php endif; ?>
	<div class="container-fluid menu-content <?php echo $columns_count ;?>">
		...
		<div class="category-<?php echo $termsArray[$cat]['ID'];?>" data-myorder="1">
			...
			<div class="row">
				...
				if (isset($term_meta['order'])) {
					$the_query_params = array(
						'suppress_filters'=>true,
						'post_type'=>'berg_menu',
						'posts_per_page'=>-1,
						'orderby'=>'post__in',
						'post__in'=>maybe_unserialize($term_meta['order']),
					...
					$the_query = new WP_Query($the_query_params);
					$the_query2 = new WP_Query(array(
						'suppress_filters'=>true,
						'posts_per_page'=>-1,
						'post_type'=>'berg_menu',
						'orderby'=>'post__in',
						'post__not_in'=>maybe_unserialize($term_meta['order']),
						'tax_query'=>array(array(
							'taxonomy'=>'berg_menu_categories',
							'terms'=>$cat,
							'field' => 'term_id'
					...
					$the_query = new WP_Query($the_query_params);
					$terms = wp_get_post_terms($cat, 'berg_menu_categories');
				}

				if ($the_query->have_posts()) {
					while ($the_query->have_posts()) {
						$the_query->the_post(); 
						get_template_part('menu', 'single');
					}
				}
