...
if ( ! function_exists('flow_elated_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function flow_elated_fonts_options_map() {
		 ...
		 * Headings
		 */
		$panel_headings = flow_elated_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => 'Headings'
		...
		//H1
		$group_heading_h1 = flow_elated_add_admin_group(array(
		...
		$row_heading_h1_1 = flow_elated_add_admin_row(array(
		...
		$row_heading_h1_2 = flow_elated_add_admin_row(array(
		...
		//H2
		$group_heading_h2 = flow_elated_add_admin_group(array(
		...
		$row_heading_h2_1 = flow_elated_add_admin_row(array(
		...
		$row_heading_h2_2 = flow_elated_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = flow_elated_add_admin_group(array(
		...
		$row_heading_h3_1 = flow_elated_add_admin_row(array(
		...
		$row_heading_h3_2 = flow_elated_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = flow_elated_add_admin_group(array(
		...
		$row_heading_h4_1 = flow_elated_add_admin_row(array(
		...
		$row_heading_h4_2 = flow_elated_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = flow_elated_add_admin_group(array(
		...
		$row_heading_h5_1 = flow_elated_add_admin_row(array(
		...
		$row_heading_h5_2 = flow_elated_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = flow_elated_add_admin_group(array(
		...
		$row_heading_h6_1 = flow_elated_add_admin_row(array(
		...
		$row_heading_h6_2 = flow_elated_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings = flow_elated_add_admin_panel(
			array(
				'page' => '_fonts_page',
		...
		//H1
		$group_responsive_heading_h1 = flow_elated_add_admin_group(array(
		...
		$row_responsive_heading_h1_1 = flow_elated_add_admin_row(array(
		...
		//H2
		$group_responsive_heading_h2 = flow_elated_add_admin_group(array(
		...
		$row_responsive_heading_h2_1 = flow_elated_add_admin_row(array(
		...
		//H3
		$group_responsive_heading_h3 = flow_elated_add_admin_group(array(
		...
		$row_responsive_heading_h3_1 = flow_elated_add_admin_row(array(
		...
		//H4
		$group_responsive_heading_h4 = flow_elated_add_admin_group(array(
		...
		$row_responsive_heading_h4_1 = flow_elated_add_admin_row(array(
		...
		//H5
		$group_responsive_heading_h5 = flow_elated_add_admin_group(array(
		...
		$row_responsive_heading_h5_1 = flow_elated_add_admin_row(array(
		...
		//H6
		$group_responsive_heading_h6 = flow_elated_add_admin_group(array(
		...
		$row_responsive_heading_h6_1 = flow_elated_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings2 = flow_elated_add_admin_panel(
			array(
				'page' => '_fonts_page',
		...
		//H1
		$group_responsive2_heading_h1 = flow_elated_add_admin_group(array(
		...
		$row_responsive2_heading_h1_1 = flow_elated_add_admin_row(array(
		...
		//H2
		$group_responsive2_heading_h2 = flow_elated_add_admin_group(array(
		...
		$row_responsive2_heading_h2_1 = flow_elated_add_admin_row(array(
		...
		//H3
		$group_responsive2_heading_h3 = flow_elated_add_admin_group(array(
		...
		$row_responsive2_heading_h3_1 = flow_elated_add_admin_row(array(
		...
		//H4
		$group_responsive2_heading_h4 = flow_elated_add_admin_group(array(
		...
		$row_responsive2_heading_h4_1 = flow_elated_add_admin_row(array(
		...
		//H5
		$group_responsive2_heading_h5 = flow_elated_add_admin_group(array(
		...
		$row_responsive2_heading_h5_1 = flow_elated_add_admin_row(array(
		...
		//H6
		$group_responsive2_heading_h6 = flow_elated_add_admin_group(array(
		...
		$row_responsive2_heading_h6_1 = flow_elated_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = flow_elated_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
				'title' => 'Text'
		...
		$group_text = flow_elated_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> 'Paragraph',
		...
		$row_text_1 = flow_elated_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$group_text_res1 = flow_elated_add_admin_group(array(
		...
		$row_res_text_1 = flow_elated_add_admin_row(array(
			'name'		=> 'row_text_1',
		...
		$group_text_res2 = flow_elated_add_admin_group(array(
		...
		$row_res_text_2 = flow_elated_add_admin_row(array(
			'name'		=> 'row_res_text_2',
		...
		$row_text_2 = flow_elated_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_link = flow_elated_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> 'Links',
		...
		$row_link_1 = flow_elated_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		$row_link_2 = flow_elated_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		flow_elated_add_admin_field(array(
			...
			'options'		=> flow_elated_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	...
	add_action( 'flow_elated_options_map', 'flow_elated_fonts_options_map', 13);
}