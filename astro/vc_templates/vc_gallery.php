...
if ( $type == 'nivo' ) {
    ...
    $slides_wrap_start = '<div class="nivoSlider popado boxed_shadow">';
    $slides_wrap_end = '</div>';
} else if ( $type == 'flexslider' || $type == 'flexslider_fade' || $type == 'flexslider_slide' || $type == 'fading' ) {
    $el_start = '<li>';
    $el_end = '</li>';
    $slides_wrap_start = '<ul class="slides popup-gallery">';
    $slides_wrap_end = '</ul>';
    ...
    $el_end = '</li>';
    $slides_wrap_start = '<ul class="wpb_image_grid_ul popup-gallery">';
    $slides_wrap_end = '</ul>';
}
...
$output .= '<div class="'.$prk_shadow.'wpb_gallery_slides'.$type.'" data-interval="'.$interval.'"'.$flex_fx.'>'.$slides_wrap_start.$gal_images.$slides_wrap_end.'</div>';
