...
<a href="#" class="admin-button button-gray js_back_to_seo_list"><?php _e('Back to groups list', 'cardealer'); ?></a><br />
...
<div class="option">
	...
	<div class="admin-one-half last">
		...
		<div class="add-button add_seo_group_category" group-id="<?php echo $seo_group_id ?>"></div>&nbsp;<strong><?php _e('Add Category', 'cardealer'); ?></strong>
