...
$tw_ck = of_get_option('twitter_ck');
$tw_cs = of_get_option('twitter_cs');
$tw_at = of_get_option('twitter_at');
$tw_as = of_get_option('twitter_as');
...
$config = array(
	...
	'oauth_access_token_secret' => $tw_as,
	'consumer_key' => $tw_ck,
...
$whitelist = array(
	'statuses/user_timeline.json?screen_name=hellominti&count=10&include_rts=false&exclude_replies=true'=>true
);
