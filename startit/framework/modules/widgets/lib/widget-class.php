 ...
 *
 * Class QodeStartitWidget
 */
abstract class QodeStartitWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'startit'); ?></p>
        <?php }
    }
...
$qode_startit_Framework = QodeStartitFramework::get_instance();
$qodeSkinManager = new QodeStartitSkinManager();
$qode_startit_Framework->setSkin($qodeSkinManager->getSkin());
