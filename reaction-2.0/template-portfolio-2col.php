...
<!-- Super Container -->
<div class="super-container full-width main-content-area portfolio-2 isotope" id="section-content">
										...
										<div style="display: none;" class="gallery_links">								
											...
											if ($attachments) {
												foreach ($attachments as $attachment) {
													...
													echo '<a data-rel="prettyPhoto['.$post_slug.']" href="'.$attachment_url.'" title="'.$attachment->post_content.'"></a>';
												}
											}
											?>
										</div>	
