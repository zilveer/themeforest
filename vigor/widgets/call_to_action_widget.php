...
class Call_To_Action extends WP_Widget {
    public function __construct() {
		parent::__construct(
			...
			'Call To Action', // Name
			array( 'description' => __( 'Call to Action Widget', 'edgt' ), ) // Args
		);
	}
    ...
    public function widget($args, $instance) {
 	...
 	public function form($instance) {
        ...
        $edgt_icon_fields = $edgtIconCollections->getShortcodeParams();
        foreach ($edgt_icon_fields as $icon_collection_key => $icon_collection_value ) {
        ...
        if(is_array($edgtIconCollections->iconCollections) && count($edgtIconCollections->iconCollections)) {
            ...
            $icon_collection_param = $edgtIconCollections->getIconCollectionsParams();

            foreach ($edgtIconCollections->iconCollections as $icon_collection_key => $icon_collection_obj) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'full_width' )); ?>"><?php _e( 'Full Width:','edgt'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'full_width' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'full_width' )); ?>">
                <option value="yes" <?php if(esc_attr($full_width) == "yes"){echo 'selected="selected"';} ?>><?php _e('Yes', 'edgt') ?></option>
                <option value="no" <?php if(esc_attr($full_width) == "no"){echo 'selected="selected"';} ?>><?php _e('No', 'edgt') ?></option>
            </select>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'content_in_grid' )); ?>"><?php _e( 'Content In Grid:','edgt'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'content_in_grid' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'content_in_grid' )); ?>">
                <option value="yes" <?php if(esc_attr($content_in_grid) == "yes"){echo 'selected="selected"';} ?>><?php _e('Yes', 'edgt') ?></option>
                <option value="no" <?php if(esc_attr($content_in_grid) == "no"){echo 'selected="selected"';} ?>><?php _e('No', 'edgt') ?></option>
            </select>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'grid_size' )); ?>"><?php _e( 'Grid Size:','edgt'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'grid_size' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'grid_size' )); ?>">
                <option value="75" <?php if(esc_attr($grid_size) == "75"){echo 'selected="selected"';} ?>><?php _e('75/25', 'edgt') ?></option>
                <option value="50" <?php if(esc_attr($grid_size) == "50"){echo 'selected="selected"';} ?>><?php _e('50/50', 'edgt') ?></option>
                <option value="66" <?php if(esc_attr($grid_size) == "66"){echo 'selected="selected"';} ?>><?php _e('66', 'edgt') ?></option>
            </select>
        </p>
        
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'type' )); ?>"><?php _e( 'Type:','edgt'); ?></label>
            <select class="dependence" data-hide-with_icon="#<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container" data-show-with_icon="#<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container, #<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container" data-hide-normal="#<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container,#<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container, #<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container" data-show-with_custom_icon="#<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container,#<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container" data-hide-with_custom_icon="#<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container" id="<?php echo esc_attr($this->get_field_id( 'type' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'type' )); ?>">
                <option value="normal" ><?php _e('Normal', 'edgt') ?></option>
                <option value="with_icon" <?php if(esc_attr($type) == "with_icon"){echo 'selected="selected"';} ?>><?php _e('With Icon', 'edgt') ?></option>
                <option value="with_custom_icon" <?php if(esc_attr($type) == "with_custom_icon"){echo 'selected="selected"';} ?>><?php _e('With Custom Icon', 'edgt') ?></option>
            </select>
        </p>
        ...
        <div style="<?php if(!$icon_options_visible) { echo 'display: none;'; } ?>" id="<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>-container">
            <p>
                <!--ICON PACK-->
                <label for="<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>"><?php _e( 'Icon Pack:','edgt' ) ?></label>
                <select <?php print $icon_pack_data_attr_str; ?> class="dependence" id="<?php echo esc_attr($this->get_field_id( 'icon_pack' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'icon_pack' )); ?>">
                    ...
                    $icon_collections = $edgtIconCollections->getIconCollections();
            ...
            <?php if(is_array($edgtIconCollections->iconCollections) && count($edgtIconCollections->iconCollections)) { ?>

                <?php foreach($edgtIconCollections->iconCollections as $key => $collection) {
                ...
                ?>
                    <p id="<?php echo esc_attr($this->get_field_id($collection->param));  ?>-container" style="<?php if(!$icon_pack_visible) { echo 'display: none;'; } ?>">
                        <label for="<?php echo esc_attr($this->get_field_id($collection->param)); ?>"><?php _e( 'Icon:','edgt' ) ?></label>
            ...
            <?php } ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'icon_position' )); ?>"><?php _e( 'Icon Position:','edgt'); ?></label>
                <select id="<?php echo esc_attr($this->get_field_id( 'icon_position' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'icon_position' )); ?>">
                    <option value="top" <?php if(esc_attr($icon_position) == "top"){echo 'selected="selected"';} ?>><?php _e('Default/Top', 'edgt') ?></option>
                    <option value="middle" <?php if(esc_attr($icon_position) == "middle"){echo 'selected="selected"';} ?>><?php _e('Middle', 'edgt') ?></option>
                    <option value="bottom" <?php if(esc_attr($icon_position) == "bottom"){echo 'selected="selected"';} ?>><?php _e('Bottom', 'edgt') ?></option>
                </select>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'icon_color' )); ?>"><?php _e( 'Icon Color:','edgt' ) ?></label>
        ...
        <p style="<?php if($type !== 'with_custom_icon') { echo 'display: none;'; } ?>" id="<?php echo esc_attr($this->get_field_id('custom_icon')); ?>-container">
            <label for="<?php echo esc_attr($this->get_field_id( 'custom_icon' )); ?>"><?php _e( 'Custom Icon:','edgt' ) ?></label>
        ...
        <p style="<?php if(!in_array($type, array('with_icon', 'with_custom_icon'))) { echo 'display: none;'; } ?>" id="<?php echo esc_attr($this->get_field_id('icon_size')); ?>-container">
            <label for="<?php echo esc_attr($this->get_field_id( 'icon_size' )); ?>"><?php _e( 'Icon Size:','edgt' ) ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'background_color' )); ?>"><?php _e( 'Background Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_color' )); ?>"><?php _e( 'Border Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'box_padding' )); ?>"><?php _e( 'Box padding (top right bottom left) px', 'edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_button' )); ?>"><?php _e( 'Show Button:','edgt'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'show_button' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'show_button' )); ?>">
                <option value="yes" <?php if(esc_attr($show_button) == "yes"){echo 'selected="selected"';} ?>><?php _e('Yes', 'edgt') ?></option>
                <option value="no" <?php if(esc_attr($show_button) == "no"){echo 'selected="selected"';} ?>><?php _e('No', 'edgt') ?></option>
            </select>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_position' )); ?>"><?php _e( 'Button position:','edgt'); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id( 'button_position' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_position' )); ?>">
                <option value="right" <?php if(esc_attr($button_position) == "right"){echo 'selected="selected"';} ?>><?php _e('Right', 'edgt') ?></option>
                <option value="center" <?php if(esc_attr($button_position) == "center"){echo 'selected="selected"';} ?>><?php _e('Center', 'edgt') ?></option>
                <option value="left" <?php if(esc_attr($button_position) == "left"){echo 'selected="selected"';} ?>><?php _e('Left', 'edgt') ?></option>
            </select>
        </p>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_text' )); ?>"><?php _e( 'Button Text:','edgt' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'button_text' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'button_text' )); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
        </p>
        
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_link' )); ?>"><?php _e( 'Button Link:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_target' )); ?>"><?php _e( 'Button Target:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_text_color' )); ?>"><?php _e( 'Button Text Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_hover_text_color' )); ?>"><?php _e( 'Button Hover Text Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_background_color' )); ?>"><?php _e( 'Button Background Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_hover_background_color' )); ?>"><?php _e( 'Button Hover Background Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_border_color' )); ?>"><?php _e( 'Button Border Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_hover_border_color' )); ?>"><?php _e( 'Button Hover Border Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'button_border_width' )); ?>"><?php _e( 'Button Border Width', 'edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_radius' )); ?>"><?php _e( 'Button Radius', 'edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>"><?php _e( 'Text:','edgt'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php _e( 'Text Color:','edgt' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_size' )); ?>"><?php _e( 'Text Size:','edgt' ); ?></label>
...
function edgt_call_to_action_load(){   
	register_widget('Call_To_Action');
}

add_action('widgets_init', 'edgt_call_to_action_load');
