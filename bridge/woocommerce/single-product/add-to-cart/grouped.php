...
<form class="cart" method="post" enctype='multipart/form-data'>
					...
					<tr>
						...
						<td class="label">
							<label for="product-<?php echo $product_id; ?>">
								<?php echo $product->is_visible() ? '<a itemprop="url" href="' . get_permalink() . '">' . get_the_title() . '</a>' : get_the_title(); ?>
							</label>
						</td>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="<?php echo esc_attr($button_classes);?>"><?php echo $product->single_add_to_cart_text(); ?></button>
