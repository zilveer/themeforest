...
class Countdown implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
			...
			'params' => array(
                ...
                array(
                    'type' => 'colorpicker',
                    'heading' => 'Vertical Separator Color',
	...
	public function render($atts, $content = null)
	{
		...
		$html = qode_startit_get_shortcode_module_template_part('templates/countdown-template', 'countdown', '', $params);
