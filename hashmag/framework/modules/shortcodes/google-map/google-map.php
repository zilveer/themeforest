<?php
namespace Hashmag\Modules\GoogleMap;
...
class GoogleMap implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Mikado Google Map', 'hashmag'),
				'base' => $this->base,
				'category' => 'by MIKADO',
	...
	public function render($atts, $content = null) {
		...
		$html = hashmag_mikado_get_shortcode_module_template_part('templates/google-map-template', 'google-map', '', $params);
