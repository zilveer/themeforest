...
$output .= "
	...
	#theme-wrapper .mobile-advanced li.page_item_has_children > a::after { color: $secondary_color; }
...
$output .= "
	...
	.dokan-theme-flatastic .dokan-widget-area .widget .widget-title { background-color: $widget_head_bg; }
";
