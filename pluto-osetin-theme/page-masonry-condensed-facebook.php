<?php
/*
* Template Name: Masonry Condensed Facebook Likes
*/
get_header(); ?>
  ...
  <div class="main-content-i">
    ...
    <div class="content side-padded-content">
      ...
      <?php if(os_get_next_posts_link($osetin_query)): ?>
        <div class="isotope-next-params" data-params="<?php echo os_get_next_posts_link($osetin_query); ?>" data-layout-type="v3" data-template-type="page-masonry-condensed-facebook"></div>
