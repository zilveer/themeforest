...
;(function($) {
  OT_UI = {
    ...
    init_tabs: function() {
      ...
      $(".wrap.settings-wrap .ui-tabs").not('.ui-tabs-inner-panel').tabs({ 
        fx: { 
          opacity: "toggle", 
          duration: "fast"
        },
        active   : $.cookie('activetab')-1,
	...
	init_inner_tabs: function() {

      $(".ui-tabs-inner-panel").tabs({ 
        fx: { 
          opacity: "toggle", 
          duration: "fast"
        },
        active   : $.cookie('activetab-inner'),
        activate : function( event, ui ){
            $.cookie( 'activetab-inner', ui.newTab.index(),{
                expires : 10
            });
        }
      });
