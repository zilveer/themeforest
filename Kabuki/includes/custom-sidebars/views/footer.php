...
?>
<div id="csfooter">
<div style="display:none; max-width: 400px;text-align:center;overflow:hidden; margin: 10px auto;padding:5px; background:#fff; border-radius: 3px; border:1px solid #DFDFDF" id="<?php echo $workingcode; ?>">
