...
<div class="pretty-photo-sc"><a href="' . do_shortcode($content) . '" rel="prettyPhoto[pp_gal]"><img src="' . do_shortcode($content) . '" width="' . $width . '" height="' . $height . '" alt="Photo" /></a></div>';
}
...
<div class="video-photo-sc"><a href="' . do_shortcode($content) . '" rel="prettyPhoto"><img src="' . $img . '" width="' . $width . '" height="' . $height . '" alt="Video" /></a></div>';
}
?>