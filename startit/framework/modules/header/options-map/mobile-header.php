...
if ( ! function_exists('qode_startit_mobile_header_options_map') ) {

	function qode_startit_mobile_header_options_map() {
		...
		$panel_mobile_header = qode_startit_add_admin_panel(array(
			'title' => 'Mobile header',
		...
		qode_startit_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => qode_startit_get_text_transform_array(true)
		));
		...
		qode_startit_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => qode_startit_get_font_style_array(true)
		));
		...
		qode_startit_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => qode_startit_get_font_weight_array(true)
		));
		...
		qode_startit_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => qode_startit_icon_collections()->getIconCollectionsExclude(array('linea_icons', 'simple_line_icons'))
		));
	...
	add_action( 'qode_startit_options_map', 'qode_startit_mobile_header_options_map', 4);
