...
extract(shortcode_atts(array(
    ...
    'target' => '',
    'href' => '',
    'title' => __('Text on the button', "homeShop"),
    'call_text' => '',
...
if ( $href != '' ) {
    $button = '<span class="sc_button trans'.$size.$icon.'">'.$title.$i_icon.'</span>';
...
$css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, ' wpb_content_element clearfix text_vspace '.$position.$el_class, $this->settings['base']);

$output .= '<div class="'.$css_class.'">';
if ( $position == 'cta_align_left' ) $output .= $button;
$output .= apply_filters('wpb_cta_text', '<div class="wpb_call_text">'. $call_text . '</div>', array('content'=>$call_text));
