function insertTypeShortcode() {
	...
	shortcodeText = '<br />[pictureframe image="' + picture_imageurl + '" align="' + picture_align + '" lightbox="' + picture_lightbox + '" title="' + picture_title + '" link="' + picture_link + '" width="' + picture_width + '"]';	
