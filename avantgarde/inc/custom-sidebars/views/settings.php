...
<div id="sidebarslistdiv">
	...
	<tbody id="custom-sidebars" class="list:user user-list">
		...
		<tr id="cs-1" class="alternate">
			<td class="name column-name"><?php echo esc_attr($cs['name'])?></td>
			<td class="email column-email"><?php echo esc_attr($cs['description'])?></td>
			<td class="role column-date"><a class="" href="widgets.php"><?php _e('Configure Widgets','custom-sidebars'); ?></a></td>
			<td class="role column-rating"><a class="" href="themes.php?page=customsidebars&p=edit&id=<?php echo esc_attr($cs['id']); ?>"><?php _e('Edit','custom-sidebars'); ?></a></td>
			<td class="role column-rating"><a class="csdeletelink" href="themes.php?page=customsidebars&delete=<?php echo esc_attr($cs['id']); ?>&_n=<?php echo esc_attr($deletenonce); ?>"><?php _e('Delete','custom-sidebars'); ?></a></td>
		</tr>
		<?php endforeach;else:?>
		<tr id="cs-1" class="alternate">
