	...
	<div class="page_wrap <?php if(get_theme_mod("t2t_customizer_page_background_repeat") == "stretch") { echo "backstretch"; } ?>" data-background-image="<?php echo get_theme_mod("t2t_customizer_page_background"); ?>">
		<!-- Start Header -->
		<header id="vertical" class="<?php if(!$is_fullscreen_template) { if(get_theme_mod("t2t_customizer_page_header_background_repeat") == "stretch") { echo "backstretch"; } ?>" data-background-image="<?php echo get_theme_mod("t2t_customizer_page_header_background"); } ?>">
			<div class="container">
