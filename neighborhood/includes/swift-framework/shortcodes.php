<?php	
	...
	function social_icons($atts, $content = null) {
		...
		$xing = $vk = $snapchat = $twitch = $whatsapp = $rss = "";
		
		if (isset($options['xing_url'])) {
		$xing = $options['xing_url'];
		}
		
		if (isset($options['vk_url'])) {
		$vk = $options['vk_url'];
		}
		
		if (isset($options['snapchat_url'])) {
		$snapchat = $options['snapchat_url'];
		}
		
		if (isset($options['twitch_url'])) {
		$twitch = $options['twitch_url'];
		}
		
		if (isset($options['whatsapp_url'])) {
		$whatsapp = $options['whatsapp_url'];
		}
		
		if (isset($options['rss_url'])) {
		$rss = $options['rss_url'];
		}
		...
		if ($type == '') {
			...
			if ($vk) {
				$social_icons .= '<li class="vk"><a href="'.$vk.'" target="_blank"><i class="fa-vk"></i></a></li>'."\n";
			}
			if ($twitch) {
				$social_icons .= '<li class="twitch"><a href="'.$twitch.'" target="_blank"><i class="fa-twitch"></i></a></li>'."\n";
			}
			if ($snapchat) {
				$social_icons .= '<li class="snapchat"><a href="'.$snapchat.'" target="_blank"><i class="fa-snapchat"></i></a></li>'."\n";
			}
			if ($whatsapp) {
				$social_icons .= '<li class="whatsapp"><a href="'.$whatsapp.'" target="_blank"><i class="fa-whatsapp"></i></a></li>'."\n";
			}
			if ($rss) {
				$social_icons .= '<li class="rss"><a href="'.$rss.'" target="_blank"><i class="fa-rss"></i></a></li>'."\n";
			}
	...
	================================================= */
	if ( ! function_exists( 'sf_share_links' ) ) {
