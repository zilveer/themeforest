	...
	<div class="container_12">
    	<div class="col1-layout">
			...
			<?php if (have_posts()): while (have_posts()): the_post() ?>
				...
				?>
				<li class="grid_12 <?php echo $skills_as_text; ?>">
				<?php $skills_as_text = ''; ?>
            		<div class="portfolio">
            		<?php if($themeteam_video_embed) { ?>
						<div class="imgframe">
							<a href="<?php echo $themeteam_video_embed; ?>" rel="prettyPhoto">
          						<?php the_post_thumbnail('thumb940x530'); ?><span class="frame"><span><span><span><span><span class="empty"><em class="play"> </em></span></span></span></span></span></span>
          					</a>
          				</div>
          			<?php }else if(has_post_thumbnail()){ ?>
          				<div class="imgframe">
          					<a href="<?php echo esc_attr($full[0]); ?>" rel="prettyPhoto">
          						<?php the_post_thumbnail('thumb940x530'); ?><span class="frame"><span><span><span><span><span class="empty"><em class="zoom"> </em></span></span></span></span></span></span>
          					</a>
          				</div>
          			<?php } ?>
          				<article class="entry">
