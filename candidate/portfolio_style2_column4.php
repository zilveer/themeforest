<?php
// Template Name: MediaPagination Column4
?>
...
$style_media = 'col-lg-3 col-md-4 col-sm-6 ';
	...
	$style_media = 'col-lg-3 col-md-4 col-sm-12 ';
	$type = 'post-blog';
		...
		<section class="section full-width-bg gray-bg">
			...
			<div class="row">
				...
				<div id="container-items-portfolio" > 
					...
					if(get_option('sense_projects_num4') && get_option('sense_projects_num4') != '') {
					$pp = get_option('sense_projects_num4');
					}
