...
<div class="wrap about-wrap redux-status">
    <h1><?php esc_html_e( 'Redux Framework - System Status', 'redux-framework' ); ?></h1>
    ...
    <div class="updated redux-message">
        <p><?php esc_html_e( 'Please copy and paste this information in your ticket when contacting support:', 'redux-framework' ); ?> </p>

        <p class="submit"><a href="#"
                             class="button-primary debug-report"><?php esc_html_e( 'Get System Report', 'redux-framework' ); ?></a>
            <a class="skip button-primary"
               ...
               target="_blank"><?php esc_html_e( 'Understanding the Status Report', 'redux-framework' ); ?></a></p>
        ...
        <div id="debug-report">
            ...
            <p class="submit">
                <button id="copy-for-support" class="button-primary redux-hint-qtip" href="#"
                        qtip-content="<?php esc_html_e( 'Copied!', 'redux-framework' ); ?>"><?php esc_html_e( 'Copy for Support', 'redux-framework' ); ?></button>
            </p>
        </div>
    </div>
    <br/>
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            <td data-export-label="Redux Version"><?php esc_html_e( 'Redux Version', 'redux-framework' ); ?>:</td>
        ...
        <tr>
            <td data-export-label="Redux Data Directory Writable"><?php esc_html_e( 'Redux Data Directory Writable', 'redux-framework' ); ?>
                :
            </td>
            ...
            foreach ( $sysinfo['plugins'] as $name => $plugin_data ) {
                ...
                if ( ! empty( $plugin_data['Name'] ) ) {
                    ...
                    <tr>
                        ...
                        <td class="help">&nbsp;</td>
                        <td><?php echo sprintf( esc_html__( 'by %s', 'by author', 'redux-framework' ), $plugin_data['Author'] ) . ' &ndash; ' . esc_html( $plugin_data['Version'] ) . $version_string . $network_string; ?></td>
                    </tr>
                <?php
                }
            }
        ...
        if ( ! empty( $sysinfo['redux_instances'] ) && is_array( $sysinfo['redux_instances'] ) ) {
            foreach ( $sysinfo['redux_instances'] as $inst => $data ) {
                ...
                <table class="redux_status_table widefat" cellspacing="0" id="status">
                    ...
                    <tr>
                        <th colspan="3"
                            data-export-label="Redux Instance: <?php echo $inst_name; ?>"><?php esc_html_e( 'Redux Instance: ', 'redux-framework' );
                                echo $inst_name; ?></th>
                    </tr>
                    </thead>
                    <tbody>
