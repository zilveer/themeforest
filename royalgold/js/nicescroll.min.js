/* jquery.nicescroll 3.6.0 InuYaksa MIT http://nicescroll.areaaperta.com */
...
jQuery(function(){
	if (!navigator.userAgent.toLowerCase().match(/(iphone|ipod|ipad|android)/)) {
		var scroll_selector = "html,#header";
		if (jQuery('html').hasClass('oldie')) scroll_selector = "html";
		htmlScrollbar = jQuery(scroll_selector).niceScroll({
