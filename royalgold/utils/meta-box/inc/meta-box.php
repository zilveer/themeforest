...
if ( ! class_exists( 'RW_Meta_Box' ) ) {
	...
	class RW_Meta_Box {
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( 'royalgold', RWMB_CSS_URL . 'style.css', array(), RWMB_VER );
				...
				echo '
					...
					if ( typeof rwmb == "undefined" )
					{
						var rwmb = {
							...
							summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'royalgold' ) . '"
						};
					}
					else
					{
		...
		static function end_html( $html, $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . __( '+', 'royalgold' ) . '</a>';
		...
		{
			$button = '<a href="#" class="rwmb-button button remove-clone">&#8211;</a>';
