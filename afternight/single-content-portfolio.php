...
?>
<article class="post portfolio-single landscape <?php echo $no_meta_class; ?>">
    ...
    <div class="row element">
    	...
    	<div class="<?php if( options::logic( 'blog_post' , 'meta' ) && meta::logic( $post , 'settings' , 'meta' )) echo 'four columns'; else { echo 'hidden';}?>">

            <?php if(meta::logic( $post , 'settings' , 'meta' ) && options::logic( 'blog_post' , 'meta' )){  /*check if meta is enabled in general posts setting and  for this post*/ ?>
            <ul class="full-entry-meta">
                ...
                ?>
                <li>
                    <div class="meta_name"><?php _e('More','cosmotheme'); ?></div>
                    <div class="meta_value">
            ...
            <?php   } /*EOF if meta is enabled*/ ?>  
            
            <div class="clear"></div>
            
        </div>
        <div class="<?php if(!( options::logic( 'blog_post' , 'meta' ) && meta::logic( $post , 'settings' , 'meta' ))) echo 'twelve columns'; else { echo 'eight columns'; } ?> entry-content">
            <?php 
