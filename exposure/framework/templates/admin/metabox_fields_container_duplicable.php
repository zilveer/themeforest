...
<div class="thb-fields-container duplicable <?php echo $fields_container->isSortable() ? 'sortable' : ''; ?> <?php echo $fields_container->isPrependable() ? 'prependable' : ''; ?> <?php echo count($fields) == 0 ? 'no-fields' : ''; ?>" id="thb-fields-container-<?php echo $fields_container->getSlug(); ?>" data-slug="<?php echo $fields_container->getSlug(); ?>">
