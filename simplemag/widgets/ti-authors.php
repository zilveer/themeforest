	...
	**/
	public function widget( $args, $instance ) {
        ...
        <div class="clearfix <?php echo $widget_type; ?>">
            ...
            $author_avatar = get_avatar( get_the_author_meta( 'user_email', $author_id ), '64', '', get_the_author_meta( 'display_name', $author_id ) );
            ?>
...
/*
 * Register and load the widget into Widgets
*/
function ti_load_widget_authors() {
    register_widget( 'TI_Authors' );
}

add_action( 'widgets_init', 'ti_load_widget_authors' );