...
// Video background
if( get_mental_option( 'menubar_background_video' ) ) { $menubar_background_video = get_mental_option( 'menubar_background_video' ); }
if( get_mental_option( 'menubar_background_video_opacity' ) ) { $menubar_background_video_opacity = get_mental_option( 'menubar_background_video_opacity' ); }
?>
...
<div id="menu-bar" style="<?php if ( ! empty( $background_image ) ) { echo ' background-image: url(\'' . esc_url($background_image) . '\');'; } ?>">
	...
	<?php if ( ! empty( $menubar_background_video ) ): ?>
		<div class="st-video-background" style="opacity: <?php echo esc_attr($menubar_background_video_opacity);?>; z-index: -1;">
