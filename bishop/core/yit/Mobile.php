...
/**
 * Advanced management for mobile
 *
 * @class YIT_Mobile
 * @package    Yithemes
 * @since      2.0.0
 ...
 */
class YIT_Mobile extends YIT_Object {
	...
	protected static $properties = array(
		...
		'IE'      => array('IEMobile/[VER];', 'IEMobile [VER]', 'MSIE [VER];', 'rv:[VER].0;'),
 ...
 */
function YIT_Mobile() {
	return YIT_Registry::get_instance()->mobile;
}