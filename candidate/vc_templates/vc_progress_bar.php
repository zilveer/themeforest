...
$output = '<div class="vc_progress_bar ' . esc_attr( $css_class ) . '">';
...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<p>' . $line['label'] .'</p>
						<div class="progressbar vc_single_bar ' . $bgcolor . '" data-percent="' . esc_attr( $percentage_value ) . '">
							<span class="progress-percent">' . $unit . '</span>
							<div class="vc_bar progress-width"  ' . $line['bgcolor'] . '></div>
						</div>';
