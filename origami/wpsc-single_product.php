...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					<div class="single-imagecol imgframe">
						<?php if ( wpsc_the_product_thumbnail() ) : 
                            
                                ?><a rel="<?php echo wpsc_the_product_title(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?>" href="<?php echo wpsc_the_product_image(); ?>"><img class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php 
                                echo wpsc_the_product_thumbnail($image_width,$image_height,'','single'); ?>"/><span class="frame"><span><span><span><span><span class="empty"><em> </em></span></span></span></span></span></span></a><?php 
					...
					<div class="productcol">			
						...
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php if(wpsc_has_multi_adding()): ?>
								...
								<input type="text" class="text" id="wpsc_quantity_update_<?php echo wpsc_the_product_id(); ?>" name="wpsc_quantity_update" size="2" value="1" />
							...
							<?php endif; ?><input type="hidden" value="add_to_cart" name="wpsc_ajax_action" />
                            ...
                            if((get_option('hide_addtocart_button') == 0) &&  (get_option('addtocart_or_buynow') !='1')) : ?>
								<?php if(wpsc_product_has_stock()) : ?><div class="wpsc_buy_button_container"><?php 
                                ...
                                if(wpsc_product_external_link(wpsc_the_product_id()) != '') : ?>
											...
											<?php else: ?><input type="submit" value="<?php _e('Add To Cart', 'wpsc'); ?>" name="Buy" class="wpsc_buy_button" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"/>
											<?php endif; ?>
										<div class="wpsc_loading_animation"><img title="Loading" alt="Loading" src="<?php echo wpsc_loading_animation_url(); ?>" /><?php _e('Updating cart...', 'wpsc'); ?></div>
									</div>
								<?php else : ?>
