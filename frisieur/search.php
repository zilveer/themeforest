...
<section id="blog">
    ...
    <div id="content" class="waitForLoad fadeInRight">
            ...
            while( have_posts() ) {
                ...
                <article id="post-<?php the_ID(); ?>" class="blog-post <?php echo $post_classes; ?>">
                    ...
                    <div class="actions">
                        ...
                        <a href="<?php the_permalink(); ?>" class="button button-brown"><i class="icon-file-alt"></i> <?php _e( 'Read more...', 'martanian' ); ?></a>
        ...
        <div id="blog-pagination">
            ...
            <p class="left"><?php previous_posts_link( '&laquo; Newer results' ); ?></p>
            <p class="right"><?php next_posts_link( 'Older results &raquo;' ); ?></p>
