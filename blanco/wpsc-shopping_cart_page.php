         ...
         <?php do_action ( "wpsc_before_checkout_cart_row" ); ?>
          <tr class="product_row product_row_<?php echo wpsc_the_cart_item_key(); ?> <?php echo $alt_class;?>">
             ...
             <?php do_action ( "wpsc_before_checkout_cart_item_image" ); ?>
                <img src="<?php echo wpsc_cart_item_image(75, 75); ?>" alt="<?php echo wpsc_cart_item_name(); ?>" title="<?php echo wpsc_cart_item_name(); ?>" class="product_image" />
    ...
    <?php if(wpsc_show_user_login_form()):
		...
		<div class="wpsc_registration_form">
	        ...
	        <fieldset class='wpsc_registration_form wpsc_right_registration'>
	            ...
	            <div class="wpsc_signup_text"><?php _e('Signing up is free and easy! Please fill out your details and your registration will happen automatically as you checkout. Don\'t forget to use your details to log in with next time!', 'wp-e-commerce');?></div>
	        </fieldset>
        ...
        <?php if(wpsc_checkout_form_is_header() == true){
               ...
               <tr class='same_as_shipping_row'>
                  ...
                  wpsc_update_customer_meta( 'shipping_same_as_billing', $shipping_same_as_billing );
                   ...
                   ?>
					<label for='shippingSameBilling'><?php _e('Same as billing address:','wp-e-commerce'); ?></label>
