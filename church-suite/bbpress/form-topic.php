			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<?php if ( !function_exists( 'wp_editor' ) ) : ?>
						...
						<p>
							<label for="bbp_topic_content"><?php esc_html_e( 'Topic:', 'bbpress' ); ?></label><br />
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit"><?php esc_html_e( 'Submit', 'bbpress' ); ?></button>
