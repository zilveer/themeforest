	    	...
	    	<!-- Begin main content -->
    			...
    			<form id="contact_form" method="post" action="<?php echo get_permalink($current_page->ID); ?>">
			    		...
			    		if(is_array($pp_contact_form) && !empty($pp_contact_form))
			    		{
			    			foreach($pp_contact_form as $form_input)
			    			{
			    				switch($form_input)
			    				{
			    					case 1:
			    	?>
			    					<label for="your_name"><?php echo _e( 'Name (required)', THEMEDOMAIN ); ?></label>
			        				<input id="your_name" name="your_name" type="text" class="required_field" title="<?php echo _e( 'Name', THEMEDOMAIN ); ?>*" style="width:93%"/>
			        				<br/>		
			    	<?php
			    					break;
			    	...
			    	?>
			    					...
			    					<label for="email"><?php echo _e( 'Email (required)', THEMEDOMAIN ); ?></label>
			        				<input id="email" name="email" type="text" class="required_field email" title="<?php echo _e( 'Email', THEMEDOMAIN ); ?>*" style="width:93%"/>
			        				<br/>			
			    	<?php
			    					break;
			    	...
			    	?>
			    					...
			    					<label for="message"><?php echo _e( 'Message (required)', THEMEDOMAIN ); ?></label>
			    	...
			    	?>
			        				...
			        				<input id="address" name="address" type="text" title="<?php echo _e( 'Address', THEMEDOMAIN ); ?>" style="width:93%"/>
			        				<br/>		
			    	<?php
			    					break;
			    	...
			    	?>
			        				...
			        				<input id="phone" name="phone" type="text" title="<?php echo _e( 'Phone', THEMEDOMAIN ); ?>" style="width:93%"/>
			        				<br/>		
			    	<?php
			    					break;
			    	...
			    	?>
			        				...
			        				<input id="mobile" name="mobile" type="text" title="<?php echo _e( 'Mobile', THEMEDOMAIN ); ?>" style="width:93%"/>
			        				<br/>			
			    	<?php
			    					break;
			    	...
			    	?>
			        				...
			        				<input id="company" name="company" type="text" title="<?php echo _e( 'Company Name', THEMEDOMAIN ); ?>" style="width:93%"/>
			        				<br/>			
			    	<?php
			    					break;
			    	...
			    	?>
			        				...
			        				<input id="country" name="country" type="text" title="<?php echo _e( 'Country', THEMEDOMAIN ); ?>" style="width:93%"/>
			        				<br/>			
			    	<?php
			    					break;
			    				}
