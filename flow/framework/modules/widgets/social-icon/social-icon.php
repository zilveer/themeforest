 ...
 */
class FlowSocialIconWidget extends FlowWidget {
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            'Elated Social Icon Widget' // Name
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            flow_elated_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type' => 'textfield',
                    'title' => 'Link',
    ...
    public function widget($args, $instance) {
        ...
        <div class="widget eltd-social-icon-widget-holder" <?php flow_elated_inline_style($social_icon_styles) ?> >
        <a <?php echo flow_elated_get_inline_attr($hover_color, 'data-hover-color'); ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
