...
?>
<div id="reviews">
	<h3 class="reviews-title"><?php printf( __('Reviews (%s)', ET_DOMAIN), $product->get_review_count() );  ?></h3>
	<div id="comments">
		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						'title_reply'          => '<span>' . __('Leave a reply', ET_DOMAIN) . '</span>',
					...
					$comment_form['comment_field'] .= '<div class="form-group"><label for="comment" class="control-label">'.__('Your Review', ET_DOMAIN).'</label><textarea class="form-control required-field"  id="comment" name="comment" cols="45" rows="12" aria-required="true"></textarea></div>';
