...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		...
		$icon = tb_default(of_get_option('favicon'), $imagepath . 'favicon.png');

		$of_page = add_theme_page( __("Grace Options", 'options_framework_theme'), __("Grace Options", 'options_framework_theme'), 'edit_theme_options', 'options-framework','optionsframework_page' );
...
/*******************************************/
if ( ! function_exists( 'of_get_all_options' ) ) {

	/**
	 * Get All Theme Option.
	 */
	 
	function of_get_all_options() {
		$config = get_option( 'optionsframework' );
