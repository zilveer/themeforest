...
$galleries_arr = get_posts($args);
$galleries_select = array();
$galleries_select['(Hide image gallery)'] = '';
	...
	array (
		...
		'portfolios' => array(
			array("section" => "Content Type", "id" => "portfolio_type", "type" => "select", "title" => "Video Type", "description" => "Select content type for this portfolio item:", 
				...
				array("section" => "Content Type", "id" => "portfolio_gallery_id", "type" => "select", "title" => "Featured Image Gallery (for portfolio content type only)", "description" => "If you select \"Portfolio Content\" or \"AJAX Portfolio Content\" you can select image gallery to display on single portfolio page.", "items" => $galleries_select),
		),
		...
		'gallery' => array(
			array("section" => "Content Type", "id" => "gallery", "title" => "Custom Gallery URL", "description" => "Enter custom URL for this gallery so it will be linked to this URL instead on galleries grid template"),
		),
);
