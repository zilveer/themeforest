...
if(isset($edgt_options['blog_standard_type_content_position'])){
	$blog_content_position = $edgt_options['blog_standard_type_content_position'];
}
...
if(isset($edgt_options['blog_standard_type_number_of_chars']) && $edgt_options['blog_standard_type_number_of_chars'] != "") {
    edgt_set_blog_word_count(esc_attr($edgt_options['blog_standard_type_number_of_chars']));
}
