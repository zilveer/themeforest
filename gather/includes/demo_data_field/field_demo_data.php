...
if ( ! class_exists( 'ReduxFramework_demo_data' ) ) {
    class ReduxFramework_demo_data {
        ...
        function render() {
            ...
            // }
            echo '<div class="cththemes_import_message" id="cththemes_import_message"></div><a href="#" class="button button-primary cththemes_import" id="cththemes_import">Import Demo Data</a>     <img id="cththemes_import_loading" src="'.get_template_directory_uri().'/includes/demo_data_field/ajax-loader.gif" alt="loading" style="display:none;margin-top:9px;margin-left:15px;">';
        }
