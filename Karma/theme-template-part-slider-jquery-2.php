<?php
//grab custom slider bg color from page-metabox
global $post;
$tt_jquery2_slider_bg = get_post_meta($post->ID, 'truethemes_slider_jq_bgcolor', true);
?>

<div class="jquery2-slider-wrap flexslider">
	<div class="jquery2-slider-bg" style="background-color:<?php if (!empty($tt_jquery2_slider_bg)): echo $tt_jquery2_slider_bg; endif;?>">
        <ul class="slides">
...
$tt_karma_slider_category_id = (int)$tt_karma_slider_category[0];
        ...
        <?php //normal image layout (436 x 270) 
        ...
        <?php //full-width image layout (840 x 270)
        ...
        <?php //full-bleed image layout - 920 x 360 
        elseif ('full-bleed-image' == $slider_image_layout):
        $image_width  = 920;
        $image_height = 358;
        $image = truethemes_crop_image($thumb='',$slider_image,$image_width,$image_height);
        ?>
