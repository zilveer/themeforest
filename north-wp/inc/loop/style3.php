...
<section class="blog-section row posts style3<?php if ($blog_header) { ?> low-top-padding<?php } ?>" id="infinitescroll" data-count="<?php echo get_option('posts_per_page'); ?>" data-total="<?php echo $wp_query->max_num_pages; ?>" data-type="style3">
