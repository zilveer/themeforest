...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page( THEMENAME, 'Theme Options', 'edit_theme_options', 'theme-options', 'optionsframework_options_page');
...
function of_style_only(){
	...
	wp_enqueue_style(array('css-loaders','font-awesome'));
	wp_enqueue_style('laborator-style', ADMIN_DIR . 'assets/css/laborator-smof.css', null, THEMEVERSION);
...
function of_load_only()
{
	...
	wp_enqueue_script('smof', ADMIN_DIR .'assets/js/smof.js', array( 'jquery' ), THEMEVERSION);
