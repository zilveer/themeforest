    ...
    <div class="social_wrapper">
        <ul>
        	...
        	<?php
        		...
        		{
        	?>
        	<li><a title="Instagram" href="http://instagram.com/<?php echo $pp_instagram_username; ?>" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/social/instagram.png" alt=""/></a></li>
        	<?php
        		}
        	?>
        </ul>
