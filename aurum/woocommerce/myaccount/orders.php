...
<?php if ( $has_orders ) : ?>
	...
	<div class="page-title">
		<h2>
			<?php _e('Orders <small>My recent orders</small>', 'aurum'); ?>
		</h2>
	</div>
	<?php // end: modified by Arlind ?>

	<?php // start: modified by Arlind ?>
	<table class="woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table view-cart order-list">
	<?php // end: modified by Arlind ?>
		<thead>
			<tr>
