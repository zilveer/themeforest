...
class ezTweet {
    ...
    private function getTwitterJSON() {
        ...
        $tmhOAuth = new tmhOAuth(array(
            'host'                  => esc_attr($_POST['request']['host']),
        ...
        $url = esc_attr($_POST['request']['url']);
        $params = esc_attr($_POST['request']['parameters']);
...
$ezTweet = new ezTweet;
$ezTweet->consumer_key = get_theme_option('consumer_key');
$ezTweet->consumer_secret = get_theme_option('consumer_secret');
$ezTweet->user_token = get_theme_option('user_token');
$ezTweet->user_secret = get_theme_option('user_secret');
$ezTweet->fetch();
