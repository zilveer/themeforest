			...
			<div class="inner">
				...
				<div class="inner_wrapper">
					...
					<div class="sidebar_content">
						...
						<h1 class="cufon"><?php printf( __( 'Results for &quot;%s&quot;', '' ), '' . get_search_query() . '' ); ?></h1><br/><hr/>
...
?>
						...
						<div class="post_wrapper">
							...
							<div class="post_header">
								...
								<div class="post_detail" style="float:left;width:400px">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/calendar--pencil.png" alt="" class="middle"/>&nbsp;Posted on <?php the_time('F j, Y'); ?>&nbsp;&nbsp;&nbsp;&nbsp;
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/user--pencil.png" alt="" class="middle"/>&nbsp;by&nbsp;<?php the_author(); ?>
								</div>
								<div class="post_detail" style="float:right;width:100px;text-align:right;margin-right:5px">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/balloon-left.png" alt="" class="middle"/>&nbsp;<?php comments_number('0', '1', '%'); ?>
								</div>
								</div>
							</div>
