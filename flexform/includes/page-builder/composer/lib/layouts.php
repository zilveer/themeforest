                    ...
                    <div class="container">
                        <div class="nav-collapse">
                            ...
                            <ul class="nav pull-right">
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle wpb_templates" href="#">'.__('Custom Templates', 'js_composer').' <b class="caret"></b></a>
                            ...
                            <ul class="nav pull-right">
                                <li class="dropdown">
                                    <a data-toggle="dropdown" class="dropdown-toggle wpb_templates" href="#">'.__('Pre-Built Templates', 'js_composer').' <b class="caret"></b></a>
                                    <ul class="dropdown-menu wpb_templates_ul">
