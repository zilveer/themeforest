<?php 
	...
	*/
	...
	function sf_customize_register($wp_customize) {
		...
		$wp_customize->add_setting( 'theme_detailing', array(
			'default'        => 'light',
			'type'           => 'option',
			'transport'      => 'postMessage',
			'capability'     => 'edit_theme_options',
		...
		$wp_customize->add_control( 'theme_detailing', array(
		    'label'      => __( 'Theme Detailing', 'swiftframework' ),
		    'section'    => 'color_scheme',
		    'settings'   => 'theme_detailing',
		    'type'       => 'select',
		    'choices'    => array(
		        'light' => 'Light',
		        'dark' => 'Dark'
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ticker_bg_color', array(
			'label'   => __( 'Ticker Background Color', 'swiftframework' ),
			'section' => 'header_styling',
			'settings'   => 'ticker_bg_color',
		) ) );
		
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'ticker_text_color', array(
			'label'   => __( 'Ticker Text Color', 'swiftframework' ),
			'section' => 'header_styling',
			'settings'   => 'ticker_text_color',
		) ) );	
		...
		$wp_customize->add_setting( 'footer_bg_color1', array(
			'default'        => '#FFFFFF',
			'type'           => 'option',
			'transport'      => 'postMessage',
			'capability'     => 'edit_theme_options',
		) );
		$wp_customize->add_setting( 'footer_bg_color2', array(
			'default'        => '#F7F7F7',
			'type'           => 'option',
			'transport'      => 'postMessage',
			'capability'     => 'edit_theme_options',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_bg_color1', array(
			'label'   => __( 'Footer Background Color Gradient From', 'swiftframework' ),
			'section' => 'footer_styling',
			'settings'   => 'footer_bg_color1',
			'priority'       => 1,
		) ) );
		
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_bg_color2', array(
			'label'   => __( 'Footer Background Color Gradient To', 'swiftframework' ),
			'section' => 'footer_styling',
	...
	function sf_customize_preview() {
		...
		wp.customize('secondary_accent_color',function( value ) {
			value.bind(function(to) {
				$('article.type-post #respond .form-submit input#submit,.pagination-wrap li span.current,.flexslider ul.slides,ul.wp-tag-cloud li > a,.loved-item .loved-count,.twitter-link,.subscribers-list li > a.social-circle,.sidebar .widget_calendar tbody tr > td a,.related-item figure,.ui-tabs .ui-tabs-nav li.ui-tabs-active a, .wpb_accordion .wpb_accordion_section > h3.ui-state-active a').css('background-color', to ? to : '' );
				$('#posts-slider .flex-caption-large .comments-likes > div,#posts-slider .flex-caption-large .comments-likes span.loved,.sidebar .widget_calendar tfoot a,.widget_sf_infocus_widget .infocus-item h5 a').css('color', to ? to : '' );
				$('.page-heading h1,#calendar_wrap caption').css('border-bottom-color', to ? to : '' );
				$('.wp-tag-cloud li a:before').css('border-right-color', to ? to : '' );
			});
		});
		
		wp.customize('secondary_accent_alt_color',function( value ) {
			value.bind(function(to) {
				$('.pagination-wrap li span.current,#posts-slider .flex-caption-large,#posts-slider .flex-caption-large h1 a,ul.wp-tag-cloud li > a,.loved-item .loved-count,.twitter-link > a > span,.subscribers-list li > a.social-circle,.sidebar .widget_calendar tbody tr > td a,.ui-tabs .ui-tabs-nav li.ui-tabs-active a, .wpb_accordion .wpb_accordion_section > h3.ui-state-active a,.ui-accordion .ui-accordion-header.ui-state-active .ui-icon').css('color', to ? to : '' );
			});
		});
		
		wp.customize('theme_detailing',function( value ) {
			value.bind(function(to) {
				if (to == "dark") {
