						...
						<div class="form-field form-required">
							...
							switch ( $customField[ 'type' ] ) {
								...
								case "selectbox-animation": {
									$page_transitions = "4";
									if (isset($qode_options_magnet['page_transitions'])) $page_transitions = $qode_options_magnet['page_transitions'];
									if($page_transitions == "1" || $page_transitions == "2" || $page_transitions == "3" || $page_transitions == "4"){
										...
										?>
											...
											<option value="curtain" <?php if (get_post_meta( $post->ID, $this->prefix . $customField[ 'name' ], true ) == "curtain" ) { ?> selected="selected" <?php } ?>>Curtain</option>
