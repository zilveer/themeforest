 ...
 */
add_action('widgets_init', 'OrangeIdea_load_latest_post_widgets');

function OrangeIdea_load_latest_post_widgets()
{
	register_widget('OrangeIdea_Latest_Posts_Widget');
}
 ...
 *
 */
	class OrangeIdea_Latest_Posts_Widget extends WP_Widget {

	/**
	 * Widget setup.
	 */		
	function OrangeIdea_Latest_Posts_Widget() {
		
		/* Widget settings. */
		$widget_ops = array('classname' => 'OrangeIdea_latest_post_widget', 'description' => __( 'OrangeIdea: Latest Posts', 'orangeidea' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'OrangeIdea_latest_post_widget' );

		/* Create the widget. */		
		$this->__construct( 'OrangeIdea_latest_post_widget', 'OrangeIdea: Latest Posts ', $widget_ops);
	}
