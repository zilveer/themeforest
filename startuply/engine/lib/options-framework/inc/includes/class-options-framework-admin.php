...
class Options_Framework_Admin {
	...
	function add_custom_options_page() {
		...
		// Below code from https://gist.github.com/devinsays/884d6abe92857a329d99
		switch( $menu['mode'] ) {
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'startuply_lato', "http://fonts.googleapis.com/css?family=Lato:100,300,400,700,900,100italic,300italic,400italic,700italic,900italic" );
	 ...
	 */
	 function options_page() { ?>
		...
		<div class="theme-options-heading">
			<h1>Startup<span class="highlight">ly</span></h1>
		</div>

		<aside class="nav-tab-wrapper">
			<ul>
		...
		<div id="optionsframework-metabox" class="metabox-holder">
			<div id="optionsframework">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save', 'textdomain' ); ?>" />
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			...
			do_action( 'optionsframework_after_validate', $default );
			return $default;
		}
