 ...
 */
/**
Template Name: Full Width Listing
*/
get_header(); ?>
        ...
        <div class="grid_12 col1-layout">
          <div class="clearfix">
             ...
             <div class="post">
                ...
                <div class="imgframe"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_post_thumbnail('thumb940'); ?><span class="frame"><span><span><span><span><span class="empty"><em> </em></span></span></span></span></span></span></a></div>
                <?php endif ?>
