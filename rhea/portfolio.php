			...
			<div class="inner">
				...
				<?php
					foreach($all_photo_arr as $key => $portfolio_item)
					{
						...
						if(has_post_thumbnail($portfolio_item->ID, 'portfolio'))
    					{
    						$image_id = get_post_thumbnail_id($portfolio_item->ID);
						    $image_url = wp_get_attachment_image_src($image_id, 'full', true);
    					    $small_image_url = wp_get_attachment_image_src($image_id, 'portfolio', true);
    					}
				...
				<div class="one_half <?php echo $last_class; ?>" style="margin-bottom:6%;margin-top:1%">
				<div class="one_half gallery2" style="width:100%">
    				...
    				?>		
							...
							<?php
    							...
    							?>
    							<div class="shadow">
    								<div class="zoom"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/Spotlight.png" alt=""/></div>
    							</div>
...
<div style="display:none;">
    <div id="video_<?php echo $portfolio_video_id; ?>" style="width:640px;height:360px">
        ...
        <iframe src="http://player.vimeo.com/video/<?php echo $portfolio_video_id; ?>?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="640" height="360" frameborder="0"></iframe>
				...
				<br class="clear"/>
				<div class="portfolio_desc" style="width:300px;padding-top:20px">
				    <h6 class="cufon"><?php echo $portfolio_item->post_title?></h6><br/>
				    <span>
