...
if ( !function_exists( 'morning_records_template_services_2_theme_setup' ) ) {
	add_action( 'morning_records_action_before_init_theme', 'morning_records_template_services_2_theme_setup', 1 );
	function morning_records_template_services_2_theme_setup() {
		morning_records_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'morning-records'),
...
// Template output
if ( !function_exists( 'morning_records_template_services_2_output' ) ) {
	function morning_records_template_services_2_output($post_options, $post_data) {
