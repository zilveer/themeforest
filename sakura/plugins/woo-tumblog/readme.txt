=== WooTumblog ===
Contributors: Jeffikus of WooThemes
Donate link: http://www.woothemes.com/
Tags: tumblr, tumblog, quickpress, custom taxonomy, post
...
1. Woo Tumblog Dashboard Widget.
2. Twenty Ten integration
3. Posts Tumblog Filter and Menu Options.
4. Tumblog Custom Fields and Taxonomy in Add Post.
5. Woo Tumblog Options Page
...
= 2.0.2 =
* Only load tumblog styles on dashboard

= 2.0.1 =
 * s3 compatibility fix with image resizer option
 
= 2.0.0 =
 * Now includes Post Formats support!
