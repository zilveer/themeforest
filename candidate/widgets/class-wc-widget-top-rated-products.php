...
class Candidat_WC_Widget_Top_Rated_Products extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a list of your top rated products on your site.', 'candidate' );
		$this->widget_id          = 'woocommerce_top_rated_products';
		$this->widget_name        = __( 'WooCommerce Top Rated Products', 'candidate' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => __( 'Top Rated Products', 'candidate' ),
